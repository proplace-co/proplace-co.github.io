...
`;class G extends u.Component{constructor(){super(...arguments);st(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(n,r){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,n,r.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Sr=8;function Cr(){const{t,lang:a,token:n,dossiers:r,caps:i,markRow:o,dispatch:c}=E(),[s,d]=u.useState(!1),[m,h]=u.useState(!1),[l,b]=u.useState(!1),v=n||"home",{names:x,verdicts:f}=u.useMemo(()=>{const w=[],k={};return r.forEach(N=>{N.kind!=="target"||!N.name||(w.push(N.name),k[N.name]=ya(N)||"")}),{names:w,verdicts:k}},[r]),g=u.useMemo(()=>x.length?wa(v,x,f,a):null,[v,x.length]);if(!i.pipe||s||!g||g.firstVisit||!g.added.length&&!g.gone.length)return null;const p=m?g.added:g.added.slice(0,Sr),y=g.added.length-p.length,C=w=>{const k=r.find(N=>N.name===w);k&&(o(k.id),c({type:"popup",id:k.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(g.added.length,g.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{d(!0),ka(v,x,f,g.fp,a)},children:"×"})]}),!!g.added.length&&e.jsxs("div",{className:"since-c",children:[p.map(w=>e.jsx("button",{type:"button",onClick:()=>C(w),children:w},w)),y>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>h(!0),children:t.sinceMore(y)})]}),!!g.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>b(w=>!w),children:t.sinceOut(g.gone.length)}),l&&g.gone.slice(0,20).map(w=>e.jsx("span",{className:"gone",children:w},w))]})]})}const We=600,xe=62,kt="atl2:fstats";function zr(){const{t,lang:a,data:n,caps:r,st:i,dispatch:o}=E(),[c,s]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(kt)==="on"}catch{return!1}}),d=n.stats,m=u.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),h=u.useMemo(()=>{if(d!=null&&d.since)return d.since;const y=new Date;return y.setDate(y.getDate()-((d==null?void 0:d.window_days)||30)),y.toISOString().slice(0,10)},[d==null?void 0:d.since,d==null?void 0:d.window_days]);if(!r.showFunnel||!d||typeof d.screened!="number")return null;const l=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,b=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),v=m.reduce((y,C)=>Math.max(y,C.s||0),0),x=m.length?We/m.length:0,f=Math.max(4,x-4),g=m.length>=5&&v>0,p=[[d.screened,t.funScreened(l(h)),d.screened_today],...typeof d.kept=="number"?[[d.kept,t.funKept,d.kept_today]]:[],...typeof d.analyzed=="number"?[[d.analyzed,t.funAnalyzed,d.analyzed_today]]:[],...typeof d.shown=="number"?[[d.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(c?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[p.map(([y,C,w],k)=>e.jsxs("span",{className:"fst-t",children:[k>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:b(y)}),e.jsx("i",{children:C}),c&&typeof w=="number"&&w>0&&e.jsx("em",{children:t.funToday(w)})]},C)),g&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":c,title:c?t.fstatsHide:t.fstatsShow,onClick:()=>{const y=!c;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(kt,y?"on":"off")}catch{}},children:c?"⌃":"⌄"})]}),c&&g&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${We} ${xe}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[m.map((y,C)=>{const w=(y.s||0)/v*(xe-4),k=(y.m||0)/v*(xe-4),N=C*x+(x-f)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${l(y.d)} — ${y.s} ${t.actScreened} · ${y.m} ${t.actKept}`}),e.jsx("rect",{x:N,y:xe-2-w,width:f,height:w,fill:"#cfe0d6"}),e.jsx("rect",{x:N,y:xe-2-k,width:f,height:k,fill:"#185c38"})]},y.d)}),e.jsx("line",{x1:0,y1:xe-1.5,x2:We,y2:xe-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:l(m[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const Er=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Tr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:i}=E(),[o,c]=u.useState(""),[s,d]=u.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const m=(t.ceoStatus||"").trim(),h=(je(t)||"").startsWith("CALL")&&Z(t)===3,l=Z(t)>=2,b=async x=>{if(o||x==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;c(x);const f=await i(t,x);c(""),f&&(d(!0),setTimeout(()=>d(!1),2200))},v=h?[["Validé",a.csYes],["Écarté",a.csNo]]:Er.filter(([x])=>!(l&&x==="Retenu")).map(([x,f])=>[x,a[f]]);return e.jsxs("div",{className:"csp",onClick:x=>x.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([x,f])=>e.jsx("button",{type:"button",className:"csb"+(m===x?" on":"")+(o===x?" busy":""),disabled:!!o,onClick:()=>{b(x)},children:f},x)),s&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(Ar,{o:t})]})}function Ar({o:t}){const{t:a,saveNote:n,flash:r}=E(),[i,o]=u.useState(t.ceoNote||""),[c,s]=u.useState(!1),[d,m]=u.useState(!1),h=i.trim()!==(t.ceoNote||"").trim(),l=async()=>{if(c||!h)return;s(!0);const b=await n(t,i.trim());s(!1),b&&(m(!0),setTimeout(()=>m(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:c,onChange:b=>o(b.target.value),onKeyDown:b=>{b.key==="Enter"&&l()}}),e.jsx("button",{type:"button",disabled:c||!h,onClick:()=>{l()},children:d?a.csNoteSaved:a.csNoteOk})]})}function qr({placeholder:t,onDone:a}){const{t:n}=E(),[r,i]=u.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Lr({o:t}){var g;const{t:a,token:n,caps:r,canWrite:i,stageOf:o,setStage:c,flashErr:s}=E(),[d,m]=u.useState(!1);if(!r.pipe||!i||r.lockActions||Z(t)!==4)return null;const h=o(t),l=(h==null?void 0:h.stage)||"todo",b=async p=>{if(d||p===l)return;m(!0);const y=h;c(t,{stage:p,stamps:(h==null?void 0:h.stamps)||{}});const C=Math.max(Date.now(),jt+=1);jt=C;const w=await ja(n,{company:t.name||"",stage:p,cts:C,deal_id:t.airtableId,check_id:t.checkId});m(!1),!w.stale&&(w.ok||(c(t,y),s(a.actErr)))},v=(g=h==null?void 0:h.stamps)==null?void 0:g.sent,x=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,f=l==="sent"&&v&&x>=4;return e.jsxs("div",{className:"stg",onClick:p=>p.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([p,y])=>e.jsx("button",{type:"button",className:"stgb"+(l===p?" on":""),disabled:d,onClick:()=>{b(p)},children:y},p)),f&&e.jsx("span",{className:"stgj4",children:a.j4Badge(x)})]})}let jt=0;const Fe=8,Pe=340;function Nt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function Or({steps:t,onClose:a}){const{t:n,dispatch:r,counts:i,scoped:o,byId:c,st:s}=E(),[d,m]=u.useState(0),[h,l]=u.useState(null),[b,v]=u.useState([]),x=u.useRef(!1);u.useEffect(()=>{x.current||(x.current=!0,v(t.filter(k=>!!document.querySelector(k.need||k.sel))))},[t]);const f=b[d],g=d>=b.length;u.useEffect(()=>{f&&(f.ptab!==void 0&&s.ptab!==f.ptab&&r({type:"ptab",tab:f.ptab}),f.dens&&s.dens!==f.dens&&r({type:"dens",dens:f.dens}))},[d,f]);const p=u.useCallback(()=>{if(!f){l(null);return}const k=document.querySelector(f.sel);if(!k){l(null);return}k.scrollIntoView({block:"nearest",behavior:"smooth"}),l(k.getBoundingClientRect())},[f]);u.useLayoutEffect(()=>{p();const k=window.setTimeout(p,260),N=()=>p();return window.addEventListener("scroll",N,!0),window.addEventListener("resize",N),()=>{window.clearTimeout(k),window.removeEventListener("scroll",N,!0),window.removeEventListener("resize",N)}},[p]);const y=u.useRef(a);if(y.current=a,u.useEffect(()=>{const k=N=>{N.key==="Escape"?(N.preventDefault(),N.stopPropagation(),y.current()):N.key==="ArrowRight"?m(z=>z+1):N.key==="ArrowLeft"&&m(z=>Math.max(0,z-1))};return document.addEventListener("keydown",k,!0),()=>document.removeEventListener("keydown",k,!0)},[]),!b.length)return null;let C=null;if(g){const k=i[3]||0,N=o.find(z=>z.memoUrl)||[...c.values()].find(z=>z.memoUrl);k>0?C={title:k===1?n.ahaATitle1:n.ahaATitleN(k),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:N?C={title:n.ahaBTitle,body:n.ahaBBody(N.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:N.id}),a()}}:C={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Pe};if(!g&&h){const k=h.bottom+14,z=window.innerHeight-k>190?k:Math.max(12,h.top-200);w={left:Math.min(Math.max(12,h.left+h.width/2-Pe/2),window.innerWidth-Pe-12),top:z,width:Pe}}return Le.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!g&&h&&e.jsx("div",{className:"tour-hole",style:{left:h.left-Fe,top:h.top-Fe,width:h.width+Fe*2,height:h.height+Fe*2}}),(g||!h)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(g?" fin":""),style:w,children:[g&&C?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:C.title}),e.jsx("p",{children:e.jsx(Nt,{text:C.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>m(b.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:C.go,children:C.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(d+1,b.length)}),e.jsx("h3",{children:f==null?void 0:f.title}),e.jsx("p",{children:e.jsx(Nt,{text:(f==null?void 0:f.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>m(k=>Math.max(0,k-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>m(k=>k+1),children:d===b.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Rr(){const{dossiers:t,scopedAll:a,pipe:n,mode:r,t:i,st:o,dispatch:c}=E(),s=n?a:t,d=u.useMemo(()=>s.filter(p=>ke(p.date)===0&&p.kind==="target"),[s]),m=u.useMemo(()=>n?a.filter(p=>Z(p)===0).slice().sort((p,y)=>(y.date||"").localeCompare(p.date||"")):[],[a,n]),h=u.useMemo(()=>d.filter(p=>n?Z(p)===0:!te(p)),[d,n]),l=n?m:h,b=n?a.length-m.length:d.length-h.length,v=n?a.length:d.length,x=v?Math.min(100,b/v*100):100;let f;n?f=i.morningThesis(d.length,m.length):d.length?b===0?f=i.goalSourced(d.length):b>=d.length?f=i.goalCleared:f=i.goalDone(b,d.length):f=i.goalSourced(0);const g=()=>{if(!n){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),r==="client"&&m.length&&c({type:"chainStart",queue:m.map(p=>p.id)})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:f}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:x+"%"}})}),l.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:g,children:n?i.morningEval(l.length):o.pileMode?i.goalContinue(l.length):i.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Mr(){var M,D;const{t,lang:a,st:n,dispatch:r,token:i,fund:o,data:c,dossiers:s,mode:d,doSync:m,startTour:h}=E(),[l,b]=u.useState(null),[v,x]=u.useState([]),f=d==="client";u.useEffect(()=>{if(!i||!o)return;let T=!0;return(async()=>{const[P,q]=await Promise.all([Xe(o),Rt(i)]);T&&(P&&b(P),x(q))})(),()=>{T=!1}},[i,o]);const g=(l==null?void 0:l.per_day)??null,p=((M=l==null?void 0:l.pool_order)==null?void 0:M.length)??0,y=v.filter(T=>T.status==="running").length,C=u.useMemo(()=>s.filter(T=>T.kind==="target"&&te(T)).length,[s]),w=c.marketEstimate,k=typeof((D=c.stats)==null?void 0:D.screened)=="number"?c.stats.screened:C,N=w&&w>0?Math.min(100,Math.round(k/w*100)):null,z=T=>T.toLocaleString(a==="en"?"en-US":"fr-FR"),S=(o||"P").split(/\s+/).map(T=>T[0]).join("").slice(0,2).toUpperCase(),A=(()=>{const T=Date.parse(c.generatedAt||"");if(Number.isNaN(T))return"";const P=new Date(T),q=B=>String(B).padStart(2,"0");return`${q(P.getDate())}/${q(P.getMonth()+1)} à ${q(P.getHours())}:${q(P.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:S}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),A&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(A)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:h,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[N===null&&k>0&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsx("span",{className:"ev",children:e.jsx("b",{children:z(k)})})]}),N!==null&&w&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:N+"%"}})}),e.jsxs("b",{children:[N," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(k,w)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>r({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),g!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"q",children:g})," ",t.identPerDay]}),e.jsx("span",{className:"edv"})]}),g===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),y>0&&e.jsxs("span",{className:"ev",children:["⏳ ",y]}),e.jsx("span",{className:"ego",children:t.identPending(p)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:T=>{T.stopPropagation(),r({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!f,onClick:m,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:n.filters.search,onChange:T=>r({type:"filters",patch:{search:T.target.value}})})]})]})]})}function Dr(){const{t,counts:a,dispatch:n}=E();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,i],o)=>{const c=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(c?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:i}),c&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Fr=["--p0","--p1","--p2","--p3","--p4"];function Pr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:i}=E(),o=u.useRef({});u.useEffect(()=>{o.current={...n}},[n]);const c=m=>{const h=o.current[m],l=h!==void 0?n[m]-h:0;return e.jsxs("button",{type:"button",className:"step"+(m===3&&n[3]>0?" wait":""),style:{"--c":`var(${Fr[m]})`,"--tc":m<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===m,title:r.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsxs("span",{className:"l",children:[r.plabels[m].toUpperCase(),m===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(l>0?" up":l<0?" down":""),children:[n[m],l!==0&&e.jsxs("em",{className:"delta",children:[l>0?"+":"−",Math.abs(l)]})]})]},m)},s=(m,h,l)=>e.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":m===5?"var(--p5)":m===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===m,title:r.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsx("span",{className:"l",children:l.toUpperCase()}),e.jsx("span",{className:"n",children:n[m]})]},m),d=(m,h,l,b=!1)=>e.jsx("button",{type:"button",className:"tool",title:h,disabled:b,onClick:l,children:m},h);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(c)}),e.jsxs("div",{className:"offtrack",children:[s(5,!1,r.plabels[5]),s(7,!0,r.plabels[7]),s(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[d("↩",r.toolUndo,i,t.undo.length===0),d("↺",r.toolReset,()=>{a({type:"reset"})}),d("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),d("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),d("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Br=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Ir(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:i,doAnalyse:o,mode:c}=E(),s=u.useRef(null),[d,m]=u.useState(60);u.useEffect(()=>{let v=0;const x=()=>{var C;const f=s.current;if(!f)return;const g=(C=f.parentElement)==null?void 0:C.querySelector('.funnel [aria-selected="true"]');if(!g)return;const p=g.getBoundingClientRect(),y=f.getBoundingClientRect();m(Math.max(20,Math.min(p.left+p.width/2-y.left,y.width-30)))};return v=requestAnimationFrame(x),window.addEventListener("resize",x),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",x)}},[t.ptab]);const h=t.ptab;let l=n.tuto[h].p;if(h===3){const v=r.filter(g=>g.kind==="target"&&Z(g)===3),x=v.filter(g=>Ge(g)==="auto").length,f=v.filter(g=>Ge(g)==="cd").length;l=n.tutoPending(x,f,v.length)}const b=(()=>{if(c!=="client")return null;if(h===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(v=>v.id)})};if(h===1){const v=r.filter(x=>x.kind==="target"&&Z(x)===1&&!i.has(x.id)).slice(0,10);if(v.length)return{label:n.tuto[1].a,run:()=>v.forEach(x=>o(x))}}return null})();return e.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Br[h],"--ax":d+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[h].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:l}})]})}),b&&e.jsx("button",{type:"button",className:"tprim",onClick:b.run,children:b.label})]})}const St=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Ct(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function $r(t,a){const[n,r]=u.useState(1);return u.useEffect(()=>{let i=!0,o=0;const c=()=>{var m;if(!i)return;const d=(m=t.current)==null?void 0:m.getScreenCTM();d&&d.a>0?r(d.a):o=requestAnimationFrame(c)};c();const s=new ResizeObserver(()=>c());return t.current&&s.observe(t.current),window.addEventListener("resize",c),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",c)}},[t,a]),n}function Vr(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:i,markedId:o,byId:c,lang:s,t:d}=E(),m=u.useRef(null),h=u.useRef(null),l=Ze.find(S=>S.key===t.continent),b=$r(m,t.continent+":"+t.mapFolded),[v,x]=u.useState(new Map),[f,g]=u.useState(null);u.useEffect(()=>{const S=m.current;if(!S)return;const A=new Map;S.querySelectorAll("path[data-i2]").forEach(M=>{const D=M.dataset.i2;if(D)try{const T=M.getBBox();T.width>0&&A.set(D,{x:T.x,y:T.y,w:T.width,h:T.height})}catch{}}),x(A)},[t.continent,b]);const p=u.useMemo(()=>n.filter(S=>S.cc),[n]),y=u.useMemo(()=>{const S=new Map;return p.forEach(A=>S.set(A.cc,(S.get(A.cc)||0)+1)),S},[p]),C=u.useMemo(()=>p.map(S=>{const A=S.cc?v.get(S.cc):void 0;if(!A)return null;const M=Ct(S.name||S.id||""),D=Ct((S.id||S.name||"")+"·y"),T=(M-.5)*Math.min(A.w*.55,60),P=(D-.5)*Math.min(A.h*.55,60);return{d:S,x:A.x+A.w/2+T,y:A.y+A.h/2+P}}).filter(S=>!!S),[p,v]),w=S=>b>0?S/b:S,k=u.useMemo(()=>r?[0,1,2,3,4,5].map(S=>({c:St[S],fr:d.plabels[S].toUpperCase(),en:d.plabels[S].toUpperCase(),n:n.filter(A=>A.kind==="target"&&Z(A)===S).length})).filter(S=>S.n>0):ut.map((S,A)=>({...S,n:n.filter(M=>mt(M)===A).length})),[n,r,d.plabels]),N=o?c.get(o):null,z=N?C.find(S=>S.d.id===N.id):null;return e.jsxs("div",{className:"mapzone",ref:h,children:[e.jsxs("svg",{ref:m,viewBox:l.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?l.fr:l.en,onMouseLeave:()=>{g(null),i(null)},children:[e.jsx("g",{children:l.countries.map((S,A)=>e.jsx("g",{className:"ct"+(S.i2&&y.get(S.i2)?"":" empty"),children:e.jsx("path",{d:S.d,"data-i2":S.i2||void 0})},A))}),e.jsx("g",{children:C.map(S=>{const A=ut[mt(S.d)],M=!!Q(S.d),D=S.d.kind==="target",T=r&&D?St[Z(S.d)]:A.c,P=!r&&te(S.d);return e.jsxs("g",{className:"co"+(P?" done":""),onMouseEnter:()=>{var R,_;const q=(R=h.current)==null?void 0:R.getBoundingClientRect(),B=(_=m.current)==null?void 0:_.createSVGPoint();if(B&&m.current&&q){B.x=S.x,B.y=S.y;const se=B.matrixTransform(m.current.getScreenCTM());g({x:se.x-q.left,y:se.y-q.top,label:S.d.name+" · "+(Ne(S.d.cc,s)||S.d.countryLabel||"")})}i(S.d.id)},onMouseLeave:()=>{g(null),i(null)},onClick:()=>{var R;const q=(R=m.current)==null?void 0:R.createSVGPoint();let B=null;if(q&&m.current){q.x=S.x,q.y=S.y;const _=q.matrixTransform(m.current.getScreenCTM());B={x:_.x,y:_.y}}a({type:"popup",id:S.d.id,anchor:B})},children:[e.jsx("circle",{className:"h",cx:S.x,cy:S.y,r:w(Math.max(11,A.px+7))}),e.jsx("circle",{className:"v",cx:S.x,cy:S.y,r:w(A.px),fill:T,stroke:M?"#DC2626":"#ffffff",strokeWidth:w(M?2.2:1.3)})]},S.d.id||S.d.name)})}),z&&e.jsx("circle",{className:"ring on",cx:z.x,cy:z.y,r:w(13),fill:"none",stroke:"#0F172A",strokeWidth:w(2)})]}),e.jsx("div",{className:"hov"+(f?" on":""),style:f?{left:f.x,top:f.y}:void 0,children:f==null?void 0:f.label}),e.jsx("div",{className:"legend",children:k.map((S,A)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":S.c}}),s==="fr"?S.fr:S.en," ",e.jsx("b",{children:S.n})]},A))}),n.some(S=>!S.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",d.notLocated," ",e.jsx("b",{children:n.filter(S=>!S.cc).length})]})})]})}function Ur(t,a){const n=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t);if(!n)return t;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(n[2])-1]||n[2],o=Number(n[3]);return a==="en"?`${i} ${o}, ${n[1]}`:`${o} ${i} ${n[1]}`}function Hr(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:i,contName:o,lang:c}=E(),s=t.filters,d=u.useMemo(()=>n.filter(x=>x.continent===t.continent),[n,t.continent]),m=x=>d.filter(f=>x!=="country"&&s.country.length&&!s.country.includes(f.cc||"")?!1:at(f,s,i,x==="country"?void 0:x)),h=u.useMemo(()=>{const x=m("win"),f=g=>x.filter(p=>(p.date?Math.max(0,Math.floor((Date.now()-Date.parse(p.date))/864e5)):9999)<=g).length;return[f(0),f(7),f(30),x.length]},[d,s,i]),l=u.useMemo(()=>s.day?m("win").filter(x=>(x.date||"").slice(0,10)===s.day).length:0,[d,s,i]),b=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),v=(x,f,g,p="fbtn")=>e.jsxs("button",{type:"button",className:p,"aria-expanded":t.openFacet===x,onClick:()=>a({type:"openFacet",facet:x}),children:[e.jsx("span",{className:"fl",children:f}),g>0&&e.jsx("span",{className:"n",children:g}),e.jsx("span",{className:"cv",children:"▾"})]},x);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[s.day?e.jsxs("div",{className:"seg",children:[e.jsxs("button",{type:"button","aria-pressed":!0,children:[r.fDay(Ur(s.day,c)),e.jsx("b",{children:l})]}),e.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:r.fDayOff})]}):e.jsx("div",{className:"seg",children:["1","7","30","all"].map((x,f)=>e.jsxs("button",{type:"button","aria-pressed":s.win===x,onClick:()=>a({type:"filters",patch:{win:x}}),children:[r.dates[f],e.jsx("b",{children:h[f]})]},x))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:s.search,onChange:x=>a({type:"filters",patch:{search:x.target.value}})})]}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),s.signalOnly&&e.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,s.sector.length),v("pay",r.fCountry,s.country.length),v("det",r.fEngine,s.engine.length),v("sta",r.fStage,s.stage.length),i&&v("ang","Angle",s.angle.length),i&&v("mem","Mémo",s.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),b>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(d.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(b)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(_r,{poolFor:m})]})}function _r({poolFor:t}){const{st:a,dispatch:n,t:r,lang:i}=E(),o=a.filters,c=a.openFacet,{title:s,cols:d,options:m}=u.useMemo(()=>{if(c==="sig"){const x=t("signal").filter(p=>Q(p)),f=new Map;x.forEach(p=>{const y=p.engine||"";f.set(y,(f.get(y)||0)+1)});const g=[{v:"*",label:r.fpSigAll,n:x.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ft([...f.keys()],i).map(p=>({v:p,label:we(p)+" "+de(p,i),n:f.get(p)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(p)}))];return{title:r.fpSigTitle,cols:2,options:g}}if(c==="sec"){const x=t("sector"),f=new Map;return x.forEach(g=>{g.sector&&f.set(g.sector,(f.get(g.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...f.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:g,n:p,html:!1,on:o.sector.includes(g)}))}}if(c==="pay"){const x=t("country"),f=new Map;return x.forEach(g=>{g.cc&&f.set(g.cc,(f.get(g.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...f.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:Ne(g,i)||g,n:p,html:!1,on:o.country.includes(g)}))}}if(c==="det"){const x=t("engine"),f=new Map;return x.forEach(g=>{g.engine&&f.set(g.engine,(f.get(g.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:ft([...f.keys()],i).map(g=>({v:g,label:we(g)+" "+de(g,i)+' <span style="color:var(--dim);font-size:10px">· '+Na(Sa(g),i)+"</span>",n:f.get(g)||0,html:!0,on:o.engine.includes(g)}))}}if(c==="ang"){const x=t("angle"),f=new Map;return x.forEach(g=>{g.angle&&f.set(g.angle,(f.get(g.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:g.replace(/[_-]+/g," "),n:p,html:!1,on:o.angle.includes(g)}))}}if(c==="mem"){const x=t("memoLevel"),f=new Map;x.forEach(p=>{if(p.kind==="target"){const y=Je(p);f.set(y,(f.get(y)||0)+1)}});const g=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(p=>({v:String(p),label:g[p],n:f.get(p)||0,html:!1,on:o.memoLevel.includes(p)}))}}const b=t("stage"),v=new Map;return b.forEach(x=>{x.stage&&v.set(x.stage,(v.get(x.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((x,f)=>f[1]-x[1]).map(([x,f])=>({v:x,label:x,n:f,html:!1,on:o.stage.includes(x)}))}},[c,a,i]),h=b=>{if(c==="sig"){if(b==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const x=o.signalEngines.includes(b)?o.signalEngines.filter(f=>f!==b):[...o.signalEngines,b];n({type:"filters",patch:{signalOnly:!0,signalEngines:x}})}return}if(c==="mem"){n({type:"toggleMemoLevel",value:Number(b)});return}n({type:"toggleFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage",value:b})},l=()=>{n(c==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:c==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:s}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:l,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(d===2?" two":""),children:m.map(b=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":b.on,onClick:()=>h(b.v),children:[e.jsx("span",{className:"bx"}),b.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:b.label}}):e.jsx("span",{className:"l",children:b.label}),e.jsx("span",{className:"n",children:b.n})]},b.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const zt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Yr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:i,dispatch:o,evalBusy:c,evalCards:s,caps:d,data:m}=E(),h=a==="client",[l,b]=u.useState(""),[v,x]=u.useState(!1),[f,g]=u.useState(""),[p,y]=u.useState(!1),[C,w]=u.useState(""),[k,N]=u.useState([]),z=u.useRef(!1),S=l.trim()?zt.test(l.trim())?t.evalUrl:t.evalName:t.evalWaiting,A=u.useMemo(()=>f.split(`
`).map(q=>q.trim()).filter(Boolean).slice(0,15),[f]),M=k.length?k:s,D=m.credits,T=()=>{const q=l.trim();q&&(r(null,q),b(""))},P=async()=>{if(!h){r(null,A[0]||"");return}if(!A.length||p)return;y(!0),z.current=!1;const q=[];for(let B=0;B<A.length&&!z.current;B++){w(t.evaluating(B+1,A.length,A[B]));const R=await Mt(n,A[B],"atelier2");if(q.unshift({name:R.company||A[B],verdict:R.verdict,reason:R.reason||"",remaining:R.remaining??null}),N([...q]),R.verdict==="quota"){q.unshift({name:"",verdict:"quota",reason:t.quota(A.length-B-1),remaining:0}),N([...q]);break}}w(""),g(""),y(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:l,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:q=>b(q.target.value),onKeyDown:q=>{q.key==="Enter"&&T()}}),e.jsx("span",{className:"detect"+(zt.test(l.trim())?" url":""),children:S})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),disabled:c,onClick:T,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),d.showCredits&&D&&e.jsxs("button",{type:"button",className:"credits"+(D.total_available<=0&&!D.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:D.unlimited?"∞":D.total_available}),!D.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",D.daily_grant+D.purchased]}),D.total_available<=0&&!D.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>x(!v),children:t.evalMulti})}),v&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:f,placeholder:t.bulkPh,onChange:q=>g(q.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{justifyContent:"center"},disabled:p||!A.length,onClick:()=>{P()},children:[e.jsx("span",{className:"fill"}),p&&C?C:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(A.length)})]})]}),M.slice(0,1).map((q,B)=>{const R=q.verdict==="kept",_=q.verdict==="quota",se=R?"var(--brand)":_?"var(--bolt)":"var(--red)",ce=R?"var(--brand-l)":_?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":se,"--bgc":ce},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:R?"✓ "+t.kept:_?"⏳":"✗ "+t.dropped})}),q.name&&e.jsx("span",{className:"rn",children:q.name}),e.jsx("span",{className:"rr",children:q.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",q.reason]}):null}),!_&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(R?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},B)}),h&&(i.kept+i.dropped>0||M.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(i.kept,i.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Wr(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Gr(){const{st:t,dispatch:a,byId:n,t:r,doDeep:i}=E(),o=t.memoConsole?n.get(t.memoConsole):null,c=u.useMemo(()=>o?[o.reasoning||"",Wr(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const s=je(o),d=Je(o);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:o.name}),s&&e.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:r.memoSynth})}),e.jsx("div",{className:"mb2",children:c?c.split(`

`).map((m,h)=>e.jsx("p",{style:{margin:"0 0 10px"},children:m},h)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[et(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:d===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}const Kr=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Be=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Qr(t){const a=String(t||"");if(!a)return"";let n="",r=0;for(;r<a.length;){const i=a.indexOf("<",r);if(i<0){n+=Be(a.slice(r));break}n+=Be(a.slice(r,i));const o=a.indexOf(">",i);if(o<0){n+=Be(a.slice(i));break}const c=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(c),d=s?s[2].toLowerCase():"";s&&Kr.has(d)?n+=`<${s[1]}${d}>`:n+=Be(a.slice(i,o+1)),r=o+1}return n}const Et=(t,a)=>{const n=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(n)?a==="en"?n:`${n.slice(8,10)}/${n.slice(5,7)}/${n.slice(0,4)}`:""};function K({k:t,v:a,href:n}){return a==null||a===""?null:e.jsxs("div",{className:"cdl",children:[e.jsx("span",{className:"cdk",children:t}),n?e.jsx("a",{className:"cdv",href:n,target:"_blank",rel:"noopener noreferrer",children:String(a)}):e.jsx("span",{className:"cdv",children:String(a)})]})}function Jr({o:t}){const{t:a,lang:n,dispatch:r,caps:i}=E(),o=$e(t),c=je(t),s=(t.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[t.sector,t.stage,t.countryLabel,t.city,t.website,t.domain,t.linkedinCompany,t.angle,t.date].filter(Boolean).length,m=[t.contactName,t.contactEmail,t.contactLinkedin].filter(Boolean).length,h=[t.ceoStatus,t.ceoNote,i.pipe?t.memoUrl:"",i.pipe?t.memoPdfUrl:""].filter(Boolean).length+(typeof t.engagement=="number"&&t.engagement>0?1:0),l=u.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(t.reasoning?1:0)+(c?1:0)},{k:"ana",lib:a.cdAnalyse,n:(t.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:m},{k:"suivi",lib:a.cdSuivi,n:h}].filter(f=>f.n>0),[t,a,s,c,d,m,h]),[b,v]=u.useState("");if(!l.length)return null;const x=l.some(f=>f.k===b)?b:l[0].k;return e.jsxs("div",{className:"cdtabs",children:[e.jsx("div",{className:"cdnav",role:"tablist",children:l.map(f=>e.jsx("button",{type:"button",role:"tab","aria-selected":x===f.k,className:x===f.k?"on":"",onClick:g=>{g.stopPropagation(),v(f.k)},children:f.lib},f.k))}),e.jsxs("div",{className:"cdbody",onClick:f=>f.stopPropagation(),children:[x==="conv"&&e.jsxs(e.Fragment,{children:[s&&e.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[e.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),e.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.reasoning&&e.jsx("p",{className:"cdtxt",children:t.reasoning}),c&&e.jsxs("div",{className:"cdv1 memo",children:[e.jsx("b",{children:c}),e.jsx("span",{className:"cdw",children:a.cdMemo(t.memoType||"")})]}),e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(K,{k:a.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(K,{k:a.cdVerdictDate,v:Et(t.verdictDate,n)})]})]}),x==="ana"&&e.jsxs(e.Fragment,{children:[t.summary&&e.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Qr(t.summary)}}),i.pipe&&!i.lockActions&&e.jsx(Xr,{o:t})]}),x==="soc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdSector,v:t.sector}),e.jsx(K,{k:a.cdStage,v:t.stage}),e.jsx(K,{k:a.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(K,{k:a.cdSite,v:t.domain||t.website,href:t.website||void 0}),e.jsx(K,{k:a.cdLinkedin,v:t.linkedinCompany?"LinkedIn":"",href:t.linkedinCompany}),e.jsx(K,{k:a.cdAngle,v:t.angle}),e.jsx(K,{k:a.cdDetected,v:Et(t.date,n)})]}),x==="ctc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdName,v:t.contactName}),e.jsx(K,{k:a.cdEmail,v:t.contactEmail,href:t.contactEmail?`mailto:${t.contactEmail}`:void 0}),e.jsx(K,{k:a.cdLinkedin,v:t.contactLinkedin?"LinkedIn":"",href:t.contactLinkedin})]}),x==="suivi"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdCeoStatus,v:t.ceoStatus}),e.jsx(K,{k:a.cdEngagement,v:typeof t.engagement=="number"&&t.engagement>0?t.engagement:""})]}),t.ceoNote&&e.jsxs("p",{className:"cdtxt",children:["💬 ",t.ceoNote]}),i.pipe&&(t.memoUrl||t.memoPdfUrl)&&e.jsxs("div",{className:"cdacts",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),t.memoPdfUrl&&e.jsx("a",{className:"abtn",href:t.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Xr({o:t}){const{t:a,token:n}=E(),[r,i]=u.useState(!1),[o,c]=u.useState(null),s=async()=>{r||(i(!0),c(await Ca(n,t.name,t.website||t.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},m=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],h=m.some(([,l])=>l);return e.jsxs("div",{className:"qab",children:[!o&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mnote dim",children:a.qaHint}),e.jsx("button",{type:"button",className:"abtn",disabled:r,onClick:()=>{s()},children:r?a.qaBusy:a.qaRun})]}),o&&h&&e.jsxs(e.Fragment,{children:[m.filter(([,l])=>l).map(([l,b])=>e.jsxs("div",{className:"qal",children:[e.jsx("span",{className:"qak",children:l}),e.jsx("p",{children:b})]},l)),!!(o.pages||[]).length&&e.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!h&&e.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function $t({name:t}){const{t:a,token:n,caps:r,mode:i,flashErr:o}=E(),[c,s]=u.useState(!1),[d,m]=u.useState(null);if(!r.pipe||i!=="client"||r.lockActions)return null;const h=async()=>{if(c)return;s(!0);const l=await za(n,t);if(s(!1),!l){o(a.actErr);return}m(l.results||[])};return e.jsxs("div",{className:"simb",onClick:l=>l.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:c,onClick:()=>{h()},children:c?a.similarBusy:a.similar}),d&&(d.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:d.map(l=>e.jsxs("li",{children:[e.jsx("b",{className:l.verdict==="kept"?"ok":"ko",children:l.company}),l.reason&&e.jsx("span",{children:l.reason})]},l.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Vt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function nt({o:t}){const{t:a}=E(),n=$e(t),r=je(t),i=Z(t),o=Ge(t),c=Ea(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(Vt[r]||"v-cons"),title:a.vt[r],children:r}):i===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&c!==null&&e.jsx("span",{className:"wait2 "+(c>10?"hot":c>=5?"warm":""),title:a.waitTitle(c),children:a.waitChip(c)})]})}function Tt({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:i}=E(),[o,c]=u.useState(!1);if(u.useEffect(()=>{r||c(!1)},[r]),te(t)){const m=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[m?"✓":"✗"," ",e.jsx("b",{children:m?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const d=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:r,onClick:m=>{m.stopPropagation(),c(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function Zr({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:i,doAnalyse:o,doDecide:c,doPromote:s,doRepeche:d,doApproach:m,dispatch:h}=E();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:v=>{v.stopPropagation(),h({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(Tt,{o:t})});const l=Z(t),b=v=>x=>{x.stopPropagation(),v()};if(l===0)return e.jsx("span",{className:"cell",children:e.jsx(Tt,{o:t})});if(l===1){const v=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:b(()=>o(t)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(l===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>c(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>c(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})});if(l===4){const v=i.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:v,onClick:b(()=>m(t)),children:v?a.actApproachSent:a.actApproach})})}return l===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:b(()=>s(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):l===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:b(()=>d(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>h({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function en({o:t}){const{t:a,doThumb:n,thumbOf:r}=E(),i=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function tn({o:t}){const{lang:a}=E();return Q(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(Se,{o:t}),e.jsx(Ve,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[we(t.engine||"")," ",de(t.engine||"",a)]})})}function an({o:t,locked:a,open:n,onToggle:r}){const{st:i,dispatch:o,caps:c,markRow:s,markedId:d,favIds:m,toggleFav:h}=E(),l=Z(t),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],v=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,x=v<=0?0:v<=7?1:v<=30?2:3,f=c.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][l]:b[x],g=m.has(t.id),p=y=>{if(a)return;if(c.pipe){r();return}const C=y.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return e.jsxs(u.Fragment,{children:[e.jsxs("div",{className:"row"+(d===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>s(t.id),onMouseLeave:()=>s(null),onClick:p,children:[e.jsx("span",{className:"pt",style:{"--c":f}}),e.jsx(_t,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[c.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:g?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),h(t)},children:g?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(y=>y&&y!==t.name)||""})]}),e.jsx(rn,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(tn,{o:t}),c.pipe&&e.jsx(nt,{o:t}),c.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(Zr,{o:t}),c.showThumbs&&e.jsx(en,{o:t})]}),(n||i.dens==="deplie")&&!a&&e.jsx(nn,{o:t})]})}function rn({o:t}){const{lang:a,caps:n}=E();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=tt(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function nn({o:t}){const{t:a,lang:n,dispatch:r,caps:i,outbound:o,doOnboard:c}=E();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),e.jsx(Jr,{o:t}),e.jsx(Tr,{o:t}),e.jsx(Lr,{o:t}),e.jsx($t,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(nt,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[we(t.engine||"")," ",de(t.engine||"",n)]}),Q(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(Se,{o:t})})]}),i.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>c(t),children:a.actOnboard})]})]})]})}function on({o:t,locked:a}){const{t:n,dispatch:r,caps:i,doDecide:o}=E(),c=Z(t),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][c];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":s},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(nt,{o:t}),Q(t)&&e.jsx(Se,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&i.pipe&&c===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function sn(){const t=E(),{st:a,dispatch:n,t:r,caps:i,scoped:o,lang:c,sessTally:s,data:d,dossiers:m}=t,[h,l]=u.useState(new Set);u.useEffect(()=>{l(new Set)},[a.ptab,a.continent]);const b=k=>l(N=>{const z=new Set(N);return z.has(k)?z.delete(k):z.add(k),z}),v=u.useMemo(()=>rt(o,a.sort),[o,a.sort]),x=u.useMemo(()=>v.filter(k=>Q(k)&&!te(k)).length,[v]),f=i.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,g=(k,N,z="",S=!1)=>e.jsxs("button",{type:"button","data-s":k,className:z,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:S?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:k}),children:[N,e.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),p=u.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const k=new Map;return v.forEach(N=>{const z=N.engine||"?";k.has(z)||k.set(z,[]),k.get(z).push(N)}),[...k.entries()]},[v,i.pipe,a.groupBy]),y=i.lockRowsAfter;let C=0;const w=(k,N)=>{const z=a.shown[N]||Ie,A=k.slice(0,z).map(M=>{const D=y!==null&&C>=y;return C++,a.dens==="maxi"?e.jsx(on,{o:M,locked:D},M.id):e.jsx(an,{o:M,locked:D,open:h.has(M.id),onToggle:()=>b(M.id)},M.id)});return k.length>z&&A.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:N,by:Ie}),children:r.more(Math.min(Ie,k.length-z),k.length-z)},N+":more")),A};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:v.length})," ",f]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,i.pipe&&t.fund?" · "+t.fund:""]}),i.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),i.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([k,N])=>e.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k,onClick:()=>n({type:"dens",dens:k}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:N})]},k))}),i.showChain&&v.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:v.filter(k=>i.pipe?!0:!te(k)).map(k=>k.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",i.pipe?r.browse(v.length):r.chainAll(v.filter(k=>!te(k)).length)]})]}),x>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(x)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),g("country",r.colCountry),g("name",r.colCompany),g("amount",r.colAmount,"h-amt",!0),g("stage",r.colStage,"h-stade"),g("signal",r.colSignal,"h-sig"),i.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),i.pipe&&g("score",r.colScore,"h-sc",!0),e.jsx("span",{}),i.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[p?p.map(([k,N])=>e.jsxs(u.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:we(k)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:de(k,c)}),e.jsx("div",{className:"s",children:r.grpCount(N.filter(z=>!te(z)).length,N.length)})]})]}),w(N,k)]},k)):w(v,"pt"+a.ptab),!v.length&&!(d.loading&&!m.length)&&e.jsx("div",{className:"void",children:i.pipe?r.emptyTab:r.emptyScope})]}),i.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(s.kept>0||s.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(s.kept,s.dropped)}})]})}const ln=`
...
`;function dn(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,i=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let c=t.y+10;return c+n>i-8&&(c=Math.max(8,t.y-n-14)),c<8&&(c=8),{left:o,top:c}}function cn(){const{st:t,dispatch:a,byId:n,t:r,lang:i,caps:o,mode:c,askEvaluate:s,doAnalyse:d,doDecide:m,doPromote:h,doRepeche:l,doApproach:b,doDeep:v,doOnboard:x,outbound:f,evalBusy:g}=E(),p=t.popupId?n.get(t.popupId):null;if(!p)return null;const y=Q(p),C=Z(p),w=je(p),k=p.kind==="target",N=z=>{a({type:"filters",patch:z}),a({type:"popup",id:null})};return Le.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:ln}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:dn(t.popupAnchor),onClick:z=>z.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:p.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(ke(p.date)),de(p.engine,i))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[p.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>N({country:[p.cc]}),children:(Ne(p.cc,i)||p.countryLabel||"").toUpperCase()}),p.sector&&e.jsx("button",{type:"button",onClick:()=>N({sector:[p.sector]}),children:p.sector.toUpperCase()}),p.stage&&e.jsx("button",{type:"button",onClick:()=>N({stage:[p.stage]}),children:p.stage.toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&e.jsx("span",{className:"am2",children:tt(p.amountEur,i)})]}),(p.tagline||p.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:p.tagline||p.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[we(p.engine)," ",e.jsx("b",{children:de(p.engine,i)})," — ",Ta(p.engine,i),p.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",p.noteTitle]})]}),y?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(Se,{o:p,lg:!0})," ",e.jsx(Ve,{o:p,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(Dt(y,i))," · ",r.win7(Ft(y,i))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),p.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&C>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:p.reasoning})]}),o.pipe&&k&&w&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[w,typeof p.score=="number"&&p.score>0?" · "+r.score(p.score):""]})})]}),e.jsx($t,{name:p.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||c!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[C===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>s(p),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),C===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),C===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),C===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(p,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{m(p,!1),a({type:"popup",id:null})},children:r.actNo}),et(p)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{v(p),a({type:"popup",id:null})},children:r.memoDeep})]}),C===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{b(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),C===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{l(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),p.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:p.id}),a({type:"popup",id:null})},children:"📄"}),f&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{x(p),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>s(p),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),p.website&&e.jsx("a",{className:"psite",href:p.website.startsWith("http")?p.website:"https://"+p.website,target:"_blank",rel:"noopener noreferrer",title:p.website,children:"🌐"})]})]})]}),document.body)}function At(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function pn(t,a){const n=Aa(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function un(t,a){const r=[a.head.split("|").map(At).join(";")];for(const i of t){const o=a.stageOf(i);r.push([i.name||"",pn(i,a.plabels),$e(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(At).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function mn(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const fn=(t,a)=>{const n=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(n)?a==="en"?n:`${n.slice(8,10)}/${n.slice(5,7)}/${n.slice(0,4)}`:""};function ie({k:t,v:a}){return a==null||a===""?null:e.jsxs("div",{className:"dsl",children:[e.jsx("span",{children:t}),e.jsx("b",{children:String(a)})]})}function xn({o:t,qa:a}){const{t:n,lang:r,fund:i}=E(),o=(t.cribleStatus||"").trim().toUpperCase()||($e(t)==="NO MATCH"?"NO MATCH":"MATCH"),c=je(t),s=(a==null?void 0:a.blocs)||{},d=[[n.qaVP,s.value_prop],[n.qaProduct,s.produit],[n.qaModel,s.modele],[n.qaSummary,s.synthese]];return e.jsxs("article",{className:"dspage",children:[e.jsxs("header",{className:"dsh",children:[e.jsxs("div",{children:[e.jsx("b",{children:t.name}),t.tagline&&e.jsx("p",{children:t.tagline})]}),e.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?n.vOut:n.vKept,c&&e.jsx("em",{children:c})]})]}),t.reasoning&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsWhy}),e.jsx("p",{className:"dstxt",children:t.reasoning})]}),e.jsxs("section",{className:"dsgrid",children:[e.jsx(ie,{k:n.cdSector,v:t.sector}),e.jsx(ie,{k:n.cdStage,v:t.stage}),e.jsx(ie,{k:n.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(ie,{k:n.cdSite,v:t.domain||t.website}),e.jsx(ie,{k:n.cdName,v:t.contactName}),e.jsx(ie,{k:n.cdEmail,v:t.contactEmail}),e.jsx(ie,{k:n.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(ie,{k:n.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(ie,{k:n.cdAngle,v:t.angle}),e.jsx(ie,{k:n.cdDetected,v:fn(t.date,r)})]}),d.some(([,m])=>m)&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsAnalysis}),d.filter(([,m])=>m).map(([m,h])=>e.jsxs("div",{className:"dsb",children:[e.jsx("span",{children:m}),e.jsx("p",{children:h})]},m))]}),(t.ceoStatus||t.ceoNote)&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsDecision}),t.ceoStatus&&e.jsx("p",{className:"dstxt",children:e.jsx("b",{children:t.ceoStatus})}),t.ceoNote&&e.jsxs("p",{className:"dstxt",children:["« ",t.ceoNote," »"]})]}),e.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function gn(){const{t,lang:a,token:n,scoped:r,fund:i,data:o,dispatch:c}=E(),[s,d]=u.useState({}),m=25,h=u.useMemo(()=>r.slice(0,m),[r]);u.useEffect(()=>{h.length&&qa(n,h.map(v=>v.name)).then(d)},[n,h]);const l=o.stats,b=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return e.jsxs("div",{className:"dossier",children:[e.jsxs("div",{className:"dsbar",children:[e.jsx("b",{children:t.dsTitle(h.length)}),r.length>m&&e.jsx("span",{className:"mnote dim",children:t.dsCap(m,r.length)}),e.jsx("span",{className:"dssp"}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:t.printBtn})]}),e.jsxs("div",{className:"dscover",children:[e.jsx("b",{children:i}),l&&typeof l.screened=="number"&&e.jsxs("p",{children:[b(l.screened)," ",t.funScreened(""),typeof l.kept=="number"&&e.jsxs(e.Fragment,{children:[" · ",b(l.kept)," ",t.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&e.jsxs(e.Fragment,{children:[" · ",t.covOf(b(o.marketEstimate)),", ",Math.round(l.screened/o.marketEstimate*100)," %"]})]})]}),h.map(v=>e.jsx(xn,{o:v,qa:s[v.name]},v.id)),!h.length&&e.jsx("p",{className:"mnote",children:t.dsEmpty})]})}const hn=50;function ot({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:i}=E(),[o,c]=u.useState(null),[s,d]=u.useState(!1),[m,h]=u.useState(""),[l,b]=u.useState(0),[v,x]=u.useState(""),[f,g]=u.useState(!1),p=u.useRef(null);u.useEffect(()=>()=>{p.current&&window.clearInterval(p.current)},[]);const y=async w=>{d(!0),h("");const k=await a();if(d(!1),k.ok){c(k);return}if(k.busy){h(i.alertPreviewBusy);return}if(!w){h(i.alertPreviewFail);return}b(hn),p.current=window.setInterval(()=>{b(N=>N>1?N-1:(p.current&&window.clearInterval(p.current),y(!1),0))},1e3)},C=async()=>{if(r||f)return;g(!0),x("");const w=await n();g(!1),x(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:s||l>0,onClick:()=>{y(!0)},children:s?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||f,onClick:()=>{C()},children:f?"…":i.alertTest})]}),l>0&&e.jsx("p",{className:"mnote",children:i.alertPreviewRetry(l)}),m&&e.jsx("p",{className:"mnote warn",children:m}),v&&e.jsx("p",{className:"mnote",children:v}),!v&&e.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const qe="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function X({title:t,icon:a,children:n,wide:r}){const{dispatch:i}=E();return Le.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function bn(){const{st:t}=E();switch(t.modal){case"chain":return e.jsx(yn,{});case"space":return e.jsx(wn,{});case"alert":return e.jsx(kn,{});case"queue":return e.jsx(zn,{});case"export":return e.jsx(En,{});case"plug":return e.jsx(qn,{});case"recharge":return e.jsx(On,{});case"cover":return e.jsx(Mn,{});case"dossier":return e.jsx(Rn,{});case"crit":return e.jsx(Dn,{});case"tuto":return e.jsx(Fn,{});case"rdv":return e.jsx(vn,{});case"memoalert":return e.jsx(Tn,{});default:return null}}function vn(){const{dispatch:t,fund:a}=E(),n=typeof document<"u"&&!!document.getElementById("rdv");return u.useEffect(()=>{n&&(t({type:"modal",modal:null}),wr())},[n,t]),n?null:e.jsx(Ra,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function yn(){const{st:t,dispatch:a,byId:n,t:r,lang:i,mode:o,askEvaluate:c,evalBusy:s}=E(),d=o==="client",m=t.chain.queue.map(v=>n.get(v)).filter(v=>!!v),h=t.chain.idx,l=m[h],b=h>=m.length;return Le.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:b?r.finished:`${h+1} / ${m.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(b?100:h/Math.max(1,m.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:b||!l?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(m.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:l.name}),e.jsx("div",{className:"sub",children:[Ne(l.cc,i)||l.countryLabel,l.sector,l.stage,r.daysAgo(ke(l.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:de(l.engine,i).toUpperCase()}),typeof l.amountEur=="number"&&l.amountEur>0&&e.jsx("span",{children:tt(l.amountEur,i)})]}),Q(l)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(Se,{o:l,lg:!0})," ",e.jsx(Ve,{o:l,src:!0})]}),(l.tagline||l.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:l.tagline||l.headline})]}),l.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:l.reasoning})]}),d&&te(l)&&e.jsxs("div",{className:"vbox",style:{"--c":ge(l)==="retenu"?"var(--brand)":ge(l)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:ge(l)==="retenu"?"✓ "+r.kept:ge(l)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:l.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!b&&l&&!(d&&te(l))&&e.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{c(l)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?r.closeBtn:r.skip})]})]})})}),document.body)}function wn(){const{st:t,dispatch:a,dossiers:n,t:r,mode:i}=E(),o=i==="client",c=u.useMemo(()=>o?n.filter(l=>te(l)):[],[n,o]),s=u.useMemo(()=>rt(c.filter(l=>ge(l)==="retenu"),{key:"signal",dir:-1}),[c]),d=u.useMemo(()=>c.filter(l=>ge(l)==="ecarte"),[c]),m=t.spaceTab==="retenu"?s:d,h=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(X,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:s.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:d.length})]})]}),m.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),m.slice(0,40).map(l=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":h},children:typeof l.score=="number"&&l.score>0?l.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:l.name}),e.jsx("div",{className:"rr",children:l.reasoning||l.tagline||""})]})]},l.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function kn(){const{mode:t}=E();return t==="client"||t==="apercu"?e.jsx(jn,{}):e.jsx(Cn,{})}function jn(){const{t,token:a,flash:n,flashErr:r,mode:i}=E(),[o,c]=u.useState("d"),s=i!=="client";return e.jsxs(X,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>c("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>c("w"),children:t.alertTabWeekly})]}),o==="d"?e.jsx(Nn,{t,token:a,readOnly:s,flash:n,flashErr:r}):e.jsx(Sn,{t,token:a,readOnly:s,flash:n,flashErr:r})]})}function Nn({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,c]=u.useState(null),[s,d]=u.useState(!1),[m,h]=u.useState(0);u.useEffect(()=>{let x=!0;return d(!1),ht(a).then(f=>{x&&(f?c(f):d(!0))}),()=>{x=!1}},[a,m]);const l=x=>{n||ht(a,x).then(f=>{if(!f){i(t.actErr);return}c(f),f.throttled?i(t.alertThrottled):r(t.alertSaved)})};if(s)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(x=>x+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const b=x=>!o.sections||o.sections.includes(x),v=x=>{const f=o.sections||t.alertSec.map(([g])=>g);l({sections:b(x)?f.filter(g=>g!==x):[...f,x]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>l({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>l({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>l({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>l({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>l({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([x,f])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:b(x),disabled:n,onChange:()=>v(x)}),e.jsxs("span",{children:[f,x==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},x))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(ot,{label:t.alertPreview,readOnly:n,onPreview:()=>$a(a),onTest:()=>Ia(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Sn({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,c]=u.useState(null),[s,d]=u.useState(!1),[m,h]=u.useState(0);u.useEffect(()=>{let x=!0;return d(!1),bt(a).then(f=>{x&&(f?c(f):d(!0))}),()=>{x=!1}},[a,m]);const l=x=>{n||bt(a,x).then(f=>{if(!f){i(t.actErr);return}c(f),r(t.alertSaved)})};if(s)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(x=>x+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const b=o.dow??0,v=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>l({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:b,disabled:n,onChange:x=>l({dow:Number(x.target.value)}),children:t.alertDow.map((x,f)=>e.jsx("option",{value:f,children:x},x))}),e.jsx("button",{type:"button",onClick:()=>l({hour:Math.max(6,v-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[v," h"]}),e.jsx("button",{type:"button",onClick:()=>l({hour:Math.min(21,v+1)}),disabled:n,children:"＋"})]})]}),e.jsx(ot,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>Ua(a),onTest:()=>Va(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Cn(){const{st:t,t:a,lang:n,scoped:r,contName:i}=E(),[o,c]=u.useState(""),[s,d]=u.useState(!1),[m,h]=u.useState(!1),l=t.filters,b=u.useMemo(()=>r.filter(g=>Q(g)).length,[r]),v=l.win==="1"?0:l.win==="7"?1:l.win==="30"?2:3,x=async()=>{if(!(!/.+@.+\..+/.test(o)||m)){h(!0);try{await fetch(`${Qe}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o.trim(),sectors:l.sector,countries:l.country,source:"atelier2",website:""})}),d(!0)}finally{h(!1)}}},f=[[a.amRows.continent,i],[a.amRows.since,a.amSince[v]],[a.amRows.signal,l.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,l.engine.length?l.engine.map(g=>de(g,n)).join(", "):a.amAllEngines],[a.amRows.sectors,l.sector.length?l.sector.join(", "):a.amAllSectors],[a.amRows.countries,l.country.length?l.country.map(g=>Ne(g,n)||g).join(", "):a.amAllCountries],[a.amRows.stages,l.stage.length?l.stage.join(", "):a.amAllStages]];return e.jsx(X,{title:a.alertTitle,icon:"🔔",children:s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(o)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:f.map(([g,p])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:g}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:p}})]},g))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:o,onChange:g=>c(g.target.value),onKeyDown:g=>{g.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,b)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function zn(){var f,g,p;const{t,token:a,fund:n,mode:r,flash:i}=E(),[o,c]=u.useState(null),[s,d]=u.useState([]),[m,h]=u.useState(0),l=r==="client";u.useEffect(()=>{let y=!0;return(async()=>{const[C,w]=await Promise.all([Xe(n),Rt(a)]);y&&(C&&c(C),d(w))})(),()=>{y=!1}},[a,n,m]);const b=(o==null?void 0:o.per_day)??2,v=((f=o==null?void 0:o.analyzed_today)==null?void 0:f.length)??0,x=(g=o==null?void 0:o.tomorrow)!=null&&g.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(X,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(v,v+(((p=o==null?void 0:o.pool_order)==null?void 0:p.length)??0))}})}),e.jsxs("div",{className:"qrate",children:[t.covRate," — ",e.jsx("b",{children:t.covRateNow(b)})]})]}),s.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:s.map(y=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:y.company}),e.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),e.jsx("span",{className:"qt",children:y.status}),y.url&&e.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),l&&y.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{gt(a,y.company,"retry").then(()=>h(C=>C+1))},children:t.queueRetry}),l&&y.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{gt(a,y.company,"delete").then(()=>h(C=>C+1))},children:t.queueDelete})]},y.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[x.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),x.slice(0,10).map((y,C)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",C+1]}),e.jsx("b",{children:y.name}),typeof y.score=="number"&&e.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function En(){const{t,token:a,flash:n,scoped:r,caps:i,stageOf:o,dispatch:c}=E(),s=`${qe}/cibles/list.csv?token=${a}`,d=`${qe}/cibles/list.json?token=${a}`,m=`${qe}/cibles/export.xlsx?token=${a}&scope=full`,h=`=IMPORTDATA("${s}")`,l=g=>{var p;(p=navigator.clipboard)==null||p.writeText(g).then(()=>n(t.exportCopied))},b=[{def:t.exportCsv,value:s,href:s},{def:t.exportSheet,value:h},{def:t.exportLive,value:d,href:d},{def:t.exportXlsx,value:m,href:m}],v=!i.lockActions&&r.length>0,x=()=>{mn(un(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:g=>(t.stg.find(([p])=>p===g)||["",""])[1]})),n(t.exportViewDone(r.length))},f=()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return e.jsxs(X,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🖨️"}),e.jsxs("div",{children:[e.jsx("b",{children:t.printTitle}),e.jsx("p",{children:t.printDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb",onClick:f,children:t.printBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🗂"}),e.jsxs("div",{children:[e.jsx("b",{children:t.dsBtn}),e.jsx("p",{children:t.dsHint})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>c({type:"modal",modal:"dossier"}),children:t.exportViewBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:x,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:b.map(({def:g,value:p,href:y})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:g[0]}),e.jsxs("div",{children:[e.jsx("b",{children:g[1]}),e.jsx("p",{children:g[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>l(p),children:t.exportCopy}),y&&e.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},g[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function Tn(){const{t,token:a,flash:n,flashErr:r,mode:i}=E(),o=i!=="client",[c,s]=u.useState(null),[d,m]=u.useState(!1),[h,l]=u.useState(0),[b,v]=u.useState(!1);u.useEffect(()=>{let p=!0;return m(!1),xt(a).then(y=>{p&&(y?s(y):m(!0))}),()=>{p=!1}},[a,h]);const x=()=>(c==null?void 0:c.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},f=p=>{if(o||!c)return;const y={enabled:p.enabled??!!c.enabled,email:p.email??(c.email||""),sections:p.sections??x()};v(!0),xt(a,y).then(C=>{if(v(!1),!C){r(t.memoAlertErr);return}s(C),n(t.memoAlertSaved)})};if(d)return e.jsx(X,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>l(p=>p+1),children:t.retry})]})});if(!c)return e.jsx(X,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const g=x();return e.jsxs(X,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":c.enabled===!0,disabled:o||b,style:c.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!c.enabled}),children:c.enabled?"ON":"OFF"})})]}),e.jsx(An,{value:c.email||"",readOnly:o||b,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:p=>f({email:p})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([p,y])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!g[p],disabled:o||b,onChange:()=>f({sections:{...g,[p]:!g[p]}})}),e.jsx("span",{children:y})]},p))}),e.jsx(ot,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>Oa(a,g),onTest:()=>La(a,g)})]})}function An({value:t,readOnly:a,label:n,okLabel:r,onSave:i}){const[o,c]=u.useState(t);u.useEffect(()=>{c(t)},[t]);const s=o.trim()!==t.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:m=>c(m.target.value),onKeyDown:m=>{m.key==="Enter"&&s&&d&&i(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!d,onClick:()=>i(o.trim()),children:r})]})]})}function qn(){const{t,token:a,flash:n,flashErr:r,canWrite:i}=E(),[o,c]=u.useState(null),[s,d]=u.useState(!1),[m,h]=u.useState(null),[l,b]=u.useState(""),[v,x]=u.useState(0);u.useEffect(()=>{let p=!0;return d(!1),Ke(a).then(y=>{p&&(y?c({configured:y.configured,url_hint:y.url_hint}):d(!0))}),Da(a).then(y=>{p&&h(y)}),()=>{p=!1}},[a,v]);const f=(p,y)=>{i&&Ke(a,p).then(C=>{if(!C||C.ok===!1){r(t.actErr);return}p.test&&C.sent===!1?r(t.plugTestThrottled):n(y),x(w=>w+1)})},g='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(X,{title:t.plugTitle,icon:"🔌",wide:!0,children:[m&&e.jsx("p",{className:"mnote"+(m.enabled?" warn":""),children:m.enabled?t.plugAutoOn(m.destination||"webhook"):t.plugAutoOff}),s?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>x(p=>p+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:l,disabled:!i,onChange:p=>b(p.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!i||!l.trim(),onClick:()=>f({url:l.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>f({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>f({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(Ln,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:g}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var p;(p=navigator.clipboard)==null||p.writeText(g).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function Ln(){const{t,token:a,lang:n}=E(),[r,i]=u.useState("valides"),[o,c]=u.useState(!1),[s,d]=u.useState(null),[m,h]=u.useState(null),[l,b]=u.useState(!1),[v,x]=u.useState(!1),[f,g]=u.useState(null),[p,y]=u.useState(null),[C,w]=u.useState(null),k=`atl2:bulk:${a}:${r}`;u.useEffect(()=>{Ke(a).then(T=>{y(T&&T.configured?T.url_hint||"webhook":null)})},[a]),u.useEffect(()=>{d(null),h(null),b(!1),g(null);try{const T=JSON.parse(localStorage.getItem(k)||"null");w(T&&Date.now()-Date.parse(T.t)<24*3600*1e3?T:null)}catch{w(null)}},[k]);const N=async()=>{c(!0),b(!1),g(null);const T=await Pa(a,r);d(T),h(T.ok?r:null),c(!1)},z=u.useRef(!1),S=async()=>{if(z.current)return;z.current=!0,x(!0);const T=`${a}:${r}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let P;try{P=await Ba(a,r,"webhook",void 0,T)}finally{z.current=!1}if(x(!1),b(!1),g(P),P.ok&&(P.pushed||0)>0){const q={t:new Date().toISOString(),n:P.pushed||0};w(q);try{localStorage.setItem(k,JSON.stringify(q))}catch{}}},A=s!=null&&s.ok&&s.ready||0,M=!!(s!=null&&s.ok)&&m===r&&A>0&&!!p&&!C,D=C?new Date(C.t).toLocaleString(n==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:r,onChange:T=>i(T.target.value),children:t.plugBulkTabs.map(([T,P])=>e.jsx("option",{value:T,children:P},T))}),e.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{N()},children:o?"…":t.plugBulkPreview})]}),s&&(s.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr})),!!(s!=null&&s.ok)&&e.jsx("p",{className:"mnote dim",children:t.bulkScope}),C&&e.jsx("p",{className:"mnote",children:t.bulkLocked(D,C.n)}),!C&&!!(s!=null&&s.ok)&&!p&&e.jsx("p",{className:"mnote warn",children:t.bulkNoDest}),!C&&!s&&e.jsx("p",{className:"mnote dim",children:t.bulkPreviewFirst}),M&&!l&&e.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>b(!0),children:t.bulkArm}),M&&l&&e.jsxs("div",{className:"bulkc",children:[e.jsx("p",{className:"mnote warn",children:t.bulkWarn(A,p||"")}),e.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{S()},children:v?t.bulkSending:t.bulkConfirm(p||"")}),e.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>b(!1),children:t.bulkCancel})]}),f&&(f.ok?f.replayed?e.jsx("p",{className:"mnote",children:f.pending?t.bulkPending:t.bulkReplayed}):(f.pushed||0)>0?e.jsx("p",{className:"mnote",children:t.bulkDone(f.pushed||0,f.linkedinReady||0,f.skippedNoEmail||0)}):e.jsx("p",{className:"mnote warn",children:t.bulkNone}):e.jsx("p",{className:"mnote warn",children:f.error||t.actErr}))]})}function On(){const{t,data:a,lang:n}=E(),r=a.credits,i=a.email,o=async c=>{if(!i)return;const s=window.location.href.split("?")[0];try{const m=await(await fetch(`${Qe}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:c,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();m.url&&(window.location.href=m.url)}catch{}};return e.jsxs(X,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(c=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(c.credits,c.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(c.lookup_key)},children:t.rechargeBuy})]},c.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function Rn(){const{t}=E();return e.jsx(X,{title:t.dsBtn,icon:"🗂",wide:!0,children:e.jsx(gn,{})})}function Mn(){const{t,lang:a,data:n,dossiers:r,token:i,canWrite:o,flash:c}=E(),[s,d]=u.useState(null),[m,h]=u.useState(!1);u.useEffect(()=>{let N=!0;return Xe(i).then(z=>{N&&z&&typeof z.per_day=="number"&&d(z.per_day)}),()=>{N=!1}},[i]);const l=n.stats,b=typeof(l==null?void 0:l.screened)=="number"?l.screened:r.filter(N=>N.kind==="target"&&te(N)).length,v=n.marketEstimate||0,x=v>0?Math.min(100,Math.round(b/v*100)):null,f=(l==null?void 0:l.window_days)||30,g=b>0?b/f:0,p=v>0?Math.max(0,v-b):0,C=v>0&&g>0&&b>=100?Math.round(p/g):null,w=N=>Math.round(N).toLocaleString(a==="en"?"en-US":"fr-FR"),k=N=>{m||!o||(h(!0),Fa(i,N).then(z=>{if(h(!1),z===null){c(t.actErr);return}d(z),c(t.alertSaved)}))};return e.jsxs(X,{title:t.coverTitle,icon:"🌍",children:[e.jsxs("div",{className:"covg",children:[e.jsx("b",{children:t.covScreened(w(b))}),v>0&&e.jsx("span",{children:t.covOf(w(v))})]}),x!==null?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"covbar",children:[e.jsx("i",{style:{width:x+"%"}}),e.jsxs("em",{children:[x," %"]})]}),C!==null&&e.jsx("p",{className:"mnote",children:t.covEta(C)})]}):e.jsx("p",{className:"mnote dim",children:t.covNoEst}),g>=1&&e.jsx("p",{className:"mnote",children:t.covPace(w(g))}),l&&e.jsxs("div",{className:"covf",children:[typeof l.kept=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(l.kept)})," ",t.covKept]}),typeof l.analyzed=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(l.analyzed)})," ",t.covAna]}),typeof l.shown=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(l.shown)})," ",t.covShown]})]}),o&&s!==null&&e.jsxs("div",{className:"covr",children:[e.jsxs("div",{className:"covrh",children:[e.jsx("span",{children:t.covRate}),e.jsx("b",{children:t.covRateNow(s)})]}),e.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(N=>e.jsx("button",{type:"button",className:s===N?"on":"",disabled:m,onClick:()=>k(N),children:N===0?"⏸":N},N))}),e.jsx("p",{className:"mnote dim",children:t.covRateHint})]})]})}function Dn(){var p,y,C;const{t,dossiers:a,token:n,mode:r,flash:i,criteria:o}=E(),c=r==="client",s=u.useMemo(()=>{const w=new Set;return a.forEach(k=>{k.angle&&w.add(k.angle)}),[...w]},[a]),[d,m]=u.useState(null);u.useEffect(()=>{let w=!0;return Ma(n).then(k=>{w&&m(k.thumbs)}),()=>{w=!1}},[n]);const[h,l]=u.useState(""),[b,v]=u.useState(""),[x,f]=u.useState(!1),g=async()=>{const w=h.trim();if(!(!w||x||!c)){f(!0),v("");try{const N=await(await fetch(`${qe}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:w,who:"atelier2"})})).json().catch(()=>({}));if(N.reply&&v(String(N.reply)),N.job_id){v(t.critChatRunning);const z=async()=>{const S=await fetch(`${qe}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:N.job_id})}).then(A=>A.json()).catch(()=>null);if(S&&S.done){v(String(S.reply||S.clarification||S.summary||"✓")),f(!1),S.applied&&i(t.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),l("");return}l("")}finally{b.startsWith("⏳")||f(!1)}}};return e.jsxs(X,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((p=o.points)!=null&&p.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(w=>e.jsx("li",{children:w},w))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(w=>{var k,N;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:w.title}),w.why&&e.jsx("p",{className:"why",children:w.why}),e.jsxs("div",{className:"lo",children:[!!((k=w.look)!=null&&k.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:w.look.map(z=>e.jsx("li",{children:z},z))})]}),!!((N=w.out)!=null&&N.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:w.out.map(z=>e.jsx("li",{children:z},z))})]})]})]},w.title)})]}),!!((C=o==null?void 0:o.gate)!=null&&C.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>e.jsxs("li",{children:[w.k&&e.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>e.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:h,disabled:!c||x,onChange:w=>l(w.target.value),onKeyDown:w=>{w.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(x?" loading":""),style:{padding:"12px 18px"},disabled:!c||x||!h.trim(),onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),b&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:b})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),d===null?e.jsx("div",{className:"sp-empty",children:"…"}):d.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:d.slice(0,12).map((w,k)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:w.company}),e.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},k))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([w,k])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Vt[w]||"v-cons"),children:w}),e.jsx("span",{children:k})]},w))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([w,k])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:w}),e.jsxs("span",{children:["← ",k]})]},w))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function Fn(){const{t,dispatch:a,startTour:n}=E(),r=i=>{var o,c;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(c=document.querySelector(".atl2 .demand input"))==null||c.focus())};return e.jsxs(X,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([i,o],c)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:c+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+c))})]})}const Ut="atl2:mapfold",Pn=()=>{if(typeof window>"u")return!1;try{const t=localStorage.getItem(Ut);if(t==="on")return!0;if(t==="off")return!1}catch{}return window.innerHeight<1e3},Ht=u.createContext(null),E=()=>{const t=u.useContext(Ht);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function Se({o:t,lg:a}){const{lang:n}=E(),r=Q(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:vt(r,n),children:[r.emoji," ",vt(r,n)]}):null}function Ve({o:t,src:a}){const{lang:n,t:r}=E(),i=Q(t);if(!i)return null;const o=Ga(i),c=Ka(i);return e.jsxs("em",{className:"sigwin"+(c?" hot":""),title:r.signaledOn(Dt(i,n))+" · "+r.win7(Ft(i,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(s,d)=>e.jsx("i",{className:d<o?"on":""},d))}),e.jsx("span",{className:"lb",children:c?r.lastDay:r.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&e.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function _t({o:t}){const{lang:a}=E(),n=Wa(t.cc),r=t.cc?Ne(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const qt="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Yt=t=>`atl2:tour:${t||"anon"}`;function Bn(t){try{return localStorage.getItem(Yt(t))==="1"}catch{return!0}}function Lt(t){try{localStorage.setItem(Yt(t),"1")}catch{}}function In(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function Yn({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:i,onFiltersChange:o}){const{lang:c}=Ha(),s=rr[c],d=fr(t,c,a),[m,h]=u.useReducer(gr,void 0,()=>xr((r==null?void 0:r.continent)??"europe",t||Pn(),{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),l=u.useRef(!0);u.useEffect(()=>{if(l.current){l.current=!1;return}if(!t)try{localStorage.setItem(Ut,m.mapFolded?"on":"off")}catch{}},[m.mapFolded,t]);const b=u.useRef(o);b.current=o,u.useEffect(()=>{var j;(j=b.current)==null||j.call(b,m.filters)},[m.filters]);const[v,x]=u.useState(null),[f,g]=u.useState(null),[p,y]=u.useState({kept:0,dropped:0}),[C,w]=u.useState(!1),[k,N]=u.useState(""),[z,S]=u.useState(!1),[A,M]=u.useState(null),[D,T]=u.useState(!1),[P,q]=u.useState(!1),[,B]=u.useState(0),R=()=>B(j=>j+1),_=u.useRef([]),se=u.useRef(new Set),ce=u.useRef(new Set),Oe=u.useRef(new Map),he=u.useRef(null),{mode:pe}=d,Y=u.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),V=Y.pipe,U=d.session.token||"",F=pe==="client"&&!t;u.useEffect(()=>{if(document.querySelector(`link[href="${qt}"]`))return;const j=document.createElement("link");j.rel="stylesheet",j.href=qt,document.head.appendChild(j)},[]);const I=(j,L=!1)=>{N(j),S(L),he.current&&clearTimeout(he.current),he.current=setTimeout(()=>N(""),L?4200:2400)},H=j=>I(j,!0),ne=u.useMemo(()=>{const j=new Map;return d.dossiers.forEach(L=>{L.id&&j.set(L.id,L)}),j},[d.dossiers]),ae=u.useMemo(()=>d.dossiers.filter(j=>Bt(j,m,V)),[d.dossiers,m,V]),J=u.useRef(!1);u.useEffect(()=>{if(J.current||t||d.loading||!d.dossiers.length)return;if(!Y.showFunnel||Bn(d.session.token||"")){J.current=!0;return}J.current=!0;const j=window.setTimeout(()=>{Lt(d.session.token||""),T(!0)},700);return()=>window.clearTimeout(j)},[t,d.loading,d.dossiers.length,Y.showFunnel,d.session.token]);const ee=u.useMemo(()=>d.dossiers.filter(j=>hr(j,m,V,d.favIds)),[d.dossiers,m,V,d.favIds]),Ce=u.useMemo(()=>_a(ae,d.favIds),[ae,d.favIds]),$=Ze.find(j=>j.key===m.continent),le=c==="fr"?$.fr:$.en,ue=(j,L)=>{const O=((j==null?void 0:j.name)||L||"").trim();if(!F){g({kicker:O});return}!O||C||(w(!0),(async()=>{try{const W=await Mt(U,O,"atelier2"),Re={name:W.company||O,verdict:W.verdict,reason:W.reason||"",remaining:W.remaining??null};_.current=[Re,..._.current].slice(0,8),W.verdict==="kept"&&y(me=>({...me,kept:me.kept+1})),W.verdict==="ruled_out"&&y(me=>({...me,dropped:me.dropped+1}));const Te=j||d.dossiers.find(me=>(me.name||"").toLowerCase()===O.toLowerCase());Te&&(W.verdict==="kept"?Te.verdict=Te.verdict||"MATCH":W.verdict==="ruled_out"&&(Te.verdict="NO MATCH"),W.reason&&(Te.reasoning=W.reason)),R()}finally{w(!1)}})())},ze=j=>{if(!F){g({kicker:j.name});return}se.current.add(j.id),Ae(U,"fast_request",j.name||"",""),I(s.memoInstantSent(j.name)),R()},be=j=>Oe.current.get(j.id)??d.thumbs.get((j.name||"").trim().toLowerCase()),re=(j,L)=>h({type:"undoPush",entry:{id:j.id,name:j.name,prevCeoStatus:L}}),ve=async(j,L,O)=>{const W=j.ceoStatus||"";j.ceoStatus=L,R();const Re=await _e(U,{status:L,airtable_id:j.airtableId,check_id:j.checkId,company:j.name,...(O==null?void 0:O.note)!==void 0?{note:O.note}:{},...O!=null&&O.via?{via:O.via}:{}});return Re.ok?Re.skipped?(j.ceoStatus=W,R(),H(s.actNotPersisted),!1):((O==null?void 0:O.undo)!==!1&&re(j,W),O!=null&&O.msg&&I(O.msg),(L==="Validé"||L==="Écarté")&&!j.ceoNote&&(O==null?void 0:O.note)===void 0&&M({o:j,yes:L==="Validé"}),!0):(j.ceoStatus=W,R(),H(s.actErr),!1)},Ee=async(j,L)=>{const O=await _e(U,{status:j.ceoStatus||"Retenu",airtable_id:j.airtableId,check_id:j.checkId,company:j.name,note:L,via:"note"});return!O.ok||O.skipped?(H(O.skipped?s.actNotPersisted:s.actErr),!1):(j.ceoNote=L,R(),!0)},oe=u.useRef(new Map),ye=j=>oe.current.has(j.id)?oe.current.get(j.id):d.stages.get((j.name||"").trim().toLowerCase()),Wt=(j,L)=>{oe.current.set(j.id,L),R()},Gt=(j,L)=>{F&&ve(j,L?"Validé":"Écarté",{msg:L?s.decidedYes(j.name):s.decidedNo(j.name)})},Kt=j=>{F&&ve(j,"À trancher",{msg:s.promoted(j.name)})},Qt=j=>{F&&(async()=>{const L=j.ceoStatus||"";j.ceoStatus="Retenu",R();const O=await _e(U,{status:"Retenu",check_id:j.checkId,company:j.name});if(!O.ok||O.skipped){j.ceoStatus=L,R(),H(O.skipped?s.actNotPersisted:s.actErr);return}re(j,L),I(s.repeched(j.name))})()},Jt=()=>{const j=m.undo[m.undo.length-1];if(!j){I(s.undoNone);return}const L=ne.get(j.id);if(!L){h({type:"undoPop"}),I(s.undoNone);return}let O=j.prevCeoStatus;if(!O)if((L.verdict||"").toUpperCase().includes("CALL"))O="À trancher";else{I(s.undoLockedTitle);return}(async()=>await ve(L,O,{undo:!1})&&(h({type:"undoPop"}),L.ceoStatus=j.prevCeoStatus,R(),I(s.undoDone(L.name))))()},Xt=j=>{F&&(ce.current.add(j.id),R(),(async()=>{const L=await Qa(U,j.name,"email");if(!L||L.ok===!1){ce.current.delete(j.id),R(),H(s.actErr);return}Ae(U,"approach",j.name||"",""),I(s.actApproachSent)})())},Zt=(j,L)=>{F&&(async()=>{if(!(await Ae(U,L?"yes":"no",j.name||"","")).ok){H(s.actErr);return}Oe.current.set(j.id,L?"yes":"no"),R(),I(L?s.thumbUpDone:s.thumbDnDone)})()},ea=j=>{!F||!et(j)||(Ae(U,"detailed_request",j.name||"",""),I(s.memoDeepSent(j.name)))},ta=j=>{const L=new Set(d.favIds),O=L.has(j.id);O?L.delete(j.id):L.add(j.id),d.setFavIds(L),F&&Ja(U,{id:j.id,co:j.name},O)},aa=()=>{!F||P||window.confirm(s.identSyncConfirm)&&(q(!0),(async()=>{const j=await Xa(U);q(!1),j?I(s.identSyncDone):H(s.actErr)})())},it=/proplace/i.test(d.fund||""),ra=j=>{!F||!it||(Ae(U,"onboard_request",j.name||"",""),I(s.onboardSent(j.name)))},na={st:m,dispatch:h,t:s,lang:c,mode:pe,caps:Y,pipe:V,token:U,fund:d.fund,email:d.email,criteria:d.criteria,data:d,doRepeche:Qt,thumbOf:be,canWrite:F,commitStatus:ve,saveNote:Ee,stageOf:ye,setStage:Wt,flashErr:H,startTour:()=>T(!0),dossiers:d.dossiers,scopedAll:ae,scoped:ee,counts:Ce,byId:ne,contName:le,favIds:d.favIds,toggleFav:ta,askEvaluate:ue,doAnalyse:ze,doDecide:Gt,doPromote:Kt,doApproach:Xt,doThumb:Zt,doDeep:ea,doUndo:Jt,doSync:aa,doOnboard:ra,outbound:it,memoQueued:se.current,approachDone:ce.current,sessTally:p,evalCards:_.current,evalBusy:C,markRow:x,markedId:v,flash:I};return u.useEffect(()=>{const j=L=>{L.key==="Escape"&&(h({type:"popup",id:null}),h({type:"modal",modal:null}),h({type:"openFacet",facet:null}))};return window.addEventListener("keydown",j),()=>window.removeEventListener("keydown",j)},[]),e.jsx(Ht.Provider,{value:na,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:ir}),e.jsxs("div",{className:"app"+(V?" pipe":""),children:[Y.showTicker&&e.jsx(G,{name:"live",children:e.jsx(br,{})}),Y.showIdent&&e.jsx(G,{name:"identite",children:e.jsx(Mr,{})}),Y.showOnb&&e.jsx(G,{name:"onboarding",children:e.jsx(Dr,{})}),Y.showMorning&&e.jsx(G,{name:"matin",children:e.jsx(Rr,{})}),e.jsx(G,{name:"fraicheur",children:e.jsx(Cr,{})}),e.jsx(G,{name:"mesure",children:e.jsx(zr,{})}),Y.showFunnel&&e.jsx(G,{name:"entonnoir",children:e.jsx($n,{})}),Y.showFunnel&&e.jsx(G,{name:"tunnel",children:e.jsx(Pr,{})}),Y.showFunnel&&e.jsx(G,{name:"tuto",children:e.jsx(Ir,{})}),e.jsx(G,{name:"carte",fallback:e.jsx("div",{className:"void",children:s.loadError}),children:e.jsxs("div",{className:"fzone",children:[e.jsx(Vn,{}),e.jsxs("div",{className:"stage"+(m.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(Vr,{}),e.jsx(Hr,{})]})]})}),Y.showDemand&&e.jsx(G,{name:"evaluation",children:e.jsx(Yr,{})}),Y.showDemand&&m.memoConsole&&e.jsx(G,{name:"console",children:e.jsx(Gr,{})}),e.jsx(G,{name:"liste",fallback:e.jsxs("div",{className:"void",children:[s.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:e.jsx(sn,{})}),d.loading&&e.jsx("div",{className:"void",children:s.loadingV2}),d.error&&!d.loading&&e.jsxs("div",{className:"void",children:[s.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:s.retry})]})]}),Y.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:s.lockbarText}),e.jsx("button",{type:"button",onClick:()=>h({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),m.popupId&&e.jsx(G,{name:"fiche",children:e.jsx(cn,{})}),e.jsx(G,{name:"modales",children:e.jsx(bn,{})}),e.jsx(jr,{}),A&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:A.o.name}),e.jsx(qr,{placeholder:A.yes?s.whyYesPh:s.whyNoPh,onDone:j=>{const L=A.o;M(null),j&&Ee(L,j).then(O=>{O&&I(s.csNoteSaved)})}})]}),D&&e.jsx(Or,{steps:In(s),onClose:()=>{T(!1),Lt(U)}}),k&&e.jsx("div",{className:"flash on"+(z?" err":""),children:k}),f&&e.jsx(Ya,{variant:"acquirer",initialCompany:Ot().co,initialWebsite:Ot().site,onClose:()=>g(null)})]})})}function $n(){const{t}=E(),[a,n]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Vn(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:i,t:o}=E(),c=u.useMemo(()=>{const s={};return t.forEach(d=>{d.continent&&at(d,a.filters,r)&&(s[d.continent]=(s[d.continent]||0)+1)}),s},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[Za.map(s=>{const d=Ze.find(m=>m.key===s);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===s,onClick:()=>n({type:"continent",key:s}),children:[i==="fr"?d.fr:d.en,e.jsx("span",{className:"n",children:c[s]||0})]},s)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Ot(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Un(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{_t as FlagCell,Se as SigBadge,Ve as SigWin,Yn as default,Un as fmtShort,E as useV2};
