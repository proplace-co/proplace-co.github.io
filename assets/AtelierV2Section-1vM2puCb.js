...
.atl2 .bulk .side .hint{white-space:nowrap}`,Ts=`
...
.atl2 .apch:hover,.atl2 .apday:hover{border-color:#94A3B8}
.atl2 .apch.on{background:var(--ink);color:#fff;border-color:var(--ink)}
.atl2 .apday.on{background:#EFF8F2;border-color:#BBE7CC;color:#0A6B3D}
...
.atl2 .apfield label{font-family:var(--mono);font-size:10px;letter-spacing:.08em;
  text-transform:uppercase;color:var(--dim)}
...
.atl2 .dn-n{font-size:11px;font-weight:650;color:var(--brand-d,#0A6B3D);
...
.atl2 .dn-d{font-family:var(--mono);font-size:10px;letter-spacing:.05em;
  color:var(--dim)}
...
`,Rs=qs+Ts+Ls;function sn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Fs(){const e=sn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ms(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Fs();return r==="0"?"client":r==="1"||sn("embed")==="1"&&sn("chrome")==="1"?"apercu":"client"}const Os={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ds=e=>Os[e];function Ea(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Et=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!eo(a)||Ea(a))&&(e.noCo=!0)}return Object.assign(e,{continent:bi(e.cc)})};function Va(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Is=60*60*1e3;function Ps(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Is?null:a}catch{return null}}function ca(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Bs=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function _s(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:si(),[e,n]),i=p.useMemo(()=>n?"visiteur":Ms(e,o),[e,o,n]),s=p.useMemo(()=>Ds(i),[i]),l=i!=="visiteur",d=Bs(r),[x,c]=p.useState([]),[g,u]=p.useState(""),[b,f]=p.useState(null),[v,w]=p.useState(null),[m,y]=p.useState(null),[j,k]=p.useState(()=>new Map),[N,A]=p.useState(()=>new Map),[S,R]=p.useState(""),[T,D]=p.useState(new Set),[F,$]=p.useState(null),[M,I]=p.useState(!0),[h,q]=p.useState(!1),[U,X]=p.useState(0),[E,C]=p.useState(0),O=p.useRef(0),B=p.useMemo(()=>{var G;if(i!=="client")return"";try{return((G=li())==null?void 0:G.email)||""}catch{return""}},[i]);p.useEffect(()=>{const G=++O.current;let ue=!0;const K=()=>ue&&G===O.current,ce=(l&&o.token?o.token:"pub:"+a)+(d?":"+d:""),le=Ps(ce);return le?(c(le.objs.map(Et)),le.fund&&u(le.fund),f(le.marketEstimate??null),w(le.criteria??null),y(le.stats??null),R(le.generatedAt||""),I(!1)):I(!0),(async()=>{try{if(r==="ops"){const be=await _a(),fe=((be==null?void 0:be.recent_ops)||[]).map(de=>{const pe=va(de.company_name||de.title?de:{...de,title:(de.headline_fr||de.headline||"").slice(0,120)},a),ge=String(de.rubrique||"").toLowerCase();return pe&&(ge==="nominations"||ge==="recrutements")&&(pe.engine=ge),pe&&!String(de.company_name||"").trim()&&(pe.noCo=!0),pe}).filter(de=>!!de).map(de=>(eo((de.name||"").trim())||(de.noCo=!0),de));try{const de=di(),pe=await ci(),ge=((pe==null?void 0:pe.date)||"").slice(0,10),Q=de?de.doc:pe,re=pi(Q),he=((de==null?void 0:de.day)||(Q==null?void 0:Q.date)||ge||"").slice(0,10);if(he&&re.length){const ke=new Set;for(const ne of fe){if((ne.date||"").slice(0,10)!==he)continue;const ve=_n(re,ke,ne.name,"");ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}for(const ne of fe){if(ne.decryptHtml||(ne.date||"").slice(0,10)!==he)continue;const ve=_n(re,ke,"",ne.headline||ne.tagline||ne.name);ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}}if(he){const ke=((Q==null?void 0:Q.title_fr)||"").trim(),ne=((Q==null?void 0:Q.lead_fr)||"").trim(),ve=ui(Q),oe=((Q==null?void 0:Q.url)||"").trim();ke&&(ve||oe)&&fe.unshift({id:`edito:${he}`,kind:"op",name:ke,cc:null,date:he,engine:"edito",dealKind:"other",headline:ke,tagline:ne||ke,decryptHtml:ve||void 0,url:oe,noCo:!0})}}catch{}if(!K())return;c(fe.map(Et)),ca(ce,{objs:fe})}else if(typeof r=="object"){const fe=(await $n()||[]).filter(pe=>(pe.slug||"")===r.research).map(pe=>Un(pe,a)).filter(pe=>!!pe),de=Va(await Hn(fe,a));if(!K())return;c(de.map(Et)),ca(ce,{objs:de})}else if(l&&o.token){const be=mi(o.token),fe=_a(),de=fi(o.token),pe=hi(o.token),ge=xi(o.token),Q=await be;let re=Q?Q.targets:[];K()&&Q&&(u(Q.fund||""),f(Q.marketEstimate??null),w(Q.criteria??null),y(Q.stats??null),R(Q.generatedAt||""),c(re.map(Et)),I(!1),q(!1));const[he,ke,ne,ve]=await Promise.all([fe,de,pe,ge]),oe=((he==null?void 0:he.recent_ops)||[]).map(xe=>va(xe,a)).filter(xe=>!!xe),ze=new Set(re.map(xe=>xe.id));if(re=[...re,...oe.filter(xe=>!ze.has(xe.id)&&(ze.add(xe.id),!0))],!K())return;c(re.map(Et));const Ke=new Set;for(const xe of ke){const Se=(xe.id||xe.co||"").toString().trim().toLowerCase();Se&&Ke.add(Se.startsWith("t:")?Se:"t:"+Se)}D(Ke),k(ne),A(ve),Q&&ca(ce,{fund:Q.fund,marketEstimate:Q.marketEstimate,criteria:Q.criteria,stats:Q.stats,generatedAt:Q.generatedAt,objs:re})}else{const be=gi(),fe=$n(),de=_a(),pe=await be;K()&&pe.length&&(c(Va(pe).map(Et)),I(!1),q(!1));const[ge,Q]=await Promise.all([fe,de]),re=(ge||[]).map(ve=>Un(ve,a)).filter(ve=>!!ve),he=await Hn(re,a),ke=((Q==null?void 0:Q.recent_ops)||[]).map(ve=>va(ve,a)).filter(ve=>!!ve),ne=Va([...pe,...he,...ke]);if(!K())return;c(ne.map(Et)),ca(ce,{objs:ne})}K()&&q(!1)}catch{K()&&!le&&q(!0)}finally{K()&&I(!1)}})(),()=>{ue=!1}},[l,o.token,a,U,d]),p.useEffect(()=>{if(!s.showCredits||!B){$(null);return}let G=!0;return(async()=>{try{const ue=await fetch(`${Da}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:B})});if(!ue.ok)return;const K=await ue.json();G&&K&&K.ok!==!1&&$(K)}catch{}})(),()=>{G=!1}},[s.showCredits,B,E]);const _=p.useCallback(G=>D(new Set(G)),[]);return{session:o,mode:i,caps:s,fund:g,email:B,marketEstimate:b,generatedAt:S,criteria:v,stats:m,thumbs:j,stages:N,dossiers:x,favIds:T,setFavIds:_,credits:F,reloadCredits:()=>C(G=>G+1),loading:M,error:h,refresh:()=>X(G=>G+1)}}function Ge(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ya=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Sa(e){return ya.has(e.engine||"")}function We(e){return!!e.noCo||Sa(e)&&!!e.url}const mo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),$s=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...mo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,memoTab:0,undo:[],mapFolded:a}),Us=new Set(["signal","amount","score","crible","memo"]);function Hs(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:mo(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Us.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??fo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const fo=80;function Ca(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Nn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ht(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ct(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(ao(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function ea(e,a,r){return Ge(e)?Ca(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ca(e,a.filters,r)}function Vs(e,a,r,n){return!(!ea(e,a,r)||r&&!to(e,a.ptab,n))}function zn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-ht(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return yi(o);case"memo":return vi(o);case"signal":{const i=Me(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const s=n(o),l=n(i);return s<l?-a.dir:s>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Wa={},sr=(Wa==null?void 0:Wa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function lr(){return new Date().toISOString().slice(0,10)}const An=p.createContext(null);function ho(){return p.useContext(An)}function Ws(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),s=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),l.querySelectorAll("*").forEach(d=>{const x=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(c=>d.removeAttribute(c.name)),x&&/^https?:\/\//i.test(x)&&(d.setAttribute("href",x),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Gs(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),s=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),d=(i==="href"||i==="src")&&/^https?:\/\//i.test(s);!l&&!d&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function dr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),s=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),s&&n.setAttribute("class",s),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function cr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${i} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${i} ${r[1]}`}function xo(){const e=p.useContext(An);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ys({token:e,children:a}){const{dispatch:r,st:n,lang:o}=W(),[i,s]=p.useState(()=>n.filters.day||lr()),[l,d]=p.useState(null),[x,c]=p.useState(!1),g=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){s(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{s(lr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=w=>{var y;const m=(y=w.detail)==null?void 0:y.day;typeof m=="string"&&g(m)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[g]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&s(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let v=!1;c(!0);const w=new URLSearchParams({token:e,date:i});return fetch(`${sr}/cibles/edition.json?${w}`).then(m=>m.json()).then(m=>{v||d(m)}).catch(()=>{v||d({ok:!1,error:"network"})}).finally(()=>{v||c(!1)}),()=>{v=!0}},[e,i]);const b=p.useMemo(()=>`${sr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),f=p.useMemo(()=>({token:e,day:i,ed:l,loading:x,pickDay:g,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,x,g,u,n.filters.day,b,o]);return t.jsx(An.Provider,{value:f,children:a})}function Qs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=xo(),[o,i]=p.useState(()=>n||no());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const s=l=>{var d;return i(!!((d=l.detail)!=null&&d.open))};return window.addEventListener(ja,s),()=>window.removeEventListener(ja,s)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(wi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Ks(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function pr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function ur(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Js(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=xo(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!s,d=a&&!a.ok,x=p.useRef(null),[c,g]=p.useState("fonds"),[u,b]=p.useState(null),[f,v]=p.useState("idle"),w=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),w.current=!1,g("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||w.current)return;w.current=!0;let N=!0;return v("load"),Ks(e).then(A=>{N&&(b(A),v("fait"))}),()=>{N=!1}},[c,e]);const m=p.useMemo(()=>Gs((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),y=p.useRef(null);p.useEffect(()=>{const N=y.current;if(!N||!m)return;let A=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(A||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{A=!0}},[m]);const j=p.useMemo(()=>dr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>dr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const N=x.current;if(!N||!j)return;let A=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(A||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{A=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>g("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>g("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&d&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?pr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:cr(e,!0)}),"."]}):pr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:cr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>g("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&s&&j?t.jsx("div",{ref:x,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,c==="fonds"&&s&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(m?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:y,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:m}})]}):t.jsx("p",{className:f==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:f!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:ur(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:ur(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Xs=300,pa=7,Zs={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},go={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},el=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ga(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Ei(r)&&r!=="media")return"news:"+r;const n=Me(e);return n?"sig:"+(n.theme&&go.fr[n.theme]?n.theme:"other"):"actualites"}function tl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:s,fund:l}=W(),d=ho(),x=s==="en",[c,g]=p.useState("all"),[u,b]=p.useState(!1),f=p.useMemo(()=>{var ue;const h=(a.filters.day||"").slice(0,10),q=K=>!(!i&&a.continent!=="monde"&&K.continent!==a.continent||h&&(K.date||"").slice(0,10)!==h),U=e.filter(K=>q(K)&&Me(K)&&(!i||K.kind!=="target"||Ne(K)!==5)),X=i&&(((ue=d==null?void 0:d.ed)==null?void 0:ue.ops)||[]).length?d.ed.ops.map(K=>va(K,s)).filter(K=>!!K).map(K=>(K.briefOnly=!0,K)).filter(K=>!h||(K.date||"").slice(0,10)===h):[],E=e.filter(K=>q(K)&&K.kind==="op"&&(h?!0:ht(K.date)<=pa)),C=i?X.length?X:E.filter(K=>{const ce=(l||"").trim().toLowerCase();if(!ce)return!1;const le=K.match||null;return le?Object.keys(le).map(be=>be.trim().toLowerCase()).includes(ce):!1}):E,O=h||new Date().toISOString().slice(0,10),B=K=>{const ce=Ga(K);return ce==="ma"?0:ce==="levees"?1:2};C.sort((K,ce)=>{const le=B(K)-B(ce);if(le)return le;const be=(K.date||"").slice(0,10)===O?0:1,fe=(ce.date||"").slice(0,10)===O?0:1;return be!==fe?be-fe:(ce.amountEur||0)-(K.amountEur||0)});const _=new Set,G=[];for(const K of[...C,...zn(U,{key:"signal",dir:-1})]){const ce=K.id||K.name;!ce||_.has(ce)||(_.add(ce),G.push(K))}return i&&G.length===0?e.filter(ce=>q(ce)&&ht(ce.date)<=pa).sort((ce,le)=>(le.date||"").localeCompare(ce.date||"")).slice(0,80):G},[e,a.continent,a.filters.day,i,l,s,d]),v=p.useMemo(()=>{const h={};for(const q of f){const U=Ga(q);h[U]=(h[U]||0)+1}return h},[f]),w=p.useMemo(()=>c==="all"?f:f.filter(h=>Ga(h)===c),[f,c]),m=p.useMemo(()=>w.slice(0,Xs),[w]),y=w.length-m.length,j=p.useRef(null);p.useEffect(()=>{var C,O;const h=j.current;if(!h)return;const q=()=>{const B=h.scrollWidth;B<200||(h.style.animationDuration=Math.max(18,Math.round(B/130))+"s")};q();const U=requestAnimationFrame(q),X=window.setTimeout(q,1200);let E=!0;return(O=(C=document.fonts)==null?void 0:C.ready)==null||O.then(()=>{E&&q()}),()=>{E=!1,cancelAnimationFrame(U),window.clearTimeout(X)}},[m.length,c]);const k=h=>h==="all"?f.length:v[h]||0,N=h=>{if(h==="all")return x?"All":"Tout";if(h.startsWith("sig:"))return go[x?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const q=h.slice(5);return ji[q]?Ni(q,x?"en":"fr"):h}return Zs[x?"en":"fr"][h]},A=[{k:"all"}],S=["ma","levees"].filter(h=>k(h)>0||h===c);if(S.length){A.push({g:x?"Deals":"Opérations"});for(const h of S)A.push({k:h})}const R=["nominations","recrutements"].filter(h=>k(h)>0||h===c),T=ki.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>k(h)>0||h===c),D=k("actualites")>0||c==="actualites"?["actualites"]:[];if(R.length||T.length||D.length){A.push({g:x?"News":"Actualités"});for(const h of R)A.push({k:h});for(const h of T)A.push({k:h});for(const h of D)A.push({k:h})}const F=el.map(h=>"sig:"+h).filter(h=>k(h)>0||h===c);if(F.length){A.push({g:x?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of F)A.push({k:h})}const $=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(x?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},M=(()=>{const h=(a.filters.day||"").slice(0,10),q=!i&&a.continent!=="monde"&&o?x?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(x?`LIVE covers the events of ${$(h)}.`:`Le LIVE regroupe les événements du ${$(h)}.`)+q:(x?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+q})(),I=h=>m.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ie(q)?" spent":""),onClick:U=>{const X=q.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:X?"":q.id,name:q.name,url:q.url||"",text:q.tagline||q.headline||"",card:q.card}}))}catch{}if(X||n({type:"focus",id:q.id}),a.dens!=="liste"){const E=U.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:E.left+E.width/2,y:E.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(yt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(Zo,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Ic(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Ia,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(q.id||q.name))).concat(y>0?[t.jsx("span",{className:"tk quiet",children:x?`+ ${y} more — filter by section to see them`:`+ ${y} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(h=>!h),children:[N(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:M}),A.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===c,onClick:()=>{g(h.k),b(!1)},children:[N(h.k),t.jsx("b",{children:k(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:m.length?t.jsxs("div",{className:"run",ref:j,children:[I(0),I(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!d&&t.jsxs("button",{type:"button",className:"tk-edito",title:x?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",x?"Today's editorial":"Edito du jour"]}),!!d&&t.jsx(nl,{isEn:x})]})}const al=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function nl({isEn:e}){const[a,r]=p.useState(()=>no());p.useEffect(()=>{const o=i=>{var s;return r(!!((s=i.detail)!=null&&s.open))};return window.addEventListener(ja,o),()=>window.removeEventListener(ja,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Si(!a),children:al})}const qn="+33 6 83 10 72 86",za="alexandre@proplace.co",bo=`tel:${qn.replace(/[^\d+]/g,"")}`;function rl(){return null}class rt extends p.Component{constructor(){super(...arguments);Pn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const vo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function mr(e,a){if((wt(e)||"").startsWith("CALL")&&Ne(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ne(e)>=2;return vo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const fr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",ol={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function il({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:s}=W(),[l,d]=p.useState(""),[x,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!g)return;const y=j=>{b.current&&!b.current.contains(j.target)&&(u(!1),c(!1))};return document.addEventListener("click",y,!0),()=>document.removeEventListener("click",y,!0)},[g]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const f=(e.ceoStatus||"").trim(),v=async y=>{if(l)return;if(y==="Analysé"&&!e.memoUrl){c(!0);return}d(y);const j=(mr(e,a).find(([N])=>N===y)||[y,y])[1],k=await o(e,y,{msg:a.csMoved(e.name,j)});d(""),k&&(c(!1),u(!1))},w=mr(e,a),m=y=>(w.find(([j])=>j===y)||[])[1]||y;return w.length===2?t.jsx("span",{className:"rstat rst2",onClick:y=>y.stopPropagation(),children:w.map(([y,j])=>t.jsx("button",{type:"button",className:"rsd "+(y==="Validé"?"yes":"no")+(l===y?" busy":""),disabled:!!l,onClick:()=>{v(y)},children:j},y))}):t.jsxs("span",{className:"rstat"+(g||x?" rs-open":""),ref:b,onClick:y=>y.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":g,disabled:!!l,title:a.csLabel,className:"rsel rs-"+fr(f),onClick:()=>{u(y=>!y),c(!1)},children:l?m(l)+"…":f?m(f):a.csNone}),g&&!x&&t.jsx("span",{className:"rsmenu",role:"listbox",children:w.map(([y,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":f===y,className:"rsopt"+(f===y?" on":"")+(l===y?" busy":""),disabled:!!l,onClick:()=>{if(y===f){u(!1);return}v(y)},children:[t.jsx("i",{className:"pt2",style:{background:ol[fr(y)]}}),j]},y))}),x&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{i(e),c(!1),u(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{d("Analysé");const y=await o(e,"Analysé");d(""),y&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function sl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=W(),[i,s]=p.useState(""),[l,d]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),c=(wt(e)||"").startsWith("CALL")&&Ne(e)===3,g=Ne(e)>=2,u=async f=>{if(i||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(f);const v=await o(e,f);s(""),v&&(d(!0),setTimeout(()=>d(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:vo.filter(([f])=>!(g&&f==="Retenu")).map(([f,v])=>[f,a[v]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([f,v])=>t.jsx("button",{type:"button",className:"csb"+(x===f?" on":"")+(i===f?" busy":""),disabled:!!i,onClick:()=>{u(f)},children:v},f)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ll,{o:e})]})}function ll({o:e}){const{t:a,saveNote:r,flash:n}=W(),[o,i]=p.useState(e.ceoNote||""),[s,l]=p.useState(!1),[d,x]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),g=async()=>{if(s||!c)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:s,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&g()}}),t.jsx("button",{type:"button",disabled:s||!c,onClick:()=>{g()},children:d?a.csNoteSaved:a.csNoteOk})]})}function dl({placeholder:e,onDone:a}){const{t:r}=W(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function cl({o:e}){var w;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:s,flashErr:l}=W(),[d,x]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Ne(e)!==4)return null;const c=i(e),g=(c==null?void 0:c.stage)||"todo",u=async m=>{if(d||m===g)return;x(!0);const y=c;s(e,{stage:m,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),hr+=1);hr=j;const k=await Ci(r,{company:e.name||"",stage:m,cts:j,deal_id:e.airtableId,check_id:e.checkId});x(!1),!k.stale&&(k.ok||(s(e,y),l(a.actErr)))},b=(w=c==null?void 0:c.stamps)==null?void 0:w.sent,f=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=g==="sent"&&b&&f>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(g===m?" on":""),disabled:d,onClick:()=>{u(m)},children:y},m)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let hr=0;const Wt=8,vt=360;function xr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function gr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(xr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(xr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function pl({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=W(),[s,l]=p.useState(0),[d,x]=p.useState(null),[c,g]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),f=p.useRef(!1);p.useEffect(()=>{const S=b.current;return()=>{f.current||(n({type:"ptab",tab:S.ptab}),n({type:"dens",dens:S.dens}),n({type:"modal",modal:S.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,g(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const v=c[s],w=s>=c.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const S=v.click,R=window.setTimeout(()=>{const T=document.querySelector(S);T&&T.getAttribute("aria-selected")!=="true"&&T.click()},60);return()=>window.clearTimeout(R)}},[s,v]);const m=p.useRef(-1),y=p.useCallback(()=>{if(!v){x(null);return}const S=D=>{if(!D)return null;for(const F of document.querySelectorAll(D)){const $=F.getBoundingClientRect();if($.width>1&&$.height>1)return F}return null},R=S(v.sel)||S(v.need);if(!R){x(null);return}m.current!==s&&(m.current=s,R.scrollIntoView({block:"nearest",behavior:"smooth"}));const T=R.getBoundingClientRect();x(D=>D&&Math.abs(D.top-T.top)<1&&Math.abs(D.left-T.left)<1&&Math.abs(D.width-T.width)<1&&Math.abs(D.height-T.height)<1?D:T)},[v,s]);p.useLayoutEffect(()=>{y();const S=[90,300,700,1300].map(D=>window.setTimeout(y,D)),R=window.setInterval(y,400),T=()=>y();return window.addEventListener("scroll",T,!0),window.addEventListener("resize",T),()=>{S.forEach(D=>window.clearTimeout(D)),window.clearInterval(R),window.removeEventListener("scroll",T,!0),window.removeEventListener("resize",T)}},[y]);const j=p.useRef(a);if(j.current=a,p.useEffect(()=>{const S=R=>{R.key==="Escape"?(R.preventDefault(),R.stopPropagation(),j.current()):R.key==="ArrowRight"?l(T=>T+1):R.key==="ArrowLeft"&&l(T=>Math.max(0,T-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!c.length)return null;let k=null;const N=S=>()=>{f.current=!0,n({type:"modal",modal:null}),S()};if(w){const S=o[3]||0;S>0?k={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let A={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:vt};if(!w&&d){const S=d.bottom+14,R=window.innerHeight-S;let T=R>190?S:Math.max(12,d.top-200),D=Math.min(Math.max(12,d.left+d.width/2-vt/2),window.innerWidth-vt-12);R<=190&&d.top<212&&(window.innerWidth-d.right>=vt+40?D=Math.min(d.right+26,window.innerWidth-vt-12):d.left>=vt+40&&(D=Math.max(12,d.left-vt-26)),T=Math.max(12,d.top-Wt)),A={left:D,top:T,width:vt}}return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!w&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Wt,top:d.top-Wt,width:d.width+Wt*2,height:d.height+Wt*2}}),(w||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(w?" fin":""),style:A,children:[w&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(gr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(gr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>l(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(S=>S+1),children:s===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function yo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function wo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ul(){var R,T;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:s,data:l,dispatch:d}=W(),x=r?a:e,c=p.useMemo(()=>x.filter(D=>ht(D.date)===0&&D.kind==="target"),[x]),g=p.useMemo(()=>r?a.filter(D=>D.kind==="target"&&Ne(D)===0).slice().sort((D,F)=>(F.date||"").localeCompare(D.date||"")):[],[a,r]),u=p.useMemo(()=>c.filter(D=>r?Ne(D)===0:!Ie(D)),[c,r]),b=r?g:u,f=r?a.length-g.length:c.length-u.length,v=r?a.length:c.length,w=v?Math.min(100,f/v*100):100,m=p.useMemo(()=>yo(x),[x]),y=!!m&&ht(m)>0,j=p.useMemo(()=>y?x.filter(D=>(D.date||"").slice(0,10)===m):[],[x,m,y]),k=typeof((R=l.stats)==null?void 0:R.kept_today)=="number"?l.stats.kept_today:null,N=typeof((T=l.stats)==null?void 0:T.screened_today)=="number"?l.stats.screened_today:c.length;let A;y?A=o.morningLast(j.length,g.length,wo(m,s)):r?A=o.morningThesis(N,g.length,k):c.length?f===0?A=o.goalSourced(c.length):f>=c.length?A=o.goalCleared:A=o.goalDone(f,c.length):A=o.goalSourced(0);const S=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&g.length&&d({type:"chainStart",queue:g.map(D=>D.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:A}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:w+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:S,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ml(){var U,X;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:s,dossiers:l,mode:d,doSync:x,startTour:c,flash:g,flashErr:u}=W(),[b,f]=p.useState(null),[v,w]=p.useState(!0),[m,y]=p.useState([]),j=d==="client";p.useEffect(()=>{if(!o||!i)return;let E=!0;return w(!0),(async()=>{const[C,O]=await Promise.all([En(i),ro(o)]);E&&(C&&f(C),w(!1),y(O))})(),()=>{E=!1}},[o,i]);const[k,N]=p.useState(!1),A=()=>{!j||k||!i||(N(!0),zi(i).then(E=>{N(!1),E?g(e.identRepubDone):u(e.actErr)}))},S=(b==null?void 0:b.per_day)??null,R=((U=b==null?void 0:b.pool_order)==null?void 0:U.length)??0,T=m.filter(E=>E.status==="running").length,D=p.useMemo(()=>l.filter(E=>E.kind==="target"&&Ie(E)).length,[l]),F=s.marketEstimate,$=typeof((X=s.stats)==null?void 0:X.screened)=="number"?s.stats.screened:D,M=F&&F>0?Math.min(100,Math.round($/F*100)):null,I=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),h=(i||"P").split(/\s+/).map(E=>E[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const E=Date.parse(s.generatedAt||"");if(Number.isNaN(E))return"";const C=new Date(E),O=B=>String(B).padStart(2,"0");return`${O(C.getDate())}/${O(C.getMonth()+1)} à ${O(C.getHours())}:${O(C.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),q?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[M===null&&$>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:I($)})})]}),M!==null&&F&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:M+"%"}})}),t.jsxs("b",{children:[M," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf($,F)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),S!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:S})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),S===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),T>0&&t.jsxs("span",{className:"ev",children:["⏳ ",T]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(R)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:E=>{E.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||k,onClick:A,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:E=>n({type:"filters",patch:{search:E.target.value}})})]})]})]})}class qt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],s=a+i,l=Math.abs(a)<Math.abs(i)?a-(s-i):i-(s-a);l&&(r[n++]=l),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,o=a[--r],s=n+o,i=o-(s-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=s+o,o==n-s&&(s=n))}return s}}function*fl(e){for(const a of e)yield*a}function ko(e){return Array.from(fl(e))}var we=1e-6,me=Math.PI,et=me/2,br=me/4,at=me*2,mt=180/me,Ye=me/180,Ce=Math.abs,hl=Math.atan,ta=Math.atan2,Te=Math.cos,Le=Math.sin,xl=Math.sign||function(e){return e>0?1:e<0?-1:0},Lt=Math.sqrt;function gl(e){return e>1?0:e<-1?me:Math.acos(e)}function aa(e){return e>1?et:e<-1?-et:Math.asin(e)}function tt(){}function Aa(e,a){e&&yr.hasOwnProperty(e.type)&&yr[e.type](e,a)}var vr={Feature:function(e,a){Aa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Aa(r[n].geometry,a)}},yr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ln(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ln(r[n],a,0)},Polygon:function(e,a){wr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)wr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Aa(r[n],a)}};function ln(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function wr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ln(e[r],a,1);a.polygonEnd()}function Mt(e,a){e&&vr.hasOwnProperty(e.type)?vr[e.type](e,a):Aa(e,a)}function dn(e){return[ta(e[1],e[0]),aa(e[2])]}function It(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*Le(a),Le(r)]}function ua(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function qa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ya(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ma(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function cn(e){var a=Lt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function pn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function un(e,a){return Ce(e)>me&&(e-=Math.round(e/at)*at),[e,a]}un.invert=un;function bl(e,a,r){return(e%=at)?a||r?pn(jr(e),Nr(a,r)):jr(e):a||r?Nr(a,r):un}function kr(e){return function(a,r){return a+=e,Ce(a)>me&&(a-=Math.round(a/at)*at),[a,r]}}function jr(e){var a=kr(e);return a.invert=kr(-e),a}function Nr(e,a){var r=Te(e),n=Le(e),o=Te(a),i=Le(a);function s(l,d){var x=Te(d),c=Te(l)*x,g=Le(l)*x,u=Le(d),b=u*r+c*n;return[ta(g*o-b*i,c*r-u*n),aa(b*o+g*i)]}return s.invert=function(l,d){var x=Te(d),c=Te(l)*x,g=Le(l)*x,u=Le(d),b=u*o-g*i;return[ta(g*o+u*i,c*r+b*n),aa(b*r-c*n)]},s}function vl(e,a,r,n,o,i){if(r){var s=Te(a),l=Le(a),d=n*r;o==null?(o=a+n*at,i=a-d/2):(o=Er(s,o),i=Er(s,i),(n>0?o<i:o>i)&&(o+=n*at));for(var x,c=o;n>0?c>i:c<i;c-=d)x=dn([s,-l*Te(c),-l*Le(c)]),e.point(x[0],x[1])}}function Er(e,a){a=It(a),a[0]-=e,cn(a);var r=gl(-a[1]);return((-a[2]<0?-r:r)+at-we)%at}function jo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:tt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function wa(e,a){return Ce(e[0]-a[0])<we&&Ce(e[1]-a[1])<we}function fa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function No(e,a,r,n,o){var i=[],s=[],l,d;if(e.forEach(function(f){if(!((v=f.length-1)<=0)){var v,w=f[0],m=f[v],y;if(wa(w,m)){if(!w[2]&&!m[2]){for(o.lineStart(),l=0;l<v;++l)o.point((w=f[l])[0],w[1]);o.lineEnd();return}m[0]+=2*we}i.push(y=new fa(w,f,null,!0)),s.push(y.o=new fa(w,null,y,!1)),i.push(y=new fa(m,f,null,!1)),s.push(y.o=new fa(m,null,y,!0))}}),!!i.length){for(s.sort(a),Sr(i),Sr(s),l=0,d=s.length;l<d;++l)s[l].e=r=!r;for(var x=i[0],c,g;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;c=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,d=c.length;l<d;++l)o.point((g=c[l])[0],g[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(c=u.p.z,l=c.length-1;l>=0;--l)o.point((g=c[l])[0],g[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Sr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Qa(e){return Ce(e[0])<=me?e[0]:xl(e[0])*((Ce(e[0])+me)%at-me)}function yl(e,a){var r=Qa(a),n=a[1],o=Le(n),i=[Le(r),-Te(r),0],s=0,l=0,d=new qt;o===1?n=et+we:o===-1&&(n=-et-we);for(var x=0,c=e.length;x<c;++x)if(u=(g=e[x]).length)for(var g,u,b=g[u-1],f=Qa(b),v=b[1]/2+br,w=Le(v),m=Te(v),y=0;y<u;++y,f=k,w=A,m=S,b=j){var j=g[y],k=Qa(j),N=j[1]/2+br,A=Le(N),S=Te(N),R=k-f,T=R>=0?1:-1,D=T*R,F=D>me,$=w*A;if(d.add(ta($*T*Le(D),m*S+$*Te(D))),s+=F?R+T*at:R,F^f>=r^k>=r){var M=qa(It(b),It(j));cn(M);var I=qa(i,M);cn(I);var h=(F^R>=0?-1:1)*aa(I[2]);(n>h||n===h&&(M[0]||M[1]))&&(l+=F^R>=0?1:-1)}}return(s<-we||s<we&&d<-1e-12)^l&1}function Eo(e,a,r,n){return function(o){var i=a(o),s=jo(),l=a(s),d=!1,x,c,g,u={point:b,lineStart:v,lineEnd:w,polygonStart:function(){u.point=m,u.lineStart=y,u.lineEnd=j,c=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=w,c=ko(c);var k=yl(x,n);c.length?(d||(o.polygonStart(),d=!0),No(c,kl,k,r,o)):k&&(d||(o.polygonStart(),d=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),d&&(o.polygonEnd(),d=!1),c=x=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,N){e(k,N)&&o.point(k,N)}function f(k,N){i.point(k,N)}function v(){u.point=f,i.lineStart()}function w(){u.point=b,i.lineEnd()}function m(k,N){g.push([k,N]),l.point(k,N)}function y(){l.lineStart(),g=[]}function j(){m(g[0][0],g[0][1]),l.lineEnd();var k=l.clean(),N=s.result(),A,S=N.length,R,T,D;if(g.pop(),x.push(g),g=null,!!S){if(k&1){if(T=N[0],(R=T.length-1)>0){for(d||(o.polygonStart(),d=!0),o.lineStart(),A=0;A<R;++A)o.point((D=T[A])[0],D[1]);o.lineEnd()}return}S>1&&k&2&&N.push(N.pop().concat(N.shift())),c.push(N.filter(wl))}}return u}}function wl(e){return e.length>1}function kl(e,a){return((e=e.x)[0]<0?e[1]-et-we:et-e[1])-((a=a.x)[0]<0?a[1]-et-we:et-a[1])}const Cr=Eo(function(){return!0},jl,El,[-me,-et]);function jl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,s){var l=i>0?me:-me,d=Ce(i-a);Ce(d-me)<we?(e.point(a,r=(r+s)/2>0?et:-et),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&d>=me&&(Ce(a-n)<we&&(a-=n*we),Ce(i-l)<we&&(i-=l*we),r=Nl(a,r,i,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=s),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Nl(e,a,r,n){var o,i,s=Le(e-r);return Ce(s)>we?hl((Le(a)*(i=Te(n))*Le(r)-Le(n)*(o=Te(a))*Le(e))/(o*i*s)):(a+n)/2}function El(e,a,r,n){var o;if(e==null)o=r*et,n.point(-me,o),n.point(0,o),n.point(me,o),n.point(me,0),n.point(me,-o),n.point(0,-o),n.point(-me,-o),n.point(-me,0),n.point(-me,o);else if(Ce(e[0]-a[0])>we){var i=e[0]<a[0]?me:-me;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Sl(e){var a=Te(e),r=2*Ye,n=a>0,o=Ce(a)>we;function i(c,g,u,b){vl(b,e,r,u,c,g)}function s(c,g){return Te(c)*Te(g)>a}function l(c){var g,u,b,f,v;return{lineStart:function(){f=b=!1,v=1},point:function(w,m){var y=[w,m],j,k=s(w,m),N=n?k?0:x(w,m):k?x(w+(w<0?me:-me),m):0;if(!g&&(f=b=k)&&c.lineStart(),k!==b&&(j=d(g,y),(!j||wa(g,j)||wa(y,j))&&(y[2]=1)),k!==b)v=0,k?(c.lineStart(),j=d(y,g),c.point(j[0],j[1])):(j=d(g,y),c.point(j[0],j[1],2),c.lineEnd()),g=j;else if(o&&g&&n^k){var A;!(N&u)&&(A=d(y,g,!0))&&(v=0,n?(c.lineStart(),c.point(A[0][0],A[0][1]),c.point(A[1][0],A[1][1]),c.lineEnd()):(c.point(A[1][0],A[1][1]),c.lineEnd(),c.lineStart(),c.point(A[0][0],A[0][1],3)))}k&&(!g||!wa(g,y))&&c.point(y[0],y[1]),g=y,b=k,u=N},lineEnd:function(){b&&c.lineEnd(),g=null},clean:function(){return v|(f&&b)<<1}}}function d(c,g,u){var b=It(c),f=It(g),v=[1,0,0],w=qa(b,f),m=ua(w,w),y=w[0],j=m-y*y;if(!j)return!u&&c;var k=a*m/j,N=-a*y/j,A=qa(v,w),S=ma(v,k),R=ma(w,N);Ya(S,R);var T=A,D=ua(S,T),F=ua(T,T),$=D*D-F*(ua(S,S)-1);if(!($<0)){var M=Lt($),I=ma(T,(-D-M)/F);if(Ya(I,S),I=dn(I),!u)return I;var h=c[0],q=g[0],U=c[1],X=g[1],E;q<h&&(E=h,h=q,q=E);var C=q-h,O=Ce(C-me)<we,B=O||C<we;if(!O&&X<U&&(E=U,U=X,X=E),B?O?U+X>0^I[1]<(Ce(I[0]-h)<we?U:X):U<=I[1]&&I[1]<=X:C>me^(h<=I[0]&&I[0]<=q)){var _=ma(T,(-D+M)/F);return Ya(_,S),[I,dn(_)]}}}function x(c,g){var u=n?e:me-e,b=0;return c<-u?b|=1:c>u&&(b|=2),g<-u?b|=4:g>u&&(b|=8),b}return Eo(s,l,i,n?[0,-e]:[-me,e-me])}function Cl(e,a,r,n,o,i){var s=e[0],l=e[1],d=a[0],x=a[1],c=0,g=1,u=d-s,b=x-l,f;if(f=r-s,!(!u&&f>0)){if(f/=u,u<0){if(f<c)return;f<g&&(g=f)}else if(u>0){if(f>g)return;f>c&&(c=f)}if(f=o-s,!(!u&&f<0)){if(f/=u,u<0){if(f>g)return;f>c&&(c=f)}else if(u>0){if(f<c)return;f<g&&(g=f)}if(f=n-l,!(!b&&f>0)){if(f/=b,b<0){if(f<c)return;f<g&&(g=f)}else if(b>0){if(f>g)return;f>c&&(c=f)}if(f=i-l,!(!b&&f<0)){if(f/=b,b<0){if(f>g)return;f>c&&(c=f)}else if(b>0){if(f<c)return;f<g&&(g=f)}return c>0&&(e[0]=s+c*u,e[1]=l+c*b),g<1&&(a[0]=s+g*u,a[1]=l+g*b),!0}}}}}var Gt=1e9,ha=-Gt;function zl(e,a,r,n){function o(x,c){return e<=x&&x<=r&&a<=c&&c<=n}function i(x,c,g,u){var b=0,f=0;if(x==null||(b=s(x,g))!==(f=s(c,g))||d(x,c)<0^g>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+g+4)%4)!==f);else u.point(c[0],c[1])}function s(x,c){return Ce(x[0]-e)<we?c>0?0:3:Ce(x[0]-r)<we?c>0?2:1:Ce(x[1]-a)<we?c>0?1:0:c>0?3:2}function l(x,c){return d(x.x,c.x)}function d(x,c){var g=s(x,1),u=s(c,1);return g!==u?g-u:g===0?c[1]-x[1]:g===1?x[0]-c[0]:g===2?x[1]-c[1]:c[0]-x[0]}return function(x){var c=x,g=jo(),u,b,f,v,w,m,y,j,k,N,A,S={point:R,lineStart:$,lineEnd:M,polygonStart:D,polygonEnd:F};function R(h,q){o(h,q)&&c.point(h,q)}function T(){for(var h=0,q=0,U=b.length;q<U;++q)for(var X=b[q],E=1,C=X.length,O=X[0],B,_,G=O[0],ue=O[1];E<C;++E)B=G,_=ue,O=X[E],G=O[0],ue=O[1],_<=n?ue>n&&(G-B)*(n-_)>(ue-_)*(e-B)&&++h:ue<=n&&(G-B)*(n-_)<(ue-_)*(e-B)&&--h;return h}function D(){c=g,u=[],b=[],A=!0}function F(){var h=T(),q=A&&h,U=(u=ko(u)).length;(q||U)&&(x.polygonStart(),q&&(x.lineStart(),i(null,null,1,x),x.lineEnd()),U&&No(u,l,h,i,x),x.polygonEnd()),c=x,u=b=f=null}function $(){S.point=I,b&&b.push(f=[]),N=!0,k=!1,y=j=NaN}function M(){u&&(I(v,w),m&&k&&g.rejoin(),u.push(g.result())),S.point=R,k&&c.lineEnd()}function I(h,q){var U=o(h,q);if(b&&f.push([h,q]),N)v=h,w=q,m=U,N=!1,U&&(c.lineStart(),c.point(h,q));else if(U&&k)c.point(h,q);else{var X=[y=Math.max(ha,Math.min(Gt,y)),j=Math.max(ha,Math.min(Gt,j))],E=[h=Math.max(ha,Math.min(Gt,h)),q=Math.max(ha,Math.min(Gt,q))];Cl(X,E,e,a,r,n)?(k||(c.lineStart(),c.point(X[0],X[1])),c.point(E[0],E[1]),U||c.lineEnd(),A=!1):U&&(c.lineStart(),c.point(h,q),A=!1)}y=h,j=q,k=U}return S}}const mn=e=>e;var Ka=new qt,fn=new qt,So,Co,hn,xn,ft={point:tt,lineStart:tt,lineEnd:tt,polygonStart:function(){ft.lineStart=Al,ft.lineEnd=Tl},polygonEnd:function(){ft.lineStart=ft.lineEnd=ft.point=tt,Ka.add(Ce(fn)),fn=new qt},result:function(){var e=Ka/2;return Ka=new qt,e}};function Al(){ft.point=ql}function ql(e,a){ft.point=zo,So=hn=e,Co=xn=a}function zo(e,a){fn.add(xn*e-hn*a),hn=e,xn=a}function Tl(){zo(So,Co)}var Pt=1/0,Ta=Pt,na=-Pt,La=na,Ra={point:Ll,lineStart:tt,lineEnd:tt,polygonStart:tt,polygonEnd:tt,result:function(){var e=[[Pt,Ta],[na,La]];return na=La=-(Ta=Pt=1/0),e}};function Ll(e,a){e<Pt&&(Pt=e),e>na&&(na=e),a<Ta&&(Ta=a),a>La&&(La=a)}var gn=0,bn=0,Yt=0,Fa=0,Ma=0,Ot=0,vn=0,yn=0,Qt=0,Ao,qo,ct,pt,Ze={point:Tt,lineStart:zr,lineEnd:Ar,polygonStart:function(){Ze.lineStart=Ml,Ze.lineEnd=Ol},polygonEnd:function(){Ze.point=Tt,Ze.lineStart=zr,Ze.lineEnd=Ar},result:function(){var e=Qt?[vn/Qt,yn/Qt]:Ot?[Fa/Ot,Ma/Ot]:Yt?[gn/Yt,bn/Yt]:[NaN,NaN];return gn=bn=Yt=Fa=Ma=Ot=vn=yn=Qt=0,e}};function Tt(e,a){gn+=e,bn+=a,++Yt}function zr(){Ze.point=Rl}function Rl(e,a){Ze.point=Fl,Tt(ct=e,pt=a)}function Fl(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Fa+=o*(ct+e)/2,Ma+=o*(pt+a)/2,Ot+=o,Tt(ct=e,pt=a)}function Ar(){Ze.point=Tt}function Ml(){Ze.point=Dl}function Ol(){To(Ao,qo)}function Dl(e,a){Ze.point=To,Tt(Ao=ct=e,qo=pt=a)}function To(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Fa+=o*(ct+e)/2,Ma+=o*(pt+a)/2,Ot+=o,o=pt*e-ct*a,vn+=o*(ct+e),yn+=o*(pt+a),Qt+=o*3,Tt(ct=e,pt=a)}function Lo(e){this._context=e}Lo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,at);break}}},result:tt};var wn=new qt,Ja,Ro,Fo,Kt,Jt,ra={point:tt,lineStart:function(){ra.point=Il},lineEnd:function(){Ja&&Mo(Ro,Fo),ra.point=tt},polygonStart:function(){Ja=!0},polygonEnd:function(){Ja=null},result:function(){var e=+wn;return wn=new qt,e}};function Il(e,a){ra.point=Mo,Ro=Kt=e,Fo=Jt=a}function Mo(e,a){Kt-=e,Jt-=a,wn.add(Lt(Kt*Kt+Jt*Jt)),Kt=e,Jt=a}let qr,Oa,Tr,Lr;class Rr{constructor(a){this._append=a==null?Oo:Pl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Tr||this._append!==Oa){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Tr=n,Oa=this._append,Lr=this._,this._=o}this._+=Lr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Oo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Pl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Oo;if(a!==qr){const r=10**a;qr=a,Oa=function(o){let i=1;this._+=o[0];for(const s=o.length;i<s;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Oa}function Bl(e,a){let r=3,n=4.5,o,i;function s(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Mt(l,o(i))),i.result()}return s.area=function(l){return Mt(l,o(ft)),ft.result()},s.measure=function(l){return Mt(l,o(ra)),ra.result()},s.bounds=function(l){return Mt(l,o(Ra)),Ra.result()},s.centroid=function(l){return Mt(l,o(Ze)),Ze.result()},s.projection=function(l){return arguments.length?(o=l==null?(e=null,mn):(e=l).stream,s):e},s.context=function(l){return arguments.length?(i=l==null?(a=null,new Rr(r)):new Lo(a=l),typeof n!="function"&&i.pointRadius(n),s):a},s.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),s):n},s.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const d=Math.floor(l);if(!(d>=0))throw new RangeError(`invalid digits: ${l}`);r=d}return a===null&&(i=new Rr(r)),s},s.projection(e).digits(r).context(a)}function Tn(e){return function(a){var r=new kn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function kn(){}kn.prototype={constructor:kn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ln(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Mt(r,e.stream(Ra)),a(Ra.result()),n!=null&&e.clipExtent(n),e}function Do(e,a,r){return Ln(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],s=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-s*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(i-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([l,d])},r)}function _l(e,a,r){return Do(e,[[0,0],a],r)}function $l(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),s=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([s,l])},r)}function Ul(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),s=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([s,l])},r)}var Fr=16,Hl=Te(30*Ye);function Mr(e,a){return+a?Wl(e,a):Vl(e)}function Vl(e){return Tn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Wl(e,a){function r(n,o,i,s,l,d,x,c,g,u,b,f,v,w){var m=x-n,y=c-o,j=m*m+y*y;if(j>4*a&&v--){var k=s+u,N=l+b,A=d+f,S=Lt(k*k+N*N+A*A),R=aa(A/=S),T=Ce(Ce(A)-1)<we||Ce(i-g)<we?(i+g)/2:ta(N,k),D=e(T,R),F=D[0],$=D[1],M=F-n,I=$-o,h=y*M-m*I;(h*h/j>a||Ce((m*M+y*I)/j-.5)>.3||s*u+l*b+d*f<Hl)&&(r(n,o,i,s,l,d,F,$,T,k/=S,N/=S,A,v,w),w.point(F,$),r(F,$,T,k,N,A,x,c,g,u,b,f,v,w))}}return function(n){var o,i,s,l,d,x,c,g,u,b,f,v,w={point:m,lineStart:y,lineEnd:k,polygonStart:function(){n.polygonStart(),w.lineStart=N},polygonEnd:function(){n.polygonEnd(),w.lineStart=y}};function m(R,T){R=e(R,T),n.point(R[0],R[1])}function y(){g=NaN,w.point=j,n.lineStart()}function j(R,T){var D=It([R,T]),F=e(R,T);r(g,u,c,b,f,v,g=F[0],u=F[1],c=R,b=D[0],f=D[1],v=D[2],Fr,n),n.point(g,u)}function k(){w.point=m,n.lineEnd()}function N(){y(),w.point=A,w.lineEnd=S}function A(R,T){j(o=R,T),i=g,s=u,l=b,d=f,x=v,w.point=j}function S(){r(g,u,c,b,f,v,i,s,o,l,d,x,Fr,n),w.lineEnd=k,k()}return w}}var Gl=Tn({point:function(e,a){this.stream.point(e*Ye,a*Ye)}});function Yl(e){return Tn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Ql(e,a,r,n,o){function i(s,l){return s*=n,l*=o,[a+e*s,r-e*l]}return i.invert=function(s,l){return[(s-a)/e*n,(r-l)/e*o]},i}function Or(e,a,r,n,o,i){if(!i)return Ql(e,a,r,n,o);var s=Te(i),l=Le(i),d=s*e,x=l*e,c=s/e,g=l/e,u=(l*r-s*a)/e,b=(l*a+s*r)/e;function f(v,w){return v*=n,w*=o,[d*v-x*w+a,r-x*v-d*w]}return f.invert=function(v,w){return[n*(c*v-g*w+u),o*(b-g*v-c*w)]},f}function Kl(e){return Jl(function(){return e})()}function Jl(e){var a,r=150,n=480,o=250,i=0,s=0,l=0,d=0,x=0,c,g=0,u=1,b=1,f=null,v=Cr,w=null,m,y,j,k=mn,N=.5,A,S,R,T,D;function F(h){return R(h[0]*Ye,h[1]*Ye)}function $(h){return h=R.invert(h[0],h[1]),h&&[h[0]*mt,h[1]*mt]}F.stream=function(h){return T&&D===h?T:T=Gl(Yl(c)(v(A(k(D=h)))))},F.preclip=function(h){return arguments.length?(v=h,f=void 0,I()):v},F.postclip=function(h){return arguments.length?(k=h,w=m=y=j=null,I()):k},F.clipAngle=function(h){return arguments.length?(v=+h?Sl(f=h*Ye):(f=null,Cr),I()):f*mt},F.clipExtent=function(h){return arguments.length?(k=h==null?(w=m=y=j=null,mn):zl(w=+h[0][0],m=+h[0][1],y=+h[1][0],j=+h[1][1]),I()):w==null?null:[[w,m],[y,j]]},F.scale=function(h){return arguments.length?(r=+h,M()):r},F.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],M()):[n,o]},F.center=function(h){return arguments.length?(i=h[0]%360*Ye,s=h[1]%360*Ye,M()):[i*mt,s*mt]},F.rotate=function(h){return arguments.length?(l=h[0]%360*Ye,d=h[1]%360*Ye,x=h.length>2?h[2]%360*Ye:0,M()):[l*mt,d*mt,x*mt]},F.angle=function(h){return arguments.length?(g=h%360*Ye,M()):g*mt},F.reflectX=function(h){return arguments.length?(u=h?-1:1,M()):u<0},F.reflectY=function(h){return arguments.length?(b=h?-1:1,M()):b<0},F.precision=function(h){return arguments.length?(A=Mr(S,N=h*h),I()):Lt(N)},F.fitExtent=function(h,q){return Do(F,h,q)},F.fitSize=function(h,q){return _l(F,h,q)},F.fitWidth=function(h,q){return $l(F,h,q)},F.fitHeight=function(h,q){return Ul(F,h,q)};function M(){var h=Or(r,0,0,u,b,g).apply(null,a(i,s)),q=Or(r,n-h[0],o-h[1],u,b,g);return c=bl(l,d,x),S=pn(a,q),R=pn(c,S),A=Mr(S,N),I()}function I(){return T=D=null,F}return function(){return a=e.apply(this,arguments),F.invert=a.invert&&$,M()}}function Io(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Io.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,s=i*i;r-=o=(r*(1.007226+i*(.015085+s*(-.044475+.028874*i-.005916*s)))-a)/(1.007226+i*(.015085*3+s*(-.044475*7+.028874*9*i-.005916*11*s)))}while(Ce(o)>we&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Xl(){return Kl(Io).scale(175.295)}function Zl(e){return e}function ed(e){if(e==null)return Zl;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],s=e.translate[1];return function(l,d){d||(a=r=0);var x=2,c=l.length,g=new Array(c);for(g[0]=(a+=l[0])*n+i,g[1]=(r+=l[1])*o+s;x<c;)g[x]=l[x],++x;return g}}function td(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function ad(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Dr(e,r)})}:Dr(e,a)}function Dr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=nd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function nd(e,a){var r=ed(e.transform),n=e.arcs;function o(c,g){g.length&&g.pop();for(var u=n[c<0?~c:c],b=0,f=u.length;b<f;++b)g.push(r(u[b],b));c<0&&td(g,f)}function i(c){return r(c)}function s(c){for(var g=[],u=0,b=c.length;u<b;++u)o(c[u],g);return g.length<2&&g.push(g[0]),g}function l(c){for(var g=s(c);g.length<4;)g.push(g[0]);return g}function d(c){return c.map(l)}function x(c){var g=c.type,u;switch(g){case"GeometryCollection":return{type:g,geometries:c.geometries.map(x)};case"Point":u=i(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(i);break;case"LineString":u=s(c.arcs);break;case"MultiLineString":u=c.arcs.map(s);break;case"Polygon":u=d(c.arcs);break;case"MultiPolygon":u=c.arcs.map(d);break;default:return null}return{type:g,coordinates:u}}return x(a)}const Po={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},rd=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function od(e,a,r){const n=Po[e];if(!n||!n.length)return-1;const o=rd(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(s=>o.includes(s)))return i}return Math.floor(r*n.length)%n.length}let xa=null;function id(){return xa||(xa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=ad(r,n),i=Xl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=Bl(i),l=(o.features||[]).filter(c=>{var g;return(((g=c.properties)==null?void 0:g.name)||"")!=="Antarctica"}).map(c=>{var b;const g=((b=c.properties)==null?void 0:b.name)||"",u=s(c)||"";return u?{i2:Ai(g)||null,n:g,d:u}:null}).filter(c=>!!c);if(!l.length)return null;const d={};for(const[c,g]of Object.entries(qi)){const u=i(g);u&&(d[c]={x:u[0],y:u[1]})}const x={};for(const[c,g]of Object.entries(Po)){const u=g.map(b=>i(b.ll)).filter(b=>!!b).map(([b,f])=>({x:b,y:f}));u.length&&(x[c]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:d,metros:x}}catch{return null}})(),xa)}function sd(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return id().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const ld="8 40 984 210",dd={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Ir=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Pr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function cd(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const s=()=>{var x;if(!o)return;const d=(x=e.current)==null?void 0:x.getScreenCTM();d&&d.a>0?n(d.a):i=requestAnimationFrame(s)};s();const l=new ResizeObserver(()=>s());return e.current&&l.observe(e.current),window.addEventListener("resize",s),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function Br({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],s)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function pd(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:s,lang:l,t:d,data:x,dossiers:c,source:g}=W(),u=x.loading&&!c.length,b=p.useRef(null),f=p.useRef(null),v=sd(e.continent==="monde"),w=e.continent==="monde"?v:Sn.find(h=>h.key===e.continent)||null,m=cd(b,e.continent+":"+e.mapFolded+":"+!!w),[y,j]=p.useState(new Map),[k,N]=p.useState(null);p.useEffect(()=>{const h=b.current;if(!h)return;const q=new Map;h.querySelectorAll("path[data-i2]").forEach(U=>{const X=U.dataset.i2;if(X)try{const E=U.getBBox();E.width>0&&q.set(X,{x:E.x,y:E.y,w:E.width,h:E.height})}catch{}}),j(q)},[e.continent,m,w]);const A=p.useMemo(()=>r.filter(h=>h.cc),[r]),S=p.useMemo(()=>{const h=new Map;return A.forEach(q=>h.set(q.cc,(h.get(q.cc)||0)+1)),h},[A]),R=e.continent==="monde"&&v?v.anchors:null,T=e.continent==="monde"&&v?v.metros:null,D=p.useMemo(()=>A.map(h=>{const q=Pr(h.name||h.id||""),U=Pr((h.id||h.name||"")+"·y");if(R&&h.cc){const B=T?T[h.cc]:void 0;if(B&&B.length){const G=od(h.cc,h.city,q);if(G>=0&&B[G])return{d:h,x:B[G].x+(q-.5)*5,y:B[G].y+(U-.5)*5}}const _=R[h.cc];if(_)return{d:h,x:_.x+(q-.5)*10,y:_.y+(U-.5)*10}}const X=h.cc?y.get(h.cc):void 0;if(!X)return null;const E=dd[`${e.continent}:${h.cc||""}`];if(E)return{d:h,x:X.x+X.w*(E.fx+(q-.5)*E.sx),y:X.y+X.h*(E.fy+(U-.5)*E.sy)};const C=(q-.5)*Math.min(X.w*.55,60),O=(U-.5)*Math.min(X.h*.55,60);return{d:h,x:X.x+X.w/2+C,y:X.y+X.h/2+O}}).filter(h=>!!h),[A,y,R,T,e.continent]),F=h=>m>0?h/m:h,$=p.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:Ir[h],fr:d.plabels[h].toUpperCase(),en:d.plabels[h].toUpperCase(),n:r.filter(q=>q.kind==="target"&&Ne(q)===h).length})).filter(h=>h.n>0):Vn.map((h,q)=>({...h,n:r.filter(U=>Wn(U)===q).length})),[r,n,d.plabels]),M=i?s.get(i):null,I=M?D.find(h=>h.d.id===M.id):null;return w?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:f,children:[u&&t.jsx(Br,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?ld:w.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?w.fr:w.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:w.countries.map((h,q)=>t.jsx("g",{className:"ct"+(h.i2&&S.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},q))}),t.jsx("g",{children:D.map(h=>{const q=Vn[Wn(h.d)],U=!!Me(h.d),X=h.d.kind==="target",E=n&&X?Ir[Ne(h.d)]:q.c,C=!n&&Ie(h.d);return t.jsxs("g",{className:"co"+(C?" done":""),onMouseEnter:()=>{var _,G;const O=(_=f.current)==null?void 0:_.getBoundingClientRect(),B=(G=b.current)==null?void 0:G.createSVGPoint();if(B&&b.current&&O){B.x=h.x,B.y=h.y;const ue=B.matrixTransform(b.current.getScreenCTM());N({x:ue.x-O.left,y:ue.y-O.top,label:h.d.name+" · "+($t(h.d.cc,l)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var _;if(g==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const O=(_=b.current)==null?void 0:_.createSVGPoint();let B=null;if(O&&b.current){O.x=h.x,O.y=h.y;const G=O.matrixTransform(b.current.getScreenCTM());B={x:G.x,y:G.y}}a({type:"popup",id:h.d.id,anchor:B})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:F(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:F(q.px),fill:E,stroke:U?"#DC2626":"#ffffff",strokeWidth:F(U?2.2:1.3)})]},h.d.id||h.d.name)})}),I&&t.jsx("circle",{className:"ring on",cx:I.x,cy:I.y,r:F(13),fill:"none",stroke:"#0F172A",strokeWidth:F(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:$.map((h,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),l==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},q))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:f,children:t.jsx(Br,{msgs:d.loadMsgs})})}function ud(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Bo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:s,lang:l}=W(),d=a.filters,[x,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null),f=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(I=>I.continent===a.continent),[n,a.continent]),w=I=>v.filter(h=>I!=="country"&&d.country.length&&!d.country.includes(h.cc||"")?!1:Ca(h,d,i,I==="country"?void 0:I)),m=I=>!i||I.kind!=="op",y=p.useMemo(()=>{const I=w("win").filter(m),h=q=>I.filter(U=>(U.date?Math.max(0,Math.floor((Date.now()-Date.parse(U.date))/864e5)):9999)<=q).length;return[h(0),h(7),h(30),I.length]},[v,d,i]),j=p.useMemo(()=>d.day?w("win").filter(m).filter(I=>(I.date||"").slice(0,10)===d.day).length:0,[v,d,i]),k=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length+d.crible.length,N=k+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!x&&!g)return;const I=q=>{var X,E;const U=q.target;x&&!((X=b.current)!=null&&X.contains(U))&&c(!1),g&&!((E=f.current)!=null&&E.contains(U))&&u(!1)},h=q=>{q.key==="Escape"&&(c(!1),u(!1))};return document.addEventListener("mousedown",I),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",I),document.removeEventListener("keydown",h)}},[x,g]);const A=(I,h,q,U="fbtn")=>t.jsxs("button",{type:"button",className:U,"aria-expanded":a.openFacet===I,onClick:()=>r({type:"openFacet",facet:I}),children:[t.jsx("span",{className:"fl",children:h}),q>0&&t.jsx("span",{className:"n",children:q}),t.jsx("span",{className:"cv",children:"▾"})]},I),S=["1","7","30","all"],R=Math.max(0,S.indexOf(d.win||"all")),T=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(ud(d.day,l))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:f,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>u(I=>!I),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[R]}),t.jsx("b",{children:y[R]}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:S.map((I,h)=>t.jsxs("button",{type:"button",role:"option","aria-selected":d.win===I,onClick:()=>{r({type:"filters",patch:{win:I}}),u(!1)},children:[o.datesShort[h],t.jsx("span",{className:"n",children:y[h]})]},I))})]}):t.jsx("div",{className:"seg",children:S.map((I,h)=>t.jsxs("button",{type:"button","aria-pressed":d.win===I,onClick:()=>r({type:"filters",patch:{win:I}}),children:[t.jsx("span",{className:"sl",children:o.dates[h]}),t.jsx("b",{children:y[h]})]},I))}),D=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:d.search,onChange:I=>r({type:"filters",patch:{search:I.target.value}})})]}),F=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):A("sec",o.fSector,d.sector.length),A("pay",o.fCountry,d.country.length),A("det",o.fEngine,d.engine.length),A("sta",o.fStage,d.stage.length),i&&A("crib",o.fVerdict,d.crible.length),i&&A("ang","Angle",d.angle.length),i&&A("mem","Mémo",d.memoLevel.length)]}),$=(I=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),I&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),M=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":x,"aria-haspopup":"true",onClick:()=>{c(I=>!I),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:F})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(d.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:T}),t.jsxs("div",{className:"fstrip-b",children:[D,M,$(!1)]})]}),a.openFacet&&t.jsx(_r,{poolFor:w})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[T,D,F,t.jsx("span",{className:"fgrow"}),$()]}),a.openFacet&&t.jsx(_r,{poolFor:w})]})}function _r({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:s}=W(),l=a.filters,d=a.openFacet,{title:x,cols:c,options:g}=p.useMemo(()=>{if(d==="sig"){const w=e("signal").filter(j=>Me(j)),m=new Map;w.forEach(j=>{const k=j.engine||"";m.set(k,(m.get(k)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:w.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...rn([...m.keys()],o).map(j=>({v:j,label:At(j)+" "+Qe(j,o),n:m.get(j)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(d==="crib"){const w=e("crible").filter(y=>!i||to(y,a.ptab,s.favIds)),m=new Map;return w.forEach(y=>{const j=ao(y);j&&j!=="NEW"&&m.set(j,(m.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...m.entries()].sort((y,j)=>(Gn[y[0]]??9)-(Gn[j[0]]??9)||j[1]-y[1]).map(([y,j])=>({v:y,label:'<span class="fdot" style="background:'+(Ti[y]||"#94A3B8")+'"></span>'+y,n:j,html:!0,on:l.crible.includes(y)}))}}if(d==="sec"){const w=e("sector"),m=new Map;return w.forEach(y=>{y.sector&&m.set(y.sector,(m.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...m.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:y,n:j,html:!1,on:l.sector.includes(y)}))}}if(d==="pay"){const w=e("country"),m=new Map;return w.forEach(y=>{y.cc&&m.set(y.cc,(m.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...m.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:$t(y,o)||y,n:j,html:!1,on:l.country.includes(y)}))}}if(d==="det"){const w=e("engine"),m=new Map;return w.forEach(y=>{y.engine&&m.set(y.engine,(m.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:rn([...m.keys()],o).map(y=>({v:y,label:At(y)+" "+Qe(y,o)+' <span style="color:var(--dim);font-size:10px">· '+Li(Ri(y),o)+"</span>",n:m.get(y)||0,html:!0,on:l.engine.includes(y)}))}}if(d==="ang"){const w=e("angle"),m=new Map;return w.forEach(y=>{y.angle&&m.set(y.angle,(m.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...m.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:y.replace(/[_-]+/g," "),n:j,html:!1,on:l.angle.includes(y)}))}}if(d==="mem"){const w=e("memoLevel"),m=new Map;w.forEach(j=>{if(j.kind==="target"){const k=Nn(j);m.set(k,(m.get(k)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:y[j],n:m.get(j)||0,html:!1,on:l.memoLevel.includes(j)}))}}const f=e("stage"),v=new Map;return f.forEach(w=>{w.stage&&v.set(w.stage,(v.get(w.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((w,m)=>m[1]-w[1]).map(([w,m])=>({v:w,label:w,n:m,html:!1,on:l.stage.includes(w)}))}},[d,a,o]),u=f=>{if(d==="sig"){if(f==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const w=l.signalEngines.includes(f)?l.signalEngines.filter(m=>m!==f):[...l.signalEngines,f];r({type:"filters",patch:{signalOnly:!0,signalEngines:w}})}return}if(d==="mem"){r({type:"toggleMemoLevel",value:Number(f)});return}r({type:"toggleFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":d==="crib"?"crible":"stage",value:f})},b=()=>{r(d==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:d==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":d==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:x}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(f=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":f.on,onClick:()=>u(f.v),children:[t.jsx("span",{className:"bx"}),f.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:f.label}}):t.jsx("span",{className:"l",children:f.label}),t.jsx("span",{className:"n",children:f.n})]},f.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function _o({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:s,t:l}=W(),d=p.useMemo(()=>{const b={};return r.forEach(f=>{Ca(f,n.filters,i)&&(b.monde=(b.monde||0)+1,f.continent&&(b[f.continent]=(b[f.continent]||0)+1))}),b},[r,n.filters,i]),[x,c]=p.useState(!1),g=p.useRef(null);p.useEffect(()=>{if(!x)return;const b=v=>{var w;(w=g.current)!=null&&w.contains(v.target)||c(!1)},f=v=>{v.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",f),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",f)}},[x]);const u=b=>{const f=Sn.find(v=>v.key===b);return b==="monde"?l.contWorld:s==="fr"?f.fr:f.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:g,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:d[n.continent]||0}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Yn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:d[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[Yn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:d[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function jn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function $o(e){return"atl2:evalq:"+(e||"anon")}function md(e,a){const r=$o(e),n=jn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const s=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(s)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function Uo(){const{t:e,data:a,dossiers:r}=W(),n=a.session.token||"",o=$o(n),[i,s]=p.useState(()=>jn(o)),l=p.useRef(!1),[d,x]=p.useState(!1);p.useEffect(()=>{try{const E=i.slice(0,30).map(({descBusy:C,evalBusy:O,...B})=>B);localStorage.setItem(o,JSON.stringify(E)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[i,o]),p.useEffect(()=>{const E=()=>{if(l.current)return;const C=jn(o);s(O=>JSON.stringify(O.map(({descBusy:B,evalBusy:_,...G})=>G))===JSON.stringify(C)?O:C)};return window.addEventListener("atl2:evalq",E),window.addEventListener("storage",E),()=>{window.removeEventListener("atl2:evalq",E),window.removeEventListener("storage",E)}},[o]);const[c,g]=p.useState([]),[u,b]=p.useState(""),[f,v]=p.useState(!1),[w,m]=p.useState(!1),[y,j]=p.useState(""),k=p.useCallback((E,C)=>s(O=>O.map((B,_)=>_===E?{...B,...C}:B)),[]),N=p.useCallback((E,C)=>{const O=C.trim();O&&(k(E,{name:O,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Cn(O).then(B=>{const _=B.candidates||[];B.website?k(E,{site:B.website,status:"ready"}):_.length===1?k(E,{site:_[0].url,status:"ready"}):_.length>1?k(E,{status:"pick",candidates:_.slice(0,4)}):k(E,{status:"ready"})}).catch(()=>k(E,{status:"ready"})))},[k]),A=p.useCallback((E,C,O)=>{k(E,{descBusy:!0}),oo(n,C,O).then(B=>{if(B.quota){x(!0),k(E,{descBusy:!1,descDone:!0});return}const _=B.blocs||{},G=(_.synthese||_.value_prop||_.produit||_.modele||"").trim();k(E,{descBusy:!1,descDone:!0,desc:G})}).catch(()=>k(E,{descBusy:!1,descDone:!0}))},[k,n]);p.useEffect(()=>{const E=i.findIndex(O=>O.auto&&O.name.trim()&&O.status==="");if(E>=0){N(E,i[E].name);return}if(d)return;const C=i.findIndex(O=>O.status==="ready"&&O.site&&!O.descDone&&!O.descBusy);C>=0&&A(C,i[C].name,i[C].site)},[i,N,A,d]);const[S,R]=p.useState(!1),T=p.useCallback(async(E,C)=>{k(E,{evalBusy:!0});const O=await io(n,(C.site||C.name).trim(),"atelier2");return O.verdict==="quota"?(k(E,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:O.reason||"",remaining:0}})),!1):(k(E,{evalBusy:!1,status:O.verdict==="kept"?"kept":"out",reason:O.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:O.company||C.name,verdict:O.verdict,reason:O.reason||"",remaining:O.remaining??null}})),!0)},[k,n]),D=async()=>{if(S)return;const E=i.map((C,O)=>({r:C,i:O})).filter(({r:C})=>C.name.trim()&&C.status!=="kept"&&C.status!=="out"&&C.status!=="resolving");if(E.length){R(!0);for(const{r:C,i:O}of E)if(!await T(O,C))break;R(!1)}},F=p.useMemo(()=>{const E=new Set,C=[];return i.filter(O=>O.status==="kept").forEach(O=>{const B=O.name.trim().toLowerCase();B&&!E.has(B)&&(E.add(B),C.push(O.name.trim()))}),r.filter(O=>Ne(O)>=1&&Ne(O)<=4&&(O.website||O.domain)).forEach(O=>{const B=(O.name||"").trim().toLowerCase();B&&!E.has(B)&&(E.add(B),C.push((O.name||"").trim()))}),C},[i,r]),$=p.useMemo(()=>{const E=new Set;return r.forEach(C=>{const O=(C.name||"").trim().toLowerCase();O&&E.add(O)}),i.forEach(C=>{const O=C.name.trim().toLowerCase();O&&E.add(O)}),E},[r,i]),M=async()=>{if(u||!F.length)return;m(!1);const E=[];for(const C of F.slice(0,2)){b(C);const O=await so(n,C);if(O){if(O.verdict==="quota"){v(!0);break}(O.results||[]).forEach(B=>{const _=(B.company||"").trim().toLowerCase();!_||$.has(_)||E.some(G=>G.name.toLowerCase()===_)||E.push({name:(B.company||"").trim(),verdict:B.verdict||"",reason:B.reason,from:C})})}}b(""),m(!0),g(C=>[...E,...C].slice(0,24))},I=async(E,C)=>{if(u)return;m(!1),b(E==="thesis"?e.pxThesis:C);const O=await Fi(n,E,C,6);if(b(""),m(!0),!O)return;if(O.verdict==="quota"){v(!0);return}const B=[];(O.results||[]).forEach(_=>{const G=(_.company||"").trim().toLowerCase();!G||$.has(G)||B.some(ue=>ue.name.toLowerCase()===G)||B.push({name:(_.company||"").trim(),verdict:_.verdict||"",reason:_.reason,from:E==="thesis"?e.pxThesis:C})}),g(_=>[...B,..._].slice(0,24))},h=()=>{const E=y.trim();E.length<3||I(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(E)?"registry":"keyword",E)},q=E=>{s(C=>[...C,{name:E.name,site:"",status:"",auto:!0}].slice(0,30)),g(C=>C.filter(O=>O.name!==E.name))},U=i.filter(E=>E.name.trim()&&E.status!=="kept"&&E.status!=="out").length,X=E=>E.name.trim()&&E.status!=="kept"&&E.status!=="out"&&E.status!=="resolving"&&!E.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((E,C)=>t.jsxs("div",{className:"eq-row"+(E.status==="kept"?" r-kept":E.status==="out"?" r-out":""),children:[t.jsx("input",{value:E.name,placeholder:e.eqNamePh,onChange:O=>{const B=O.target.value.split(`
`).map(_=>_.trim()).filter(Boolean);B.length>1?s(_=>{const G=[..._];return G.splice(C,1,...B.map(ue=>({name:ue,site:"",status:"",auto:!0}))),G.slice(0,30)}):k(C,{name:O.target.value})},onBlur:()=>{E.name.trim()&&!E.site&&E.status!=="resolving"&&E.status!=="pick"&&N(C,E.name)},onKeyDown:O=>{O.key==="Enter"&&N(C,E.name)}}),t.jsxs("span",{className:"eq-site",children:[E.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),E.status==="pick"&&(E.candidates||[]).map(O=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>k(C,{site:O.url,status:"ready",candidates:void 0}),children:(O.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},O.url)),E.status!=="resolving"&&E.status!=="pick"&&(E.site?t.jsxs("a",{href:E.site.startsWith("http")?E.site:"https://"+E.site,target:"_blank",rel:"nofollow noopener",children:[E.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:E.name.trim()&&E.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:E.desc||"",children:E.descBusy?t.jsx("i",{children:e.eqDescBusy}):E.desc?E.desc:t.jsx("em",{children:E.descDone?d?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(E.status||"vide"),title:E.reason||"",children:E.status==="kept"?"✓ "+e.kept:E.status==="out"?"✗ "+e.dropped:E.status==="ready"?e.eqReady:E.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!X(E)||S,onClick:()=>{T(C,E)},children:E.evalBusy?"⏳":"⚡"}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>s(O=>O.filter((B,_)=>_!==C)),children:"×"})]},C)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>s(E=>[...E,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]}),t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!u,onClick:()=>{I("thesis","")},children:u===e.pxThesis?e.sgBusy(u):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:y,placeholder:e.pxPlace,onChange:E=>j(E.target.value),onKeyDown:E=>{E.key==="Enter"&&h()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u||y.trim().length<3,onClick:h,children:e.pxGoFree}),!!F.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u,onClick:()=>{M()},children:u&&u!==e.pxThesis&&u!==y?e.sgBusy(u):e.sgGo}),!!F.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(F[0],F.length)}),f&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),w&&!c.length&&!f&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),c.map(E=>t.jsxs("span",{className:"eq-sc"+(E.verdict==="kept"?" ok":""),title:(E.reason||"")+" — "+e.sgVia(E.from),children:[t.jsx("b",{children:E.name}),E.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>q(E),children:"+"})]},E.name))]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(S?" loading":""),style:{justifyContent:"center"},disabled:S||!U,onClick:()=>{D()},children:[t.jsx("span",{className:"fill"}),S?e.eqRunning:e.eqGo(U)]}),t.jsx("span",{className:"hint",children:e.eqHint}),i.some(E=>E.status==="kept"||E.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>s(E=>E.filter(C=>C.status!=="kept"&&C.status!=="out")),children:e.eqClearDone})]})]})}function Ho(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function fd(e){var o;const a=[],r=new Set,n=i=>{const s=(i||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function $r({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:s}){const{t:l}=W();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(d=>d.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(d.name),children:l.rsEvalOne})]},d.name))})]}):null}function Vo({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=W(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx($r,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx($r,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function hd({card:e,onEvaluate:a,onAddAll:r}){var l,d,x;const{t:n}=W(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ho(e.summary_md||"").map((c,g)=>t.jsx("p",{children:c},g))})]}),t.jsx(Vo,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(c=>t.jsx("li",{children:c},c))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function xd(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function gd({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:s}=W(),l=o,[d,x]=p.useState(null),[c,g]=p.useState(null),[u,b]=p.useState(null),[f,v]=p.useState(!1);p.useEffect(()=>{let m=!0;return(async()=>{const y=await lo({email:s,cbToken:l});m&&x(y)})(),()=>{m=!1}},[s,l,n]);const w=m=>{g(m),b(null),v(!0),(async()=>{const y=await Mi(m.id);b(y),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{g(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(d||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>w(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[xd(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?i.rsPub:i.rsPriv})]},m.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?i.rsPub:i.rsPriv})]}),f&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!f&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!f&&u&&t.jsx(hd,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ka=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Xt(e){return/^https?:\/\//i.test((e||"").trim())}function lt(e){const a=(e||"").trim();return a?Xt(a)?a:ka.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function bd(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function vd(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:s,evalBusy:l,evalCards:d,caps:x,data:c,canWrite:g,source:u,dossiers:b,doAnalyse:f,liveMemos:v,pipe:w}=W(),m=a==="client",y=p.useMemo(()=>r||(u!=="default"?Oi():""),[r,u]),[j,k]=p.useState(""),[N,A]=p.useState(!1),[S,R]=p.useState(""),[T,D]=p.useState(""),[F,$]=p.useState(""),[M,I]=p.useState(!1),[h,q]=p.useState(!1),[U,X]=p.useState([]);p.useEffect(()=>{const P=ee=>{const ie=ee.detail;ie&&X(Z=>[ie,...Z].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[E,C]=p.useState(!1),[O,B]=p.useState(!1),[_,G]=p.useState(!1),ue=p.useRef(!1),[K,ce]=p.useState(""),[le,be]=p.useState(""),[fe,de]=p.useState(!1),[pe,ge]=p.useState(!1),[Q,re]=p.useState(0),[he,ke]=p.useState(""),[ne,ve]=p.useState(null),[oe,ze]=p.useState(null),[Ke,xe]=p.useState(!1),[Se,Rt]=p.useState(null),[Pe,Je]=p.useState(0),qe=p.useRef(!1),it=j.trim()?ka.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),ee=(P.get("rs")||"").trim(),ie=(P.get("rstext")||"").trim();ee&&/^https?:\/\//i.test(ee)&&ce(ee),ie&&be(ie),(ee&&/^https?:\/\//i.test(ee)||ie)&&C(!0)},[]),p.useEffect(()=>{const P=ee=>{const ie=ee.detail||{},Z=String(ie.url||"").trim(),je=String(ie.text||"").trim();Z&&/^https?:\/\//i.test(Z)&&ce(Z),je&&be(je),(Z&&/^https?:\/\//i.test(Z)||je)&&(C(!0),k(""),R(""),de(!0),window.setTimeout(()=>de(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),p.useEffect(()=>{const P=ee=>{const ie=ee.detail||{},Z=String(ie.name||"").trim();if(!Z)return;C(!1),k(Z),R(Z);const je=lt(String(ie.website||ie.domain||""));D(je),$(lt(String(ie.url||""))),I(!je),A(!0),window.setTimeout(()=>A(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),p.useEffect(()=>{const P=(S||"").trim();if(!P||E||T){(T||!P||E)&&I(!1);return}const ee=b.find(je=>_e(je.name)===_e(P)),ie=lt((ee==null?void 0:ee.website)||"")||lt((ee==null?void 0:ee.domain)||"");if(ie){D(ie),I(!1);return}let Z=!0;return I(!0),Cn(P).then(je=>{var $e,Ae;if(!Z)return;const De=lt(je.website||"")||lt(((Ae=($e=je.candidates)==null?void 0:$e[0])==null?void 0:Ae.url)||"");De&&D(De)}).catch(()=>{}).finally(()=>{Z&&I(!1)}),()=>{Z=!1}},[S,E,T,b]),p.useEffect(()=>{const P=ee=>{var Z;const ie=String(((Z=ee.detail)==null?void 0:Z.url)||"").trim();Xt(ie)&&window.open(ie,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),p.useEffect(()=>{if(ue.current===E)return;ue.current=E,G(!0);const P=window.setTimeout(()=>G(!1),560);return()=>window.clearTimeout(P)},[E]),p.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ee=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!ee)return;const ie=()=>ee.style.setProperty("--demand-h",`${P.offsetHeight}px`);ie();const Z=new ResizeObserver(ie);return Z.observe(P),()=>Z.disconnect()},[u,N,fe,h,E,_,M]),p.useEffect(()=>{if(!g&&!y){Rt(null);return}let P=!0;return(async()=>{const ee=await lo({email:n,cbToken:y});P&&Rt(ee.length)})(),()=>{P=!1}},[g,y,n,Pe]);const kt=U.length?U:d,Oe=c.credits,xt=p.useCallback(P=>{md(r,P)&&q(!0)},[r]);p.useEffect(()=>{if(!pe)return;re(0);const P=window.setInterval(()=>re(ee=>ee+1),1e3);return()=>window.clearInterval(P)},[pe]);const ut=p.useMemo(()=>{const P=j.trim().toLowerCase();return!P||!w?null:b.find(ee=>_e(ee.name)===P&&Ne(ee)===1)||null},[j,b,w]),Xe=()=>{const P=j.trim();if(P){if(ut){f(ut);return}o(null,P),m&&k("")}},jt=async()=>{var ie,Z,je;if(qe.current)return;const P=K.trim().replace(/\s+/g,""),ee=le.trim();if(!P&&!ee){ke(e.rsNeed);return}if(!m&&!y){o(null,P||ee.slice(0,80));return}qe.current=!0,ke(""),ve(null),ze(null),ge(!0);try{const De=await Ii({url:P,text:ee,email:n,cbToken:y});if(ge(!1),!De||De.status!=="success"){ke((De==null?void 0:De.message)||"Erreur");return}ve(De),C(!1),xt((((ie=De.prospective)==null?void 0:ie.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),ze({state:"pending"});const $e=await Pi(De,{email:n,cbToken:y});ze($e.ok?{state:"ok",scopeLabel:((Z=$e.summary)==null?void 0:Z.scope_label)||"",scope:((je=$e.summary)==null?void 0:je.scope)||""}:{state:"fail",msg:$e.error||""}),$e.ok&&Je(Ae=>Ae+1)}finally{qe.current=!1,ge(!1)}},gt=[ne==null?void 0:ne.industry,...(ne==null?void 0:ne.market_tags)||[],ne==null?void 0:ne.author].map(P=>(P||"").trim()).filter(Boolean),bt=(oe==null?void 0:oe.state)==="pending",Ft=oe&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):oe.state==="ok"?t.jsx("span",{className:"rslink ok",children:oe.scope&&oe.scope!=="public"?e.rsSavedIn(oe.scopeLabel||oe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:oe.msg,children:e.rsSaveFail})),Nt=fd(ne).length,Re=E,nt=(S||j).trim(),L=b.find(P=>_e(P.name)===_e(nt)),H=lt(j)||T||lt((L==null?void 0:L.website)||"")||lt((L==null?void 0:L.domain)||""),Y=F||lt((L==null?void 0:L.url)||""),ae=ut?e.actAnalyse:nt?e.evalGoOn(nt.length>22?nt.slice(0,21)+"…":nt):e.evalGo,ye=pe?`${Di(K.trim())==="youtube"&&K.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Q)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Re?" rs-mode":"")+(S&&j.trim()===S||N||fe?" pair":"")+(N||fe||_?" echo":"")+(_?" swap":""),children:[t.jsxs("div",{className:"drow"+((Re?fe:N)||_?" flash":"")+((Re?K.trim():ka.test(j.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Re?K:j,placeholder:Re?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Re?600:200,spellCheck:Re?!1:void 0,inputMode:Re?"url":void 0,onChange:P=>{if(Re){ce(P.target.value);return}k(P.target.value),S&&P.target.value.trim()!==S&&(R(""),D(""),$(""),I(!1))},onKeyDown:P=>{P.key==="Enter"&&(Re?jt():Xe())}}),t.jsx("span",{className:"detect"+(Re?" off":"")+(ka.test(j.trim())?" url":""),children:it})]}),t.jsx("span",{className:"dacts",children:Re?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(pe?" loading":""),disabled:pe||bt||!K.trim()&&!le.trim(),onClick:()=>{jt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ye})]}),t.jsxs("a",{className:"viewbtn"+(Xt(K)?"":" off"),href:Xt(K)?K.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{Xt(K)||P.preventDefault()},children:[t.jsx(bd,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ut?" analyse":"")+(l?" loading":""),disabled:l,onClick:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ae})]}),t.jsxs("a",{className:"viewbtn sm"+(M?" searching":H?"":" off"),href:H||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":M||void 0,title:M?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{H||P.preventDefault()},children:[M&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),M?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(Y?"":" off"),href:Y||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{Y||P.preventDefault()},children:e.viewSrc})]})}),x.showCredits&&Oe&&t.jsxs("button",{type:"button",className:"credits"+(Oe.total_available<=0&&!Oe.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Oe.unlimited?"∞":Oe.total_available}),!Oe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Oe.daily_grant+Oe.purchased]}),Oe.total_available<=0&&!Oe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>q(!h),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(E?" on":""),onClick:()=>C(!E),children:e.rsOpen}),Se!==null&&Se>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Ke?" on":""),onClick:()=>xe(!Ke),children:e.rsArchOpen(Se)})]}),Ke&&t.jsx(gd,{bump:Pe,cbToken:y,onClose:()=>xe(!1),onEvaluate:P=>o(null,P),onAddAll:xt}),t.jsx("div",{className:"rsp slim"+(E?" on":" off"),"aria-hidden":!E,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:E?void 0:-1,onClick:()=>B(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:O?"▴":"▾"})]}),O&&t.jsx("textarea",{className:"rstext",value:le,placeholder:e.rsTextPh,tabIndex:E?void 0:-1,onChange:P=>be(P.target.value)})]})}),he&&t.jsx("div",{className:"rserr",children:he}),ne&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ne.title}),ne.source_url&&t.jsx("a",{href:ne.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ve(null),ze(null)},children:"×"})]}),ne.market&&t.jsx("p",{className:"rsmk",children:ne.market}),gt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),gt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[ne.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ne.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ho(ne.summary_md||"").map((P,ee)=>t.jsx("p",{children:P},ee))})]}),t.jsx(Vo,{card:ne,onEvaluate:P=>o(null,P),onAddAll:xt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Nt)}),Ft]})]}),h&&t.jsx(Uo,{}),kt.slice(0,1).map((P,ee)=>{const ie=P.verdict==="kept",Z=P.verdict==="quota",je=P.verdict==="unresolved",De=ie?"var(--brand)":Z?"var(--bolt)":je?"var(--blue)":"var(--red)",$e=ie?"var(--brand-l)":Z?"#FEF3C7":je?"#EEF4FF":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":De,"--bgc":$e},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ie?"✓ "+e.kept:Z?"⏳":je?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(Ae=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ae.url.startsWith("http")?Ae.url:`https://${Ae.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ae.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,Ae.url,P.name),children:e.evalPickGo})]},Ae.url))}),!Z&&!je&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:ie?1:5});const Ae=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ue=[...document.querySelectorAll(".atl2 .list .row")].find(Pa=>{var la;return(((la=Pa.querySelector(".rnm"))==null?void 0:la.textContent)||"").trim().toLowerCase().includes(Ae)});Ue&&(Ue.scrollIntoView({behavior:"smooth",block:"center"}),Ue.classList.add("flashrow"),window.setTimeout(()=>Ue.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ie?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ee)}),m&&(i.kept+i.dropped>0||kt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function yd(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function wd(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=W(),i=e.memoConsole?r.get(e.memoConsole):null,s=p.useMemo(()=>i?[i.reasoning||"",yd(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=wt(i),d=Nn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:s?s.split(`

`).map((x,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Dt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Rn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=W(),[s,l]=p.useState(!1),[d,x]=p.useState(null),c=n.pipe&&o==="client"&&!n.lockActions,g=async()=>{if(!c||s)return;l(!0);const u=await so(r,e);if(l(!1),!u){i(a.actErr);return}x(u.results||[])};return p.useEffect(()=>{if(!c)return;const u=b=>{var v;const f=String(((v=b.detail)==null?void 0:v.name)||"").trim();f&&f.toLowerCase()===e.toLowerCase()&&g()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,c]),p.useEffect(()=>{if(c)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),g())}catch{}},[e,c]),c?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{g()},children:s?a.similarBusy:a.similar}),d&&(d.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:d.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const kd=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ga=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function jd(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ga(a.slice(n));break}r+=ga(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ga(a.slice(o));break}const s=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(s),d=l?l[2].toLowerCase():"";l&&kd.has(d)?r+=`<${l[1]}${d}>`:r+=ga(a.slice(o,i+1)),n=i+1}return r}const Nd=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),Ur={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function Wo(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(Nd.has(o)){n.remove();continue}for(const s of Array.from(n.attributes)){const l=s.name.toLowerCase();(!(Ur["*"].has(l)||((r=Ur[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(s.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const s=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");s!==i&&(s?n.setAttribute("style",s):n.removeAttribute("style"))}if(o==="a"){const s=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(s)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const s=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(s)){n.remove();continue}n.setAttribute("loading","lazy")}Wo(n)}}function Xa(e){const a=e.cloneNode(!0);return Wo(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Za=new Map;function Ed(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=Za.get(a);return r||(r=Sd(a).catch(()=>null),r.then(n=>{n||Za.delete(a)}),Za.set(a,r)),r}async function Sd(e){var g,u;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=new DOMParser().parseFromString(await a.text(),"text/html"),n=b=>{var f;return(((f=r.querySelector(b))==null?void 0:f.textContent)||"").trim()},o=r.querySelector(".sb-score"),i=((g=Array.from((o==null?void 0:o.classList)||[]).find(b=>b.startsWith("sb-score-")))==null?void 0:g.slice(9))||"",s=[];let l=null;const d=Array.from(r.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const b of d){if(b.classList.contains("sb-nav-heading")){l={label:(b.textContent||"").trim(),items:[]},s.push(l);continue}const f=b.getAttribute("href")||"";if(!f.startsWith("#"))continue;const v=f.slice(1),w=Cd(r,v);w&&(l||(l={label:"",items:[]},s.push(l)),l.items.push({id:v,title:(b.textContent||"").trim(),html:w,poids:w.length}))}const x=((u=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:u[1])||"",c={score:n(".sb-score"),scoreTone:i,tags:Array.from(r.querySelectorAll(".sb-tag")).map(b=>(b.textContent||"").trim()).filter(Boolean),name:n(".sidebar-company-name"),tagline:n(".sidebar-tagline"),desc:n(".meta-desc"),groups:s.filter(b=>b.items.length),mindmapSlug:r.querySelector(".cm-mindmap-png")?x:""};return c.groups.length?c:null}const Hr={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Cd(e,a){const r=e.getElementById(a),n=r?Vr(e,r):"";if(n)return n;const o=Hr[a]?e.querySelector(Hr[a]):null;return o&&o!==r?Vr(e,o):""}function Vr(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Xa(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(d=>/^h3$/i.test(d.tagName))[0]===a)for(const d of i){if(d===a)break;/^h2$/i.test(d.tagName)||o.appendChild(d.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?Xa(o):""}return Xa(a)}const en=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ot({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Wr(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Gr({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const tn=new Map;function zd(e,a){const{token:r}=W(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let s=tn.get(i);s||(s=Bi(r,e.name,e.checkId),tn.set(i,s),s.then(d=>{(!d||!d.reasoning&&!d.summaryHtml)&&tn.delete(i)}));let l=!0;return s.then(d=>{l&&d&&o({id:e.id,d})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Ad=6e4;function qd({o:e}){const{t:a,doDeep:r}=W(),[n,o]=p.useState(null),[i,s]=p.useState(e.memoUrl?"load":"off"),[l,d]=p.useState(()=>new Set),[x,c]=p.useState(!1),g=p.useRef(new Map);p.useEffect(()=>{let v=!0;if(d(new Set),c(!1),g.current=new Map,!e.memoUrl){s("off"),o(null);return}return s("load"),o(null),Ed(e.memoUrl).then(w=>{v&&(o(w),s(w?"ok":"err"))}),()=>{v=!1}},[e.memoUrl]);const u=wt(e),b=v=>{var w;return(w=g.current.get(v))==null?void 0:w.scrollIntoView({behavior:"smooth",block:"start"})},f=t.jsxs("div",{className:"cdacts",children:[Dt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:v=>{v.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const v=[e.reasoning||"",Wr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[v.length?v.join(`

`).split(`

`).map((w,m)=>t.jsx("p",{className:"cdtxt",children:w},m)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),f]})}if(i!=="ok"){const v=[e.reasoning||"",Wr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),v.length>0&&v.join(`

`).split(`

`).map((w,m)=>t.jsx("p",{className:"cdtxt",children:w},m)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:w=>{w.stopPropagation(),c(m=>!m)},children:x?a.memoHideHere:a.memoReadHere})}),x&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:w=>w.stopPropagation()}),f,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(v=>t.jsx("span",{className:"md-tag",children:v},v)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(v=>v.items.map(w=>t.jsx("button",{type:"button",className:"md-jump",onClick:m=>{m.stopPropagation(),b(w.id)},children:w.title},w.id)))}),n.groups.map((v,w)=>t.jsxs("div",{className:"md-grp",children:[v.label&&t.jsx("div",{className:"md-grp-h",children:v.label}),v.items.map(m=>{const y=m.poids>Ad&&!l.has(m.id),j=m.id==="fiche-contact"||m.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:k=>{k&&g.current.set(m.id,k)},children:[t.jsx("h4",{className:"md-h",children:m.title}),j&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:k=>k.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:"LinkedIn"})]}),y?t.jsx("button",{type:"button",className:"abtn md-more",onClick:k=>{k.stopPropagation(),d(N=>new Set(N).add(m.id))},children:a.memoUnfold(Math.round(m.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:m.html}}),!y&&n.mindmapSlug&&m.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Da}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:k=>k.stopPropagation()})]})]},m.id)})]},v.label||w)),f,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:a.memoOpenFull})]})}function Td({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:s,lang:l}=W(),[d,x]=p.useState(!1),[c,g]=p.useState(!1),[u,b]=p.useState(!1),[f,v]=p.useState(null),[w,m]=p.useState(""),[y,j]=p.useState(null),[k,N]=p.useState(""),A={airtableId:e.airtableId,checkId:e.checkId},S=!!(e.airtableId||e.checkId),R=f&&f.id===e.id?f.entries:[],T=!!f&&f.id===e.id;if(p.useEffect(()=>{m(""),j(null),b(!1)},[e.id]),p.useEffect(()=>{if(!d||T||!S||!o)return;let F=!0;g(!0),b(!1);const $=e.id;return Qn(r,"list",A).then(M=>{if(!(!F||$!==e.id)){if(g(!1),!M.ok){b(!0);return}v({id:$,entries:M.entries})}}),()=>{F=!1}},[d,T,S,r,e.id,o]),!n.pipe||!o||!S)return null;const D=(F,$)=>{g(!0);const M=e.id;Qn(r,F,A,$).then(I=>{if(M===e.id){if(g(!1),!I.ok){s(a.notesErr);return}v({id:M,entries:I.entries}),b(!1),F==="add"&&(m(""),i(a.notesAdded)),F==="edit"&&j(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":d,onClick:F=>{F.stopPropagation(),x($=>!$)},children:[t.jsx("b",{children:a.notesT}),R.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(R.length)}),t.jsx("i",{children:d?"▾":"▸"})]}),d&&t.jsxs("div",{className:"dn-b",onClick:F=>F.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),c&&!R.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!c&&!u&&T&&!R.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),R.map(F=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:l==="fr"?F.date.split("-").reverse().join("/"):F.date}),y===F.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:k,rows:3,onChange:$=>N($.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||!k.trim(),onClick:()=>D("edit",{entryId:F.id,text:k.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>j(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:F.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{j(F.id),N(F.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:c,onClick:()=>{window.confirm(a.notesDelAsk)&&D("delete",{entryId:F.id})},children:a.notesDel})]})]})]},F.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:w,onChange:F=>m(F.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:c||!w.trim(),onClick:()=>D("add",{text:w.trim()}),children:a.notesAdd})]})]})]})}function Fn({o:e}){var k;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i}=W(),s=ia(e),l=wt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(s==="NO MATCH"?"NO MATCH":s==="MATCH"?"MATCH":""),x=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,c=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,g=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),u=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(d?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Dt(e)?1:0},{k:"soc",lib:a.cdSociete,n:x},{k:"ctc",lib:a.cdContact,n:c},{k:"suivi",lib:a.cdSuivi,n:g}].filter(N=>N.n>0),[e,a,o,d,l,x,c,g]),[b,f]=p.useState(""),v=u.some(N=>N.k===b)?b:((k=u[0])==null?void 0:k.k)||"",w=zd(e,v==="eval"||v==="conv");if(!u.length)return null;const m=((w==null?void 0:w.reasoning)||"").length>(e.reasoning||"").length?w.reasoning:e.reasoning||"",y=((w==null?void 0:w.summaryHtml)||"").length>(e.summary||"").length?w.summaryHtml:e.summary||"",j=(w==null?void 0:w.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:u.map(N=>t.jsx("button",{type:"button",role:"tab","aria-selected":v===N.k,"data-tour":"tab-"+N.k,className:v===N.k?"on":"",onClick:A=>{A.stopPropagation(),f(N.k)},children:N.lib},N.k))}),t.jsxs("div",{className:"cdbody",onClick:N=>N.stopPropagation(),children:[v==="eval"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(Gr,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),m&&m.split(`

`).map((N,A)=>t.jsx("p",{className:"cdtxt",children:N},A)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Ld,{o:e})]}),v==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof j=="number"&&t.jsx(Gr,{v:j,sur:100,k:a.cdConvScore}),en(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",en(e.verdictDate,r)]})]}),y&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:jd(y)}})]}),v==="memo"&&t.jsx(qd,{o:e}),v==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdSector,v:e.sector}),t.jsx(ot,{k:a.cdStage,v:e.stage}),t.jsx(ot,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ot,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(ot,{k:a.cdAngle,v:e.angle}),t.jsx(ot,{k:a.cdDetected,v:en(e.date,r)})]}),v==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdName,v:e.contactName}),t.jsx(ot,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),v==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(ot,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(Td,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}const ba=new Map;function Ld({o:e}){const{t:a,token:r}=W(),[n,o]=p.useState(!1),[i,s]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const g=`${r}:${e.name.toLowerCase()}`;let u=ba.get(g);u||(u=co(r,[e.name]).then(f=>f[e.name]||Object.values(f)[0]||null).catch(()=>null),ba.set(g,u),u.then(f=>{(!f||!f.ok)&&ba.delete(g)}));let b=!0;return u.then(f=>{b&&f&&f.ok&&s(f)}),()=>{b=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const g=await oo(r,e.name,e.website||e.domain||"");s(g),g.ok&&ba.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(g)),o(!1)},d=(i==null?void 0:i.blocs)||{},x=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],c=x.some(([,g])=>g);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&c&&t.jsxs(t.Fragment,{children:[x.filter(([,g])=>g).map(([g,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:g}),t.jsx("p",{children:u})]},g)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!c&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function sa({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let s=!1;const l=()=>{const x=Math.max(280,Math.min(560,i.clientWidth||320));Kn({kind:"op",card:e},x).then(c=>{!s&&c&&i.isConnected&&i.replaceChildren(c)})},d=window.requestAnimationFrame(l);return()=>{s=!0,window.cancelAnimationFrame(d),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let s=!1;Kn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(d=>{!s&&d&&i.isConnected&&i.replaceChildren(d)});const l=d=>{d.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{s=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&_t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Rd=`
...
`;function Fd(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:s,top:l}}function Md(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:s,askEvaluate:l,doAnalyse:d,doDecide:x,doPromote:c,doRepeche:g,doApproach:u,doDeep:b,doOnboard:f,outbound:v,evalBusy:w}=W(),m=e.popupId?r.get(e.popupId):null;if(!m)return null;const y=Me(m),j=Ne(m),k=wt(m),N=ia(m),A=m.kind==="target",S=R=>{a({type:"filters",patch:R}),a({type:"popup",id:null})};return _t.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Rd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Fd(e.popupAnchor,!!m.card),onClick:R=>R.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:m.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ht(m.date)),Qe(m.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[m.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[m.cc]}),children:($t(m.cc,o)||m.countryLabel||"").toUpperCase()}),m.sector&&t.jsx("button",{type:"button",onClick:()=>S({sector:[m.sector]}),children:m.sector.toUpperCase()}),m.stage&&t.jsx("button",{type:"button",onClick:()=>S({stage:[m.stage]}),children:m.stage.toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{className:"am2",children:Ut(m.amountEur,o)})]}),i.pipe&&A&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),m.ceoStatus&&t.jsx("span",{className:"pstep own",children:m.ceoStatus})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[At(m.engine)," ",t.jsx("b",{children:Qe(m.engine,o)})," — ",_i(m.engine,o),m.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",m.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(yt,{o:m,lg:!0})," ",t.jsx(Ia,{o:m,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(po(y,o))," · ",n.win7(uo(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),m.card?t.jsx(sa,{spec:m.card}):null,m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),i.pipe&&A&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof m.score=="number"&&m.score>0?" · "+n.score(m.score):""]})}),i.pipe&&A&&t.jsx(Fn,{o:m})]}),t.jsx(Rn,{name:m.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||s!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>l(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(m,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(m,!1),a({type:"popup",id:null})},children:n.actNo}),Dt(m)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(m),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),m.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:m.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{f(m),a({type:"popup",id:null})},children:"🚀"})]}):m.engine==="media"&&m.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var R;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"popup",id:null}),(R=document.querySelector(".atl2 .demand"))==null||R.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:w,title:n.evalGoOn(m.name),onClick:()=>l(m),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>l(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)," →"]}),m.website&&t.jsx("a",{className:"psite",href:m.website.startsWith("http")?m.website:"https://"+m.website,target:"_blank",rel:"noopener noreferrer",title:m.website,children:"🌐"})]})]})]}),document.body)}function Od(){const{lang:e,token:a,dossiers:r,caps:n}=W(),o=a||"home",{names:i,verdicts:s}=p.useMemo(()=>{const d=[],x={};return r.forEach(c=>{c.kind!=="target"||!c.name||(d.push(c.name),x[c.name]=$i(c)||"")}),{names:d,verdicts:x}},[r]);return{diff:p.useMemo(()=>i.length?Ui(o,i,s,e):null,[o,i.length]),names:i,verdicts:s,scope:o,caps:n}}function Dd(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:s,caps:l}=W(),[d,x]=p.useState(!1),[c,g]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!d)return;const j=k=>{u.current&&!u.current.contains(k.target)&&x(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[d]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],f=i.loading&&!s.length,v=p.useRef({});p.useEffect(()=>{v.current={...r}},[r]);const w=j=>{const k=v.current[j],N=k!==void 0?r[j]-k:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${Zt[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j].toUpperCase(),j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[j],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},j)},m=(j,k,N)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),style:{"--c":`var(${Zt[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:N.toUpperCase()}),t.jsx("span",{className:"n",children:r[j]})]},j),y=(j,k,N,A=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:A,onClick:N,children:j},k);return t.jsxs("div",{className:"funnel"+(f?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(w)}),t.jsxs("div",{className:"offtrack",children:[m(5,!1,n.plabels[5]),m(7,!0,n.plabels[7]),m(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[y("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(c?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}g(!0),window.setTimeout(()=>g(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":d,title:n.toolSort,onClick:()=>x(j=>!j),children:"⇅"}),d&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([j,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[k,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),y("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),y("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Id(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:s}=W(),l=p.useRef(null),[d,x]=p.useState(60);p.useEffect(()=>{let f=0;const v=()=>{var k;const w=l.current;if(!w)return;const m=(k=w.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!m)return;const y=m.getBoundingClientRect(),j=w.getBoundingClientRect();x(Math.max(20,Math.min(y.left+y.width/2-j.left,j.width-30)))};return f=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(f),window.removeEventListener("resize",v)}},[e.ptab]);const c=e.ptab;let g=r.tuto[c].p;if(c===3){const f=n.filter(m=>m.kind==="target"&&Ne(m)===3),v=f.filter(m=>on(m)==="auto").length,w=f.filter(m=>on(m)==="cd").length;g=r.tutoPending(v,w,f.length)}const u=(()=>{if(s!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(f=>f.id)})};if(c===1){const f=n.filter(v=>v.kind==="target"&&Ne(v)===1&&!o.has(v.id)).slice(0,10);if(f.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:f.map(v=>v.id)})}}return null})(),b=Hi(c);return t.jsxs("div",{ref:l,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Zt[c]})`,"--ax":d+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:g}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const an=600,St=62,Yr="atl2:fstats";function Pd(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=W(),[s,l]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Yr)==="on"}catch{return!1}}),d=r.stats,x=p.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),c=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const g=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,u=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((N,A)=>Math.max(N,A.s||0),0),f=x.length?an/x.length:0,v=Math.max(4,f-4),w=x.length>=5&&b>0,m=r.marketEstimate||0,y=g(new Date().toISOString().slice(0,10)),j=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],k=[];return typeof d.screened_window=="number"&&c&&k.push({cle:"fenetre",periode:e.funPerWindow(g(c),y),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:j(d.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[k.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([A,S],R)=>t.jsxs("span",{className:"fst-t",children:[R>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(A)}),t.jsx("i",{children:S})]},N.cle+S)),N.cle==="total"&&m>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(m),Math.min(100,Math.round((d.screened||0)/m*100)))})]}),N.cle===k[k.length-1].cle&&w&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const A=!s;l(A),A&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Yr,A?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},N.cle)),s&&w&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${an} ${St}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((N,A)=>{const S=(N.s||0)/b*(St-4),R=(N.m||0)/b*(St-4),T=A*f+(f-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${g(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:T,y:St-2-S,width:v,height:S,fill:"#cfe0d6"}),t.jsx("rect",{x:T,y:St-2-R,width:v,height:R,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:St-1.5,x2:an,y2:St-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:g(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Go={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Mn({o:e,locked:a=!1}){const{t:r}=W(),n=ia(e),o=wt(e),i=Ne(e),s=on(e),l=Vi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Go[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&s==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&s==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(il,{o:e})]})}const Bt=e=>e.length>22?e.slice(0,21)+"…":e;function oa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Yo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Bd({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const s=()=>{var f,v,w;const l=document.querySelector(".atl2.ops .desk-list"),d=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const x=l.getBoundingClientRect(),c=d?d.getBoundingClientRect().bottom:x.top;i({top:Math.round(c),left:Math.round(x.left),width:Math.round(x.width)});const g=[...l.querySelectorAll(":scope .grp")];let u=null;for(const m of g){const y=m.querySelector(".grp-h");y&&y.getBoundingClientRect().bottom<=c+2&&(u=m)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((f=b.querySelector(".ic"))==null?void 0:f.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((w=b.querySelector(".s"))==null?void 0:w.textContent)||"").trim()})};return s(),window.addEventListener("scroll",s,{passive:!0}),window.addEventListener("resize",s),()=>{window.removeEventListener("scroll",s),window.removeEventListener("resize",s)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function _d(e){const r=()=>{const n=Yo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Qr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=W(),[i,s]=p.useState(!1);if(p.useEffect(()=>{n||s(!1)},[n]),Ie(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}function On({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:s,doPromote:l,doRepeche:d,doApproach:x,dispatch:c,liveMemos:g}=W(),u=f=>v=>{v.stopPropagation(),f()};if(r.lockActions){const f=u(()=>c({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:f,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Ne(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:f,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:f,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:f,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:f,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:f,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:f,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:f,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:f,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:f=>{f.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Sa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:f=>{f.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Qr,{o:e})});const b=Ne(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Qr,{o:e})});if(b===1){const f=g.liveOf(e.name);if(f&&(f.status==="boot"||f.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Na,{item:f,serverOff:g.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:u(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>c({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const f=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:f,onClick:u(()=>x(e)),children:f?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>c({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>c({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>c({type:"memoConsole",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function $d({o:e}){const{t:a,doThumb:r,thumbOf:n}=W(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Ud({o:e}){const{lang:a}=W();return Me(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(yt,{o:e}),t.jsx(Ia,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[At(e.engine||"")," ",Qe(e.engine||"",a)]})})}function Hd({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:s,fresh:l}){const{dispatch:d,caps:x,markRow:c,markedId:g,favIds:u,toggleFav:b,t:f}=W(),v=Ne(e),w=["#0F172A","#475C6E","#8798A8","#B9C6D2"],m=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,y=m<=0?0:m<=7?1:m<=30?2:3,j=x.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][v]:w[y],k=u.has(e.id),N=A=>{if(a)return;if(s){s(e.id);return}if(x.pipe||e.kind==="op"){n();return}const S=A.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(g===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(x.pipe&&e.kind==="target"?" p"+v:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>c(e.id),onMouseLeave:()=>c(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(Zo,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${f.cdEngagement} ${Math.round(e.engagement*10)/10} · ${f.cdEngagementHint}`,children:"🔥"}),Me(e)&&t.jsx(yt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[x.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:A=>{A.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[We(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(A=>A&&A!==e.name)||""]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:f.acqSee(e.acquirer),onClick:A=>{A.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",Bt(e.acquirer)]}),Ge(e)?t.jsx("span",{className:"rdec",title:f.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:f.zoomNewsMark,children:"📰"}):null]}),t.jsx(Vd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Ud,{o:e}),x.pipe&&t.jsx(Mn,{o:e,locked:a}),x.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(On,{o:e}),x.showThumbs&&t.jsx($d,{o:e})]}),r&&!a&&!s&&t.jsx(Yd,{o:e})]})}function Vd({o:e}){const{lang:a,caps:r}=W();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ut(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Wd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=W(),s=(u,b=!1)=>f=>{f.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),d=Ut(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=Ie(e),g=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped})]}):We(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),oa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Bt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(sa,{spec:e.card})})]})}function Gd({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=W();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Qe(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(On,{o:e})}),t.jsx(Fn,{o:e})]})}function Qo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:s,caps:l,dossiers:d}=W(),x=p.useRef(null),c=Ge(e);if(p.useEffect(()=>{if(!c||!(e!=null&&e.decryptHtml))return;const h=x.current;if(!h)return;let q=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async U=>{await U.ensureEditoCss(),!(q||!h.isConnected)&&(U.beautifyEditoRows(h),U.mountCardFits(h))}),()=>{q=!0}},[c,e==null?void 0:e.decryptHtml]),!e&&!a){const h=d.find(Ge);if(h)return t.jsx(Qo,{o:h})}const g=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||g,f=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!g||Ea(g),w=(e==null?void 0:e.engine)||"",m=Ge(e),y=e?Ut(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),N=d.find(Ge),A=((N==null?void 0:N.url)||"").trim(),S=!!u&&!!A&&(u===A||u.endsWith(A)||A.endsWith(u)),R=(h,q=!1)=>U=>{U.stopPropagation(),q&&s({type:"continent",key:"monde"}),s({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const T=()=>{g&&(s({type:"continent",key:"monde"}),s({type:"filters",patch:{search:g}}))},D=()=>{e!=null&&e.sector&&s({type:"filters",patch:{sector:[e.sector]}})},F=()=>{oa({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:g})},$=e?Ie(e):!1,M=$&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",I=m?r.doEdito.replace(/^📖\s*/,""):w?Qe(w,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[I,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!m&&(v||Sa({engine:w}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:x,className:"ed-decrypt-b zoom-body"+(m?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:R({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:R({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:R({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),f&&t.jsx("div",{className:"zoom-card",children:t.jsx(sa,{spec:f})}),(u&&!S&&!m||N&&!m)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!S&&!m&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),N&&!m&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),s({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[$?t.jsxs("span",{className:"verdict",style:{"--c":M?"var(--brand)":"var(--red)"},children:[M?"✓":"✗"," ",t.jsx("b",{children:M?r.kept:r.dropped})]}):!v&&g?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:h=>{h.stopPropagation(),o(e,g)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Bt(g))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!m&&(v||Sa({engine:w}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&g?" ghost":""),onClick:h=>{h.stopPropagation(),F()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&g&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Bt(g)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&g&&l.pipe&&t.jsx(Rn,{name:g})]})]})}function Yd({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:s}=W();return!o.pipe&&e.kind==="op"?t.jsx(Wd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Fn,{o:e}),t.jsx(sl,{o:e}),t.jsx(cl,{o:e}),t.jsx(Rn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Mn,{o:e})})]}),e.card&&t.jsx(sa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[At(e.engine||"")," ",Qe(e.engine||"",r)]}),Me(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(yt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function Qd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:s,doDecide:l,lang:d}=W();if(!s.pipe&&e.kind==="op"){const g=Ut(e.amountEur,d),u=(()=>{const f=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return f?f[1].slice(0,32):""})(),b=(f,v=!1)=>w=>{w.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:f})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(sa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),g&&t.jsx("span",{className:"damt",children:g})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[At(e.engine||"")," ",Qe(e.engine||"",d)]}),Me(e)&&t.jsx(yt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:f=>f.stopPropagation(),children:[(d==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(On,{o:e})})]})}const x=Ne(e),c=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][x];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":c},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Mn,{o:e}),Me(e)&&t.jsx(yt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&s.pipe&&x===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function Kd(){const{t:e}=W(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Jd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=W(),i=o==="en",s=c=>n.plabels[c]||"",l=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),d=l.includes(0)?0:l.sort((c,g)=>(e[g]||0)-(e[c]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?i?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:i?`${x} ${x>1?"files":"file"} in “${s(d)}”`:`${x} dossier${x>1?"s":""} dans « ${s(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(i?"Open ":"Ouvrir ")+s(d)," →"]})]})}function Xd(){var bt,Ft,Nt,Re,nt;const e=W(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:s,scopedAll:l,markRow:d,lang:x,sessTally:c,data:g,dossiers:u,source:b,focusExtra:f,byId:v,token:w}=e,m=ho(),y=p.useMemo(()=>{var Y,ae,ye,P;if(!w||b==="ops")return null;const L=(((Y=m==null?void 0:m.ed)==null?void 0:Y.date)||(m==null?void 0:m.day)||"").slice(0,10),H=[(ae=m==null?void 0:m.ed)==null?void 0:ae.html,(ye=m==null?void 0:m.ed)==null?void 0:ye.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:x==="en"?"Today's brief":"Brief du jour",headline:x==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((P=m==null?void 0:m.ed)==null?void 0:P.date)||L,decryptHtml:H||void 0,date:L,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[w,b,x,(bt=m==null?void 0:m.ed)==null?void 0:bt.html,(Ft=m==null?void 0:m.ed)==null?void 0:Ft.acquirers_html,(Nt=m==null?void 0:m.ed)==null?void 0:Nt.date,m==null?void 0:m.day]),j=L=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:fo,[k,N]=p.useState(new Set);p.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[A,S]=p.useState(null);p.useEffect(()=>{S(null)},[a.ptab,a.continent]);const[R,T]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){T(!1);return}const L=document.getElementById("atl2-stage");if(!L){T(!1);return}const H=new IntersectionObserver(([Y])=>T(!!Y&&Y.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return H.observe(L),()=>H.disconnect()},[a.mapFolded]);const D=a.mapFolded||!R,F=L=>N(H=>{const Y=new Set(H);return Y.has(L)?Y.delete(L):Y.add(L),Y}),$=b==="ops"||o.pipe,[M,I]=p.useState("all"),[h,q]=p.useState(!1),[U,X]=p.useState(null),[E,C]=p.useState(!1),O=p.useRef(!0);p.useEffect(()=>{if(O.current){O.current=!1;return}I("all"),C(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!E)return;const L=H=>{var Y,ae;(ae=(Y=H.target)==null?void 0:Y.closest)!=null&&ae.call(Y,".atl2 .doable")||C(!1)};return document.addEventListener("click",L,!0),()=>document.removeEventListener("click",L,!0)},[E]);const B=p.useMemo(()=>{var H;const L=new Map;for(const Y of Ws(((H=m==null?void 0:m.ed)==null?void 0:H.html)||""))L.has(Y.t)||L.set(Y.t,Y.html);return L},[(Re=m==null?void 0:m.ed)==null?void 0:Re.html]),_=p.useCallback(L=>{if(L.decryptHtml)return L.decryptHtml;if(!B.size)return;const H=(L.name||"").trim().toLowerCase();if(H.length<3)return;const Y=B.get(H);if(Y)return Y;for(const[ae,ye]of B)if(ae.includes(H)||H.includes(ae))return ye},[B]),{diff:G}=Od(),[ue,K]=p.useState(!1),ce=a.filters.win==="1"&&!a.filters.day,[le,be]=p.useState(!1),fe=p.useMemo(()=>new Set(((G==null?void 0:G.added)||[]).map(L=>L.trim().toLowerCase()).filter(Boolean)),[G]),de=p.useMemo(()=>{if(!fe.size)return 0;const L={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(H=>!Ge(H)&&fe.has((H.name||"").trim().toLowerCase())&&ea(H,L,o.pipe)).length},[u,fe,a,o.pipe]);p.useEffect(()=>{const L=()=>{be(!1),q(!1),I("all"),C(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",L),()=>window.removeEventListener("ppmap:tunnel",L)},[]),p.useEffect(()=>{be(!1),q(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const pe=p.useMemo(()=>{const L=l.filter(Y=>!Ge(Y)&&We(Y));let H="";for(const Y of L){const ae=(Y.date||"").slice(0,10);ae&&(!H||ae<H)&&(H=ae)}return{n:L.length,since:H?H.split("-").reverse().slice(0,2).join("/"):""}},[l]),ge=pe.n,Q=p.useMemo(()=>{const H=le&&fe.size>0||a.filters.signalOnly||M!=="all"||h?l:s;let Y=zn(H,a.sort);return Y=Y.filter(ae=>!Ge(ae)),le&&fe.size&&(Y=Y.filter(ae=>fe.has((ae.name||"").trim().toLowerCase()))),h||M==="explore"?Y=Y.filter(We):M==="eval"?Y=Y.filter(ae=>!We(ae)&&!ae.noCo&&(ae.kind==="op"||!Ie(ae))):o.pipe&&(Y=Y.filter(ae=>!We(ae))),Y},[s,l,a.sort,M,le,fe,h,o.pipe]),he=p.useMemo(()=>o.pipe?u.filter(L=>L.kind==="target"&&!Ge(L)&&Me(L)&&(a.continent==="monde"||L.continent===a.continent)):Q.filter(L=>Me(L)&&!Ie(L)),[o.pipe,u,Q,a.continent]).length,ke=p.useMemo(()=>o.pipe?Q:Q.filter(L=>!Ie(L)&&!L.noCo&&!We(L)),[Q,o.pipe]),ne=b==="ops"?Q.filter(We).length:0,ve=le?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,oe=a.filters,ze=[];if(oe.day)ze.push({k:"day",lib:n.fDay(oe.day.slice(8,10)+"/"+oe.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(oe.win&&oe.win!=="all"){const L=["1","7","30"].indexOf(oe.win);L>=0&&ze.push({k:"win",lib:n.dates[L],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ke=L=>L.length<=2?L.join(", "):`${L.length} ${n.fSelected}`;for(const L of["sector","country","engine","crible"]){const H=oe[L];H&&H.length&&ze.push({k:L,lib:Ke(H),off:()=>r({type:"clearFacet",facet:L})})}oe.search&&ze.push({k:"search",lib:"🔍 "+oe.search,off:()=>r({type:"filters",patch:{search:""}})}),le&&fe.size&&ze.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>be(!1)}),oe.signalOnly&&ze.push({k:"sig",lib:"🔴 "+n.sigDock(he||oe.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const xe=(L,H,Y="",ae=!1)=>t.jsxs("button",{type:"button","data-s":L,className:Y,"aria-sort":a.sort.key===L?a.sort.dir===1?"ascending":"descending":"none",style:ae?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:L}),children:[H,t.jsx("span",{className:"ar",children:a.sort.key===L&&a.sort.dir===1?"▴":"▾"})]},L),Se=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const L=new Map;Q.forEach(ae=>{const ye=ae.engine||"?";L.has(ye)||L.set(ye,[]),L.get(ye).push(ae)});const H={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},Y=rn([...L.keys()],x);return[...L.entries()].sort((ae,ye)=>{const P=H[ae[0]]??10+Y.indexOf(ae[0]),ee=H[ye[0]]??10+Y.indexOf(ye[0]);return P-ee})},[Q,o.pipe,a.groupBy,x]),Rt=Se?Se.filter(([L])=>ya.has(L)).length:0,Pe=(()=>{var H;return((H=(Se?Se.flatMap(([,Y])=>Y):Q)[0])==null?void 0:H.id)??null})(),Je=p.useRef(!1),qe=p.useMemo(()=>u.find(Ge)||y,[u,y]);p.useEffect(()=>{const L=()=>{Je.current=!0,be(!1)};return window.addEventListener("ppmap:reveal",L),window.addEventListener("ppmap:focus",L),()=>{window.removeEventListener("ppmap:reveal",L),window.removeEventListener("ppmap:focus",L)}},[]),p.useEffect(()=>{const L=()=>{qe&&r({type:"focus",id:qe.id})};return window.addEventListener("ppmap:edito",L),()=>window.removeEventListener("ppmap:edito",L)},[qe,r]),p.useEffect(()=>{if(!a.focusId)return;X(a.focusId);const L=window.setTimeout(()=>X(null),900);return()=>window.clearTimeout(L)},[a.focusId]),p.useEffect(()=>{if($&&!(a.focusId&&(Q.some(L=>L.id===a.focusId)||u.some(L=>L.id===a.focusId)||a.focusId===(qe==null?void 0:qe.id)))&&!f){if(qe){r({type:"focus",id:qe.id});return}Pe&&r({type:"focus",id:Pe})}},[$,a.focusId,Q,Pe,f,r,u,b,qe]),p.useEffect(()=>{if(!$||!a.focusId||qe&&a.focusId===qe.id||Q.some(H=>H.id===a.focusId))return;const L=u.find(H=>H.id===a.focusId);if(L){if(Je.current){L.kind==="op"?I(We(L)?"explore":"eval"):M!=="all"&&I("all");return}M!=="all"&&Pe&&r({type:"focus",id:Pe})}},[$,a.focusId,M,Q,u,Pe,r,qe]),p.useEffect(()=>{if(!$||!a.focusId||!Je.current)return;const L=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!L){const ye=Q.findIndex(P=>P.id===a.focusId);if(ye>=0){const P=Se?"":"pt"+a.ptab;if(P){const ee=a.shown[P]||j();ye>=ee&&r({type:"more",group:P,by:ye-ee+8})}}return}Je.current=!1;const H=Yo(),Y=L.getBoundingClientRect();Y.top>=H-2&&Y.bottom<=window.innerHeight-4||_d(L)},[$,a.focusId,a.ptab,Q,a.shown,Se,r]),p.useEffect(()=>{if(typeof window>"u")return;const L=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),H=document.querySelector(".atl2.ops, .atl2.cibles");if(!L||!H)return;const Y=()=>H.style.setProperty("--listhead-h",`${L.offsetHeight}px`);Y();const ae=new ResizeObserver(Y);return ae.observe(L),()=>ae.disconnect()},[D,a.dens,a.mapFolded]);const it=p.useMemo(()=>{if(!$||!a.focusId)return null;if(y&&a.focusId===y.id)return y;const L=Q.find(Y=>Y.id===a.focusId)||u.find(Y=>Y.id===a.focusId)||null;if(!L)return null;const H=_(L);return H&&H!==L.decryptHtml?{...L,decryptHtml:H}:L},[$,a.focusId,Q,u,_,y]),kt=o.lockRowsAfter;let Oe=0;const xt=(L,H)=>{let Y=a.shown[H]||j();return L.length-Y<=4&&(Y=L.length),L.slice(0,Y).map(P=>{const ee=kt!==null&&Oe>=kt;Oe++;const ie=_(P),Z=ie&&ie!==P.decryptHtml?{...P,decryptHtml:ie}:P,je=!$&&a.dens!=="maxi"&&(a.dens==="deplie"||(A?A==="open":!!ie)),De=k.has(P.id)?!je:je,$e=$?Ae=>{Je.current=!0,r({type:"focus",id:Ae});const Ue=v.get(Ae);Ue&&(We(Ue)?oa(Ue):Ue.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ue.name,url:Ue.url||"",website:Ue.website||"",domain:Ue.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Qd,{o:Z,locked:ee,selected:$&&a.focusId===P.id,onSelect:$e},P.id):t.jsx(Hd,{o:Z,locked:ee,open:De,onToggle:()=>F(P.id),selected:$&&a.focusId===P.id,echo:U===P.id,fresh:fe.has((P.name||"").trim().toLowerCase()),onSelect:$e},P.id)})},ut="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(Q.length?"":" list-empty"),Xe=t.jsxs(t.Fragment,{children:[Se?Se.map(([L,H])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:At(L)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:L==="ma"?n.grpMa:L==="fundraising"?n.grpLev:ya.has(L)&&Rt<=1?n.grpNews:L==="nominations"?n.grpNom:L==="media"?n.grpNewsOther:L==="recrutements"?n.grpHire:ya.has(L)?n.grpNews+" · "+Qe(L,x):Qe(L,x)}),t.jsx("div",{className:"s",children:n.grpCount(H.filter(Y=>!Ie(Y)).length,H.length)})]})]}),xt(H,L)]},L)):xt(Q,"pt"+a.ptab),g.loading&&!u.length&&t.jsx(Kd,{}),o.pipe&&a.ptab===0&&!h&&!le&&M==="all"&&!a.filters.signalOnly&&!g.loading&&t.jsx(Uo,{}),!Q.length&&!(g.loading&&!u.length)&&(o.pipe&&M==="all"?t.jsx(Jd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),jt=t.jsxs(t.Fragment,{children:[!le&&!h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:Q.length})," ",ve]}),h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:Q.length})," ",n.newsWord]}),(!le||h)&&t.jsx("span",{className:"dot",children:"·"}),D&&t.jsx(_o,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[D?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ze.map(L=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:H=>{H.stopPropagation(),L.off()},children:[L.lib,t.jsx("i",{children:"×"})]},L.k)),b==="ops"&&Q.length>0&&!D&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",Q.length-ne," ",n.zoomPulseEval,ne>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",ne," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),gt=t.jsxs("div",{className:"listhead"+(D?" mapoff":""),children:[D&&t.jsx("div",{className:"lh-tools",children:t.jsx(Bo,{compact:!0})}),o.showFunnel&&ue&&ce&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(ul,{}),t.jsx(Pd,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:jt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Dd,{}),t.jsx(Id,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ce?" on":""),"aria-pressed":ce,title:n.morningDockTitle,onClick:()=>{if(ce){r({type:"filters",patch:{win:"all",day:""}}),K(!1);return}be(!1),q(!1),I("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),K(!0)},children:["📊 ",n.morningDock(typeof((nt=g.stats)==null?void 0:nt.screened_today)=="number"?g.stats.screened_today:0)]}),G&&!G.firstVisit&&(G.added.length>0||G.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(le?" on":""),"aria-pressed":le,title:n.sinceSub,onClick:()=>{const L=!le;be(L),q(!1),K(!1),I("all"),L&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(de),G!=null&&G.lastDate?` · ${n.sinceSince(G.lastDate)}`:""]}),he>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{be(!1),q(!1),K(!1),I("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(he)]}),o.pipe&&ge>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(h?" on":""),"aria-pressed":h,title:n.newsDockHint,onClick:()=>{const L=!h;q(L),be(!1),K(!1),I("all"),L&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ge),pe.since?` · ${n.newsSince(pe.since)}`:""]})]}),!o.showFunnel&&jt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([L,H])=>t.jsxs("button",{type:"button","data-d":L,"aria-pressed":a.dens===L||L==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:L}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:H})]},L))}),!$&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":A==="open",onClick:()=>{S("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":A==="closed",onClick:()=>{S("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var ie;const L={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},H=u.filter(Z=>ea(Z,L,o.pipe)&&!Ge(Z)),Y=H.filter(Z=>!We(Z)&&!Z.noCo&&(Z.kind==="op"||!Ie(Z))).length,ae=H.filter(We).length,ye=o.pipe?H.filter(Z=>Z.kind!=="op"&&Ne(Z)===1).length:0,P=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ye?` ${ye}`:""}`]]:[],["eval",`${n.doEval}${Y?` ${Y}`:""}`],["explore",`${n.doExplore}${ae?` ${ae}`:""}`]],ee=((ie=P.find(([Z])=>Z===M))==null?void 0:ie[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":E,onClick:()=>C(Z=>!Z),children:[ee,t.jsx("i",{children:"▾"})]}),E&&t.jsx("div",{className:"dolist",children:P.map(([Z,je])=>t.jsx("button",{type:"button","aria-pressed":M===Z,onClick:()=>{if(C(!1),Z==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}I(Z),Z!=="all"&&(be(!1),q(!1),K(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:je},Z))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:L=>r({type:"sort",key:L.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([L,H])=>t.jsx("option",{value:L,children:H},L))})]}),o.showChain&&ke.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ke.map(L=>L.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ke.length):n.chainAll(ke.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!$&&gt,a.dens!=="maxi"&&!$&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),xe("country",n.colCountry),xe("name",n.colCompany),xe("amount",n.colAmount,"h-amt",!0),xe("stage",n.colStage,"h-stade"),xe("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[xe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),xe("memo",n.colMemo)]}),o.pipe&&xe("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),$?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[gt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),xe("country",n.colCountry),xe("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[xe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),xe("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ut,children:Xe})]}),t.jsxs("aside",{className:"readpane"+((it?Ge(it):!f&&qe)?" is-edito":""),"aria-label":x==="fr"?"Dossier":"File",children:[qe&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===qe.id,onClick:()=>r({type:"focus",id:qe.id}),children:n.doEdito}),y&&a.focusId===y.id?t.jsx("div",{className:"zoom",children:t.jsx(Js,{})}):it&&o.pipe?t.jsx(Gd,{o:it}):t.jsx(Qo,{o:it,extra:it?null:f})]})]}):t.jsx("div",{className:ut,children:Xe}),(()=>{const L=Se||[["pt"+a.ptab,Q]];let H=0,Y=0;for(const[ye,P]of L){Y+=P.length;let ee=a.shown[ye]||j();P.length-ee<=4&&(ee=P.length),H+=Math.min(P.length,ee)}const ae=Y-H;return ae<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>L.forEach(([ye,P])=>r({type:"more",group:ye,by:P.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(ae,ae)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(H,Y)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}}),$&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Bd,{on:!!Se,rev:(Se||[]).map(([L,H])=>L+H.length).join("|")})]})}function Kr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Zd(e,a){const r=Wi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function ec(e,a){const n=[a.head.split("|").map(Kr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",Zd(o,a.plabels),ia(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Kr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function tc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const ac=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function dt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function nc({o:e,qa:a}){const{t:r,lang:n,fund:o}=W(),i=(e.cribleStatus||"").trim().toUpperCase()||(ia(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=wt(e),l=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(dt,{k:r.cdSector,v:e.sector}),t.jsx(dt,{k:r.cdStage,v:e.stage}),t.jsx(dt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(dt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(dt,{k:r.cdName,v:e.contactName}),t.jsx(dt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(dt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(dt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(dt,{k:r.cdAngle,v:e.angle}),t.jsx(dt,{k:r.cdDetected,v:ac(e.date,n)})]}),d.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,x])=>x).map(([x,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:c})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function rc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:s}=W(),[l,d]=p.useState({}),x=25,c=p.useMemo(()=>n.slice(0,x),[n]);p.useEffect(()=>{c.length&&co(r,c.map(b=>b.name)).then(d)},[r,c]);const g=i.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),g&&typeof g.screened=="number"&&t.jsxs("p",{children:[u(g.screened)," ",e.funScreened(""),typeof g.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(g.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(g.screened/i.marketEstimate*100)," %"]})]})]}),c.map(b=>t.jsx(nc,{o:b,qa:l[b.name]},b.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const oc=50;function Dn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=W(),[i,s]=p.useState(null),[l,d]=p.useState(!1),[x,c]=p.useState(""),[g,u]=p.useState(0),[b,f]=p.useState(""),[v,w]=p.useState(!1),[m,y]=p.useState(0),j=p.useRef(null),k=p.useRef(null),N=()=>{y(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>y(T=>T+1),1e3)},A=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};p.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),k.current&&window.clearInterval(k.current)},[]);const S=async T=>{d(!0),c(""),N();const D=await a();if(d(!1),A(),D.ok){s(D);return}if(D.busy){c(o.alertPreviewBusy);return}if(!T){c(o.alertPreviewFail);return}u(oc),A(),j.current=window.setInterval(()=>{u(F=>F>1?F-1:(j.current&&window.clearInterval(j.current),S(!1),0))},1e3)},R=async()=>{if(n||v||l)return;w(!0),f(""),N();const T=await r();w(!1),A(),f(T.ok?o.alertTestOk(T.sentTo||""):T.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||v||g>0,onClick:()=>{S(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||l,onClick:()=>{R()},children:v?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(m)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(m)]}),g>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(g)}),x&&t.jsx("p",{className:"mnote warn",children:x}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const zt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ve({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=W();return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function ic(){const{st:e}=W();switch(e.modal){case"chain":return t.jsx(lc,{});case"space":return t.jsx(dc,{});case"alert":return t.jsx(cc,{});case"queue":return t.jsx(hc,{});case"export":return t.jsx(xc,{});case"plug":return t.jsx(vc,{});case"approach":return t.jsx(yc,{});case"recharge":return t.jsx(jc,{});case"cover":return t.jsx(Ec,{});case"dossier":return t.jsx(Nc,{});case"crit":return t.jsx(Sc,{});case"tuto":return t.jsx(Cc,{});case"rdv":return t.jsx(sc,{});case"memoalert":return t.jsx(gc,{});default:return null}}function sc(){const{dispatch:e,fund:a,t:r}=W(),n=a||r.rdvCoFallback;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:bo,children:qn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],s)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(s+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(xs,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function lc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:s,evalBusy:l,caps:d,memoQueued:x,doAnalyse:c}=W(),g=i==="client",u=e.chain.queue.map(w=>r.get(w)).filter(w=>!!w),b=e.chain.idx,f=u[b],v=b>=u.length;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!f?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:f.name}),t.jsx("div",{className:"sub",children:[$t(f.cc,o)||f.countryLabel,f.sector,f.stage,n.daysAgo(ht(f.date))].filter(Boolean).map(w=>String(w).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Qe(f.engine,o).toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{children:Ut(f.amountEur,o)})]}),Me(f)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(yt,{o:f,lg:!0})," ",t.jsx(Ia,{o:f,src:!0})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),f.reasoning&&!(g&&Ie(f))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),g&&Ie(f)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Ct(f)==="retenu"?"var(--brand)":Ct(f)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ct(f)==="retenu"?"✓ "+n.kept:Ct(f)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:f.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&f&&d.pipe&&Ne(f)===1&&!x.has(f.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(f),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&f&&!(g&&Ie(f))&&(f.noCo&&f.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var w;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"modal",modal:null}),(w=document.querySelector(".atl2 .demand"))==null||w.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{s(f)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function dc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=W(),i=o==="client",s=p.useMemo(()=>i?r.filter(g=>Ie(g)):[],[r,i]),l=p.useMemo(()=>zn(s.filter(g=>Ct(g)==="retenu"),{key:"signal",dir:-1}),[s]),d=p.useMemo(()=>s.filter(g=>Ct(g)==="ecarte"),[s]),x=e.spaceTab==="retenu"?l:d,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ve,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(g=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof g.score=="number"&&g.score>0?g.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:g.name}),t.jsx("div",{className:"rr",children:g.reasoning||g.tagline||""})]})]},g.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function cc(){const{mode:e}=W();return e==="client"||e==="apercu"?t.jsx(pc,{}):t.jsx(fc,{})}function pc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=W(),[i,s]=p.useState("d"),l=o!=="client";return t.jsxs(Ve,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(uc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(mc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(Ko,{})]})}function uc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=p.useState(null),[l,d]=p.useState(!1),[x,c]=p.useState(0);p.useEffect(()=>{let R=!0;return d(!1),tr(a).then(T=>{R&&(T?s(T):d(!0))}),()=>{R=!1}},[a,x]);const g=p.useRef({}),[u,b]=p.useState({}),[f,v]=p.useState(!1),[w,m]=p.useState(!1),y=p.useRef(null);p.useEffect(()=>()=>{y.current&&window.clearTimeout(y.current)},[]);const j=R=>{const T=g.current;Object.keys(T).length&&(v(!0),tr(a,T).then(D=>{if(!D){v(!1),o(e.actErr);return}if(D.throttled&&R<3){y.current=window.setTimeout(()=>j(R+1),5400);return}if(g.current={},b({}),s(D),v(!1),D.throttled){o(e.alertThrottled);return}m(!0),window.setTimeout(()=>m(!1),2e3),n(e.alertSaved)}))},k=R=>{r||(g.current={...g.current,...R},b(T=>({...T,...R})),y.current&&window.clearTimeout(y.current),y.current=window.setTimeout(()=>j(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(R=>R+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...u},A=R=>!N.sections||N.sections.includes(R),S=R=>{const T=N.sections||e.alertSec.map(([D])=>D);k({sections:A(R)?T.filter(D=>D!==R):[...T,R]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,f&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!f&&w&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([R,T])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:A(R),disabled:r,onChange:()=>S(R)}),t.jsxs("span",{children:[T,R==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},R))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Dn,{label:e.alertPreview,readOnly:r,onPreview:()=>ns(a),onTest:()=>as(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function mc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=p.useState(null),[l,d]=p.useState(!1),[x,c]=p.useState(0);p.useEffect(()=>{let f=!0;return d(!1),ar(a).then(v=>{f&&(v?s(v):d(!0))}),()=>{f=!1}},[a,x]);const g=f=>{r||ar(a,f).then(v=>{if(!v){o(e.actErr);return}s(v),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:f=>g({dow:Number(f.target.value)}),children:e.alertDow.map((f,v)=>t.jsx("option",{value:v,children:f},f))}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Dn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>os(a),onTest:()=>rs(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ko(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=W(),[s,l]=p.useState(i||""),[d,x]=p.useState(!1),[c,g]=p.useState(!1);p.useEffect(()=>{i&&l(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(m=>Me(m)).length,[n]),f=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(s)||c)){g(!0);try{await fetch(`${Da}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{g(!1)}}},w=[[a.amRows.continent,o],[a.amRows.since,a.amSince[f]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(m=>Qe(m,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(m=>$t(m,r)||m).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:w.map(([m,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:m}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},m))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!i,onChange:m=>l(m.target.value),onKeyDown:m=>{m.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function fc(){const{t:e}=W();return t.jsx(Ve,{title:e.alertTitle,icon:"🔔",children:t.jsx(Ko,{})})}function hc(){var F,$;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:s,caps:l,dispatch:d,liveMemos:x}=W(),[c,g]=p.useState(()=>$a(r)),[u,b]=p.useState(()=>!$a(r)),[f,v]=p.useState([]),[w,m]=p.useState(0),y=n==="client",j=p.useMemo(()=>{const M=new Map;return o.forEach(I=>{const h=(I.name||"").trim().toLowerCase();h&&!M.has(h)&&M.set(h,I)}),M},[o]);p.useEffect(()=>{let M=!0;return(!$a(r)||w>0)&&b(!0),(async()=>{const[I,h]=await Promise.all([En(r,w>0),ro(a)]);M&&(I&&g(I),b(!1),v(h))})(),()=>{M=!1}},[a,r,w]);const k=u&&!c,N=(c==null?void 0:c.per_day)??0,A=((F=c==null?void 0:c.analyzed_today)==null?void 0:F.length)??0,S=c==null?void 0:c.offre,R=(c==null?void 0:c.pool_meta)||[],T=p.useMemo(()=>{const M=new Map;for(const I of(c==null?void 0:c.scheduled)||[])for(const h of I.names||[])M.has(h)||M.set(h,{label:I.day_label,date:I.date});return M},[c==null?void 0:c.scheduled]),D=(c==null?void 0:c.in_progress)||[];return t.jsxs(Ve,{title:e.queueTitle,wide:!0,children:[S&&t.jsxs("div",{className:"qoffre"+(S.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:S.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:S.delai})]}),t.jsx("span",{className:"osp"}),S.rythme>0?t.jsx("span",{className:"or",children:e.qRate(S.rythme)}):S.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(S.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(A,A+((($=c==null?void 0:c.pool_order)==null?void 0:$.length)??0))}})}),S&&t.jsxs("div",{className:"qeta",children:[S.file===0?e.qEtaDone:S.rythme<=0?e.qEtaPaused:e.qEta(S.file,S.rythme,S.jours_restants),S.en_retard&&t.jsxs("em",{children:[" ",e.qLate(S.delai,S.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(S==null?void 0:S.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(D.length>0||x.items.some(M=>M.status==="boot"||M.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[x.items.filter(M=>M.status==="boot"||M.status==="running"||M.status==="error").map(M=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:M.name}),t.jsx("span",{className:"qd",children:M.memoType||""}),t.jsx(Na,{item:M,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+M.name)),D.filter(M=>!x.liveOf(M.name)).map(M=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:M.name}),t.jsxs("span",{className:"qd",children:[M.memo_type||"",M.age_min?` · ${Math.round(M.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:M.state||""})]},"ip-"+M.name))]})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:f.map(M=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:M.company}),t.jsxs("span",{className:"qd",children:[M.memo_type,typeof M.est_min=="number"?` · ~${M.est_min} min`:""]}),t.jsx("span",{className:"qt",children:M.status}),M.url&&t.jsx("a",{className:"qgo",href:M.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(M.memo_type)}),y&&M.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Zn(a,M.company,"retry").then(()=>m(I=>I+1))},children:e.queueRetry}),y&&M.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Zn(a,M.company,"delete").then(()=>m(I=>I+1))},children:e.queueDelete})]},M.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(R.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&R.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),R.map((M,I)=>{const h=T.get(M.name),q=j.get((M.name||"").trim().toLowerCase()),U=x.liveOf(M.name),X=!!(q&&s.has(q.id))||!!(U&&(U.status==="boot"||U.status==="running")),E=!!(q&&Ne(q)===1&&!q.memoUrl)&&!U;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",I+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:M.name}),M.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof M.score=="number"&&t.jsx("span",{className:"qs2",children:M.score}),U&&(U.status==="boot"||U.status==="running")&&t.jsx(Na,{item:U,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),E&&(l.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>d({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:X,onClick:()=>{i(q),m(C=>C+1)},children:X?e.actAnalyseQueued:e.actAnalyse})),M.excerpt&&t.jsx("span",{className:"qex",children:M.excerpt})]},M.name+":"+I)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([M,I])=>t.jsxs("li",{children:[t.jsx("b",{children:M})," — ",I]},M))})]})}function xc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:s}=W(),l=`${zt}/cibles/list.csv?token=${a}`,d=`${zt}/cibles/list.json?token=${a}`,x=`${zt}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${l}")`,g=w=>{var m;(m=navigator.clipboard)==null||m.writeText(w).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:c},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:x,href:x}],b=!o.lockActions&&n.length>0,f=()=>{tc(ec(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:w=>(e.stg.find(([m])=>m===w)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ve,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:f,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:w,value:m,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:w[0]}),t.jsxs("div",{children:[t.jsx("b",{children:w[1]}),t.jsx("p",{children:w[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>g(m),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},w[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function gc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=W(),i=o!=="client",[s,l]=p.useState(null),[d,x]=p.useState(!1),[c,g]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let m=!0;return x(!1),Jn(a).then(y=>{m&&(y?l(y):x(!0))}),()=>{m=!1}},[a,c]);const f=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=m=>{if(i||!s)return;const y={enabled:m.enabled??!!s.enabled,email:m.email??(s.email||""),sections:m.sections??f()};b(!0),Jn(a,y).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}l(j),r(e.memoAlertSaved)})};if(d)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>g(m=>m+1),children:e.retry})]})});if(!s)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const w=f();return t.jsxs(Ve,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:i||u,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(bc,{value:s.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:m=>v({email:m})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([m,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!w[m],disabled:i||u,onChange:()=>v({sections:{...w,[m]:!w[m]}})}),t.jsx("span",{children:y})]},m))}),t.jsx(Dn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Yi(a,w),onTest:()=>Gi(a,w)})]})}function bc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,s]=p.useState(e);p.useEffect(()=>{s(e)},[e]);const l=i.trim()!==e.trim(),d=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:x=>s(x.target.value),onKeyDown:x=>{x.key==="Enter"&&l&&d&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!d,onClick:()=>o(i.trim()),children:n})]})]})}function vc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=W(),[i,s]=p.useState(null),[l,d]=p.useState(!1),[x,c]=p.useState(null),[g,u]=p.useState(!1),[b,f]=p.useState(""),[v,w]=p.useState(0),[m,y]=p.useState("webhook"),[j,k]=p.useState(""),N=p.useRef(!1);p.useEffect(()=>{let F=!0;return d(!1),Xn(a).then($=>{F&&($?s({configured:$.configured,url_hint:$.url_hint}):d(!0))}),Xi(a).then($=>{if(F){if(!$){u(!0);return}u(!1),c($),N.current||(N.current=!0,$.destination==="instantly"&&y(M=>M==="webhook"?"instantly":M),$.campaign_id&&k(M=>M||$.campaign_id||""))}}),()=>{F=!1}},[a,v]);const A=(F,$)=>{o&&Xn(a,F).then(M=>{if(!M||M.ok===!1){n(e.actErr);return}F.test&&M.sent===!1?n(e.plugTestThrottled):r($),w(I=>I+1)})},S='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',R=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),T=`curl -X POST ${zt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,D=`curl -X POST ${zt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`;return t.jsxs(Ve,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>w(F=>F+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:F=>f(F.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>A({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>A({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>A({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:R}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(R).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(kc,{destKind:m,setDestKind:y,camp:j,setCamp:k,whHint:i!=null&&i.configured?i.url_hint||"webhook":null}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugVarsT}),t.jsx("p",{className:"mnote",children:e.plugVars})]}),t.jsx(wc,{auto:x,autoKo:g,destKind:m,camp:j,onRetry:()=>w(F=>F+1),onDone:F=>{c(F),u(!1)}}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:T}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(T).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:S}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(S).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:D}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(D).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function yc(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:s,lang:l}=W(),d=p.useMemo(()=>r.find(h=>h.id===n.approachId)||null,[r,n.approachId]),[x,c]=p.useState("email"),[g,u]=p.useState(0),[b,f]=p.useState({}),[v,w]=p.useState(!1),[m,y]=p.useState(""),[j,k]=p.useState({});if(p.useEffect(()=>{!d||b[x]||v||(w(!0),y(""),Ji(a,d.name,x).then(h=>{if(w(!1),!h||h.ok===!1){y((h==null?void 0:h.error)||e.apprFail);return}f(q=>({...q,[x]:h}))}))},[d,x,a]),!d)return null;const N=b[x],A=(N==null?void 0:N.sequence)||[],S=A[g],R=h=>`${x}|${g}|${h}`,T=h=>{const q=R(h);return q in j?j[q]:String(((S==null?void 0:S[h])??"")||"")},D=(h,q)=>k(U=>({...U,[R(h)]:q})),F=R("subject")in j||R("body")in j||R("message")in j,$=T(x==="email"?"body":"message"),M=T("subject"),I=x==="email"&&M?`${M}

${$}`:$;return t.jsxs(Ve,{title:e.apprT(d.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(h=>t.jsx("button",{type:"button",className:"apch"+(x===h?" on":""),"aria-pressed":x===h,onClick:()=>{c(h),u(0)},children:h==="email"?e.apprChEmail:e.apprChLi},h)),t.jsx("span",{className:"sp"}),A.map((h,q)=>t.jsxs("button",{type:"button",className:"apday"+(g===q?" on":""),"aria-pressed":g===q,onClick:()=>u(q),children:[h.day||`J${q}`,[`${x}|${q}|subject`,`${x}|${q}|body`,`${x}|${q}|message`].some(U=>U in j)&&t.jsx("i",{children:"✎"})]},h.day||q))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,N!=null&&N.sender?" · "+e.apprSender(N.sender):""]}),v&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!m&&!v&&t.jsxs("p",{className:"mnote warn",children:[m," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{f(h=>{const q={...h};return delete q[x],q}),y("")},children:e.retry})]}),!v&&!m&&!S&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),S&&t.jsxs(t.Fragment,{children:[x==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:M,onChange:h=>D("subject",h.target.value)})]}),x==="linkedin"&&g===0&&(N==null?void 0:N.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:$,onChange:h=>D(x==="email"?"body":"message",h.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var h;(h=navigator.clipboard)==null||h.writeText(I).then(()=>i(e.exportCopied)).catch(()=>s(e.actErr))},children:e.apprCopy}),x==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(d.contactEmail||"")}?subject=${encodeURIComponent(M)}&body=${encodeURIComponent($)}`,children:e.apprMailto}),F&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function wc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:s,token:l,flash:d,flashErr:x,canWrite:c}=W(),[g,u]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:s.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[s.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:s.retry})]})]}):null;const b=!!e.enabled,f=!b&&(r==="webhook"?e.webhook_ready===!1?s.plugAutoNeed:"":n.trim()?"":s.plugCampNeed),v=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,w=()=>{if(g||!c||f)return;u(!0),(b?er(l,!1):er(l,!0,r,n.trim()||void 0)).then(y=>{if(u(!1),!y){x(s.actErr);return}o(y),d(y.enabled?s.plugAutoSavedOn:s.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:s.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:s.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:g||!c||!!f,title:f||void 0,onClick:w,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:s.plugAutoOnLbl})]}),f===s.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:f}),v&&t.jsx("p",{className:"mnote warn",children:s.plugAutoBroken})]})}function kc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:s,lang:l,canWrite:d}=W(),[x,c]=p.useState("valides"),[g,u]=p.useState(!1),[b,f]=p.useState(null),[v,w]=p.useState(null),[m,y]=p.useState(!1),[j,k]=p.useState(!1),[N,A]=p.useState(null),[S,R]=p.useState(null),T=`atl2:bulk:${s}:${x}:${e}`;p.useEffect(()=>{f(null),w(null),y(!1),A(null);try{const C=localStorage.getItem(T)||localStorage.getItem(`atl2:bulk:${s}:${x}`),O=JSON.parse(C||"null");R(O&&Date.now()-Date.parse(O.t)<24*3600*1e3?O:null)}catch{R(null)}},[T,x,s]);const D=e==="instantly"&&!r.trim(),F=`${x}|${e}|${r.trim()}`,$=async()=>{if(D||!d)return;u(!0),y(!1),A(null);const C=await es(s,x,e,r.trim()||void 0);f(C),w(C.ok?F:null),u(!1)},M=p.useRef(!1);if(!d)return null;const I=async()=>{if(M.current||!d)return;M.current=!0,k(!0);const C=`${s}:${x}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let O;try{O=await ts(s,x,e,r.trim()||void 0,C)}finally{M.current=!1}if(k(!1),y(!1),A(O),O.ok&&(O.pushed||0)>0){const B={t:new Date().toISOString(),n:O.pushed||0};R(B);try{localStorage.setItem(T,JSON.stringify(B))}catch{}}};m&&v!==null&&v!==F&&y(!1);const h=o,q=b!=null&&b.ok&&b.ready||0,U=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":h||"",X=!!(b!=null&&b.ok)&&v===F&&q>0&&!!U&&!S,E=S?new Date(S.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:x,onChange:C=>c(C.target.value),children:i.plugBulkTabs.map(([C,O])=>t.jsx("option",{value:C,children:O},C))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:C=>a(C.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:C=>n(C.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:g||D,onClick:()=>{$()},children:g?"…":i.plugBulkPreview})]}),D&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),S&&t.jsx("p",{className:"mnote",children:i.bulkLocked(E,S.n)}),!S&&!!(b!=null&&b.ok)&&!U&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!S&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),X&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>y(!0),children:i.bulkArm}),X&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(q,U)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:j,onClick:()=>{I()},children:j?i.bulkSending:i.bulkConfirm(U)}),t.jsx("button",{type:"button",className:"abtn",disabled:j,onClick:()=>y(!1),children:i.bulkCancel})]}),N&&(N.ok?N.replayed?t.jsx("p",{className:"mnote",children:N.pending?i.bulkPending:i.bulkReplayed}):(N.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(N.pushed||0,N.linkedinReady||0,N.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:N.error||i.actErr}))]})}function jc(){const{t:e,data:a,lang:r}=W(),n=a.credits,o=a.email,i=async s=>{if(!o)return;const l=window.location.href.split("?")[0];try{const x=await(await fetch(`${Da}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:s,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(Ve,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Nc(){const{t:e}=W();return t.jsx(Ve,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(rc,{})})}function Ec(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:s,flash:l}=W(),[d,x]=p.useState(null),[c,g]=p.useState(!1);p.useEffect(()=>{let T=!0;if(i)return En(i).then(D=>{T&&D&&typeof D.per_day=="number"&&x(D.per_day)}),()=>{T=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let T=!0;return Ki(o).then(D=>{T&&b(D)}),()=>{T=!1}},[o]);const f=r.stats,v=typeof(f==null?void 0:f.screened)=="number"?f.screened:n.filter(T=>T.kind==="target"&&Ie(T)).length,w=r.marketEstimate||0,m=w>0?Math.min(100,Math.round(v/w*100)):null,y=(f==null?void 0:f.window_days)||30,j=v>0?v/y:0,k=w>0?Math.max(0,w-v):0,A=w>0&&j>0&&v>=100?Math.round(k/j):null,S=T=>Math.round(T).toLocaleString(a==="en"?"en-US":"fr-FR"),R=T=>{c||!s||(g(!0),Zi(o,T).then(D=>{if(g(!1),D===null){l(e.actErr);return}x(D),l(e.alertSaved)}))};return t.jsxs(Ve,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(S(v))}),w>0&&t.jsx("span",{children:e.covOf(S(w))})]}),m!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:m+"%"}}),t.jsxs("em",{children:[m," %"]})]}),A!==null&&t.jsx("p",{className:"mnote",children:e.covEta(A)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(S(j))}),f&&t.jsxs("div",{className:"covf",children:[typeof f.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(f.kept)})," ",e.covKept]}),typeof f.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(f.analyzed)})," ",e.covAna]}),typeof f.shown=="number"&&f.shown!==f.kept&&t.jsxs("span",{children:[t.jsx("b",{children:S(f.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((T,D)=>t.jsxs("tr",{className:T.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[T.code,T.geo?` · ${T.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof T.n=="number"?S(T.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:T.source}),T.elargi&&t.jsx("em",{children:e.covWide(String(T.demande||""))}),T.erreur&&t.jsx("em",{children:e.covMissing})]})]},D)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:S(u.total||w)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),s&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(T=>t.jsx("button",{type:"button",className:d===T?"on":"",disabled:c,onClick:()=>R(T),children:T===0?"⏸":T},T))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Sc(){var m,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:s,lang:l}=W(),d=n==="client",x=p.useMemo(()=>{const k=new Set;return a.forEach(N=>{N.angle&&k.add(N.angle)}),[...k]},[a]),[c,g]=p.useState(""),[u,b]=p.useState(""),[f,v]=p.useState(!1),w=async()=>{const k=c.trim();if(!(!k||f||!d)){v(!0),b("");try{const A=await(await fetch(`${zt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&b(String(A.reply)),A.job_id){b(e.critChatRunning);const S=async()=>{const R=await fetch(`${zt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(T=>T.json()).catch(()=>null);if(R&&R.done){b(String(R.reply||R.clarification||R.summary||"✓")),v(!1),R.applied&&o(e.alertSaved);return}setTimeout(()=>{S()},8e3)};setTimeout(()=>{S()},8e3),g("");return}g("")}finally{u.startsWith("⏳")||v(!1)}}};return t.jsxs(Ve,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((m=i.points)!=null&&m.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var N,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((N=k.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(S=>t.jsx("li",{children:S},S))})]}),!!((A=k.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(S=>t.jsx("li",{children:S},S))})]})]})]},k.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:x.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!d||f,onChange:k=>g(k.target.value),onKeyDown:k=>{k.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!d||f||!c.trim(),onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Qi,{fund:s,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Go[k]||"v-cons"),children:k}),t.jsx("span",{children:N})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",N]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Cc(){const{t:e,dispatch:a,startTour:r}=W(),n=o=>{var i,s;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs(Ve,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+s))})]})}const Jo="atl2:mapfold",zc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Jo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Ac=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Xo=p.createContext(null),W=()=>{const e=p.useContext(Xo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function yt({o:e,lg:a}){const{lang:r}=W(),n=Me(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:nr(n,r),children:[n.emoji," ",nr(n,r)]}):null}function Ia({o:e,src:a}){const{lang:r,t:n}=W(),o=Me(e);if(!o)return null;const i=ps(o),s=us(o);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(po(o,r))+" · "+n.win7(uo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,d)=>t.jsx("i",{className:d<i?"on":""},d))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function qc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(s=>(s.url||"")===n);if(i)return i}const o=_e(a);if(o)return e.find(i=>_e(i.name)===o)||e.find(i=>{const s=_e(i.name);return s.length>=3&&(o.includes(s)||s.includes(o))})}function Tc(){const{scoped:e,t:a,st:r,dispatch:n}=W(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,s=e.filter(g=>!Ge(g)),l=s.length,d=s.filter(g=>!g.noCo).length,x=s.filter(g=>!!g.noCo).length,c=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:c?"7":"all"}});else{const g=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:g,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",d," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",x," ",a.zoomPulseExplore]})]})]})}function Lc(){const{t:e,lang:a,data:r,dispatch:n}=W(),o=r.stats,i=l=>l.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const s=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:s>0?e.covOf(i(s)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function Zo({o:e}){const{lang:a}=W(),r=cs(e.cc),n=e.cc?$t(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Jr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Rc=!1;function Fc(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const ei=e=>`atl2:tour:${e||"anon"}`;function Mc(e){try{return localStorage.getItem(ei(e))==="1"}catch{return!0}}function Xr(e){try{localStorage.setItem(ei(e),"1")}catch{}}function Oc(e,a,r,n,o,i){const s=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function _c({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var In;const{lang:s}=is(),l=As[s],d=_s(e,s,a),[x,c]=p.useReducer(Hs,void 0,()=>$s((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Ac():zc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),g=p.useRef(!0);p.useEffect(()=>{if(g.current){g.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Jo,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const z=()=>{window.innerWidth<=760&&c({type:"mapFold",folded:!0})};return z(),window.addEventListener("resize",z),()=>window.removeEventListener("resize",z)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var z;(z=u.current)==null||z.call(u,x.filters)},[x.filters]);const[b,f]=p.useState(()=>{if(typeof window>"u")return"both";try{const z=localStorage.getItem("atl2:chrome-mode");if(z==="eval"||z==="filt"||z==="both")return z;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,w]=p.useState(null),[m,y]=p.useState(null),[j,k]=p.useState(null),[N,A]=p.useState({kept:0,dropped:0}),[S,R]=p.useState(!1),[T,D]=p.useState(""),[F,$]=p.useState(!1),[M,I]=p.useState(null),[h,q]=p.useState(!1),[U,X]=p.useState(!1),[,E]=p.useState(0),C=()=>E(z=>z+1),O=p.useRef([]),B=p.useRef(new Set),_=p.useRef(new Set),[G,ue]=p.useState([]),[K,ce]=p.useState([]),[le,be]=p.useState(0),fe=p.useRef(new Map),de=p.useRef(null),{mode:pe}=d,ge=p.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[d.caps,o,a]),Q=ge.pipe,re=d.session.token||"",he=pe==="client"&&!e;p.useEffect(()=>{if(!re||!Q)return;let z=!0;const J=async()=>{const se=await ms(re);!z||!se||(ce(se.runs),be(Date.now()/1e3-se.now),ue(He=>He.filter(Ee=>!se.runs.some(Be=>_e(Be.company)===_e(Ee.name)))))};J();const V=G.length>0||K.some(se=>se.status==="running"),te=window.setInterval(()=>{J()},V?8e3:25e3);return()=>{z=!1,window.clearInterval(te)}},[re,Q,G.length,K.some(z=>z.status==="running")]);const ke=p.useMemo(()=>{const z=[],J=new Set;for(const V of G){const te=_e(V.name);!te||J.has(te)||(J.add(te),z.push({name:V.name,id:V.id,status:"boot",started:V.started,estMin:V.estMin,memoType:"instant"}))}for(const V of K){const te=_e(V.company);if(!te||J.has(te))continue;J.add(te);const se=V.status==="error"?"error":V.status==="done"?"done":"running";z.push({name:V.company,status:se,started:V.started||0,estMin:V.est_min||(V.memo_type==="detailed"?40:15),url:V.url,error:V.error,memoType:V.memo_type,note:V.note})}return z},[G,K]),ne=z=>ke.find(J=>_e(J.name)===_e(z))||null,ve=(z,J)=>{ue(V=>V.some(te=>_e(te.name)===_e(z.name))?V:[...V,{name:z.name,id:z.id,started:Date.now()/1e3,estMin:J==="detailed"?40:15}]),B.current.add(z.id),C()};p.useEffect(()=>{if(document.querySelector(`link[href="${Jr}"]`))return;const z=document.createElement("link");z.rel="stylesheet",z.href=Jr,document.head.appendChild(z)},[]);const oe=(z,J=!1)=>{D(z),$(J),de.current&&clearTimeout(de.current),de.current=setTimeout(()=>D(""),J?4200:2400)},ze=z=>oe(z,!0),Ke=p.useMemo(()=>{const z=new Map;return d.dossiers.forEach(J=>{J.id&&z.set(J.id,J)}),z},[d.dossiers]),xe=p.useMemo(()=>d.dossiers.filter(z=>ea(z,x,Q)),[d.dossiers,x,Q]),Se=p.useRef(!1);p.useEffect(()=>{if(Se.current||e||d.loading||!d.dossiers.length)return;if(!ge.showFunnel||Mc(d.session.token||"")){Se.current=!0;return}Se.current=!0;const z=window.setTimeout(()=>{Xr(d.session.token||""),q(!0)},700);return()=>window.clearTimeout(z)},[e,d.loading,d.dossiers.length,ge.showFunnel,d.session.token]);const Rt=p.useMemo(()=>d.dossiers.filter(z=>Vs(z,x,Q,d.favIds)),[d.dossiers,x,Q,d.favIds]),Pe=p.useMemo(()=>ss(xe.filter(z=>!We(z)),d.favIds),[xe,d.favIds]),Je=p.useRef(!1);p.useEffect(()=>{if(Je.current)return;if(!Q||a==="ops"){Je.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Je.current=!0;return}if(d.loading)return;Je.current=!0;const z=ls(Pe);z!==x.ptab&&c({type:"ptab",tab:z})},[Q,a,n==null?void 0:n.ptab,d.loading,Pe,x.ptab]);const qe=p.useMemo(()=>{const z=yo(d.dossiers);return z?ht(z)===0?l.tourToday:wo(z,s):l.tourNoRun},[d.dossiers,l,s]),it=p.useMemo(()=>d.dossiers.some(z=>!!z.memoUrl||!!z.summary||Dt(z)),[d.dossiers]),[kt,Oe]=p.useState(!1);p.useEffect(()=>{if(d.loading){Oe(!1);return}if(d.dossiers.length>0||d.error){Oe(!0);return}const z=window.setTimeout(()=>Oe(!0),6e3);return()=>window.clearTimeout(z)},[d.loading,d.dossiers.length,d.error]);const xt=(d.marketEstimate||0)>0||typeof((In=d.stats)==null?void 0:In.screened)=="number"&&d.stats.screened>0,ut=p.useMemo(()=>[1,0,2,4,5,3].find(z=>(Pe[z]||0)>0)??0,[Pe]),Xe=Sn.find(z=>z.key===x.continent),jt=x.continent==="monde"?l.contWorld:(s==="fr"?Xe==null?void 0:Xe.fr:Xe==null?void 0:Xe.en)||"";p.useEffect(()=>{const z=J=>{var te;const V=(((te=J.detail)==null?void 0:te.name)||"").trim();V&&gt(null,V)};return window.addEventListener("ppmap:evaluate",z),()=>window.removeEventListener("ppmap:evaluate",z)}),p.useEffect(()=>{const z=J=>{const V=J.detail||{},te=String(V.id||"").trim(),se=String(V.name||"").trim(),He=String(V.url||"").trim(),Ee=te&&Ke.get(te)||qc(d.dossiers,se,He);if(Ee){if(y(null),ea(Ee,x,Q)||(x.continent!=="monde"&&Ee.continent!==x.continent&&c({type:"continent",key:Ee.continent||"monde"}),c({type:"reset"})),Q&&Ee.kind!=="op"){const st=Ne(Ee);typeof st=="number"&&st!==x.ptab&&c({type:"ptab",tab:st})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),c({type:"focus",id:Ee.id}),(Ee.noCo||["media","nominations","recrutements"].includes(Ee.engine||""))&&(Ee.url||Ee.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee.url||"",text:[Ee.headline,Ee.tagline].filter(Boolean).join(`
`)}})):Ee.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ee.name,url:Ee.url||"",website:Ee.website||"",domain:Ee.domain||""}}));return}!se&&!He||(c({type:"focus",id:te||null}),y({name:se,headline:String(V.text||"").trim()||se,url:He,card:V.card}),He&&(Ea(se)||!se)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:He,text:String(V.text||"").trim()}})):se&&!Ea(se)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:se}})))};return window.addEventListener("ppmap:focus",z),()=>window.removeEventListener("ppmap:focus",z)}),p.useEffect(()=>{const z=te=>{const se={},He=String((te==null?void 0:te.sector)||"").trim();He&&(se.sector=[He]);const Ee=String((te==null?void 0:te.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ee)&&(se.day=Ee);const Be=String((te==null?void 0:te.search)||"").trim();Be&&(se.search=Be);const st=String((te==null?void 0:te.dealKind)||"").trim();(st==="ma"||st==="levee"||st==="other")&&(se.dealKind=[st]),Object.keys(se).length&&c({type:"filters",patch:se})},J=te=>z(te.detail),V=te=>{te.data&&te.data.type==="pp-filter"&&z(te.data)};return window.addEventListener("ppmap:filter",J),window.addEventListener("message",V),()=>{window.removeEventListener("ppmap:filter",J),window.removeEventListener("message",V)}},[]),p.useEffect(()=>{const z=J=>{var se;const V=(((se=J.detail)==null?void 0:se.name)||"").trim().toLowerCase();if(!V)return;const te=d.dossiers.find(He=>(He.name||"").trim().toLowerCase()===V);te&&c(a==="ops"?{type:"focus",id:te.id}:{type:"popup",id:te.id})};return window.addEventListener("ppmap:similar",z),()=>window.removeEventListener("ppmap:similar",z)});const gt=(z,J,V)=>{const te=(V||(z==null?void 0:z.name)||J||"").trim();if(!he){k({kicker:te});return}!te||S||(R(!0),(async()=>{try{let se=(J||te).trim();const He=((z==null?void 0:z.website)||(z==null?void 0:z.domain)||"").trim();if(!(/^https?:\/\//i.test(se)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(se)&&!/\s/.test(se)))if(He)se=He;else try{const Fe=await Cn(te);if(Fe!=null&&Fe.website)se=Fe.website;else if(((Fe==null?void 0:Fe.candidates)||[]).length===1)se=Fe.candidates[0].url;else if(((Fe==null?void 0:Fe.candidates)||[]).length>1){O.current=[{name:te,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(Fe.candidates||[]).slice(0,5)},...O.current].slice(0,8),C();return}}catch{}const Be=await io(re,se,"atelier2"),st={name:Be.company||te,verdict:Be.verdict,reason:Be.reason||"",remaining:Be.remaining??null};O.current=[st,...O.current].slice(0,8),Be.verdict==="kept"&&A(Fe=>({...Fe,kept:Fe.kept+1})),Be.verdict==="ruled_out"&&A(Fe=>({...Fe,dropped:Fe.dropped+1}));const Ht=z||d.dossiers.find(Fe=>(Fe.name||"").toLowerCase()===te.toLowerCase());Ht&&(Be.verdict==="kept"?Ht.verdict=Ht.verdict||"MATCH":Be.verdict==="ruled_out"&&(Ht.verdict="NO MATCH"),Be.reason&&(Ht.reasoning=Be.reason)),C()}finally{R(!1)}})())},bt=z=>{if(!he){k({kicker:z.name});return}ve(z,"instant"),Vt(re,"fast_request",z.name||"",""),oe(l.memoInstantSent(z.name))},Ft=z=>fe.current.get(z.id)??d.thumbs.get((z.name||"").trim().toLowerCase()),Nt=(z,J)=>c({type:"undoPush",entry:{id:z.id,name:z.name,prevCeoStatus:J}}),Re=async(z,J,V)=>{const te=z.ceoStatus||"";z.ceoStatus=J,C();const se=await Ua(re,{status:J,airtable_id:z.airtableId,check_id:z.checkId,company:z.name,...(V==null?void 0:V.note)!==void 0?{note:V.note}:{},...V!=null&&V.via?{via:V.via}:{}});return se.ok?se.skipped?(z.ceoStatus=te,C(),ze(l.actNotPersisted),!1):((V==null?void 0:V.undo)!==!1&&Nt(z,te),V!=null&&V.msg&&oe(V.msg),(J==="Validé"||J==="Écarté")&&!z.ceoNote&&(V==null?void 0:V.note)===void 0&&I({o:z,yes:J==="Validé"}),!0):(z.ceoStatus=te,C(),ze(l.actErr),!1)},nt=async(z,J)=>{const V=await Ua(re,{status:z.ceoStatus||"Retenu",airtable_id:z.airtableId,check_id:z.checkId,company:z.name,note:J,via:"note"});return!V.ok||V.skipped?(ze(V.skipped?l.actNotPersisted:l.actErr),!1):(z.ceoNote=J,C(),!0)},L=p.useRef(new Map),H=z=>L.current.has(z.id)?L.current.get(z.id):d.stages.get((z.name||"").trim().toLowerCase()),Y=(z,J)=>{L.current.set(z.id,J),C()},ae=(z,J)=>{he&&Re(z,J?"Validé":"Écarté",{msg:J?l.decidedYes(z.name):l.decidedNo(z.name)})},ye=z=>{he&&Re(z,"À trancher",{msg:l.promoted(z.name)})},P=z=>{he&&(async()=>{const J=z.ceoStatus||"";z.ceoStatus="Retenu",C();const V=await Ua(re,{status:"Retenu",check_id:z.checkId,company:z.name});if(!V.ok||V.skipped){z.ceoStatus=J,C(),ze(V.skipped?l.actNotPersisted:l.actErr);return}Nt(z,J),oe(l.repeched(z.name))})()},ee=()=>{const z=x.undo[x.undo.length-1];if(!z){oe(l.undoNone);return}const J=Ke.get(z.id);if(!J){c({type:"undoPop"}),oe(l.undoNone);return}let V=z.prevCeoStatus;if(!V)if((J.verdict||"").toUpperCase().includes("CALL"))V="À trancher";else{oe(l.undoLockedTitle);return}(async()=>await Re(J,V,{undo:!1})&&(c({type:"undoPop"}),J.ceoStatus=z.prevCeoStatus,C(),oe(l.undoDone(J.name))))()},ie=z=>{he&&(_.current.add(z.id),C(),c({type:"approachOpen",id:z.id}),Vt(re,"approach",z.name||"",""))},Z=(z,J)=>{he&&(async()=>{if(!(await Vt(re,J?"yes":"no",z.name||"","")).ok){ze(l.actErr);return}fe.current.set(z.id,J?"yes":"no"),C(),oe(J?l.thumbUpDone:l.thumbDnDone)})()},je=z=>{!he||!Dt(z)||(ve(z,"detailed"),Vt(re,"detailed_request",z.name||"",""),oe(l.memoDeepSent(z.name)))},De=z=>{const J=new Set(d.favIds),V=J.has(z.id);V?J.delete(z.id):J.add(z.id),d.setFavIds(J),he&&fs(re,{id:z.id,co:z.name},V)},$e=()=>{!he||U||window.confirm(l.identSyncConfirm)&&(X(!0),(async()=>{const z=await hs(re);X(!1),z?oe(l.identSyncDone):ze(l.actErr)})())},Ae=/proplace/i.test(d.fund||""),Ue=z=>{!he||!Ae||(Vt(re,"onboard_request",z.name||"",""),oe(l.onboardSent(z.name)))},Pa={st:x,dispatch:c,t:l,lang:s,mode:pe,caps:ge,pipe:Q,token:re,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:P,thumbOf:Ft,canWrite:he,commitStatus:Re,saveNote:nt,stageOf:H,setStage:Y,flashErr:ze,startTour:()=>q(!0),dossiers:d.dossiers,scopedAll:xe,scoped:Rt,counts:Pe,byId:Ke,contName:jt,favIds:d.favIds,toggleFav:De,askEvaluate:gt,doAnalyse:bt,doDecide:ae,doPromote:ye,doApproach:ie,doThumb:Z,doDeep:je,doUndo:ee,doSync:$e,doOnboard:Ue,outbound:Ae,memoQueued:B.current,liveMemos:{items:ke,serverOff:le,liveOf:ne},approachDone:_.current,sessTally:N,evalCards:O.current,evalBusy:S,markRow:w,markedId:v,flash:oe,focusExtra:m};p.useEffect(()=>{const z=J=>{J.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",z),()=>window.removeEventListener("keydown",z)},[]);const la=z=>re?t.jsx(Ys,{token:re,children:z}):t.jsx(t.Fragment,{children:z});return t.jsx(Xo.Provider,{value:Pa,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(re?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Rs}),la(t.jsxs("div",{className:"app"+(Q?" pipe":"")+(re?" has-thesis":""),children:[ge.showTicker&&t.jsx(rt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(re?" live-stack--cibles":""),children:[t.jsx(tl,{}),!!re&&t.jsx(Qs,{})]})}),ge.showIdent&&t.jsx(rt,{name:"identite",children:t.jsx(ml,{})}),!1,Rc,ge.showFunnel&&t.jsx(rt,{name:"entonnoir",children:t.jsx(Dc,{})}),!x.mapFolded&&t.jsx(rt,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(_o,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Tc,{}),a!=="ops"&&ge.showFunnel&&t.jsx(Lc,{}),t.jsx(pd,{}),t.jsx(Bo,{})]})]})}),ge.showDemand&&Q&&t.jsx(rt,{name:"direct",children:t.jsx(ys,{items:ke,serverOff:le,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([z,J])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===z,onClick:()=>{f(z);try{localStorage.setItem("atl2:chrome-mode",z)}catch{}},children:J},z))}),ge.showDemand&&t.jsx(rt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(vd,{})})}),ge.showDemand&&x.memoConsole&&t.jsx(rt,{name:"console",children:t.jsx(wd,{})}),ge.pipe&&!!re&&t.jsx(rt,{name:"moteurs",children:t.jsx(Ss,{})}),t.jsx(rt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(Xd,{})}),d.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:l.retry})]})]})),x.popupId&&x.dens!=="liste"&&a!=="ops"&&t.jsx(rt,{name:"fiche",children:t.jsx(Md,{})}),t.jsx(rt,{name:"modales",children:t.jsx(ic,{})}),t.jsx(rl,{}),M&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:M.o.name}),t.jsx(dl,{placeholder:M.yes?l.whyYesPh:l.whyNoPh,onDone:z=>{const J=M.o;I(null),z&&nt(J,z).then(V=>{V&&oe(l.csNoteSaved)})}})]}),h&&kt&&t.jsx(pl,{steps:Oc(l,qe,it,ut,xt,Pe[3]||0),onClose:()=>{q(!1),Xr(re)}}),t.jsx(Fc,{}),ge.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:bo,children:qn}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),T&&t.jsx("div",{className:"flash on"+(F?" err":""),children:T}),j&&t.jsx(ds,{variant:"acquirer",initialCompany:Zr().co,initialWebsite:Zr().site,onClose:()=>k(null)})]})})}function Dc(){const{t:e}=W(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Zr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ic(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Zo as FlagCell,yt as SigBadge,Ia as SigWin,_c as default,Ic as fmtShort,W as useV2};
