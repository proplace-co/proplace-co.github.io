...
`,qi=zi+Ti;function ja(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Li(){const e=ja("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ri(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Li();return r==="0"?"client":r==="1"||ja("embed")==="1"&&ja("chrome")==="1"?"apercu":"client"}const Mi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Oi=e=>Mi[e];function ir(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const rt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!ga(a)||ir(a))&&(e.noCo=!0)}return Object.assign(e,{continent:ko(e.cc)})};function ca(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Fi=60*60*1e3;function Di(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Fi?null:a}catch{return null}}function Ot(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Pi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ii(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:uo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Ri(e,i),[e,i,n]),c=m.useMemo(()=>Oi(o),[o]),s=o!=="visiteur",d=Pi(r),[x,l]=m.useState([]),[f,u]=m.useState(""),[b,p]=m.useState(null),[g,v]=m.useState(null),[h,N]=m.useState(null),[E,y]=m.useState(()=>new Map),[z,L]=m.useState(()=>new Map),[q,S]=m.useState(""),[C,k]=m.useState(new Set),[M,T]=m.useState(null),[O,w]=m.useState(!0),[A,F]=m.useState(!1),[_,W]=m.useState(0),[H,U]=m.useState(0),Y=m.useRef(0),G=m.useMemo(()=>{var oe;if(o!=="client")return"";try{return((oe=mo())==null?void 0:oe.email)||""}catch{return""}},[o]);m.useEffect(()=>{const oe=++Y.current;let je=!0;const ye=()=>je&&oe===Y.current,he=(s&&i.token?i.token:"pub:"+a)+(d?":"+d:""),Z=Di(he);return Z?(l(Z.objs.map(rt)),Z.fund&&u(Z.fund),p(Z.marketEstimate??null),v(Z.criteria??null),N(Z.stats??null),S(Z.generatedAt||""),w(!1)):w(!0),(async()=>{try{if(r==="ops"){const le=await sa(),K=((le==null?void 0:le.recent_ops)||[]).map(B=>{const J=Vt(B.company_name||B.title?B:{...B,title:(B.headline_fr||B.headline||"").slice(0,120)},a),me=String(B.rubrique||"").toLowerCase();return J&&(me==="nominations"||me==="recrutements")&&(J.engine=me),J&&!String(B.company_name||"").trim()&&(J.noCo=!0),J}).filter(B=>!!B).map(B=>(ga((B.name||"").trim())||(B.noCo=!0),B));try{const B=fo(),J=B&&B.doc||await xo(),me=ho(J),te=((B==null?void 0:B.day)||(J==null?void 0:J.date)||"").slice(0,10);if(me.length&&te){const be=new Set;for(const Q of K){if(Q.noCo||(Q.date||"").slice(0,10)!==te)continue;const ce=an(me,be,Q.name,"");ce>=0&&(be.add(ce),Q.decryptHtml=me[ce].html)}for(const Q of K){if(Q.decryptHtml||(Q.date||"").slice(0,10)!==te)continue;const ce=an(me,be,"",Q.headline||Q.tagline||Q.name);ce>=0&&(be.add(ce),Q.decryptHtml=me[ce].html)}me.forEach((Q,ce)=>{if(be.has(ce))return;const ze=(Q.t||"").trim(),ge=ze.split(/[:–—]/)[0].trim().slice(0,80)||ze.slice(0,40);if(!ge)return;const fe=ze+" "+Q.html,Oe=/\b(acquiert|rachat|rachet|fusion|buyout|offre sur)\b/i.test(fe),pe=/\b(l[eè]ve|lev[ée]e|raises?|funding|s[eé]rie [a-z]|series [a-z])\b/i.test(fe);K.push({id:`edito:${te}:${ce}`,kind:"op",name:ge,cc:null,date:te,engine:Oe?"ma":pe?"fundraising":"media",dealKind:Oe?"ma":pe?"levee":"other",headline:ze,decryptHtml:Q.html,noCo:!ga(ge)||ir(ge)})})}}catch{}if(!ye())return;l(K.map(rt)),Ot(he,{objs:K})}else if(typeof r=="object"){const K=(await nn()||[]).filter(J=>(J.slug||"")===r.research).map(J=>rn(J,a)).filter(J=>!!J),B=ca(await on(K,a));if(!ye())return;l(B.map(rt)),Ot(he,{objs:B})}else if(s&&i.token){const le=go(i.token),K=sa(),B=bo(i.token),J=vo(i.token),me=yo(i.token),te=await le;let be=te?te.targets:[];ye()&&te&&(u(te.fund||""),p(te.marketEstimate??null),v(te.criteria??null),N(te.stats??null),S(te.generatedAt||""),l(be.map(rt)),w(!1),F(!1));const[Q,ce,ze,ge]=await Promise.all([K,B,J,me]),fe=((Q==null?void 0:Q.recent_ops)||[]).map(pe=>Vt(pe,a)).filter(pe=>!!pe);if(be=[...be,...fe],!ye())return;l(be.map(rt));const Oe=new Set;for(const pe of ce){const Fe=(pe.id||pe.co||"").toString().trim().toLowerCase();Fe&&Oe.add(Fe.startsWith("t:")?Fe:"t:"+Fe)}k(Oe),y(ze),L(ge),te&&Ot(he,{fund:te.fund,marketEstimate:te.marketEstimate,criteria:te.criteria,stats:te.stats,generatedAt:te.generatedAt,objs:be})}else{const le=wo(),K=nn(),B=sa(),J=await le;ye()&&J.length&&(l(ca(J).map(rt)),w(!1),F(!1));const[me,te]=await Promise.all([K,B]),be=(me||[]).map(ge=>rn(ge,a)).filter(ge=>!!ge),Q=await on(be,a),ce=((te==null?void 0:te.recent_ops)||[]).map(ge=>Vt(ge,a)).filter(ge=>!!ge),ze=ca([...J,...Q,...ce]);if(!ye())return;l(ze.map(rt)),Ot(he,{objs:ze})}ye()&&F(!1)}catch{ye()&&!Z&&F(!0)}finally{ye()&&w(!1)}})(),()=>{je=!1}},[s,i.token,a,_,d]),m.useEffect(()=>{if(!c.showCredits||!G){T(null);return}let oe=!0;return(async()=>{try{const je=await fetch(`${Ia}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:G})});if(!je.ok)return;const ye=await je.json();oe&&ye&&ye.ok!==!1&&T(ye)}catch{}})(),()=>{oe=!1}},[c.showCredits,G,H]);const ee=m.useCallback(oe=>k(new Set(oe)),[]);return{session:i,mode:o,caps:c,fund:f,email:G,marketEstimate:b,generatedAt:q,criteria:g,stats:h,thumbs:E,stages:z,dossiers:x,favIds:C,setFavIds:ee,credits:M,reloadCredits:()=>U(oe=>oe+1),loading:O,error:A,refresh:()=>W(oe=>oe+1)}}const sr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),$i=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...sr(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Bi=new Set(["signal","amount","score","crible","memo"]);function _i(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:sr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Bi.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??lr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const lr=40;function Va(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!Te(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes($a(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(tt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&it(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function cr(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Va(e,a.filters,r)}function Ui(e,a,r,n){return!(!cr(e,a,r)||r&&!jo(e,a.ptab,n))}function Ha(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-tt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return So(i);case"memo":return No(i);case"signal":{const o=Te(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const c=n(i),s=n(o);return c<s?-a.dir:c>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const da={},hn=(da==null?void 0:da.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function gn(){return new Date().toISOString().slice(0,10)}const Wa=m.createContext(null);function dr(){return m.useContext(Wa)}function Vi(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),c=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!c||c.length<2||c.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),s.querySelectorAll("*").forEach(d=>{const x=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(l=>d.removeAttribute(l.name)),x&&/^https?:\/\//i.test(x)&&(d.setAttribute("href",x),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:c.toLowerCase(),html:s.outerHTML})}}catch{}return a}function bn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",c=String(Number(r[3]));return a?`${o} ${c}, ${r[1]}`:`${c==="1"?"1ᵉʳ":c} ${o} ${r[1]}`}function pr(){const e=m.useContext(Wa);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Hi({token:e,children:a}){const{dispatch:r,st:n,lang:i}=I(),[o,c]=m.useState(()=>n.filters.day||gn()),[s,d]=m.useState(null),[x,l]=m.useState(!1),f=m.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){c(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{c(gn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);m.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),m.useEffect(()=>{const g=v=>{var N;const h=(N=v.detail)==null?void 0:N.day;typeof h=="string"&&f(h)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[f]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&c(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let g=!1;l(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${hn}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{g||d(h)}).catch(()=>{g||d({ok:!1,error:"network"})}).finally(()=>{g||l(!1)}),()=>{g=!0}},[e,o]);const b=m.useMemo(()=>`${hn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:s,loading:x,pickDay:f,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,s,x,f,u,n.filters.day,b,i]);return t.jsx(Wa.Provider,{value:p,children:a})}function Wi(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=pr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!c&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:bn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:bn(e)}),"."]})}),c&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,c&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const Gi=["ma","levees","nominations","recrutements","actualites"],Ki=300,pa=7,Qi={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},ur={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Ji=["hiring","raised","news","posting","building","community","registry","exodus","other"];function vn(e){const a=Te(e);if(a)return"sig:"+(a.theme&&ur.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Xi(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:c,fund:s}=I(),d=dr(),x=c==="en",[l,f]=m.useState("all"),[u,b]=m.useState(!1),p=m.useMemo(()=>{var H;const T=(a.filters.day||"").slice(0,10),O=U=>!(!o&&a.continent!=="monde"&&U.continent!==a.continent||T&&(U.date||"").slice(0,10)!==T),w=e.filter(U=>O(U)&&Te(U)&&(!o||U.kind!=="target"||Ae(U)!==5)),A=o&&(((H=d==null?void 0:d.ed)==null?void 0:H.ops)||[]).length?d.ed.ops.map(U=>Vt(U,c)).filter(U=>!!U).filter(U=>!T||(U.date||"").slice(0,10)===T):[],F=e.filter(U=>O(U)&&U.kind==="op"&&!Te(U)&&(T?!0:tt(U.date)<=pa)),_=o?A.length?A:F.filter(U=>{const Y=(s||"").trim().toLowerCase();if(!Y)return!1;const G=U.match||null;return G?Object.keys(G).map(ee=>ee.trim().toLowerCase()).includes(Y):!1}):F,W=T||new Date().toISOString().slice(0,10);return _.sort((U,Y)=>{const G=(U.date||"").slice(0,10)===W?0:1,ee=(Y.date||"").slice(0,10)===W?0:1;return G!==ee?G-ee:(Y.amountEur||0)-(U.amountEur||0)}),[...Ha(w,{key:"signal",dir:-1}),..._]},[e,a.continent,a.filters.day,o,s,c,d]),g=m.useMemo(()=>{const T={};for(const O of p){const w=vn(O);T[w]=(T[w]||0)+1}return T},[p]),v=m.useMemo(()=>l==="all"?p:p.filter(T=>vn(T)===l),[p,l]),h=m.useMemo(()=>v.slice(0,Ki),[v]),N=v.length-h.length,E=m.useRef(null);m.useEffect(()=>{var _,W;const T=E.current;if(!T)return;const O=()=>{const H=T.scrollWidth;H<200||(T.style.animationDuration=Math.max(18,Math.round(H/130))+"s")};O();const w=requestAnimationFrame(O),A=window.setTimeout(O,1200);let F=!0;return(W=(_=document.fonts)==null?void 0:_.ready)==null||W.then(()=>{F&&O()}),()=>{F=!1,cancelAnimationFrame(w),window.clearTimeout(A)}},[h.length,l]);const y=T=>T==="all"?p.length:g[T]||0,z=T=>T==="all"?x?"All":"Tout":T.startsWith("sig:")?ur[x?"en":"fr"][T.slice(4)]||"🔔":Qi[x?"en":"fr"][T],L=[{k:"all"}],q=Gi.filter(T=>y(T)>0||T===l);if(q.length){L.push({g:x?"DEALS":"OPÉRATIONS"});for(const T of q)L.push({k:T})}const S=Ji.map(T=>"sig:"+T).filter(T=>y(T)>0||T===l);if(S.length){L.push({g:x?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const T of S)L.push({k:T})}const C=T=>{try{return new Date(T+"T12:00:00Z").toLocaleDateString(x?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return T}},k=(()=>{const T=(a.filters.day||"").slice(0,10),O=!o&&a.continent!=="monde"&&i?x?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return T?(x?`LIVE covers the events of ${C(T)}.`:`Le LIVE regroupe les événements du ${C(T)}.`)+O:(x?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+O})(),M=T=>h.map(O=>t.jsxs("button",{type:"button",className:"tk"+(Pe(O)?" spent":""),onClick:w=>{const A=w.currentTarget.getBoundingClientRect();n({type:"popup",id:O.id,anchor:{x:A.left+A.width/2,y:A.bottom}})},title:O.name+(O.tagline?" — "+O.tagline:""),children:[t.jsx(dt,{o:O}),t.jsxs("span",{className:"who",children:[t.jsx(Yr,{o:O}),t.jsx("span",{className:"co",children:O.name})]}),typeof O.amountEur=="number"&&O.amountEur>0&&t.jsx("span",{className:"am",children:kc(O.amountEur)}),O.sector&&t.jsx("span",{className:"mt",children:O.sector}),t.jsx(ra,{o:O}),t.jsx("span",{className:"tkgo",children:"→"})]},T+(O.id||O.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:x?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},T+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:T=>{T.currentTarget.contains(T.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(T=>!T),children:[z(l),t.jsx("b",{children:y(l)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:k}),L.map(T=>"g"in T?t.jsx("span",{className:"tkfilg",children:T.g},T.g):t.jsxs("button",{type:"button","aria-pressed":T.k===l,onClick:()=>{f(T.k),b(!1)},children:[z(T.k),t.jsx("b",{children:y(T.k)})]},T.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:E,children:[M(0),M(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!d&&t.jsx(es,{isEn:x})]})}const Zi=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function es({isEn:e}){const[a,r]=m.useState(()=>Co());m.useEffect(()=>{const i=o=>{var c;return r(!!((c=o.detail)!=null&&c.open))};return window.addEventListener(sn,i),()=>window.removeEventListener(sn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Ao(!a),children:Zi})}const ts="aDx8z7Hzksus",Ya="+33 6 83 10 72 86",Yt="alexandre@proplace.co",mr=`tel:${Ya.replace(/[^\d+]/g,"")}`,yn="pp-rdv-slot";function as(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ns(){const{t:e,caps:a,fund:r}=I();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:os}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:mr,children:Ya}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Yt}`,children:Yt})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],c)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(c+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(wi,{filloutId:ts,parameters:r?{company_name:r}:void 0})})]})}function rs(){const[e,a]=m.useState(()=>typeof document>"u"?null:document.getElementById(yn));return m.useEffect(()=>{e||a(document.getElementById(yn))},[e]),e?bt.createPortal(t.jsx(ns,{}),e):null}const os=`
...
`;class Le extends m.Component{constructor(){super(...arguments);en(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ua=600,ot=62,wn="atl2:fstats";function is(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=I(),[c,s]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(wn)==="on"}catch{return!1}}),d=r.stats,x=m.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),l=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const f=z=>a==="en"?z.slice(5,10):`${z.slice(8,10)}/${z.slice(5,7)}`,u=z=>z.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((z,L)=>Math.max(z,L.s||0),0),p=x.length?ua/x.length:0,g=Math.max(4,p-4),v=x.length>=5&&b>0,h=r.marketEstimate||0,N=f(new Date().toISOString().slice(0,10)),E=z=>[...typeof z=="number"?[[z,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],y=[];return typeof d.screened_window=="number"&&l&&y.push({cle:"fenetre",periode:e.funPerWindow(f(l),N),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:E(d.screened)}),t.jsxs("div",{className:"fstats"+(c?" on":""),children:[y.map(z=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:z.periode}),z.etapes.map(([L,q],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(L)}),t.jsx("i",{children:q})]},z.cle+q)),z.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((d.screened||0)/h*100)))})]}),z.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":c,title:c?e.fstatsHide:e.fstatsShow,onClick:()=>{const L=!c;s(L),L&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(wn,L?"on":"off")}catch{}},children:c?"⌃":"⌄"})]},z.cle)),c&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ua} ${ot}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((z,L)=>{const q=(z.s||0)/b*(ot-4),S=(z.m||0)/b*(ot-4),C=L*p+(p-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(z.d)} — ${z.s} ${e.actScreened} · ${z.m} ${e.actKept}`}),t.jsx("rect",{x:C,y:ot-2-q,width:g,height:q,fill:"#cfe0d6"}),t.jsx("rect",{x:C,y:ot-2-S,width:g,height:S,fill:"#185c38"})]},z.d)}),t.jsx("line",{x1:0,y1:ot-1.5,x2:ua,y2:ot-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const fr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ss(e,a){if((at(e)||"").startsWith("CALL")&&Ae(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ae(e)>=2;return fr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function ls({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:c}=I(),[s,d]=m.useState(!1),[x,l]=m.useState(""),[f,u]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),p=async g=>{if(x)return;if(g==="Analysé"&&!e.memoUrl){u(!0);return}l(g);const v=await i(e,g);l(""),v&&(d(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:g=>g.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(g=>!g),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),s&&t.jsx("span",{className:"rstm",children:f?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:c.has(e.id),onClick:()=>{o(e),u(!1),d(!1)},children:c.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const g=await i(e,"Analysé");l(""),g&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]}):ss(e,a).map(([g,v])=>t.jsx("button",{type:"button",className:"rsti"+(b===g?" on":"")+(x===g?" busy":""),disabled:!!x,onClick:()=>{p(g)},children:v},g))})]})}function cs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=I(),[o,c]=m.useState(""),[s,d]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),l=(at(e)||"").startsWith("CALL")&&Ae(e)===3,f=Ae(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;c(p);const g=await i(e,p);c(""),g&&(d(!0),setTimeout(()=>d(!1),2200))},b=l?[["Validé",a.csYes],["Écarté",a.csNo]]:fr.filter(([p])=>!(f&&p==="Retenu")).map(([p,g])=>[p,a[g]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,g])=>t.jsx("button",{type:"button",className:"csb"+(x===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:g},p)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ds,{o:e})]})}function ds({o:e}){const{t:a,saveNote:r,flash:n}=I(),[i,o]=m.useState(e.ceoNote||""),[c,s]=m.useState(!1),[d,x]=m.useState(!1),l=i.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(c||!l)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:c,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:c||!l,onClick:()=>{f()},children:d?a.csNoteSaved:a.csNoteOk})]})}function ps({placeholder:e,onDone:a}){const{t:r}=I(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function us({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:c,flashErr:s}=I(),[d,x]=m.useState(!1);if(!n.pipe||!i||n.lockActions||Ae(e)!==4)return null;const l=o(e),f=(l==null?void 0:l.stage)||"todo",u=async h=>{if(d||h===f)return;x(!0);const N=l;c(e,{stage:h,stamps:(l==null?void 0:l.stamps)||{}});const E=Math.max(Date.now(),kn+=1);kn=E;const y=await zo(r,{company:e.name||"",stage:h,cts:E,deal_id:e.airtableId,check_id:e.checkId});x(!1),!y.stale&&(y.ok||(c(e,N),s(a.actErr)))},b=(v=l==null?void 0:l.stamps)==null?void 0:v.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=f==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,N])=>t.jsx("button",{type:"button",className:"stgb"+(f===h?" on":""),disabled:d,onClick:()=>{u(h)},children:N},h)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let kn=0;const Ft=8,Dt=360;function jn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Nn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(jn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(jn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function ms({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=I(),[c,s]=m.useState(0),[d,x]=m.useState(null),[l,f]=m.useState([]),u=m.useRef(!1),b=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=m.useRef(!1);m.useEffect(()=>{const q=b.current;return()=>{p.current||(n({type:"ptab",tab:q.ptab}),n({type:"dens",dens:q.dens}),n({type:"modal",modal:q.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,f(e.filter(q=>!!document.querySelector(q.need||q.sel))))},[e]);const g=l[c],v=c>=l.length;m.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const q=g.click,S=window.setTimeout(()=>{const C=document.querySelector(q);C&&C.getAttribute("aria-selected")!=="true"&&C.click()},60);return()=>window.clearTimeout(S)}},[c,g]);const h=m.useRef(-1),N=m.useCallback(()=>{if(!g){x(null);return}const q=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!q){x(null);return}h.current!==c&&(h.current=c,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=q.getBoundingClientRect();x(C=>C&&Math.abs(C.top-S.top)<1&&Math.abs(C.left-S.left)<1&&Math.abs(C.width-S.width)<1&&Math.abs(C.height-S.height)<1?C:S)},[g,c]);m.useLayoutEffect(()=>{N();const q=[90,300,700,1300].map(C=>window.setTimeout(N,C)),S=()=>N();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{q.forEach(C=>window.clearTimeout(C)),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[N]);const E=m.useRef(a);if(E.current=a,m.useEffect(()=>{const q=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),E.current()):S.key==="ArrowRight"?s(C=>C+1):S.key==="ArrowLeft"&&s(C=>Math.max(0,C-1))};return document.addEventListener("keydown",q,!0),()=>document.removeEventListener("keydown",q,!0)},[]),!l.length)return null;let y=null;const z=q=>()=>{p.current=!0,n({type:"modal",modal:null}),q()};if(v){const q=i[3]||0;q>0?y={title:q===1?r.ahaATitle1:r.ahaATitleN(q),body:r.ahaABody,btn:r.ahaABtn,go:z(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:z(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:z(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:z(()=>{n({type:"modal",modal:"crit"}),a()})}}let L={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Dt};if(!v&&d){const q=d.bottom+14,C=window.innerHeight-q>190?q:Math.max(12,d.top-200);L={left:Math.min(Math.max(12,d.left+d.width/2-Dt/2),window.innerWidth-Dt-12),top:C,width:Dt}}return bt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Ft,top:d.top-Ft,width:d.width+Ft*2,height:d.height+Ft*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:L,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(Nn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(l.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(c+1,l.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(c+1)/l.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(Nn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:c===0,onClick:()=>s(q=>Math.max(0,q-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(q=>q+1),children:c===l.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function xr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function hr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function fs(){var S,C;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:c,data:s,dispatch:d}=I(),x=r?a:e,l=m.useMemo(()=>x.filter(k=>tt(k.date)===0&&k.kind==="target"),[x]),f=m.useMemo(()=>r?a.filter(k=>k.kind==="target"&&Ae(k)===0).slice().sort((k,M)=>(M.date||"").localeCompare(k.date||"")):[],[a,r]),u=m.useMemo(()=>l.filter(k=>r?Ae(k)===0:!Pe(k)),[l,r]),b=r?f:u,p=r?a.length-f.length:l.length-u.length,g=r?a.length:l.length,v=g?Math.min(100,p/g*100):100,h=m.useMemo(()=>xr(x),[x]),N=!!h&&tt(h)>0,E=m.useMemo(()=>N?x.filter(k=>(k.date||"").slice(0,10)===h):[],[x,h,N]),y=typeof((S=s.stats)==null?void 0:S.kept_today)=="number"?s.stats.kept_today:null,z=typeof((C=s.stats)==null?void 0:C.screened_today)=="number"?s.stats.screened_today:l.length;let L;N?L=i.morningLast(E.length,f.length,hr(h,c)):r?L=i.morningThesis(z,f.length,y):l.length?p===0?L=i.goalSourced(l.length):p>=l.length?L=i.goalCleared:L=i.goalDone(p,l.length):L=i.goalSourced(0);const q=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&f.length&&d({type:"chainStart",queue:f.map(k=>k.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:L}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:q,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function xs(){var _,W;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:c,dossiers:s,mode:d,doSync:x,startTour:l,flash:f,flashErr:u}=I(),[b,p]=m.useState(null),[g,v]=m.useState(!0),[h,N]=m.useState([]),E=d==="client";m.useEffect(()=>{if(!i||!o)return;let H=!0;return v(!0),(async()=>{const[U,Y]=await Promise.all([Ba(o),nr(i)]);H&&(U&&p(U),v(!1),N(Y))})(),()=>{H=!1}},[i,o]);const[y,z]=m.useState(!1),L=()=>{!E||y||!o||(z(!0),To(o).then(H=>{z(!1),H?f(e.identRepubDone):u(e.actErr)}))},q=(b==null?void 0:b.per_day)??null,S=((_=b==null?void 0:b.pool_order)==null?void 0:_.length)??0,C=h.filter(H=>H.status==="running").length,k=m.useMemo(()=>s.filter(H=>H.kind==="target"&&Pe(H)).length,[s]),M=c.marketEstimate,T=typeof((W=c.stats)==null?void 0:W.screened)=="number"?c.stats.screened:k,O=M&&M>0?Math.min(100,Math.round(T/M*100)):null,w=H=>H.toLocaleString(a==="en"?"en-US":"fr-FR"),A=(o||"P").split(/\s+/).map(H=>H[0]).join("").slice(0,2).toUpperCase(),F=(()=>{const H=Date.parse(c.generatedAt||"");if(Number.isNaN(H))return"";const U=new Date(H),Y=G=>String(G).padStart(2,"0");return`${Y(U.getDate())}/${Y(U.getMonth()+1)} à ${Y(U.getHours())}:${Y(U.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?A:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),F?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(F)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:l,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[O===null&&T>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:w(T)})})]}),O!==null&&M&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:O+"%"}})}),t.jsxs("b",{children:[O," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(T,M)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),q!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:q})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),q===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),C>0&&t.jsxs("span",{className:"ev",children:["⏳ ",C]}),t.jsx("span",{className:"ego",children:g?e.identPendingWait:e.identPending(S)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:H=>{H.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||y,onClick:L,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:H=>n({type:"filters",patch:{search:H.target.value}})})]})]})]})}function hs(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:c}=I(),s=o.loading&&!c.length,d=m.useRef({});m.useEffect(()=>{d.current={...r}},[r]);const x=u=>{const b=d.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${ba[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},l=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${ba[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),f=(u,b,p,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[l(5,!1,n.plabels[5]),l(7,!0,n.plabels[7]),l(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[f("↩",n.toolUndo,i,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function gs(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:c}=I(),s=m.useRef(null),[d,x]=m.useState(60);m.useEffect(()=>{let p=0;const g=()=>{var y;const v=s.current;if(!v)return;const h=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!h)return;const N=h.getBoundingClientRect(),E=v.getBoundingClientRect();x(Math.max(20,Math.min(N.left+N.width/2-E.left,E.width-30)))};return p=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",g)}},[e.ptab]);const l=e.ptab;let f=r.tuto[l].p;if(l===3){const p=n.filter(h=>h.kind==="target"&&Ae(h)===3),g=p.filter(h=>va(h)==="auto").length,v=p.filter(h=>va(h)==="cd").length;f=r.tutoPending(g,v,p.length)}const u=(()=>{if(c!=="client")return null;if(l===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(l===1){const p=n.filter(g=>g.kind==="target"&&Ae(g)===1&&!i.has(g.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(g=>g.id)})}}return null})(),b=qo(l);return t.jsxs("div",{ref:s,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${ba[l]})`,"--ax":d+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[l].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:f}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class lt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],c=a+o,s=Math.abs(a)<Math.abs(o)?a-(c-o):o-(c-a);s&&(r[n++]=s),a=c}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,c=0;if(r>0){for(c=a[--r];r>0&&(n=c,i=a[--r],c=n+i,o=i-(c-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=c+i,i==n-c&&(c=n))}return c}}function*bs(e){for(const a of e)yield*a}function gr(e){return Array.from(bs(e))}var ue=1e-6,ae=Math.PI,Ue=ae/2,Sn=ae/4,He=ae*2,Xe=180/ae,De=ae/180,xe=Math.abs,vs=Math.atan,Ct=Math.atan2,we=Math.cos,ke=Math.sin,ys=Math.sign||function(e){return e>0?1:e<0?-1:0},pt=Math.sqrt;function ws(e){return e>1?0:e<-1?ae:Math.acos(e)}function At(e){return e>1?Ue:e<-1?-Ue:Math.asin(e)}function Ve(){}function Gt(e,a){e&&Cn.hasOwnProperty(e.type)&&Cn[e.type](e,a)}var En={Feature:function(e,a){Gt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Gt(r[n].geometry,a)}},Cn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Na(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Na(r[n],a,0)},Polygon:function(e,a){An(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)An(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Gt(r[n],a)}};function Na(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function An(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Na(e[r],a,1);a.polygonEnd()}function ut(e,a){e&&En.hasOwnProperty(e.type)?En[e.type](e,a):Gt(e,a)}function Sa(e){return[Ct(e[1],e[0]),At(e[2])]}function ht(e){var a=e[0],r=e[1],n=we(r);return[n*we(a),n*ke(a),ke(r)]}function Pt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Kt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ma(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function It(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Ea(e){var a=pt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Ca(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Aa(e,a){return xe(e)>ae&&(e-=Math.round(e/He)*He),[e,a]}Aa.invert=Aa;function ks(e,a,r){return(e%=He)?a||r?Ca(Tn(e),qn(a,r)):Tn(e):a||r?qn(a,r):Aa}function zn(e){return function(a,r){return a+=e,xe(a)>ae&&(a-=Math.round(a/He)*He),[a,r]}}function Tn(e){var a=zn(e);return a.invert=zn(-e),a}function qn(e,a){var r=we(e),n=ke(e),i=we(a),o=ke(a);function c(s,d){var x=we(d),l=we(s)*x,f=ke(s)*x,u=ke(d),b=u*r+l*n;return[Ct(f*i-b*o,l*r-u*n),At(b*i+f*o)]}return c.invert=function(s,d){var x=we(d),l=we(s)*x,f=ke(s)*x,u=ke(d),b=u*i-f*o;return[Ct(f*i+u*o,l*r+b*n),At(b*r-l*n)]},c}function js(e,a,r,n,i,o){if(r){var c=we(a),s=ke(a),d=n*r;i==null?(i=a+n*He,o=a-d/2):(i=Ln(c,i),o=Ln(c,o),(n>0?i<o:i>o)&&(i+=n*He));for(var x,l=i;n>0?l>o:l<o;l-=d)x=Sa([c,-s*we(l),-s*ke(l)]),e.point(x[0],x[1])}}function Ln(e,a){a=ht(a),a[0]-=e,Ea(a);var r=ws(-a[1]);return((-a[2]<0?-r:r)+He-ue)%He}function br(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ve,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ht(e,a){return xe(e[0]-a[0])<ue&&xe(e[1]-a[1])<ue}function $t(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function vr(e,a,r,n,i){var o=[],c=[],s,d;if(e.forEach(function(p){if(!((g=p.length-1)<=0)){var g,v=p[0],h=p[g],N;if(Ht(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),s=0;s<g;++s)i.point((v=p[s])[0],v[1]);i.lineEnd();return}h[0]+=2*ue}o.push(N=new $t(v,p,null,!0)),c.push(N.o=new $t(v,null,N,!1)),o.push(N=new $t(h,p,null,!1)),c.push(N.o=new $t(h,null,N,!0))}}),!!o.length){for(c.sort(a),Rn(o),Rn(c),s=0,d=c.length;s<d;++s)c[s].e=r=!r;for(var x=o[0],l,f;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;l=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,d=l.length;s<d;++s)i.point((f=l[s])[0],f[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(l=u.p.z,s=l.length-1;s>=0;--s)i.point((f=l[s])[0],f[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,l=u.z,b=!b}while(!u.v);i.lineEnd()}}}function Rn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function fa(e){return xe(e[0])<=ae?e[0]:ys(e[0])*((xe(e[0])+ae)%He-ae)}function Ns(e,a){var r=fa(a),n=a[1],i=ke(n),o=[ke(r),-we(r),0],c=0,s=0,d=new lt;i===1?n=Ue+ue:i===-1&&(n=-Ue-ue);for(var x=0,l=e.length;x<l;++x)if(u=(f=e[x]).length)for(var f,u,b=f[u-1],p=fa(b),g=b[1]/2+Sn,v=ke(g),h=we(g),N=0;N<u;++N,p=y,v=L,h=q,b=E){var E=f[N],y=fa(E),z=E[1]/2+Sn,L=ke(z),q=we(z),S=y-p,C=S>=0?1:-1,k=C*S,M=k>ae,T=v*L;if(d.add(Ct(T*C*ke(k),h*q+T*we(k))),c+=M?S+C*He:S,M^p>=r^y>=r){var O=Kt(ht(b),ht(E));Ea(O);var w=Kt(o,O);Ea(w);var A=(M^S>=0?-1:1)*At(w[2]);(n>A||n===A&&(O[0]||O[1]))&&(s+=M^S>=0?1:-1)}}return(c<-ue||c<ue&&d<-1e-12)^s&1}function yr(e,a,r,n){return function(i){var o=a(i),c=br(),s=a(c),d=!1,x,l,f,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=h,u.lineStart=N,u.lineEnd=E,l=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,l=gr(l);var y=Ns(x,n);l.length?(d||(i.polygonStart(),d=!0),vr(l,Es,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),l=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,z){e(y,z)&&i.point(y,z)}function p(y,z){o.point(y,z)}function g(){u.point=p,o.lineStart()}function v(){u.point=b,o.lineEnd()}function h(y,z){f.push([y,z]),s.point(y,z)}function N(){s.lineStart(),f=[]}function E(){h(f[0][0],f[0][1]),s.lineEnd();var y=s.clean(),z=c.result(),L,q=z.length,S,C,k;if(f.pop(),x.push(f),f=null,!!q){if(y&1){if(C=z[0],(S=C.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),L=0;L<S;++L)i.point((k=C[L])[0],k[1]);i.lineEnd()}return}q>1&&y&2&&z.push(z.pop().concat(z.shift())),l.push(z.filter(Ss))}}return u}}function Ss(e){return e.length>1}function Es(e,a){return((e=e.x)[0]<0?e[1]-Ue-ue:Ue-e[1])-((a=a.x)[0]<0?a[1]-Ue-ue:Ue-a[1])}const Mn=yr(function(){return!0},Cs,zs,[-ae,-Ue]);function Cs(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,c){var s=o>0?ae:-ae,d=xe(o-a);xe(d-ae)<ue?(e.point(a,r=(r+c)/2>0?Ue:-Ue),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&d>=ae&&(xe(a-n)<ue&&(a-=n*ue),xe(o-s)<ue&&(o-=s*ue),r=As(a,r,o,c),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=c),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function As(e,a,r,n){var i,o,c=ke(e-r);return xe(c)>ue?vs((ke(a)*(o=we(n))*ke(r)-ke(n)*(i=we(a))*ke(e))/(i*o*c)):(a+n)/2}function zs(e,a,r,n){var i;if(e==null)i=r*Ue,n.point(-ae,i),n.point(0,i),n.point(ae,i),n.point(ae,0),n.point(ae,-i),n.point(0,-i),n.point(-ae,-i),n.point(-ae,0),n.point(-ae,i);else if(xe(e[0]-a[0])>ue){var o=e[0]<a[0]?ae:-ae;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ts(e){var a=we(e),r=2*De,n=a>0,i=xe(a)>ue;function o(l,f,u,b){js(b,e,r,u,l,f)}function c(l,f){return we(l)*we(f)>a}function s(l){var f,u,b,p,g;return{lineStart:function(){p=b=!1,g=1},point:function(v,h){var N=[v,h],E,y=c(v,h),z=n?y?0:x(v,h):y?x(v+(v<0?ae:-ae),h):0;if(!f&&(p=b=y)&&l.lineStart(),y!==b&&(E=d(f,N),(!E||Ht(f,E)||Ht(N,E))&&(N[2]=1)),y!==b)g=0,y?(l.lineStart(),E=d(N,f),l.point(E[0],E[1])):(E=d(f,N),l.point(E[0],E[1],2),l.lineEnd()),f=E;else if(i&&f&&n^y){var L;!(z&u)&&(L=d(N,f,!0))&&(g=0,n?(l.lineStart(),l.point(L[0][0],L[0][1]),l.point(L[1][0],L[1][1]),l.lineEnd()):(l.point(L[1][0],L[1][1]),l.lineEnd(),l.lineStart(),l.point(L[0][0],L[0][1],3)))}y&&(!f||!Ht(f,N))&&l.point(N[0],N[1]),f=N,b=y,u=z},lineEnd:function(){b&&l.lineEnd(),f=null},clean:function(){return g|(p&&b)<<1}}}function d(l,f,u){var b=ht(l),p=ht(f),g=[1,0,0],v=Kt(b,p),h=Pt(v,v),N=v[0],E=h-N*N;if(!E)return!u&&l;var y=a*h/E,z=-a*N/E,L=Kt(g,v),q=It(g,y),S=It(v,z);ma(q,S);var C=L,k=Pt(q,C),M=Pt(C,C),T=k*k-M*(Pt(q,q)-1);if(!(T<0)){var O=pt(T),w=It(C,(-k-O)/M);if(ma(w,q),w=Sa(w),!u)return w;var A=l[0],F=f[0],_=l[1],W=f[1],H;F<A&&(H=A,A=F,F=H);var U=F-A,Y=xe(U-ae)<ue,G=Y||U<ue;if(!Y&&W<_&&(H=_,_=W,W=H),G?Y?_+W>0^w[1]<(xe(w[0]-A)<ue?_:W):_<=w[1]&&w[1]<=W:U>ae^(A<=w[0]&&w[0]<=F)){var ee=It(C,(-k+O)/M);return ma(ee,q),[w,Sa(ee)]}}}function x(l,f){var u=n?e:ae-e,b=0;return l<-u?b|=1:l>u&&(b|=2),f<-u?b|=4:f>u&&(b|=8),b}return yr(c,s,o,n?[0,-e]:[-ae,e-ae])}function qs(e,a,r,n,i,o){var c=e[0],s=e[1],d=a[0],x=a[1],l=0,f=1,u=d-c,b=x-s,p;if(p=r-c,!(!u&&p>0)){if(p/=u,u<0){if(p<l)return;p<f&&(f=p)}else if(u>0){if(p>f)return;p>l&&(l=p)}if(p=i-c,!(!u&&p<0)){if(p/=u,u<0){if(p>f)return;p>l&&(l=p)}else if(u>0){if(p<l)return;p<f&&(f=p)}if(p=n-s,!(!b&&p>0)){if(p/=b,b<0){if(p<l)return;p<f&&(f=p)}else if(b>0){if(p>f)return;p>l&&(l=p)}if(p=o-s,!(!b&&p<0)){if(p/=b,b<0){if(p>f)return;p>l&&(l=p)}else if(b>0){if(p<l)return;p<f&&(f=p)}return l>0&&(e[0]=c+l*u,e[1]=s+l*b),f<1&&(a[0]=c+f*u,a[1]=s+f*b),!0}}}}}var wt=1e9,Bt=-wt;function Ls(e,a,r,n){function i(x,l){return e<=x&&x<=r&&a<=l&&l<=n}function o(x,l,f,u){var b=0,p=0;if(x==null||(b=c(x,f))!==(p=c(l,f))||d(x,l)<0^f>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+f+4)%4)!==p);else u.point(l[0],l[1])}function c(x,l){return xe(x[0]-e)<ue?l>0?0:3:xe(x[0]-r)<ue?l>0?2:1:xe(x[1]-a)<ue?l>0?1:0:l>0?3:2}function s(x,l){return d(x.x,l.x)}function d(x,l){var f=c(x,1),u=c(l,1);return f!==u?f-u:f===0?l[1]-x[1]:f===1?x[0]-l[0]:f===2?x[1]-l[1]:l[0]-x[0]}return function(x){var l=x,f=br(),u,b,p,g,v,h,N,E,y,z,L,q={point:S,lineStart:T,lineEnd:O,polygonStart:k,polygonEnd:M};function S(A,F){i(A,F)&&l.point(A,F)}function C(){for(var A=0,F=0,_=b.length;F<_;++F)for(var W=b[F],H=1,U=W.length,Y=W[0],G,ee,oe=Y[0],je=Y[1];H<U;++H)G=oe,ee=je,Y=W[H],oe=Y[0],je=Y[1],ee<=n?je>n&&(oe-G)*(n-ee)>(je-ee)*(e-G)&&++A:je<=n&&(oe-G)*(n-ee)<(je-ee)*(e-G)&&--A;return A}function k(){l=f,u=[],b=[],L=!0}function M(){var A=C(),F=L&&A,_=(u=gr(u)).length;(F||_)&&(x.polygonStart(),F&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),_&&vr(u,s,A,o,x),x.polygonEnd()),l=x,u=b=p=null}function T(){q.point=w,b&&b.push(p=[]),z=!0,y=!1,N=E=NaN}function O(){u&&(w(g,v),h&&y&&f.rejoin(),u.push(f.result())),q.point=S,y&&l.lineEnd()}function w(A,F){var _=i(A,F);if(b&&p.push([A,F]),z)g=A,v=F,h=_,z=!1,_&&(l.lineStart(),l.point(A,F));else if(_&&y)l.point(A,F);else{var W=[N=Math.max(Bt,Math.min(wt,N)),E=Math.max(Bt,Math.min(wt,E))],H=[A=Math.max(Bt,Math.min(wt,A)),F=Math.max(Bt,Math.min(wt,F))];qs(W,H,e,a,r,n)?(y||(l.lineStart(),l.point(W[0],W[1])),l.point(H[0],H[1]),_||l.lineEnd(),L=!1):_&&(l.lineStart(),l.point(A,F),L=!1)}N=A,E=F,y=_}return q}}const za=e=>e;var xa=new lt,Ta=new lt,wr,kr,qa,La,et={point:Ve,lineStart:Ve,lineEnd:Ve,polygonStart:function(){et.lineStart=Rs,et.lineEnd=Os},polygonEnd:function(){et.lineStart=et.lineEnd=et.point=Ve,xa.add(xe(Ta)),Ta=new lt},result:function(){var e=xa/2;return xa=new lt,e}};function Rs(){et.point=Ms}function Ms(e,a){et.point=jr,wr=qa=e,kr=La=a}function jr(e,a){Ta.add(La*e-qa*a),qa=e,La=a}function Os(){jr(wr,kr)}var gt=1/0,Qt=gt,zt=-gt,Jt=zt,Xt={point:Fs,lineStart:Ve,lineEnd:Ve,polygonStart:Ve,polygonEnd:Ve,result:function(){var e=[[gt,Qt],[zt,Jt]];return zt=Jt=-(Qt=gt=1/0),e}};function Fs(e,a){e<gt&&(gt=e),e>zt&&(zt=e),a<Qt&&(Qt=a),a>Jt&&(Jt=a)}var Ra=0,Ma=0,kt=0,Zt=0,ea=0,mt=0,Oa=0,Fa=0,jt=0,Nr,Sr,Ye,Ge,_e={point:ct,lineStart:On,lineEnd:Fn,polygonStart:function(){_e.lineStart=Is,_e.lineEnd=$s},polygonEnd:function(){_e.point=ct,_e.lineStart=On,_e.lineEnd=Fn},result:function(){var e=jt?[Oa/jt,Fa/jt]:mt?[Zt/mt,ea/mt]:kt?[Ra/kt,Ma/kt]:[NaN,NaN];return Ra=Ma=kt=Zt=ea=mt=Oa=Fa=jt=0,e}};function ct(e,a){Ra+=e,Ma+=a,++kt}function On(){_e.point=Ds}function Ds(e,a){_e.point=Ps,ct(Ye=e,Ge=a)}function Ps(e,a){var r=e-Ye,n=a-Ge,i=pt(r*r+n*n);Zt+=i*(Ye+e)/2,ea+=i*(Ge+a)/2,mt+=i,ct(Ye=e,Ge=a)}function Fn(){_e.point=ct}function Is(){_e.point=Bs}function $s(){Er(Nr,Sr)}function Bs(e,a){_e.point=Er,ct(Nr=Ye=e,Sr=Ge=a)}function Er(e,a){var r=e-Ye,n=a-Ge,i=pt(r*r+n*n);Zt+=i*(Ye+e)/2,ea+=i*(Ge+a)/2,mt+=i,i=Ge*e-Ye*a,Oa+=i*(Ye+e),Fa+=i*(Ge+a),jt+=i*3,ct(Ye=e,Ge=a)}function Cr(e){this._context=e}Cr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,He);break}}},result:Ve};var Da=new lt,ha,Ar,zr,Nt,St,Tt={point:Ve,lineStart:function(){Tt.point=_s},lineEnd:function(){ha&&Tr(Ar,zr),Tt.point=Ve},polygonStart:function(){ha=!0},polygonEnd:function(){ha=null},result:function(){var e=+Da;return Da=new lt,e}};function _s(e,a){Tt.point=Tr,Ar=Nt=e,zr=St=a}function Tr(e,a){Nt-=e,St-=a,Da.add(pt(Nt*Nt+St*St)),Nt=e,St=a}let Dn,ta,Pn,In;class $n{constructor(a){this._append=a==null?qr:Us(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Pn||this._append!==ta){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Pn=n,ta=this._append,In=this._,this._=i}this._+=In;break}}}result(){const a=this._;return this._="",a.length?a:null}}function qr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Us(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return qr;if(a!==Dn){const r=10**a;Dn=a,ta=function(i){let o=1;this._+=i[0];for(const c=i.length;o<c;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return ta}function Vs(e,a){let r=3,n=4.5,i,o;function c(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),ut(s,i(o))),o.result()}return c.area=function(s){return ut(s,i(et)),et.result()},c.measure=function(s){return ut(s,i(Tt)),Tt.result()},c.bounds=function(s){return ut(s,i(Xt)),Xt.result()},c.centroid=function(s){return ut(s,i(_e)),_e.result()},c.projection=function(s){return arguments.length?(i=s==null?(e=null,za):(e=s).stream,c):e},c.context=function(s){return arguments.length?(o=s==null?(a=null,new $n(r)):new Cr(a=s),typeof n!="function"&&o.pointRadius(n),c):a},c.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),c):n},c.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const d=Math.floor(s);if(!(d>=0))throw new RangeError(`invalid digits: ${s}`);r=d}return a===null&&(o=new $n(r)),c},c.projection(e).digits(r).context(a)}function Ga(e){return function(a){var r=new Pa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Pa(){}Pa.prototype={constructor:Pa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ka(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),ut(r,e.stream(Xt)),a(Xt.result()),n!=null&&e.clipExtent(n),e}function Lr(e,a,r){return Ka(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],c=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-c*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-c*(n[1][1]+n[0][1]))/2;e.scale(150*c).translate([s,d])},r)}function Hs(e,a,r){return Lr(e,[[0,0],a],r)}function Ws(e,a,r){return Ka(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),c=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([c,s])},r)}function Ys(e,a,r){return Ka(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),c=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([c,s])},r)}var Bn=16,Gs=we(30*De);function _n(e,a){return+a?Qs(e,a):Ks(e)}function Ks(e){return Ga({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Qs(e,a){function r(n,i,o,c,s,d,x,l,f,u,b,p,g,v){var h=x-n,N=l-i,E=h*h+N*N;if(E>4*a&&g--){var y=c+u,z=s+b,L=d+p,q=pt(y*y+z*z+L*L),S=At(L/=q),C=xe(xe(L)-1)<ue||xe(o-f)<ue?(o+f)/2:Ct(z,y),k=e(C,S),M=k[0],T=k[1],O=M-n,w=T-i,A=N*O-h*w;(A*A/E>a||xe((h*O+N*w)/E-.5)>.3||c*u+s*b+d*p<Gs)&&(r(n,i,o,c,s,d,M,T,C,y/=q,z/=q,L,g,v),v.point(M,T),r(M,T,C,y,z,L,x,l,f,u,b,p,g,v))}}return function(n){var i,o,c,s,d,x,l,f,u,b,p,g,v={point:h,lineStart:N,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=z},polygonEnd:function(){n.polygonEnd(),v.lineStart=N}};function h(S,C){S=e(S,C),n.point(S[0],S[1])}function N(){f=NaN,v.point=E,n.lineStart()}function E(S,C){var k=ht([S,C]),M=e(S,C);r(f,u,l,b,p,g,f=M[0],u=M[1],l=S,b=k[0],p=k[1],g=k[2],Bn,n),n.point(f,u)}function y(){v.point=h,n.lineEnd()}function z(){N(),v.point=L,v.lineEnd=q}function L(S,C){E(i=S,C),o=f,c=u,s=b,d=p,x=g,v.point=E}function q(){r(f,u,l,b,p,g,o,c,i,s,d,x,Bn,n),v.lineEnd=y,y()}return v}}var Js=Ga({point:function(e,a){this.stream.point(e*De,a*De)}});function Xs(e){return Ga({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Zs(e,a,r,n,i){function o(c,s){return c*=n,s*=i,[a+e*c,r-e*s]}return o.invert=function(c,s){return[(c-a)/e*n,(r-s)/e*i]},o}function Un(e,a,r,n,i,o){if(!o)return Zs(e,a,r,n,i);var c=we(o),s=ke(o),d=c*e,x=s*e,l=c/e,f=s/e,u=(s*r-c*a)/e,b=(s*a+c*r)/e;function p(g,v){return g*=n,v*=i,[d*g-x*v+a,r-x*g-d*v]}return p.invert=function(g,v){return[n*(l*g-f*v+u),i*(b-f*g-l*v)]},p}function el(e){return tl(function(){return e})()}function tl(e){var a,r=150,n=480,i=250,o=0,c=0,s=0,d=0,x=0,l,f=0,u=1,b=1,p=null,g=Mn,v=null,h,N,E,y=za,z=.5,L,q,S,C,k;function M(A){return S(A[0]*De,A[1]*De)}function T(A){return A=S.invert(A[0],A[1]),A&&[A[0]*Xe,A[1]*Xe]}M.stream=function(A){return C&&k===A?C:C=Js(Xs(l)(g(L(y(k=A)))))},M.preclip=function(A){return arguments.length?(g=A,p=void 0,w()):g},M.postclip=function(A){return arguments.length?(y=A,v=h=N=E=null,w()):y},M.clipAngle=function(A){return arguments.length?(g=+A?Ts(p=A*De):(p=null,Mn),w()):p*Xe},M.clipExtent=function(A){return arguments.length?(y=A==null?(v=h=N=E=null,za):Ls(v=+A[0][0],h=+A[0][1],N=+A[1][0],E=+A[1][1]),w()):v==null?null:[[v,h],[N,E]]},M.scale=function(A){return arguments.length?(r=+A,O()):r},M.translate=function(A){return arguments.length?(n=+A[0],i=+A[1],O()):[n,i]},M.center=function(A){return arguments.length?(o=A[0]%360*De,c=A[1]%360*De,O()):[o*Xe,c*Xe]},M.rotate=function(A){return arguments.length?(s=A[0]%360*De,d=A[1]%360*De,x=A.length>2?A[2]%360*De:0,O()):[s*Xe,d*Xe,x*Xe]},M.angle=function(A){return arguments.length?(f=A%360*De,O()):f*Xe},M.reflectX=function(A){return arguments.length?(u=A?-1:1,O()):u<0},M.reflectY=function(A){return arguments.length?(b=A?-1:1,O()):b<0},M.precision=function(A){return arguments.length?(L=_n(q,z=A*A),w()):pt(z)},M.fitExtent=function(A,F){return Lr(M,A,F)},M.fitSize=function(A,F){return Hs(M,A,F)},M.fitWidth=function(A,F){return Ws(M,A,F)},M.fitHeight=function(A,F){return Ys(M,A,F)};function O(){var A=Un(r,0,0,u,b,f).apply(null,a(o,c)),F=Un(r,n-A[0],i-A[1],u,b,f);return l=ks(s,d,x),q=Ca(a,F),S=Ca(l,q),L=_n(q,z),w()}function w(){return C=k=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&T,O()}}function Rr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Rr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,c=o*o;r-=i=(r*(1.007226+o*(.015085+c*(-.044475+.028874*o-.005916*c)))-a)/(1.007226+o*(.015085*3+c*(-.044475*7+.028874*9*o-.005916*11*c)))}while(xe(i)>ue&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function al(){return el(Rr).scale(175.295)}function nl(e){return e}function rl(e){if(e==null)return nl;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],c=e.translate[1];return function(s,d){d||(a=r=0);var x=2,l=s.length,f=new Array(l);for(f[0]=(a+=s[0])*n+o,f[1]=(r+=s[1])*i+c;x<l;)f[x]=s[x],++x;return f}}function ol(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function il(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Vn(e,r)})}:Vn(e,a)}function Vn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=sl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function sl(e,a){var r=rl(e.transform),n=e.arcs;function i(l,f){f.length&&f.pop();for(var u=n[l<0?~l:l],b=0,p=u.length;b<p;++b)f.push(r(u[b],b));l<0&&ol(f,p)}function o(l){return r(l)}function c(l){for(var f=[],u=0,b=l.length;u<b;++u)i(l[u],f);return f.length<2&&f.push(f[0]),f}function s(l){for(var f=c(l);f.length<4;)f.push(f[0]);return f}function d(l){return l.map(s)}function x(l){var f=l.type,u;switch(f){case"GeometryCollection":return{type:f,geometries:l.geometries.map(x)};case"Point":u=o(l.coordinates);break;case"MultiPoint":u=l.coordinates.map(o);break;case"LineString":u=c(l.arcs);break;case"MultiLineString":u=l.arcs.map(c);break;case"Polygon":u=d(l.arcs);break;case"MultiPolygon":u=l.arcs.map(d);break;default:return null}return{type:f,coordinates:u}}return x(a)}const Mr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ll=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function cl(e,a,r){const n=Mr[e];if(!n||!n.length)return-1;const i=ll(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(c=>i.includes(c)))return o}return Math.floor(r*n.length)%n.length}let _t=null;function dl(){return _t||(_t=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=il(r,n),o=al().fitExtent([[8,8],[992,492]],{type:"Sphere"}),c=Vs(o),s=(i.features||[]).filter(l=>{var f;return(((f=l.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(l=>{var b;const f=((b=l.properties)==null?void 0:b.name)||"",u=c(l)||"";return u?{i2:Lo(f)||null,n:f,d:u}:null}).filter(l=>!!l);if(!s.length)return null;const d={};for(const[l,f]of Object.entries(Ro)){const u=o(f);u&&(d[l]={x:u[0],y:u[1]})}const x={};for(const[l,f]of Object.entries(Mr)){const u=f.map(b=>o(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(x[l]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:d,metros:x}}catch{return null}})(),_t)}function pl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return dl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const ul={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Hn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Wn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ml(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const c=()=>{var x;if(!i)return;const d=(x=e.current)==null?void 0:x.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(c)};c();const s=new ResizeObserver(()=>c());return e.current&&s.observe(e.current),window.addEventListener("resize",c),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",c)}},[e,a]),r}function Yn({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],c)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":c*.18+"s"}},c)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function fl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:c,lang:s,t:d,data:x,dossiers:l}=I(),f=x.loading&&!l.length,u=m.useRef(null),b=m.useRef(null),p=pl(e.continent==="monde"),g=e.continent==="monde"?p:_a.find(w=>w.key===e.continent)||null,v=ml(u,e.continent+":"+e.mapFolded+":"+!!g),[h,N]=m.useState(new Map),[E,y]=m.useState(null);m.useEffect(()=>{const w=u.current;if(!w)return;const A=new Map;w.querySelectorAll("path[data-i2]").forEach(F=>{const _=F.dataset.i2;if(_)try{const W=F.getBBox();W.width>0&&A.set(_,{x:W.x,y:W.y,w:W.width,h:W.height})}catch{}}),N(A)},[e.continent,v,g]);const z=m.useMemo(()=>r.filter(w=>w.cc),[r]),L=m.useMemo(()=>{const w=new Map;return z.forEach(A=>w.set(A.cc,(w.get(A.cc)||0)+1)),w},[z]),q=e.continent==="monde"&&p?p.anchors:null,S=e.continent==="monde"&&p?p.metros:null,C=m.useMemo(()=>z.map(w=>{const A=Wn(w.name||w.id||""),F=Wn((w.id||w.name||"")+"·y");if(q&&w.cc){const Y=S?S[w.cc]:void 0;if(Y&&Y.length){const ee=cl(w.cc,w.city,A);if(ee>=0&&Y[ee])return{d:w,x:Y[ee].x+(A-.5)*5,y:Y[ee].y+(F-.5)*5}}const G=q[w.cc];if(G)return{d:w,x:G.x+(A-.5)*10,y:G.y+(F-.5)*10}}const _=w.cc?h.get(w.cc):void 0;if(!_)return null;const W=ul[`${e.continent}:${w.cc||""}`];if(W)return{d:w,x:_.x+_.w*(W.fx+(A-.5)*W.sx),y:_.y+_.h*(W.fy+(F-.5)*W.sy)};const H=(A-.5)*Math.min(_.w*.55,60),U=(F-.5)*Math.min(_.h*.55,60);return{d:w,x:_.x+_.w/2+H,y:_.y+_.h/2+U}}).filter(w=>!!w),[z,h,q,S,e.continent]),k=w=>v>0?w/v:w,M=m.useMemo(()=>n?[0,1,2,3,4,5].map(w=>({c:Hn[w],fr:d.plabels[w].toUpperCase(),en:d.plabels[w].toUpperCase(),n:r.filter(A=>A.kind==="target"&&Ae(A)===w).length})).filter(w=>w.n>0):ln.map((w,A)=>({...w,n:r.filter(F=>cn(F)===A).length})),[r,n,d.plabels]),T=o?c.get(o):null,O=T?C.find(w=>w.d.id===T.id):null;return g?t.jsxs("div",{className:"mapzone"+(f?" waiting":""),ref:b,children:[f&&t.jsx(Yn,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?g.fr:g.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:g.countries.map((w,A)=>t.jsx("g",{className:"ct"+(w.i2&&L.get(w.i2)?"":" empty"),children:t.jsx("path",{d:w.d,"data-i2":w.i2||void 0})},A))}),t.jsx("g",{children:C.map(w=>{const A=ln[cn(w.d)],F=!!Te(w.d),_=w.d.kind==="target",W=n&&_?Hn[Ae(w.d)]:A.c,H=!n&&Pe(w.d);return t.jsxs("g",{className:"co"+(H?" done":""),onMouseEnter:()=>{var G,ee;const U=(G=b.current)==null?void 0:G.getBoundingClientRect(),Y=(ee=u.current)==null?void 0:ee.createSVGPoint();if(Y&&u.current&&U){Y.x=w.x,Y.y=w.y;const oe=Y.matrixTransform(u.current.getScreenCTM());y({x:oe.x-U.left,y:oe.y-U.top,label:w.d.name+" · "+(vt(w.d.cc,s)||w.d.countryLabel||"")})}i(w.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var G;const U=(G=u.current)==null?void 0:G.createSVGPoint();let Y=null;if(U&&u.current){U.x=w.x,U.y=w.y;const ee=U.matrixTransform(u.current.getScreenCTM());Y={x:ee.x,y:ee.y}}a({type:"popup",id:w.d.id,anchor:Y})},children:[t.jsx("circle",{className:"h",cx:w.x,cy:w.y,r:k(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:w.x,cy:w.y,r:k(A.px),fill:W,stroke:F?"#DC2626":"#ffffff",strokeWidth:k(F?2.2:1.3)})]},w.d.id||w.d.name)})}),O&&t.jsx("circle",{className:"ring on",cx:O.x,cy:O.y,r:k(13),fill:"none",stroke:"#0F172A",strokeWidth:k(2)})]}),t.jsx("div",{className:"hov"+(E?" on":""),style:E?{left:E.x,top:E.y}:void 0,children:E==null?void 0:E.label}),t.jsx("div",{className:"legend",children:M.map((w,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":w.c}}),s==="fr"?w.fr:w.en," ",t.jsx("b",{children:w.n})]},A))}),r.some(w=>!w.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(w=>!w.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(f?" waiting":""),ref:b,children:t.jsx(Yn,{msgs:d.loadMsgs})})}function xl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Or({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:c,lang:s}=I(),d=a.filters,[x,l]=m.useState(!1),f=m.useRef(null),u=m.useMemo(()=>a.continent==="monde"?n:n.filter(S=>S.continent===a.continent),[n,a.continent]),b=S=>u.filter(C=>S!=="country"&&d.country.length&&!d.country.includes(C.cc||"")?!1:Va(C,d,o,S==="country"?void 0:S)),p=m.useMemo(()=>{const S=b("win"),C=k=>S.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=k).length;return[C(0),C(7),C(30),S.length]},[u,d,o]),g=m.useMemo(()=>d.day?b("win").filter(S=>(S.date||"").slice(0,10)===d.day).length:0,[u,d,o]),v=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,h=v+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&l(!1)},[a.openFacet]),m.useEffect(()=>{if(!x)return;const S=k=>{var M;(M=f.current)!=null&&M.contains(k.target)||l(!1)},C=k=>{k.key==="Escape"&&l(!1)};return document.addEventListener("mousedown",S),document.addEventListener("keydown",C),()=>{document.removeEventListener("mousedown",S),document.removeEventListener("keydown",C)}},[x]);const N=(S,C,k,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===S,onClick:()=>r({type:"openFacet",facet:S}),children:[t.jsx("span",{className:"fl",children:C}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:"▾"})]},S),E=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(xl(d.day,s))}),t.jsx("b",{children:g})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((S,C)=>t.jsxs("button",{type:"button","aria-pressed":d.win===S,onClick:()=>r({type:"filters",patch:{win:S}}),children:[t.jsx("span",{className:"sl",children:i.dates[C]}),t.jsx("b",{children:p[C]})]},S))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:S=>r({type:"filters",patch:{search:S.target.value}})})]}),z=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",i.fSector,d.sector.length),N("pay",i.fCountry,d.country.length),N("det",i.fEngine,d.engine.length),N("sta",i.fStage,d.stage.length),o&&N("ang","Angle",d.angle.length),o&&N("mem","Mémo",d.memoLevel.length)]}),L=(S=!1)=>t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,c),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),S&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),q=t.jsxs("div",{className:"fmenu",ref:f,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":x,"aria-haspopup":"true",onClick:()=>{l(S=>!S),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:z})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(d.day?" noday":""),children:[!d.day&&t.jsx("div",{className:"fstrip-a",children:E}),t.jsxs("div",{className:"fstrip-b",children:[y,q,L(!0)]})]}),a.openFacet&&t.jsx(Gn,{poolFor:b})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[E,y,z,t.jsx("span",{className:"fgrow"}),L()]}),a.openFacet&&t.jsx(Gn,{poolFor:b})]})}function Gn({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=I(),o=a.filters,c=a.openFacet,{title:s,cols:d,options:x}=m.useMemo(()=>{if(c==="sig"){const p=e("signal").filter(h=>Te(h)),g=new Map;p.forEach(h=>{const N=h.engine||"";g.set(N,(g.get(N)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ya([...g.keys()],i).map(h=>({v:h,label:st(h)+" "+Ke(h,i),n:g.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(c==="sec"){const p=e("sector"),g=new Map;return p.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(c==="pay"){const p=e("country"),g=new Map;return p.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:vt(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(c==="det"){const p=e("engine"),g=new Map;return p.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ya([...g.keys()],i).map(v=>({v,label:st(v)+" "+Ke(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Mo(Oo(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(c==="ang"){const p=e("angle"),g=new Map;return p.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(c==="mem"){const p=e("memoLevel"),g=new Map;p.forEach(h=>{if(h.kind==="target"){const N=$a(h);g.set(N,(g.get(N)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:g.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,g)=>g[1]-p[1]).map(([p,g])=>({v:p,label:p,n:g,html:!1,on:o.stage.includes(p)}))}},[c,a,i]),l=u=>{if(c==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(c==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage",value:u})},f=()=>{r(c==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:c==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>l(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Fr({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:c,t:s}=I(),d=m.useMemo(()=>{const b={};return r.forEach(p=>{Va(p,n.filters,o)&&(b.monde=(b.monde||0)+1,p.continent&&(b[p.continent]=(b[p.continent]||0)+1))}),b},[r,n.filters,o]),[x,l]=m.useState(!1),f=m.useRef(null);m.useEffect(()=>{if(!x)return;const b=g=>{var v;(v=f.current)!=null&&v.contains(g.target)||l(!1)},p=g=>{g.key==="Escape"&&l(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",p)}},[x]);const u=b=>{const p=_a.find(g=>g.key===b);return b==="monde"?s.contWorld:c==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:f,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>l(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:d[n.continent]||0}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:dn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{i({type:"continent",key:b}),l(!1)},children:[u(b),t.jsx("span",{className:"n",children:d[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[dn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>i({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:d[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})})]})}function Dr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function hl(e){var i;const a=[],r=new Set,n=o=>{const c=(o||"").trim();!c||r.has(c.toLowerCase())||(r.add(c.toLowerCase()),a.push(c))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Kn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:c}){const{t:s}=I();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),c&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>c(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:s.rsEvalOne})]},d.name))})]}):null}function Pr({card:e,onEvaluate:a,onAddAll:r}){var c;const{t:n}=I(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((c=e==null?void 0:e.prospective)==null?void 0:c.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Kn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Kn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function gl({card:e,onEvaluate:a,onAddAll:r}){var s,d,x;const{t:n}=I(),i=[e.industry,...e.market_tags||[],e.author].map(l=>(l||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),c=(e.sources||[]).filter(l=>l&&l.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(l=>t.jsx("span",{children:l},l))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Dr(e.summary_md||"").map((l,f)=>t.jsx("p",{children:l},f))})]}),t.jsx(Pr,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(l=>t.jsx("li",{children:l},l))})]})]}),c.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:c.length})]}),t.jsx("div",{className:"rssrc",children:c.map(l=>t.jsx("a",{href:l.url,target:"_blank",rel:"noopener noreferrer",children:l.label||l.url},l.url))})]})]})}function bl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function vl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:c}=I(),s=i,[d,x]=m.useState(null),[l,f]=m.useState(null),[u,b]=m.useState(null),[p,g]=m.useState(!1);m.useEffect(()=>{let h=!0;return(async()=>{const N=await rr({email:c,cbToken:s});h&&x(N)})(),()=>{h=!1}},[c,s,n]);const v=h=>{f(h),b(null),g(!0),(async()=>{const N=await Fo(h.id);b(N),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[l?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),l&&t.jsx("span",{className:"ti",children:l.title}),!l&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!l&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[bl(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),l&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[l.source_url&&t.jsx("a",{href:l.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),l.published&&l.page_url&&t.jsx("a",{href:l.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(l.published?" on":""),children:l.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(gl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Qn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function yl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:c,evalBusy:s,evalCards:d,caps:x,data:l,canWrite:f,source:u,dossiers:b,doAnalyse:p,liveMemos:g,pipe:v}=I(),h=a==="client",N=m.useMemo(()=>r||(u!=="default"?Do():""),[r,u]),[E,y]=m.useState(""),[z,L]=m.useState(!1),[q,S]=m.useState(""),[C,k]=m.useState(!1),[M,T]=m.useState(""),[O,w]=m.useState([]),A=m.useRef(!1),[F,_]=m.useState(!1),[W,H]=m.useState(""),[U,Y]=m.useState(""),[G,ee]=m.useState(!1),[oe,je]=m.useState(0),[ye,he]=m.useState(""),[Z,le]=m.useState(null),[K,B]=m.useState(null),[J,me]=m.useState(!1),[te,be]=m.useState(null),[Q,ce]=m.useState(0),ze=m.useRef(!1),ge=E.trim()?Qn.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting,fe=m.useMemo(()=>q.split(`
`).map(D=>D.trim()).filter(Boolean).slice(0,15),[q]);m.useEffect(()=>{if(typeof window>"u")return;const D=(new URLSearchParams(window.location.search).get("rs")||"").trim();!D||!/^https?:\/\//i.test(D)||(H(D),_(!0))},[]),m.useEffect(()=>{const D=ne=>{var Se;const de=String(((Se=ne.detail)==null?void 0:Se.url)||"").trim();!de||!/^https?:\/\//i.test(de)||(H(de),_(!0))};return window.addEventListener("ppmap:research",D),()=>window.removeEventListener("ppmap:research",D)},[]),m.useEffect(()=>{if(!f&&!N){be(null);return}let D=!0;return(async()=>{const ne=await rr({email:n,cbToken:N});D&&be(ne.length)})(),()=>{D=!1}},[f,N,n,Q]);const Oe=O.length?O:d,pe=l.credits,Fe=m.useCallback(D=>{const ne=D.map(de=>(de||"").trim()).filter(Boolean);ne.length&&(S(de=>{const Se=de.split(`
`).map(ve=>ve.trim()).filter(Boolean),Je=new Set(Se.map(ve=>ve.toLowerCase())),qe=ne.filter(ve=>!Je.has(ve.toLowerCase()));return[...Se,...qe].slice(0,15).join(`
`)}),L(!0))},[]);m.useEffect(()=>{if(!G)return;je(0);const D=window.setInterval(()=>je(ne=>ne+1),1e3);return()=>window.clearInterval(D)},[G]);const R=m.useMemo(()=>{const D=E.trim().toLowerCase();return!D||!v?null:b.find(ne=>Ze(ne.name)===D&&Ae(ne)===1)||null},[E,b,v]),V=()=>{const D=E.trim();if(D){if(R){p(R);return}i(null,D),y("")}},X=async()=>{if(!h){i(null,fe[0]||"");return}if(!fe.length||C)return;k(!0),A.current=!1;const D=[];for(let ne=0;ne<fe.length&&!A.current;ne++){T(e.evaluating(ne+1,fe.length,fe[ne]));const de=await or(r,fe[ne],"atelier2");if(D.unshift({name:de.company||fe[ne],verdict:de.verdict,reason:de.reason||"",remaining:de.remaining??null}),w([...D]),de.verdict==="quota"){D.unshift({name:"",verdict:"quota",reason:e.quota(fe.length-ne-1),remaining:0}),w([...D]),S(fe.slice(ne+1).join(`
`)),T(""),k(!1);return}}T(""),S(A.current?fe.slice(D.length).join(`
`):""),k(!1)},ie=async()=>{var de,Se,Je;if(ze.current)return;const D=W.trim().replace(/\s+/g,""),ne=U.trim();if(!D&&!ne){he(e.rsNeed);return}if(!h&&!N){i(null,D||ne.slice(0,80));return}ze.current=!0,he(""),le(null),B(null),ee(!0);try{const qe=await Io({url:D,text:ne,email:n,cbToken:N});if(ee(!1),!qe||qe.status!=="success"){he((qe==null?void 0:qe.message)||"Erreur");return}le(qe),_(!1),Fe((((de=qe.prospective)==null?void 0:de.companies_to_evaluate)||[]).map($e=>($e==null?void 0:$e.name)||"")),B({state:"pending"});const ve=await $o(qe,{email:n,cbToken:N});B(ve.ok?{state:"ok",scopeLabel:((Se=ve.summary)==null?void 0:Se.scope_label)||"",scope:((Je=ve.summary)==null?void 0:Je.scope)||""}:{state:"fail",msg:ve.error||""}),ve.ok&&ce($e=>$e+1)}finally{ze.current=!1,ee(!1)}},Ne=[Z==null?void 0:Z.industry,...(Z==null?void 0:Z.market_tags)||[],Z==null?void 0:Z.author].map(D=>(D||"").trim()).filter(Boolean),se=(K==null?void 0:K.state)==="pending",Ie=K&&(se?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):K.state==="ok"?t.jsx("span",{className:"rslink ok",children:K.scope&&K.scope!=="public"?e.rsSavedIn(K.scopeLabel||K.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:K.msg,children:e.rsSaveFail})),Qe=hl(Z).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:E,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:D=>y(D.target.value),onKeyDown:D=>{D.key==="Enter"&&V()}}),t.jsx("span",{className:"detect"+(Qn.test(E.trim())?" url":""),children:ge})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(R?" analyse":"")+(s?" loading":""),disabled:s,onClick:V,children:[t.jsx("span",{className:"fill"}),R?e.actAnalyse:e.evalGo]}),x.showCredits&&pe&&t.jsxs("button",{type:"button",className:"credits"+(pe.total_available<=0&&!pe.unlimited?" empty":""),onClick:()=>c({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:pe.unlimited?"∞":pe.total_available}),!pe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",pe.daily_grant+pe.purchased]}),pe.total_available<=0&&!pe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),g.items.filter(D=>D.status==="boot"||D.status==="running").map(D=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:D.name}),t.jsx(Et,{item:D,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>c({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+D.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>L(!z),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(F?" on":""),onClick:()=>_(!F),children:e.rsOpen}),te!==null&&te>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(J?" on":""),onClick:()=>me(!J),children:e.rsArchOpen(te)})]}),J&&t.jsx(vl,{bump:Q,cbToken:N,onClose:()=>me(!1),onEvaluate:D=>i(null,D),onAddAll:Fe}),F&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:W,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:D=>H(D.target.value),onKeyDown:D=>{D.key==="Enter"&&ie()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:U,placeholder:e.rsTextPh,onChange:D=>Y(D.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(G?" loading":""),style:{justifyContent:"center"},disabled:G||se||!W.trim()&&!U.trim(),onClick:()=>{ie()},children:[t.jsx("span",{className:"fill"}),G?`${Po(W.trim())==="youtube"&&W.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(oe)}`:se?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),ye&&t.jsx("div",{className:"rserr",children:ye}),Z&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:Z.title}),Z.source_url&&t.jsx("a",{href:Z.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{le(null),B(null)},children:"×"})]}),Z.market&&t.jsx("p",{className:"rsmk",children:Z.market}),Ne.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Ne.map(D=>t.jsx("span",{children:D},D))]}),t.jsxs("div",{className:"rsbody",children:[Z.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${Z.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Dr(Z.summary_md||"").map((D,ne)=>t.jsx("p",{children:D},ne))})]}),t.jsx(Pr,{card:Z,onEvaluate:D=>i(null,D),onAddAll:Fe}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Qe)}),Ie]})]}),z&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:q,placeholder:e.bulkPh,onChange:D=>S(D.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(C?" loading":""),style:{justifyContent:"center"},disabled:C||!fe.length,onClick:()=>{X()},children:[t.jsx("span",{className:"fill"}),C&&M?M:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(fe.length)})]})]}),Oe.slice(0,1).map((D,ne)=>{const de=D.verdict==="kept",Se=D.verdict==="quota",Je=de?"var(--brand)":Se?"var(--bolt)":"var(--red)",qe=de?"var(--brand-l)":Se?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Je,"--bgc":qe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:de?"✓ "+e.kept:Se?"⏳":"✗ "+e.dropped})}),D.name&&t.jsx("span",{className:"rn",children:D.name}),t.jsx("span",{className:"rr",children:D.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",D.reason]}):null}),!!(D.candidates&&D.candidates.length)&&t.jsx("span",{className:"sitepick",children:D.candidates.map(ve=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:ve.url.startsWith("http")?ve.url:`https://${ve.url}`,target:"_blank",rel:"nofollow noopener",children:[(ve.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,ve.url),children:e.evalPickGo})]},ve.url))}),!Se&&t.jsx("button",{type:"button",className:"go",onClick:()=>{c({type:"ptab",tab:de?1:5});const ve=(D.name||"").trim().toLowerCase();window.setTimeout(()=>{const $e=[...document.querySelectorAll(".atl2 .list .row")].find(oa=>{var Rt;return(((Rt=oa.querySelector(".rnm"))==null?void 0:Rt.textContent)||"").trim().toLowerCase().includes(ve)});$e&&($e.scrollIntoView({behavior:"smooth",block:"center"}),$e.classList.add("flashrow"),window.setTimeout(()=>$e.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(de?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ne)}),h&&(o.kept+o.dropped>0||Oe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>c({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function wl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function kl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=I(),o=e.memoConsole?r.get(e.memoConsole):null,c=m.useMemo(()=>o?[o.reasoning||"",wl(o.summary||"")].filter(Boolean).join(`
...
`).map((x,l)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},l)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[xt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Ir({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=I(),[c,s]=m.useState(!1),[d,x]=m.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const l=async()=>{if(c)return;s(!0);const f=await Bo(r,e);if(s(!1),!f){o(a.actErr);return}x(f.results||[])};return t.jsxs("div",{className:"simb",onClick:f=>f.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:c,onClick:()=>{l()},children:c?a.similarBusy:a.similar}),d&&(d.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:d.map(f=>t.jsxs("li",{children:[t.jsx("b",{className:f.verdict==="kept"?"ok":"ko",children:f.company}),f.reason&&t.jsx("span",{children:f.reason})]},f.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const jl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ut=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Nl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Ut(a.slice(n));break}r+=Ut(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Ut(a.slice(i));break}const c=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(c),d=s?s[2].toLowerCase():"";s&&jl.has(d)?r+=`<${s[1]}${d}>`:r+=Ut(a.slice(i,o+1)),n=o+1}return r}const Jn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Re({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Sl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function El({o:e}){const{t:a,doDeep:r}=I(),[n,i]=m.useState(!1),o=at(e),c=[e.reasoning||"",Sl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),c.length?c.join(`

`).split(`

`).map((s,d)=>t.jsx("p",{className:"cdtxt",children:s},d)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[xt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:s=>{s.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:s=>{s.stopPropagation(),i(d=>!d)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:s=>s.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:s=>s.stopPropagation()})]})}function $r({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=I(),o=qt(e),c=at(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,l=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),f=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(c?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:l},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||xt(e)?1:0}].filter(g=>g.n>0),[e,a,s,c,d,x,l]),[u,b]=m.useState("");if(!f.length)return null;const p=f.some(g=>g.k===u)?u:f[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:f.map(g=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===g.k,"data-tour":"tab-"+g.k,className:p===g.k?"on":"",onClick:v=>{v.stopPropagation(),b(g.k)},children:g.lib},g.k))}),t.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),c&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:c}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Re,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Re,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Re,{k:a.cdVerdictDate,v:Jn(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Nl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Cl,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Re,{k:a.cdSector,v:e.sector}),t.jsx(Re,{k:a.cdStage,v:e.stage}),t.jsx(Re,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Re,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Re,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Re,{k:a.cdAngle,v:e.angle}),t.jsx(Re,{k:a.cdDetected,v:Jn(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Re,{k:a.cdName,v:e.contactName}),t.jsx(Re,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Re,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(El,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Re,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Re,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Cl({o:e}){const{t:a,token:r}=I(),[n,i]=m.useState(!1),[o,c]=m.useState(null),s=async()=>{n||(i(!0),c(await _o(r,e.name,e.website||e.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},x=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],l=x.some(([,f])=>f);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&l&&t.jsxs(t.Fragment,{children:[x.filter(([,f])=>f).map(([f,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:f}),t.jsx("p",{children:u})]},f)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!l&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function na({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let c=!1;return pn({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(s=>{!c&&s&&o.isConnected&&o.replaceChildren(s)}),()=>{c=!0,o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let c=!1;pn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(d=>{!c&&d&&o.isConnected&&o.replaceChildren(d)});const s=d=>{d.key==="Escape"&&i(!1)};return document.addEventListener("keydown",s),()=>{c=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&bt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Al=`
...
`;function zl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,c=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:c,top:s}}function Tl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:c,askEvaluate:s,doAnalyse:d,doDecide:x,doPromote:l,doRepeche:f,doApproach:u,doDeep:b,doOnboard:p,outbound:g,evalBusy:v}=I(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const N=Te(h),E=Ae(h),y=at(h),z=qt(h),L=h.kind==="target",q=S=>{a({type:"filters",patch:S}),a({type:"popup",id:null})};return bt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Al}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:zl(e.popupAnchor,!!h.card),onClick:S=>S.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(tt(h.date)),Ke(h.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>q({country:[h.cc]}),children:(vt(h.cc,i)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>q({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>q({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:Lt(h.amountEur,i)})]}),o.pipe&&L&&t.jsxs("div",{className:"pstat",children:[z&&t.jsx("span",{className:"vd "+(z==="MATCH"?"v-ok":"v-no"),title:n.vt[z],children:z}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[st(h.engine)," ",t.jsx("b",{children:Ke(h.engine,i)})," — ",Uo(h.engine,i),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),N?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(dt,{o:h,lg:!0})," ",t.jsx(ra,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Ua(N,i))," · ",n.win7(Wt(N,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(na,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),o.pipe&&L&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),o.pipe&&L&&t.jsx($r,{o:h})]}),t.jsx(Ir,{name:h.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||c!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{l(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(h,!1),a({type:"popup",id:null})},children:n.actNo}),xt(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(h),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),g&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var S;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(S=document.querySelector(".atl2 .demand"))==null||S.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(h.name),onClick:()=>s(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}const ql=8;function Ll(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:c}=I(),[s,d]=m.useState(!1),[x,l]=m.useState(!1),[f,u]=m.useState(!1),b=`atl2:sincemini:${r||"home"}`,[p,g]=m.useState(()=>{try{return localStorage.getItem(b)==="1"}catch{return!1}}),v=()=>{g(S=>{try{localStorage.setItem(b,S?"0":"1")}catch{}return!S})},h=r||"home",{names:N,verdicts:E}=m.useMemo(()=>{const S=[],C={};return n.forEach(k=>{k.kind!=="target"||!k.name||(S.push(k.name),C[k.name]=Vo(k)||"")}),{names:S,verdicts:C}},[n]),y=m.useMemo(()=>N.length?Ho(h,N,E,a):null,[h,N.length]);if(!i.pipe||s||!y||y.firstVisit||!y.added.length&&!y.gone.length)return null;const z=x?y.added:y.added.slice(0,ql),L=y.added.length-z.length,q=S=>{const C=n.find(k=>k.name===S);C&&(o(C.id),c({type:"popup",id:C.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(y.added.length,y.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:v,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{d(!0),Wo(h,N,E,y.fp,a)},children:"×"})]}),!!y.added.length&&t.jsxs("div",{className:"sg-c",children:[z.map(S=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>q(S),children:t.jsx("b",{children:S})},S)),L>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>l(!0),children:e.sinceMore(L)})]}),!!y.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(S=>!S),children:e.sinceOut(y.gone.length)}),f&&y.gone.slice(0,20).map(S=>t.jsx("span",{className:"gone",children:S},S))]})]})}const Br={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Qa({o:e,locked:a=!1}){const{t:r}=I(),n=qt(e),i=at(e),o=Ae(e),c=va(e),s=Go(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(Br[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&c==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&c==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(ls,{o:e})]})}const aa=e=>e.length>22?e.slice(0,21)+"…":e;function Xn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=I(),[o,c]=m.useState(!1);if(m.useEffect(()=>{n||c(!1)},[n]),Pe(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),c(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(aa(e.name))})]})}function _r({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:c,doPromote:s,doRepeche:d,doApproach:x,dispatch:l,liveMemos:f}=I();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p=>{p.stopPropagation(),l({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{var g;p.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(g=document.querySelector(".atl2 .demand"))==null||g.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{var g;p.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(g=document.querySelector(".atl2 .demand"))==null||g.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Xn,{o:e})});const u=Ae(e),b=p=>g=>{g.stopPropagation(),p()};if(u===0)return t.jsx("span",{className:"cell",children:t.jsx(Xn,{o:e})});if(u===1){const p=f.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Et,{item:p,serverOff:f.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const g=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:g,onClick:b(()=>o(e)),children:g?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>c(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>c(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})});if(u===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:b(()=>x(e)),children:p?a.actApproachSent:a.actApproach})})}return u===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})}):u===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>l({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Rl({o:e}){const{t:a,doThumb:r,thumbOf:n}=I(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Ml({o:e}){const{lang:a}=I();return Te(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(dt,{o:e}),t.jsx(ra,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[st(e.engine||"")," ",Ke(e.engine||"",a)]})})}function Ol({o:e,locked:a,open:r,onToggle:n,selected:i,onSelect:o}){const{dispatch:c,caps:s,markRow:d,markedId:x,favIds:l,toggleFav:f,t:u}=I(),b=Ae(e),p=["#0F172A","#475C6E","#8798A8","#B9C6D2"],g=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=g<=0?0:g<=7?1:g<=30?2:3,h=s.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][b]:p[v],N=l.has(e.id),E=y=>{if(a)return;if(o){o(e.id);return}if(s.pipe||e.kind==="op"){n();return}const z=y.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:z.left+Math.min(280,z.width/3),y:z.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:E,children:[t.jsx("span",{className:"pt",style:{"--c":h}}),t.jsx(Yr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[s.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:N?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),f(e)},children:N?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:u.acqSee(e.acquirer),onClick:y=>{y.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",aa(e.acquirer)]}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),t.jsx(Fl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Ml,{o:e}),s.pipe&&t.jsx(Qa,{o:e,locked:a}),s.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(_r,{o:e}),s.showThumbs&&t.jsx(Rl,{o:e})]}),r&&!a&&!o&&t.jsx(Dl,{o:e})]})}function Fl({o:e}){const{lang:a,caps:r}=I();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Lt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Ur({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=I(),c=(u,b=!1)=>p=>{p.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),d=Lt(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),l=Pe(e),f=l&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:c({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:c({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:c({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[l?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(aa(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(aa(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(na,{spec:e.card})})]})}function Dl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:c}=I();return!i.pipe&&e.kind==="op"?t.jsx(Ur,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx($r,{o:e}),t.jsx(cs,{o:e}),t.jsx(us,{o:e}),t.jsx(Ir,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Qa,{o:e})})]}),e.card&&t.jsx(na,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[st(e.engine||"")," ",Ke(e.engine||"",r)]}),Te(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(dt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>c(e),children:a.actOnboard})})]})]})}function Pl({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:c}=I();if(!i.pipe&&e.kind==="op"){const x=Lt(e.amountEur,c),l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),f=(u,b=!1)=>p=>{p.stopPropagation(),b&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(na,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:f({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:f({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:f({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[st(e.engine||"")," ",Ke(e.engine||"",c)]}),Te(e)&&t.jsx(dt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(_r,{o:e})})]})}const s=Ae(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" tzr":""),style:{"--c":d},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Qa,{o:e}),Te(e)&&t.jsx(dt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Il(){const{t:e}=I(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function $l({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=I(),o=i==="en",c=l=>n.plabels[l]||"",s=[0,1,2,3,4,5,6,7].filter(l=>l!==a.ptab&&(e[l]||0)>0),d=s.includes(0)?0:s.sort((l,f)=>(e[f]||0)-(e[l]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${c(a.ptab)}” for now.`:`0 ${c(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?o?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:o?`${x} ${x>1?"files":"file"} in “${c(d)}”`:`${x} dossier${x>1?"s":""} dans « ${c(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(o?"Open ":"Ouvrir ")+c(d)," →"]})]})}function Bl(){var ge,fe,Oe,pe,Fe;const e=I(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:c,scopedAll:s,markRow:d,lang:x,sessTally:l,data:f,dossiers:u,source:b}=e,p=R=>i.lockRowsAfter!==null||b==="ops"?Number.MAX_SAFE_INTEGER:lr,[g,v]=m.useState(new Set);m.useEffect(()=>{v(new Set)},[a.ptab,a.continent]);const[h,N]=m.useState(null);m.useEffect(()=>{N(null)},[a.ptab,a.continent]);const E=R=>v(V=>{const X=new Set(V);return X.has(R)?X.delete(R):X.add(R),X}),y=b==="ops"&&a.dens==="liste",[z,L]=m.useState(null),[q,S]=m.useState("all"),[C,k]=m.useState(!1);m.useEffect(()=>{S("all"),k(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!C)return;const R=V=>{var X,ie;(ie=(X=V.target)==null?void 0:X.closest)!=null&&ie.call(X,".atl2 .doable")||k(!1)};return document.addEventListener("click",R),()=>document.removeEventListener("click",R)},[C]);const M=dr(),T=m.useMemo(()=>{var V;const R=new Map;for(const X of Vi(((V=M==null?void 0:M.ed)==null?void 0:V.html)||""))R.has(X.t)||R.set(X.t,X.html);return R},[(ge=M==null?void 0:M.ed)==null?void 0:ge.html]),O=m.useCallback(R=>{if(R.decryptHtml)return R.decryptHtml;if(!T.size)return;const V=(R.name||"").trim().toLowerCase();if(V.length<3)return;const X=T.get(V);if(X)return X;for(const[ie,Ne]of T)if(ie.includes(V)||V.includes(ie))return Ne},[T]),w=m.useMemo(()=>{const R=Ha(c,a.sort);return q==="all"?R:R.filter(V=>q==="explore"?!!V.noCo:!V.noCo)},[c,a.sort,b,q]),A=m.useMemo(()=>i.pipe?s.filter(R=>Te(R)&&Yo(R)):w.filter(R=>Te(R)&&!Pe(R)),[i.pipe,s,w]),F=A.length,[_,W]=m.useState(!1),[H,U]=m.useState(!1),Y=`atl2:sigmini:${((fe=f.session)==null?void 0:fe.token)||"home"}`,[G,ee]=m.useState(()=>{try{return localStorage.getItem(Y)==="1"}catch{return!1}}),oe=m.useMemo(()=>i.pipe?w:w.filter(R=>!Pe(R)&&!R.noCo),[w,i.pipe]),je=b==="ops"?w.filter(R=>R.noCo).length:0,ye=i.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,he=a.filters,Z=[];if(he.day)Z.push({k:"day",lib:n.fDay(he.day.slice(8,10)+"/"+he.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(he.win&&he.win!=="all"){const R=["1","7","30"].indexOf(he.win);R>=0&&Z.push({k:"win",lib:n.dates[R],off:()=>r({type:"filters",patch:{win:"all"}})})}const le=R=>R.length<=2?R.join(", "):`${R.length} ${n.fSelected}`;for(const R of["sector","country","engine"]){const V=he[R];V&&V.length&&Z.push({k:R,lib:le(V),off:()=>r({type:"clearFacet",facet:R})})}he.search&&Z.push({k:"search",lib:"🔍 "+he.search,off:()=>r({type:"filters",patch:{search:""}})});const K=(R,V,X="",ie=!1)=>t.jsxs("button",{type:"button","data-s":R,className:X,"aria-sort":a.sort.key===R?a.sort.dir===1?"ascending":"descending":"none",style:ie?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:R}),children:[V,t.jsx("span",{className:"ar",children:a.sort.key===R&&a.sort.dir===1?"▴":"▾"})]},R),B=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const R=new Map;w.forEach(ie=>{const Ne=ie.engine||"?";R.has(Ne)||R.set(Ne,[]),R.get(Ne).push(ie)});const V={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},X=ya([...R.keys()],x);return[...R.entries()].sort((ie,Ne)=>{const se=V[ie[0]]??10+X.indexOf(ie[0]),Ie=V[Ne[0]]??10+X.indexOf(Ne[0]);return se-Ie})},[w,i.pipe,a.groupBy,x]),J=((pe=(Oe=B==null?void 0:B[0])==null?void 0:Oe[1][0])==null?void 0:pe.id)??((Fe=w[0])==null?void 0:Fe.id)??null;m.useEffect(()=>{y&&(z&&w.some(R=>R.id===z)||L(J))},[y,z,w,J]);const me=m.useMemo(()=>{if(!y||!z)return null;const R=w.find(X=>X.id===z);if(!R)return null;const V=O(R);return V&&V!==R.decryptHtml?{...R,decryptHtml:V}:R},[y,z,w,O]),te=i.lockRowsAfter;let be=0;const Q=(R,V)=>{let X=a.shown[V]||p();return R.length-X<=4&&(X=R.length),R.slice(0,X).map(se=>{const Ie=te!==null&&be>=te;be++;const Qe=O(se),D=Qe&&Qe!==se.decryptHtml?{...se,decryptHtml:Qe}:se,ne=se.engine==="ma"||se.engine==="fundraising",de=!y&&a.dens!=="maxi"&&(a.dens==="deplie"||(h?h==="open":!!Qe||b==="ops"&&ne)),Se=g.has(se.id)?!de:de;return a.dens==="maxi"?t.jsx(Pl,{o:D,locked:Ie},se.id):t.jsx(Ol,{o:D,locked:Ie,open:Se,onToggle:()=>E(se.id),selected:y&&z===se.id,onSelect:y?L:void 0},se.id)})},ce="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(w.length?"":" list-empty"),ze=t.jsxs(t.Fragment,{children:[B?B.map(([R,V])=>t.jsxs(m.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:st(R)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Ke(R,x)}),t.jsx("div",{className:"s",children:n.grpCount(V.filter(X=>!Pe(X)).length,V.length)})]})]}),Q(V,R)]},R)):Q(w,"pt"+a.ptab),f.loading&&!u.length&&t.jsx(Il,{}),!w.length&&!(f.loading&&!u.length)&&(i.pipe?t.jsx($l,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(a.mapFolded?" mapoff":""),children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:w.length})," ",ye]}),t.jsx("span",{className:"dot",children:"·"}),a.mapFolded&&t.jsx(Fr,{variant:"compact",mapToggle:!0}),t.jsxs("span",{className:"ctx",children:[a.mapFolded?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),Z.map(R=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:V=>{V.stopPropagation(),R.off()},children:[R.lib,t.jsx("i",{children:"×"})]},R.k)),b==="ops"&&w.length>0&&" — "+n.edSplit(w.length-je,je)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([R,V])=>t.jsxs("button",{type:"button","data-d":R,"aria-pressed":a.dens===R||R==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:R}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:V})]},R))}),!y&&(i.showFunnel||b==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":h==="open",onClick:()=>{N("open"),v(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":h==="closed",onClick:()=>{N("closed"),v(new Set)},children:n.foldAllLbl}),b==="ops"&&t.jsxs("button",{type:"button","aria-pressed":h===null,onClick:()=>{N(null),v(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||b==="ops")&&(()=>{var X;const R=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],V=((X=R.find(([ie])=>ie===q))==null?void 0:X[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":C,onClick:()=>k(ie=>!ie),children:[V,t.jsx("i",{children:"▾"})]}),C&&t.jsx("div",{className:"dolist",children:R.map(([ie,Ne])=>t.jsx("button",{type:"button","aria-pressed":q===ie,onClick:()=>{S(ie),k(!1)},children:Ne},ie))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:R=>r({type:"sort",key:R.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([R,V])=>t.jsx("option",{value:R,children:V},R))})]}),i.showChain&&oe.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:oe.map(R=>R.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(oe.length):n.chainAll(oe.length)]}),a.mapFolded&&t.jsx(Or,{compact:!0})]}),t.jsx(Ll,{}),F>0&&!a.filters.signalOnly&&!H&&t.jsxs("div",{className:"sigstrip"+(G?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(F)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!G,title:G?n.boxExpand:n.boxCollapse,onClick:()=>ee(R=>{try{localStorage.setItem(Y,R?"0":"1")}catch{}return!R}),children:G?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>U(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(_?A:A.slice(0,12)).map(R=>{const V=Te(R);return V?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(Ua(V,x),Wt(V,x)),onClick:()=>{d(R.id),r({type:"popup",id:R.id})},children:[t.jsx("b",{children:R.name}),t.jsxs("i",{children:[V.emoji," ",wa(V,x)]}),t.jsx("em",{children:Wt(V,x)})]},"sg-"+R.id):null}),!_&&A.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>W(!0),children:n.sigStripMore(A.length-12)})]})]}),a.dens!=="maxi"&&!y&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),K("country",n.colCountry),K("name",n.colCompany),K("amount",n.colAmount,"h-amt",!0),K("stage",n.colStage,"h-stade"),K("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[K("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),K("memo",n.colMemo)]}),i.pipe&&K("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),y?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),K("country",n.colCountry),K("name",n.colCompany),K("amount",n.colAmount,"h-amt",!0),K("stage",n.colStage,"h-stade"),K("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:ce,children:ze})]}),t.jsx("aside",{className:"readpane","aria-label":x==="fr"?"Décryptage":"Briefing",children:me?t.jsx(Ur,{o:me}):t.jsx("p",{className:"readpane-empty",children:x==="fr"?"Cliquez une ligne — le décryptage s’ouvre ici.":"Click a row — the briefing opens here."})})]}):t.jsx("div",{className:ce,children:ze}),b!=="ops"&&(()=>{const R=B||[["pt"+a.ptab,w]];let V=0,X=0;for(const[Ne,se]of R){X+=se.length;let Ie=a.shown[Ne]||p();se.length-Ie<=4&&(Ie=se.length),V+=Math.min(se.length,Ie)}const ie=X-V;return ie<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>R.forEach(([Ne,se])=>r({type:"more",group:Ne,by:se.length,base:p()})),children:[t.jsx("span",{className:"more-label",children:n.more(ie,ie)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(V,X)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(l.kept>0||l.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(l.kept,l.dropped)}})]})}function Zn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function _l(e,a){const r=Ko(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Ul(e,a){const n=[a.head.split("|").map(Zn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",_l(i,a.plabels),qt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Zn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Vl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Hl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function We({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Wl({o:e,qa:a}){const{t:r,lang:n,fund:i}=I(),o=(e.cribleStatus||"").trim().toUpperCase()||(qt(e)==="NO MATCH"?"NO MATCH":"MATCH"),c=at(e),s=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,c&&t.jsx("em",{children:c})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(We,{k:r.cdSector,v:e.sector}),t.jsx(We,{k:r.cdStage,v:e.stage}),t.jsx(We,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(We,{k:r.cdSite,v:e.domain||e.website}),t.jsx(We,{k:r.cdName,v:e.contactName}),t.jsx(We,{k:r.cdEmail,v:e.contactEmail}),t.jsx(We,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(We,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(We,{k:r.cdAngle,v:e.angle}),t.jsx(We,{k:r.cdDetected,v:Hl(e.date,n)})]}),d.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,x])=>x).map(([x,l])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:l})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Yl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:c}=I(),[s,d]=m.useState({}),x=25,l=m.useMemo(()=>n.slice(0,x),[n]);m.useEffect(()=>{l.length&&Qo(r,l.map(b=>b.name)).then(d)},[r,l]);const f=o.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(l.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),f&&typeof f.screened=="number"&&t.jsxs("p",{children:[u(f.screened)," ",e.funScreened(""),typeof f.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(f.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(f.screened/o.marketEstimate*100)," %"]})]})]}),l.map(b=>t.jsx(Wl,{o:b,qa:s[b.name]},b.id)),!l.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Gl=50;function Ja({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=I(),[o,c]=m.useState(null),[s,d]=m.useState(!1),[x,l]=m.useState(""),[f,u]=m.useState(0),[b,p]=m.useState(""),[g,v]=m.useState(!1),h=m.useRef(null);m.useEffect(()=>()=>{h.current&&window.clearInterval(h.current)},[]);const N=async y=>{d(!0),l("");const z=await a();if(d(!1),z.ok){c(z);return}if(z.busy){l(i.alertPreviewBusy);return}if(!y){l(i.alertPreviewFail);return}u(Gl),h.current=window.setInterval(()=>{u(L=>L>1?L-1:(h.current&&window.clearInterval(h.current),N(!1),0))},1e3)},E=async()=>{if(n||g)return;v(!0),p("");const y=await r();v(!1),p(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||f>0,onClick:()=>{N(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||g,onClick:()=>{E()},children:g?"…":i.alertTest})]}),f>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(f)}),x&&t.jsx("p",{className:"mnote warn",children:x}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const ft="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Me({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=I();return bt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Kl(){const{st:e}=I();switch(e.modal){case"chain":return t.jsx(Jl,{});case"space":return t.jsx(Xl,{});case"alert":return t.jsx(Zl,{});case"queue":return t.jsx(rc,{});case"export":return t.jsx(oc,{});case"plug":return t.jsx(lc,{});case"recharge":return t.jsx(dc,{});case"cover":return t.jsx(uc,{});case"dossier":return t.jsx(pc,{});case"crit":return t.jsx(mc,{});case"tuto":return t.jsx(fc,{});case"rdv":return t.jsx(Ql,{});case"memoalert":return t.jsx(ic,{});default:return null}}function Ql(){const{dispatch:e,fund:a}=I(),r=typeof document<"u"&&!!document.getElementById("rdv");return m.useEffect(()=>{r&&(e({type:"modal",modal:null}),as())},[r,e]),r?null:t.jsx(Zo,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Jl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:c,evalBusy:s,caps:d,memoQueued:x,doAnalyse:l}=I(),f=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,p=u[b],g=b>=u.length;return bt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:g?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(g?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:g||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[vt(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(tt(p.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ke(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:Lt(p.amountEur,i)})]}),Te(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(dt,{o:p,lg:!0})," ",t.jsx(ra,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),f&&Pe(p)&&t.jsxs("div",{className:"vbox",style:{"--c":it(p)==="retenu"?"var(--brand)":it(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:it(p)==="retenu"?"✓ "+n.kept:it(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!g&&p&&d.pipe&&Ae(p)===1&&!x.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{l(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!g&&p&&!(f&&Pe(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{c(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(g?{type:"modal",modal:null}:{type:"chainNext"}),children:g?n.closeBtn:n.skip})]})]})})}),document.body)}function Xl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=I(),o=i==="client",c=m.useMemo(()=>o?r.filter(f=>Pe(f)):[],[r,o]),s=m.useMemo(()=>Ha(c.filter(f=>it(f)==="retenu"),{key:"signal",dir:-1}),[c]),d=m.useMemo(()=>c.filter(f=>it(f)==="ecarte"),[c]),x=e.spaceTab==="retenu"?s:d,l=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Me,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(f=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":l},children:typeof f.score=="number"&&f.score>0?f.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:f.name}),t.jsx("div",{className:"rr",children:f.reasoning||f.tagline||""})]})]},f.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Zl(){const{mode:e}=I();return e==="client"||e==="apercu"?t.jsx(ec,{}):t.jsx(nc,{})}function ec(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=I(),[o,c]=m.useState("d"),s=i!=="client";return t.jsxs(Me,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>c("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>c("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>c("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(tc,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(ac,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(Vr,{})]})}function tc({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,c]=m.useState(null),[s,d]=m.useState(!1),[x,l]=m.useState(0);m.useEffect(()=>{let p=!0;return d(!1),fn(a).then(g=>{p&&(g?c(g):d(!0))}),()=>{p=!1}},[a,x]);const f=p=>{r||fn(a,p).then(g=>{if(!g){i(e.actErr);return}c(g),g.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>l(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),b=p=>{const g=o.sections||e.alertSec.map(([v])=>v);f({sections:u(p)?g.filter(v=>v!==p):[...g,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,g])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>b(p)}),t.jsxs("span",{children:[g,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ja,{label:e.alertPreview,readOnly:r,onPreview:()=>si(a),onTest:()=>ii(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function ac({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,c]=m.useState(null),[s,d]=m.useState(!1),[x,l]=m.useState(0);m.useEffect(()=>{let p=!0;return d(!1),xn(a).then(g=>{p&&(g?c(g):d(!0))}),()=>{p=!1}},[a,x]);const f=p=>{r||xn(a,p).then(g=>{if(!g){i(e.actErr);return}c(g),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>l(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,b=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>f({dow:Number(p.target.value)}),children:e.alertDow.map((p,g)=>t.jsx("option",{value:g,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ja,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ci(a),onTest:()=>li(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Vr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=I(),[c,s]=m.useState(o||""),[d,x]=m.useState(!1),[l,f]=m.useState(!1);m.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,b=m.useMemo(()=>n.filter(h=>Te(h)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(c)||l)){f(!0);try{await fetch(`${Ia}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:c.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{f(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>Ke(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>vt(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(c)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([h,N])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:N}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:c,readOnly:!!o,onChange:h=>s(h.target.value),onKeyDown:h=>{h.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function nc(){const{t:e}=I();return t.jsx(Me,{title:e.alertTitle,icon:"🔔",children:t.jsx(Vr,{})})}function rc(){var S,C;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:c,caps:s,dispatch:d,liveMemos:x}=I(),[l,f]=m.useState(null),[u,b]=m.useState([]),[p,g]=m.useState(0),v=n==="client",h=m.useMemo(()=>{const k=new Map;return i.forEach(M=>{const T=(M.name||"").trim().toLowerCase();T&&!k.has(T)&&k.set(T,M)}),k},[i]);m.useEffect(()=>{let k=!0;return(async()=>{const[M,T]=await Promise.all([Ba(r),nr(a)]);k&&(M&&f(M),b(T))})(),()=>{k=!1}},[a,r,p]);const N=(l==null?void 0:l.per_day)??0,E=((S=l==null?void 0:l.analyzed_today)==null?void 0:S.length)??0,y=l==null?void 0:l.offre,z=(l==null?void 0:l.pool_meta)||[],L=m.useMemo(()=>{const k=new Map;for(const M of(l==null?void 0:l.scheduled)||[])for(const T of M.names||[])k.has(T)||k.set(T,{label:M.day_label,date:M.date});return k},[l==null?void 0:l.scheduled]),q=(l==null?void 0:l.in_progress)||[];return t.jsxs(Me,{title:e.queueTitle,wide:!0,children:[y&&t.jsxs("div",{className:"qoffre"+(y.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:y.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:y.delai})]}),t.jsx("span",{className:"osp"}),y.rythme>0?t.jsx("span",{className:"or",children:e.qRate(y.rythme)}):y.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(y.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(E,E+(((C=l==null?void 0:l.pool_order)==null?void 0:C.length)??0))}})}),y&&t.jsxs("div",{className:"qeta",children:[y.file===0?e.qEtaDone:y.rythme<=0?e.qEtaPaused:e.qEta(y.file,y.rythme,y.jours_restants),y.en_retard&&t.jsxs("em",{children:[" ",e.qLate(y.delai,y.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(y==null?void 0:y.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(q.length>0||x.items.some(k=>k.status==="boot"||k.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[x.items.filter(k=>k.status==="boot"||k.status==="running"||k.status==="error").map(k=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:k.name}),t.jsx("span",{className:"qd",children:k.memoType||""}),t.jsx(Et,{item:k,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+k.name)),q.filter(k=>!x.liveOf(k.name)).map(k=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:k.name}),t.jsxs("span",{className:"qd",children:[k.memo_type||"",k.age_min?` · ${Math.round(k.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:k.state||""})]},"ip-"+k.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(k=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:k.company}),t.jsxs("span",{className:"qd",children:[k.memo_type,typeof k.est_min=="number"?` · ~${k.est_min} min`:""]}),t.jsx("span",{className:"qt",children:k.status}),k.url&&t.jsx("a",{className:"qgo",href:k.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),v&&k.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{mn(a,k.company,"retry").then(()=>g(M=>M+1))},children:e.queueRetry}),v&&k.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{mn(a,k.company,"delete").then(()=>g(M=>M+1))},children:e.queueDelete})]},k.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(z.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[z.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),z.map((k,M)=>{const T=L.get(k.name),O=h.get((k.name||"").trim().toLowerCase()),w=x.liveOf(k.name),A=!!(O&&c.has(O.id))||!!(w&&(w.status==="boot"||w.status==="running")),F=!!(O&&Ae(O)===1&&!O.memoUrl)&&!w;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",M+1]}),T?t.jsx("span",{className:"qwhen"+(T.label==="demain"?" soon":""),children:T.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:k.name}),k.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof k.score=="number"&&t.jsx("span",{className:"qs2",children:k.score}),w&&(w.status==="boot"||w.status==="running")&&t.jsx(Et,{item:w,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),F&&(s.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>d({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:A,onClick:()=>{o(O),g(_=>_+1)},children:A?e.actAnalyseQueued:e.actAnalyse})),k.excerpt&&t.jsx("span",{className:"qex",children:k.excerpt})]},k.name+":"+M)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([k,M])=>t.jsxs("li",{children:[t.jsx("b",{children:k})," — ",M]},k))})]})}function oc(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:c}=I(),s=`${ft}/cibles/list.csv?token=${a}`,d=`${ft}/cibles/list.json?token=${a}`,x=`${ft}/cibles/export.xlsx?token=${a}&scope=full`,l=`=IMPORTDATA("${s}")`,f=v=>{var h;(h=navigator.clipboard)==null||h.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:l},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:x,href:x}],b=!i.lockActions&&n.length>0,p=()=>{Vl(Ul(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([h])=>h===v)||["",""])[1]})),r(e.exportViewDone(n.length))},g=()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Me,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:g,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>c({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:h,href:N})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>f(h),children:e.exportCopy}),N&&t.jsx("a",{className:"exb",href:N,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function ic(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=I(),o=i!=="client",[c,s]=m.useState(null),[d,x]=m.useState(!1),[l,f]=m.useState(0),[u,b]=m.useState(!1);m.useEffect(()=>{let h=!0;return x(!1),un(a).then(N=>{h&&(N?s(N):x(!0))}),()=>{h=!1}},[a,l]);const p=()=>(c==null?void 0:c.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=h=>{if(o||!c)return;const N={enabled:h.enabled??!!c.enabled,email:h.email??(c.email||""),sections:h.sections??p()};b(!0),un(a,N).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}s(E),r(e.memoAlertSaved)})};if(d)return t.jsx(Me,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(h=>h+1),children:e.retry})]})});if(!c)return t.jsx(Me,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=p();return t.jsxs(Me,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":c.enabled===!0,disabled:o||u,style:c.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!c.enabled}),children:c.enabled?"ON":"OFF"})})]}),t.jsx(sc,{value:c.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>g({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,N])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[h],disabled:o||u,onChange:()=>g({sections:{...v,[h]:!v[h]}})}),t.jsx("span",{children:N})]},h))}),t.jsx(Ja,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>Xo(a,v),onTest:()=>Jo(a,v)})]})}function sc({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,c]=m.useState(e);m.useEffect(()=>{c(e)},[e]);const s=o.trim()!==e.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:x=>c(x.target.value),onKeyDown:x=>{x.key==="Enter"&&s&&d&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!d,onClick:()=>i(o.trim()),children:n})]})]})}function lc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=I(),[o,c]=m.useState(null),[s,d]=m.useState(!1),[x,l]=m.useState(null),[f,u]=m.useState(""),[b,p]=m.useState(0);m.useEffect(()=>{let E=!0;return d(!1),ka(a).then(y=>{E&&(y?c({configured:y.configured,url_hint:y.url_hint}):d(!0))}),ai(a).then(y=>{E&&l(y)}),()=>{E=!1}},[a,b]);const g=(E,y)=>{i&&ka(a,E).then(z=>{if(!z||z.ok===!1){n(e.actErr);return}E.test&&z.sent===!1?n(e.plugTestThrottled):r(y),p(L=>L+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),N=`curl -X POST ${ft}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Me,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(E=>E+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:f,disabled:!i,onChange:E=>u(E.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!f.trim(),onClick:()=>g({url:f.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(cc,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:N}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(N).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function cc(){const{t:e,token:a,lang:r}=I(),[n,i]=m.useState("valides"),[o,c]=m.useState(!1),[s,d]=m.useState(null),[x,l]=m.useState(null),[f,u]=m.useState(!1),[b,p]=m.useState(!1),[g,v]=m.useState(null),[h,N]=m.useState(null),[E,y]=m.useState(null),z=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{ka(a).then(T=>{N(T&&T.configured?T.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{d(null),l(null),u(!1),v(null);try{const T=JSON.parse(localStorage.getItem(z)||"null");y(T&&Date.now()-Date.parse(T.t)<24*3600*1e3?T:null)}catch{y(null)}},[z]);const L=async()=>{c(!0),u(!1),v(null);const T=await ri(a,n);d(T),l(T.ok?n:null),c(!1)},q=m.useRef(!1),S=async()=>{if(q.current)return;q.current=!0,p(!0);const T=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let O;try{O=await oi(a,n,"webhook",void 0,T)}finally{q.current=!1}if(p(!1),u(!1),v(O),O.ok&&(O.pushed||0)>0){const w={t:new Date().toISOString(),n:O.pushed||0};y(w);try{localStorage.setItem(z,JSON.stringify(w))}catch{}}},C=s!=null&&s.ok&&s.ready||0,k=!!(s!=null&&s.ok)&&x===n&&C>0&&!!h&&!E,M=E?new Date(E.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:T=>i(T.target.value),children:e.plugBulkTabs.map(([T,O])=>t.jsx("option",{value:T,children:O},T))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{L()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),E&&t.jsx("p",{className:"mnote",children:e.bulkLocked(M,E.n)}),!E&&!!(s!=null&&s.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!E&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),k&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),k&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(C,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{S()},children:b?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),g&&(g.ok?g.replayed?t.jsx("p",{className:"mnote",children:g.pending?e.bulkPending:e.bulkReplayed}):(g.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:g.error||e.actErr}))]})}function dc(){const{t:e,data:a,lang:r}=I(),n=a.credits,i=a.email,o=async c=>{if(!i)return;const s=window.location.href.split("?")[0];try{const x=await(await fetch(`${Ia}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:c,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(Me,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(c=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(c.credits,c.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(c.lookup_key)},children:e.rechargeBuy})]},c.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function pc(){const{t:e}=I();return t.jsx(Me,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Yl,{})})}function uc(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:c,flash:s}=I(),[d,x]=m.useState(null),[l,f]=m.useState(!1);m.useEffect(()=>{let C=!0;if(o)return Ba(o).then(k=>{C&&k&&typeof k.per_day=="number"&&x(k.per_day)}),()=>{C=!1}},[o]);const[u,b]=m.useState(null);m.useEffect(()=>{if(!i)return;let C=!0;return ti(i).then(k=>{C&&b(k)}),()=>{C=!1}},[i]);const p=r.stats,g=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(C=>C.kind==="target"&&Pe(C)).length,v=r.marketEstimate||0,h=v>0?Math.min(100,Math.round(g/v*100)):null,N=(p==null?void 0:p.window_days)||30,E=g>0?g/N:0,y=v>0?Math.max(0,v-g):0,L=v>0&&E>0&&g>=100?Math.round(y/E):null,q=C=>Math.round(C).toLocaleString(a==="en"?"en-US":"fr-FR"),S=C=>{l||!c||(f(!0),ni(i,C).then(k=>{if(f(!1),k===null){s(e.actErr);return}x(k),s(e.alertSaved)}))};return t.jsxs(Me,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(q(g))}),v>0&&t.jsx("span",{children:e.covOf(q(v))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),L!==null&&t.jsx("p",{className:"mnote",children:e.covEta(L)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(q(E))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((C,k)=>t.jsxs("tr",{className:C.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[C.code,C.geo?` · ${C.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof C.n=="number"?q(C.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:C.source}),C.elargi&&t.jsx("em",{children:e.covWide(String(C.demande||""))}),C.erreur&&t.jsx("em",{children:e.covMissing})]})]},k)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:q(u.total||v)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:q(p.shown)})," ",e.funShown]})]}),c&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:d===C?"on":"",disabled:l,onClick:()=>S(C),children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function mc(){var h,N,E;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:c,lang:s}=I(),d=n==="client",x=m.useMemo(()=>{const y=new Set;return a.forEach(z=>{z.angle&&y.add(z.angle)}),[...y]},[a]),[l,f]=m.useState(""),[u,b]=m.useState(""),[p,g]=m.useState(!1),v=async()=>{const y=l.trim();if(!(!y||p||!d)){g(!0),b("");try{const L=await(await fetch(`${ft}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(L.reply&&b(String(L.reply)),L.job_id){b(e.critChatRunning);const q=async()=>{const S=await fetch(`${ft}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:L.job_id})}).then(C=>C.json()).catch(()=>null);if(S&&S.done){b(String(S.reply||S.clarification||S.summary||"✓")),g(!1),S.applied&&i(e.alertSaved);return}setTimeout(()=>{q()},8e3)};setTimeout(()=>{q()},8e3),f("");return}f("")}finally{u.startsWith("⏳")||g(!1)}}};return t.jsxs(Me,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((h=o.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((N=o==null?void 0:o.angles)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var z,L;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((z=y.look)!=null&&z.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(q=>t.jsx("li",{children:q},q))})]}),!!((L=y.out)!=null&&L.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(q=>t.jsx("li",{children:q},q))})]})]})]},y.title)})]}),!!((E=o==null?void 0:o.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:x.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:l,disabled:!d||p,onChange:y=>f(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!d||p||!l.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ei,{fund:c,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Br[y]||"v-cons"),children:y}),t.jsx("span",{children:z})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",z]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function fc(){const{t:e,dispatch:a,startTour:r}=I(),n=i=>{var o,c;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(c=document.querySelector(".atl2 .demand input"))==null||c.focus())};return t.jsxs(Me,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],c)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:c+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+c))})]})}const Hr="atl2:mapfold",xc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Hr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},hc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},Wr=m.createContext(null),I=()=>{const e=m.useContext(Wr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function dt({o:e,lg:a}){const{lang:r}=I(),n=Te(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:wa(n,r),children:[n.emoji," ",wa(n,r)]}):null}function ra({o:e,src:a}){const{lang:r,t:n}=I(),i=Te(e);if(!i)return null;const o=fi(i),c=xi(i);return t.jsxs("em",{className:"sigwin"+(c?" hot":""),title:n.signaledOn(Ua(i,r))+" · "+n.win7(Wt(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,d)=>t.jsx("i",{className:d<o?"on":""},d))}),t.jsx("span",{className:"lb",children:c?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Yr({o:e}){const{lang:a}=I(),r=mi(e.cc),n=e.cc?vt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const er="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",gc=!1;function bc(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Gr=e=>`atl2:tour:${e||"anon"}`;function vc(e){try{return localStorage.getItem(Gr(e))==="1"}catch{return!0}}function tr(e){try{localStorage.setItem(Gr(e),"1")}catch{}}function yc(e,a,r,n,i){const o=e.tourT,c=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:c[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:c[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:c[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:c[0][0],modal:"crit"}].filter(Boolean)}function Sc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var Za;const{lang:c}=di(),s=Ai[c],d=Ii(e,c,a),[x,l]=m.useReducer(_i,void 0,()=>$i((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?hc():xc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??(a==="ops"?"liste":void 0),filters:r,modal:n==null?void 0:n.modal})),f=m.useRef(!0);m.useEffect(()=>{if(f.current){f.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Hr,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e,a]);const u=m.useRef(o);u.current=o,m.useEffect(()=>{var j;(j=u.current)==null||j.call(u,x.filters)},[x.filters]);const[b,p]=m.useState(null),[g,v]=m.useState(null),[h,N]=m.useState({kept:0,dropped:0}),[E,y]=m.useState(!1),[z,L]=m.useState(""),[q,S]=m.useState(!1),[C,k]=m.useState(null),[M,T]=m.useState(!1),[O,w]=m.useState(!1),[,A]=m.useState(0),F=()=>A(j=>j+1),_=m.useRef([]),W=m.useRef(new Set),H=m.useRef(new Set),[U,Y]=m.useState([]),[G,ee]=m.useState([]),[oe,je]=m.useState(0),ye=m.useRef(new Map),he=m.useRef(null),{mode:Z}=d,le=m.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),K=le.pipe,B=d.session.token||"",J=Z==="client"&&!e;m.useEffect(()=>{if(!B||!K)return;let j=!0;const $=async()=>{const Ee=await hi(B);!j||!Ee||(ee(Ee.runs),je(Date.now()/1e3-Ee.now),Y(Be=>Be.filter(ia=>!Ee.runs.some(nt=>Ze(nt.company)===Ze(ia.name)))))};$();const P=U.length>0||G.some(Ee=>Ee.status==="running"),re=window.setInterval(()=>{$()},P?8e3:25e3);return()=>{j=!1,window.clearInterval(re)}},[B,K,U.length,G.some(j=>j.status==="running")]);const me=m.useMemo(()=>{const j=[],$=new Set;for(const P of U){const re=Ze(P.name);!re||$.has(re)||($.add(re),j.push({name:P.name,id:P.id,status:"boot",started:P.started,estMin:P.estMin,memoType:"instant"}))}for(const P of G){const re=Ze(P.company);if(!re||$.has(re))continue;$.add(re);const Ee=P.status==="error"?"error":P.status==="done"?"done":"running";j.push({name:P.company,status:Ee,started:P.started||0,estMin:P.est_min||(P.memo_type==="detailed"?40:15),url:P.url,error:P.error,memoType:P.memo_type})}return j},[U,G]),te=j=>me.find($=>Ze($.name)===Ze(j))||null,be=(j,$)=>{Y(P=>P.some(re=>Ze(re.name)===Ze(j.name))?P:[...P,{name:j.name,id:j.id,started:Date.now()/1e3,estMin:$==="detailed"?40:15}]),W.current.add(j.id),F()};m.useEffect(()=>{if(document.querySelector(`link[href="${er}"]`))return;const j=document.createElement("link");j.rel="stylesheet",j.href=er,document.head.appendChild(j)},[]);const Q=(j,$=!1)=>{L(j),S($),he.current&&clearTimeout(he.current),he.current=setTimeout(()=>L(""),$?4200:2400)},ce=j=>Q(j,!0),ze=m.useMemo(()=>{const j=new Map;return d.dossiers.forEach($=>{$.id&&j.set($.id,$)}),j},[d.dossiers]),ge=m.useMemo(()=>d.dossiers.filter(j=>cr(j,x,K)),[d.dossiers,x,K]),fe=m.useRef(!1);m.useEffect(()=>{if(fe.current||e||d.loading||!d.dossiers.length)return;if(!le.showFunnel||vc(d.session.token||"")){fe.current=!0;return}fe.current=!0;const j=window.setTimeout(()=>{tr(d.session.token||""),T(!0)},700);return()=>window.clearTimeout(j)},[e,d.loading,d.dossiers.length,le.showFunnel,d.session.token]);const Oe=m.useMemo(()=>d.dossiers.filter(j=>Ui(j,x,K,d.favIds)),[d.dossiers,x,K,d.favIds]),pe=m.useMemo(()=>pi(ge,d.favIds),[ge,d.favIds]),Fe=m.useMemo(()=>{const j=xr(d.dossiers);return j?tt(j)===0?s.tourToday:hr(j,c):s.tourNoRun},[d.dossiers,s,c]),R=m.useMemo(()=>d.dossiers.some(j=>!!j.memoUrl||!!j.summary||xt(j)),[d.dossiers]),[V,X]=m.useState(!1);m.useEffect(()=>{if(d.loading){X(!1);return}if(d.dossiers.length>0||d.error){X(!0);return}const j=window.setTimeout(()=>X(!0),6e3);return()=>window.clearTimeout(j)},[d.loading,d.dossiers.length,d.error]);const ie=(d.marketEstimate||0)>0||typeof((Za=d.stats)==null?void 0:Za.screened)=="number"&&d.stats.screened>0,Ne=m.useMemo(()=>[1,0,2,4,5,3].find(j=>(pe[j]||0)>0)??0,[pe]),se=_a.find(j=>j.key===x.continent),Ie=x.continent==="monde"?s.contWorld:(c==="fr"?se==null?void 0:se.fr:se==null?void 0:se.en)||"";m.useEffect(()=>{const j=$=>{var re;const P=(((re=$.detail)==null?void 0:re.name)||"").trim();P&&Qe(null,P)};return window.addEventListener("ppmap:evaluate",j),()=>window.removeEventListener("ppmap:evaluate",j)}),m.useEffect(()=>{const j=re=>{const Ee=String(re||"").trim();Ee&&l({type:"filters",patch:{sector:[Ee]}})},$=re=>{var Ee;return j((Ee=re.detail)==null?void 0:Ee.sector)},P=re=>{re.data&&re.data.type==="pp-filter"&&j(re.data.sector)};return window.addEventListener("ppmap:filter",$),window.addEventListener("message",P),()=>{window.removeEventListener("ppmap:filter",$),window.removeEventListener("message",P)}},[]);const Qe=(j,$)=>{const P=((j==null?void 0:j.name)||$||"").trim();if(!J){v({kicker:P});return}!P||E||(y(!0),(async()=>{try{let re=P;const Ee=((j==null?void 0:j.website)||(j==null?void 0:j.domain)||"").trim();if(Ee)re=Ee;else try{const Ce=await gi(P);if(Ce!=null&&Ce.website)re=Ce.website;else if(((Ce==null?void 0:Ce.candidates)||[]).length===1)re=Ce.candidates[0].url;else if(((Ce==null?void 0:Ce.candidates)||[]).length>1){_.current=[{name:P,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(Ce.candidates||[]).slice(0,5)},..._.current].slice(0,8),F();return}}catch{}const Be=await or(B,re,"atelier2"),ia={name:Be.company||P,verdict:Be.verdict,reason:Be.reason||"",remaining:Be.remaining??null};_.current=[ia,..._.current].slice(0,8),Be.verdict==="kept"&&N(Ce=>({...Ce,kept:Ce.kept+1})),Be.verdict==="ruled_out"&&N(Ce=>({...Ce,dropped:Ce.dropped+1}));const nt=j||d.dossiers.find(Ce=>(Ce.name||"").toLowerCase()===P.toLowerCase());nt&&(Be.verdict==="kept"?nt.verdict=nt.verdict||"MATCH":Be.verdict==="ruled_out"&&(nt.verdict="NO MATCH"),Be.reason&&(nt.reasoning=Be.reason)),F()}finally{y(!1)}})())},D=j=>{if(!J){v({kicker:j.name});return}be(j,"instant"),yt(B,"fast_request",j.name||"",""),Q(s.memoInstantSent(j.name))},ne=j=>ye.current.get(j.id)??d.thumbs.get((j.name||"").trim().toLowerCase()),de=(j,$)=>l({type:"undoPush",entry:{id:j.id,name:j.name,prevCeoStatus:$}}),Se=async(j,$,P)=>{const re=j.ceoStatus||"";j.ceoStatus=$,F();const Ee=await la(B,{status:$,airtable_id:j.airtableId,check_id:j.checkId,company:j.name,...(P==null?void 0:P.note)!==void 0?{note:P.note}:{},...P!=null&&P.via?{via:P.via}:{}});return Ee.ok?Ee.skipped?(j.ceoStatus=re,F(),ce(s.actNotPersisted),!1):((P==null?void 0:P.undo)!==!1&&de(j,re),P!=null&&P.msg&&Q(P.msg),($==="Validé"||$==="Écarté")&&!j.ceoNote&&(P==null?void 0:P.note)===void 0&&k({o:j,yes:$==="Validé"}),!0):(j.ceoStatus=re,F(),ce(s.actErr),!1)},Je=async(j,$)=>{const P=await la(B,{status:j.ceoStatus||"Retenu",airtable_id:j.airtableId,check_id:j.checkId,company:j.name,note:$,via:"note"});return!P.ok||P.skipped?(ce(P.skipped?s.actNotPersisted:s.actErr),!1):(j.ceoNote=$,F(),!0)},qe=m.useRef(new Map),ve=j=>qe.current.has(j.id)?qe.current.get(j.id):d.stages.get((j.name||"").trim().toLowerCase()),$e=(j,$)=>{qe.current.set(j.id,$),F()},oa=(j,$)=>{J&&Se(j,$?"Validé":"Écarté",{msg:$?s.decidedYes(j.name):s.decidedNo(j.name)})},Rt=j=>{J&&Se(j,"À trancher",{msg:s.promoted(j.name)})},Kr=j=>{J&&(async()=>{const $=j.ceoStatus||"";j.ceoStatus="Retenu",F();const P=await la(B,{status:"Retenu",check_id:j.checkId,company:j.name});if(!P.ok||P.skipped){j.ceoStatus=$,F(),ce(P.skipped?s.actNotPersisted:s.actErr);return}de(j,$),Q(s.repeched(j.name))})()},Qr=()=>{const j=x.undo[x.undo.length-1];if(!j){Q(s.undoNone);return}const $=ze.get(j.id);if(!$){l({type:"undoPop"}),Q(s.undoNone);return}let P=j.prevCeoStatus;if(!P)if(($.verdict||"").toUpperCase().includes("CALL"))P="À trancher";else{Q(s.undoLockedTitle);return}(async()=>await Se($,P,{undo:!1})&&(l({type:"undoPop"}),$.ceoStatus=j.prevCeoStatus,F(),Q(s.undoDone($.name))))()},Jr=j=>{J&&(H.current.add(j.id),F(),(async()=>{const $=await bi(B,j.name,"email");if(!$||$.ok===!1){H.current.delete(j.id),F(),ce(s.actErr);return}yt(B,"approach",j.name||"",""),Q(s.actApproachSent)})())},Xr=(j,$)=>{J&&(async()=>{if(!(await yt(B,$?"yes":"no",j.name||"","")).ok){ce(s.actErr);return}ye.current.set(j.id,$?"yes":"no"),F(),Q($?s.thumbUpDone:s.thumbDnDone)})()},Zr=j=>{!J||!xt(j)||(be(j,"detailed"),yt(B,"detailed_request",j.name||"",""),Q(s.memoDeepSent(j.name)))},eo=j=>{const $=new Set(d.favIds),P=$.has(j.id);P?$.delete(j.id):$.add(j.id),d.setFavIds($),J&&vi(B,{id:j.id,co:j.name},P)},to=()=>{!J||O||window.confirm(s.identSyncConfirm)&&(w(!0),(async()=>{const j=await yi(B);w(!1),j?Q(s.identSyncDone):ce(s.actErr)})())},Xa=/proplace/i.test(d.fund||""),ao=j=>{!J||!Xa||(yt(B,"onboard_request",j.name||"",""),Q(s.onboardSent(j.name)))},no={st:x,dispatch:l,t:s,lang:c,mode:Z,caps:le,pipe:K,token:B,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:Kr,thumbOf:ne,canWrite:J,commitStatus:Se,saveNote:Je,stageOf:ve,setStage:$e,flashErr:ce,startTour:()=>T(!0),dossiers:d.dossiers,scopedAll:ge,scoped:Oe,counts:pe,byId:ze,contName:Ie,favIds:d.favIds,toggleFav:eo,askEvaluate:Qe,doAnalyse:D,doDecide:oa,doPromote:Rt,doApproach:Jr,doThumb:Xr,doDeep:Zr,doUndo:Qr,doSync:to,doOnboard:ao,outbound:Xa,memoQueued:W.current,liveMemos:{items:me,serverOff:oe,liveOf:te},approachDone:H.current,sessTally:h,evalCards:_.current,evalBusy:E,markRow:p,markedId:b,flash:Q};m.useEffect(()=>{const j=$=>{$.key==="Escape"&&(l({type:"popup",id:null}),l({type:"modal",modal:null}),l({type:"openFacet",facet:null}))};return window.addEventListener("keydown",j),()=>window.removeEventListener("keydown",j)},[]);const ro=j=>B?t.jsx(Hi,{token:B,children:j}):t.jsx(t.Fragment,{children:j});return t.jsx(Wr.Provider,{value:no,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":""),children:[t.jsx("style",{children:qi}),le.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:mr,children:Ya}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Yt}`,children:Yt})]}),t.jsx("button",{type:"button",onClick:()=>l({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),ro(t.jsxs("div",{className:"app"+(K?" pipe":"")+(B?" has-thesis":""),children:[le.showTicker&&t.jsx(Le,{name:"live",children:t.jsxs("div",{className:"live-stack"+(B?" live-stack--cibles":""),children:[t.jsx(Xi,{}),!!B&&t.jsx(Wi,{})]})}),le.showIdent&&t.jsx(Le,{name:"identite",children:t.jsx(xs,{})}),!1,!!B&&t.jsx(Le,{name:"brief",children:t.jsx(Yi,{})}),gc,le.showMorning&&t.jsx(Le,{name:"matin",children:t.jsx(fs,{})}),t.jsx(Le,{name:"mesure",children:t.jsx(is,{})}),le.showFunnel&&t.jsx(Le,{name:"entonnoir",children:t.jsx(wc,{})}),le.showFunnel&&t.jsx(Le,{name:"tunnel",children:t.jsx(hs,{})}),le.showFunnel&&t.jsx(Le,{name:"tuto",children:t.jsx(gs,{})}),!x.mapFolded&&t.jsx(Le,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Fr,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[t.jsx(fl,{}),t.jsx(Or,{})]})]})}),le.showDemand&&K&&t.jsx(Le,{name:"direct",children:t.jsx(Si,{items:me,serverOff:oe,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>l({type:"modal",modal:"queue"})})}),le.showDemand&&t.jsx(Le,{name:"evaluation",children:t.jsx(yl,{})}),le.showDemand&&x.memoConsole&&t.jsx(Le,{name:"console",children:t.jsx(kl,{})}),t.jsx(Le,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(Bl,{})}),d.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:s.retry})]})]})),x.popupId&&t.jsx(Le,{name:"fiche",children:t.jsx(Tl,{})}),t.jsx(Le,{name:"modales",children:t.jsx(Kl,{})}),t.jsx(rs,{}),C&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:C.o.name}),t.jsx(ps,{placeholder:C.yes?s.whyYesPh:s.whyNoPh,onDone:j=>{const $=C.o;k(null),j&&Je($,j).then(P=>{P&&Q(s.csNoteSaved)})}})]}),M&&V&&t.jsx(ms,{steps:yc(s,Fe,R,Ne,ie),onClose:()=>{T(!1),tr(B)}}),t.jsx(bc,{}),z&&t.jsx("div",{className:"flash on"+(q?" err":""),children:z}),g&&t.jsx(ui,{variant:"acquirer",initialCompany:ar().co,initialWebsite:ar().site,onClose:()=>v(null)})]})})}function wc(){const{t:e}=I(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function ar(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function kc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Yr as FlagCell,dt as SigBadge,ra as SigWin,Sc as default,kc as fmtShort,I as useV2};
