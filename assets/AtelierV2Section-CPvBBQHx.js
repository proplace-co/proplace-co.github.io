...
`,Za=Ja+Xa;function er(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function tr(t,a){return t||a.mode!=="client"||!a.token?"visiteur":er("teaser")==="1"?"apercu":"client"}const ar={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},rr=t=>ar[t],fe=t=>Object.assign(t,{continent:xa(t.cc)});function Ue(t){const a=new Set,n=[];for(const r of t){const l=(r.name||"").toLowerCase();!l||a.has(l)||(a.add(l),n.push(r))}return n}const nr=60*60*1e3;function or(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>nr?null:a}catch{return null}}function Fe(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const lr=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function ir(t,a,n="default"){const r=n!=="default",l=c.useMemo(()=>t||r?{mode:"anon"}:sa(),[t,r]),o=c.useMemo(()=>r?"visiteur":tr(t,l),[t,l,r]),i=c.useMemo(()=>rr(o),[o]),f=o!=="visiteur",d=lr(n),[p,h]=c.useState([]),[s,v]=c.useState(""),[b,m]=c.useState(null),[g,x]=c.useState(null),[u,w]=c.useState(null),[k,y]=c.useState(()=>new Map),[S,C]=c.useState(()=>new Map),[F,N]=c.useState(""),[E,P]=c.useState(new Set),[O,M]=c.useState(null),[q,T]=c.useState(!0),[B,R]=c.useState(!1),[H,oe]=c.useState(0),[de,Ae]=c.useState(0),xe=c.useRef(0),ce=c.useMemo(()=>{var V;if(o!=="client")return"";try{return((V=da())==null?void 0:V.email)||""}catch{return""}},[o]);c.useEffect(()=>{const V=++xe.current;let U=!0;const D=()=>U&&V===xe.current,I=(f&&l.token?l.token:"pub:"+a)+(d?":"+d:""),_=or(I);return _?(h(_.objs.map(fe)),_.fund&&v(_.fund),m(_.marketEstimate??null),x(_.criteria??null),w(_.stats??null),N(_.generatedAt||""),T(!1)):T(!0),(async()=>{try{if(n==="ops"){const re=await Ie(),te=((re==null?void 0:re.recent_ops)||[]).map(Q=>$e(Q,a)).filter(Q=>!!Q);if(!D())return;h(te.map(fe)),Fe(I,{objs:te})}else if(typeof n=="object"){const te=(await nt()||[]).filter(J=>(J.slug||"")===n.research).map(J=>ot(J,a)).filter(J=>!!J),Q=Ue(await lt(te,a));if(!D())return;h(Q.map(fe)),Fe(I,{objs:Q})}else if(f&&l.token){const re=ca(l.token),te=Ie(),Q=pa(l.token),J=ua(l.token),je=fa(l.token),$=await re;let le=$?$.targets:[];D()&&$&&(v($.fund||""),m($.marketEstimate??null),x($.criteria??null),w($.stats??null),N($.generatedAt||""),h(le.map(fe)),T(!1),R(!1));const[pe,Ne,ge,ae]=await Promise.all([te,Q,J,je]),he=((pe==null?void 0:pe.recent_ops)||[]).map(ne=>$e(ne,a)).filter(ne=>!!ne);if(le=[...le,...he],!D())return;h(le.map(fe));const Se=new Set;for(const ne of Ne){const be=(ne.id||ne.co||"").toString().trim().toLowerCase();be&&Se.add(be.startsWith("t:")?be:"t:"+be)}P(Se),y(ge),C(ae),$&&Fe(I,{fund:$.fund,marketEstimate:$.marketEstimate,criteria:$.criteria,stats:$.stats,generatedAt:$.generatedAt,objs:le})}else{const re=ma(),te=nt(),Q=Ie(),J=await re;D()&&J.length&&(h(Ue(J).map(fe)),T(!1),R(!1));const[je,$]=await Promise.all([te,Q]),le=(je||[]).map(ae=>ot(ae,a)).filter(ae=>!!ae),pe=await lt(le,a),Ne=(($==null?void 0:$.recent_ops)||[]).map(ae=>$e(ae,a)).filter(ae=>!!ae),ge=Ue([...J,...pe,...Ne]);if(!D())return;h(ge.map(fe)),Fe(I,{objs:ge})}D()&&R(!1)}catch{D()&&!_&&R(!0)}finally{D()&&T(!1)}})(),()=>{U=!1}},[f,l.token,a,H,d]),c.useEffect(()=>{if(!i.showCredits||!ce){M(null);return}let V=!0;return(async()=>{try{const U=await fetch(`${Ye}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ce})});if(!U.ok)return;const D=await U.json();V&&D&&D.ok!==!1&&M(D)}catch{}})(),()=>{V=!1}},[i.showCredits,ce,de]);const Y=c.useCallback(V=>P(new Set(V)),[]);return{session:l,mode:o,caps:i,fund:s,email:ce,marketEstimate:b,generatedAt:F,criteria:g,stats:u,thumbs:k,stages:S,dossiers:p,favIds:E,setFavIds:Y,credits:O,reloadCredits:()=>Ae(V=>V+1),loading:q,error:B,refresh:()=>oe(V=>V+1)}}const Mt=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),sr=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...Mt(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function dr(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(l=>l!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(l=>l!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Mt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||De)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const De=60;function Je(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!K(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(We(t)))return!1;if(r!=="win"&&a.win!=="all"){const l=a.win==="1"?0:a.win==="7"?7:30;if(ye(t.date)>l)return!1}if(r!=="status"&&!n&&a.status!=="all"&&se(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const l=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(l))return!1}return!0}function Dt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:Je(t,a.filters,n)}function cr(t,a,n,r){return!(!Dt(t,a,n)||n&&!ga(t,a.ptab,r))}function Xe(t,a){const n=a.key,r=l=>{switch(n){case"name":return(l.name||"").toLowerCase();case"country":return l.countryLabel||l.cc||"";case"stage":return l.stage||"";case"amount":return l.amountEur||-1;case"age":return-ye(l.date);case"score":return typeof l.score=="number"?l.score:-1;case"signal":{const o=K(l);return o?100-(o.left??0):-1}}};return[...t].sort((l,o)=>{const i=r(l),f=r(o);return i<f?-a.dir:i>f?a.dir:(l.name||"").localeCompare(o.name||"")})}function pr(){const{dossiers:t,st:a,t:n,dispatch:r,contName:l,pipe:o}=z(),i=c.useMemo(()=>{const d=s=>o?!0:s.continent===a.continent,p=t.filter(s=>d(s)&&K(s)),h=t.filter(s=>d(s)&&s.kind==="op"&&!K(s)&&(s.dealKind==="ma"||s.dealKind==="levee")&&ye(s.date)<=2);return h.sort((s,v)=>(v.amountEur||0)-(s.amountEur||0)),[...Xe(p,{key:"signal",dir:-1}),...h].slice(0,40)},[t,a.continent,o]),f=d=>i.map(p=>e.jsxs("button",{type:"button",className:"tk"+(X(p)?" spent":""),onClick:h=>{const s=h.currentTarget.getBoundingClientRect();r({type:"popup",id:p.id,anchor:{x:s.left+s.width/2,y:s.bottom}})},title:p.name+(p.tagline?" — "+p.tagline:""),children:[e.jsx(ke,{o:p}),e.jsxs("span",{className:"who",children:[e.jsx(Vt,{o:p}),e.jsx("span",{className:"co",children:p.name})]}),typeof p.amountEur=="number"&&p.amountEur>0&&e.jsx("span",{className:"am",children:zn(p.amountEur)}),p.sector&&e.jsx("span",{className:"mt",children:p.sector}),e.jsx(Be,{o:p}),e.jsx("span",{className:"tkgo",children:"→"})]},d+(p.id||p.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:i.length})]}),e.jsx("div",{className:"win",children:i.length?e.jsxs("div",{className:"run",children:[f(0),f(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(l)})})})]})}const ur="aDx8z7Hzksus",qt="+33 6 83 10 72 86",gt="alexandre@proplace.co",fr=`tel:${qt.replace(/[^\d+]/g,"")}`,ht="pp-rdv-slot";function mr(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function xr(){const{t,caps:a,fund:n}=z(),r=a.showOnb,l=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:hr}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:fr,children:qt}),t.rdvSubMid,e.jsx("a",{href:`mailto:${gt}`,children:gt})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(l).map(([o,i],f)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(f+1)}),e.jsx("b",{children:o}),e.jsx("span",{children:i})]},o))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(Wa,{filloutId:ur,parameters:n?{company_name:n}:void 0})})]})}function gr(){const[t,a]=c.useState(()=>typeof document>"u"?null:document.getElementById(ht));return c.useEffect(()=>{t||a(document.getElementById(ht))},[t]),t?Te.createPortal(e.jsx(xr,{}),t):null}const hr=`
...
`;class G extends c.Component{constructor(){super(...arguments);at(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(n,r){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,n,r.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const br=8;function vr(){const{t,lang:a,token:n,dossiers:r,caps:l,markRow:o,dispatch:i}=z(),[f,d]=c.useState(!1),[p,h]=c.useState(!1),[s,v]=c.useState(!1),b=n||"home",{names:m,verdicts:g}=c.useMemo(()=>{const y=[],S={};return r.forEach(C=>{C.kind!=="target"||!C.name||(y.push(C.name),S[C.name]=ha(C)||"")}),{names:y,verdicts:S}},[r]),x=c.useMemo(()=>m.length?ba(b,m,g,a):null,[b,m.length]);if(!l.pipe||f||!x||x.firstVisit||!x.added.length&&!x.gone.length)return null;const u=p?x.added:x.added.slice(0,br),w=x.added.length-u.length,k=y=>{const S=r.find(C=>C.name===y);S&&(o(S.id),i({type:"popup",id:S.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(x.added.length,x.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{d(!0),va(b,m,g,x.fp,a)},children:"×"})]}),!!x.added.length&&e.jsxs("div",{className:"since-c",children:[u.map(y=>e.jsx("button",{type:"button",onClick:()=>k(y),children:y},y)),w>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>h(!0),children:t.sinceMore(w)})]}),!!x.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>v(y=>!y),children:t.sinceOut(x.gone.length)}),s&&x.gone.slice(0,20).map(y=>e.jsx("span",{className:"gone",children:y},y))]})]})}const _e=600,me=62,bt="atl2:fstats";function yr(){const{t,lang:a,data:n,caps:r,st:l,dispatch:o}=z(),[i,f]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(bt)==="on"}catch{return!1}}),d=n.stats,p=c.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),h=c.useMemo(()=>{if(d!=null&&d.since)return d.since;const w=new Date;return w.setDate(w.getDate()-((d==null?void 0:d.window_days)||30)),w.toISOString().slice(0,10)},[d==null?void 0:d.since,d==null?void 0:d.window_days]);if(!r.showFunnel||!d||typeof d.screened!="number")return null;const s=w=>a==="en"?w.slice(5,10):`${w.slice(8,10)}/${w.slice(5,7)}`,v=w=>w.toLocaleString(a==="en"?"en-US":"fr-FR"),b=p.reduce((w,k)=>Math.max(w,k.s||0),0),m=p.length?_e/p.length:0,g=Math.max(4,m-4),x=p.length>=5&&b>0,u=[[d.screened,t.funScreened(s(h)),d.screened_today],...typeof d.kept=="number"?[[d.kept,t.funKept,d.kept_today]]:[],...typeof d.analyzed=="number"?[[d.analyzed,t.funAnalyzed,d.analyzed_today]]:[],...typeof d.shown=="number"?[[d.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(i?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[u.map(([w,k,y],S)=>e.jsxs("span",{className:"fst-t",children:[S>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:v(w)}),e.jsx("i",{children:k}),i&&typeof y=="number"&&y>0&&e.jsx("em",{children:t.funToday(y)})]},k)),x&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":i,title:i?t.fstatsHide:t.fstatsShow,onClick:()=>{const w=!i;f(w),w&&!l.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(bt,w?"on":"off")}catch{}},children:i?"⌃":"⌄"})]}),i&&x&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${_e} ${me}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[p.map((w,k)=>{const y=(w.s||0)/b*(me-4),S=(w.m||0)/b*(me-4),C=k*m+(m-g)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${s(w.d)} — ${w.s} ${t.actScreened} · ${w.m} ${t.actKept}`}),e.jsx("rect",{x:C,y:me-2-y,width:g,height:y,fill:"#cfe0d6"}),e.jsx("rect",{x:C,y:me-2-S,width:g,height:S,fill:"#185c38"})]},w.d)}),e.jsx("line",{x1:0,y1:me-1.5,x2:_e,y2:me-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:s(p[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const wr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function kr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:l}=z(),[o,i]=c.useState(""),[f,d]=c.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const p=(t.ceoStatus||"").trim(),h=(Pe(t)||"").startsWith("CALL")&&ee(t)===3,s=ee(t)>=2,v=async m=>{if(o||m==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;i(m);const g=await l(t,m);i(""),g&&(d(!0),setTimeout(()=>d(!1),2200))},b=h?[["Validé",a.csYes],["Écarté",a.csNo]]:wr.filter(([m])=>!(s&&m==="Retenu")).map(([m,g])=>[m,a[g]]);return e.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,g])=>e.jsx("button",{type:"button",className:"csb"+(p===m?" on":"")+(o===m?" busy":""),disabled:!!o,onClick:()=>{v(m)},children:g},m)),f&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(jr,{o:t})]})}function jr({o:t}){const{t:a,saveNote:n,flash:r}=z(),[l,o]=c.useState(t.ceoNote||""),[i,f]=c.useState(!1),[d,p]=c.useState(!1),h=l.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(i||!h)return;f(!0);const v=await n(t,l.trim());f(!1),v&&(p(!0),setTimeout(()=>p(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:l,disabled:i,onChange:v=>o(v.target.value),onKeyDown:v=>{v.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:i||!h,onClick:()=>{s()},children:d?a.csNoteSaved:a.csNoteOk})]})}function Nr({placeholder:t,onDone:a}){const{t:n}=z(),[r,l]=c.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>l(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Sr({o:t}){var x;const{t:a,token:n,caps:r,canWrite:l,stageOf:o,setStage:i,flashErr:f}=z(),[d,p]=c.useState(!1);if(!r.pipe||!l||r.lockActions||ee(t)!==4)return null;const h=o(t),s=(h==null?void 0:h.stage)||"todo",v=async u=>{if(d||u===s)return;p(!0);const w=h;i(t,{stage:u,stamps:(h==null?void 0:h.stamps)||{}});const k=Math.max(Date.now(),vt+=1);vt=k;const y=await ya(n,{company:t.name||"",stage:u,cts:k,deal_id:t.airtableId,check_id:t.checkId});p(!1),!y.stale&&(y.ok||(i(t,w),f(a.actErr)))},b=(x=h==null?void 0:h.stamps)==null?void 0:x.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=s==="sent"&&b&&m>=4;return e.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,w])=>e.jsx("button",{type:"button",className:"stgb"+(s===u?" on":""),disabled:d,onClick:()=>{v(u)},children:w},u)),g&&e.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let vt=0;const Re=8,Me=340;function yt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function Cr({steps:t,onClose:a}){const{t:n,dispatch:r,counts:l,scoped:o,byId:i,st:f}=z(),[d,p]=c.useState(0),[h,s]=c.useState(null),[v,b]=c.useState([]),m=c.useRef(!1);c.useEffect(()=>{m.current||(m.current=!0,b(t.filter(S=>!!document.querySelector(S.need||S.sel))))},[t]);const g=v[d],x=d>=v.length;c.useEffect(()=>{g&&(g.ptab!==void 0&&f.ptab!==g.ptab&&r({type:"ptab",tab:g.ptab}),g.dens&&f.dens!==g.dens&&r({type:"dens",dens:g.dens}))},[d,g]);const u=c.useCallback(()=>{if(!g){s(null);return}const S=document.querySelector(g.sel);if(!S){s(null);return}S.scrollIntoView({block:"nearest",behavior:"smooth"}),s(S.getBoundingClientRect())},[g]);c.useLayoutEffect(()=>{u();const S=window.setTimeout(u,260),C=()=>u();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{window.clearTimeout(S),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[u]);const w=c.useRef(a);if(w.current=a,c.useEffect(()=>{const S=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),w.current()):C.key==="ArrowRight"?p(F=>F+1):C.key==="ArrowLeft"&&p(F=>Math.max(0,F-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!v.length)return null;let k=null;if(x){const S=l[3]||0,C=o.find(F=>F.memoUrl)||[...i.values()].find(F=>F.memoUrl);S>0?k={title:S===1?n.ahaATitle1:n.ahaATitleN(S),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:C?k={title:n.ahaBTitle,body:n.ahaBBody(C.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:C.id}),a()}}:k={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Me};if(!x&&h){const S=h.bottom+14,F=window.innerHeight-S>190?S:Math.max(12,h.top-200);y={left:Math.min(Math.max(12,h.left+h.width/2-Me/2),window.innerWidth-Me-12),top:F,width:Me}}return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!x&&h&&e.jsx("div",{className:"tour-hole",style:{left:h.left-Re,top:h.top-Re,width:h.width+Re*2,height:h.height+Re*2}}),(x||!h)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(x?" fin":""),style:y,children:[x&&k?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:k.title}),e.jsx("p",{children:e.jsx(yt,{text:k.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>p(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(d+1,v.length)}),e.jsx("h3",{children:g==null?void 0:g.title}),e.jsx("p",{children:e.jsx(yt,{text:(g==null?void 0:g.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>p(S=>Math.max(0,S-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>p(S=>S+1),children:d===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function zr(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:l}=z(),o=c.useMemo(()=>t.filter(s=>ye(s.date)===0&&s.kind==="target"),[t]),i=c.useMemo(()=>o.filter(s=>a?ee(s)===0:!X(s)),[o,a]),f=o.length-i.length,d=o.length?Math.min(100,f/o.length*100):100;let p;a?p=n.morningThesis(o.length,f,i.length):o.length?f===0?p=n.goalSourced(o.length):f>=o.length?p=n.goalCleared:p=n.goalDone(f,o.length):p=n.goalSourced(0);const h=()=>{a?(l({type:"ptab",tab:0}),l({type:"filters",patch:{win:"1"}})):l({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:p}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:d+"%"}})}),i.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:a?n.morningEval(i.length):r.pileMode?n.goalContinue(i.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Er(){var P;const{t,st:a,dispatch:n,token:r,fund:l,data:o,dossiers:i,mode:f,doSync:d,startTour:p}=z(),[h,s]=c.useState(null),[v,b]=c.useState([]),[m,g]=c.useState(!1),x=f==="client";c.useEffect(()=>{if(!r||!l)return;let O=!0;return(async()=>{const[M,q]=await Promise.all([Tt(l),At(r)]);O&&(M&&s(M),b(q))})(),()=>{O=!1}},[r,l]);const u=(h==null?void 0:h.per_day)??null,w=((P=h==null?void 0:h.pool_order)==null?void 0:P.length)??0,k=v.filter(O=>O.status==="running").length,y=O=>{if(!x||u===null||m)return;const M=Math.max(0,Math.min(10,u+O));M!==u&&(g(!0),s(q=>q&&{...q,per_day:M}),Ot(r,M).then(q=>{g(!1),s(q===null?T=>T&&{...T,per_day:u}:T=>T&&{...T,per_day:q})}))},S=c.useMemo(()=>i.filter(O=>O.kind==="target"&&X(O)).length,[i]),C=o.marketEstimate,F=C&&C>0?Math.min(100,Math.round(S/C*100)):null,N=(l||"P").split(/\s+/).map(O=>O[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const O=Date.parse(o.generatedAt||"");if(Number.isNaN(O))return"";const M=new Date(O),q=T=>String(T).padStart(2,"0");return`${q(M.getDate())}/${q(M.getMonth()+1)} à ${q(M.getHours())}:${q(M.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:l})]}),e.jsx("h1",{children:t.identTitle(l||"…")}),e.jsx("span",{className:"idsp"}),E&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(E)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:p,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[F!==null&&C&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:F+"%"}})}),e.jsxs("b",{children:[F," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(S,C)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),u!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),y(-1)},children:"−"}),e.jsx("b",{className:"q",children:u})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),y(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),u===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),k>0&&e.jsxs("span",{className:"ev",children:["⏳ ",k]}),e.jsx("span",{className:"ego",children:t.identPending(w)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:O=>{O.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!x,onClick:d,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:O=>n({type:"filters",patch:{search:O.target.value}})})]})]})]})}function Tr(){const{t,counts:a,dispatch:n}=z();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,l],o)=>{const i=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(i?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:l}),i&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Ar=["--p0","--p1","--p2","--p3","--p4"];function Or(){const{st:t,dispatch:a,counts:n,t:r,doUndo:l}=z(),o=c.useRef({});c.useEffect(()=>{o.current={...n}},[n]);const i=p=>{const h=o.current[p],s=h!==void 0?n[p]-h:0;return e.jsxs("button",{type:"button",className:"step"+(p===3&&n[3]>0?" wait":""),style:{"--c":`var(${Ar[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===p,title:r.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[e.jsxs("span",{className:"l",children:[r.plabels[p].toUpperCase(),p===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[p],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},p)},f=(p,h,s)=>e.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":p===5?"var(--p5)":p===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===p,title:r.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[p]})]},p),d=(p,h,s,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:h,disabled:v,onClick:s,children:p},h);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(i)}),e.jsxs("div",{className:"offtrack",children:[f(5,!1,r.plabels[5]),f(7,!0,r.plabels[7]),f(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[d("↩",r.toolUndo,l,t.undo.length===0),d("↺",r.toolReset,()=>{a({type:"reset"})}),d("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),d("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),d("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Lr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Fr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:l,doAnalyse:o,mode:i}=z(),f=c.useRef(null),[d,p]=c.useState(60);c.useEffect(()=>{let b=0;const m=()=>{var k;const g=f.current;if(!g)return;const x=(k=g.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!x)return;const u=x.getBoundingClientRect(),w=g.getBoundingClientRect();p(Math.max(20,Math.min(u.left+u.width/2-w.left,w.width-30)))};return b=requestAnimationFrame(m),window.addEventListener("resize",m),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",m)}},[t.ptab]);const h=t.ptab;let s=n.tuto[h].p;if(h===3){const b=r.filter(x=>x.kind==="target"&&ee(x)===3),m=b.filter(x=>He(x)==="auto").length,g=b.filter(x=>He(x)==="cd").length;s=n.tutoPending(m,g,b.length)}const v=(()=>{if(i!=="client")return null;if(h===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(h===1){const b=r.filter(m=>m.kind==="target"&&ee(m)===1&&!l.has(m.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(m=>o(m))}}return null})();return e.jsxs("div",{ref:f,className:"tuto mini",style:{"--bg":Lr[h],"--ax":d+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[h].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const wt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function kt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Rr(t,a){const[n,r]=c.useState(1);return c.useEffect(()=>{let l=!0,o=0;const i=()=>{var p;if(!l)return;const d=(p=t.current)==null?void 0:p.getScreenCTM();d&&d.a>0?r(d.a):o=requestAnimationFrame(i)};i();const f=new ResizeObserver(()=>i());return t.current&&f.observe(t.current),window.addEventListener("resize",i),()=>{l=!1,cancelAnimationFrame(o),f.disconnect(),window.removeEventListener("resize",i)}},[t,a]),n}function Mr(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:l,markedId:o,byId:i,lang:f,t:d}=z(),p=c.useRef(null),h=c.useRef(null),s=Ge.find(N=>N.key===t.continent),v=Rr(p,t.continent+":"+t.mapFolded),[b,m]=c.useState(new Map),[g,x]=c.useState(null);c.useEffect(()=>{const N=p.current;if(!N)return;const E=new Map;N.querySelectorAll("path[data-i2]").forEach(P=>{const O=P.dataset.i2;if(O)try{const M=P.getBBox();M.width>0&&E.set(O,{x:M.x,y:M.y,w:M.width,h:M.height})}catch{}}),m(E)},[t.continent,v]);const u=c.useMemo(()=>n.filter(N=>N.cc),[n]),w=c.useMemo(()=>{const N=new Map;return u.forEach(E=>N.set(E.cc,(N.get(E.cc)||0)+1)),N},[u]),k=c.useMemo(()=>u.map(N=>{const E=N.cc?b.get(N.cc):void 0;if(!E)return null;const P=kt(N.name||N.id||""),O=kt((N.id||N.name||"")+"·y"),M=(P-.5)*Math.min(E.w*.55,60),q=(O-.5)*Math.min(E.h*.55,60);return{d:N,x:E.x+E.w/2+M,y:E.y+E.h/2+q}}).filter(N=>!!N),[u,b]),y=N=>v>0?N/v:N,S=c.useMemo(()=>r?[0,1,2,3,4,5].map(N=>({c:wt[N],fr:d.plabels[N].toUpperCase(),en:d.plabels[N].toUpperCase(),n:n.filter(E=>E.kind==="target"&&ee(E)===N).length})).filter(N=>N.n>0):it.map((N,E)=>({...N,n:n.filter(P=>st(P)===E).length})),[n,r,d.plabels]),C=o?i.get(o):null,F=C?k.find(N=>N.d.id===C.id):null;return e.jsxs("div",{className:"mapzone",ref:h,children:[e.jsxs("svg",{ref:p,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":f==="fr"?s.fr:s.en,onMouseLeave:()=>{x(null),l(null)},children:[e.jsx("g",{children:s.countries.map((N,E)=>e.jsx("g",{className:"ct"+(N.i2&&w.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},E))}),e.jsx("g",{children:k.map(N=>{const E=it[st(N.d)],P=!!K(N.d),O=N.d.kind==="target",M=r&&O?wt[ee(N.d)]:E.c,q=!r&&X(N.d);return e.jsxs("g",{className:"co"+(q?" done":""),onMouseEnter:()=>{var R,H;const T=(R=h.current)==null?void 0:R.getBoundingClientRect(),B=(H=p.current)==null?void 0:H.createSVGPoint();if(B&&p.current&&T){B.x=N.x,B.y=N.y;const oe=B.matrixTransform(p.current.getScreenCTM());x({x:oe.x-T.left,y:oe.y-T.top,label:N.d.name+" · "+(we(N.d.cc,f)||N.d.countryLabel||"")})}l(N.d.id)},onMouseLeave:()=>{x(null),l(null)},onClick:()=>{var R;const T=(R=p.current)==null?void 0:R.createSVGPoint();let B=null;if(T&&p.current){T.x=N.x,T.y=N.y;const H=T.matrixTransform(p.current.getScreenCTM());B={x:H.x,y:H.y}}a({type:"popup",id:N.d.id,anchor:B})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:y(Math.max(11,E.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:y(E.px),fill:M,stroke:P?"#DC2626":"#ffffff",strokeWidth:y(P?2.2:1.3)})]},N.d.id||N.d.name)})}),F&&e.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:y(13),fill:"none",stroke:"#0F172A",strokeWidth:y(2)})]}),e.jsx("div",{className:"hov"+(g?" on":""),style:g?{left:g.x,top:g.y}:void 0,children:g==null?void 0:g.label}),e.jsx("div",{className:"legend",children:S.map((N,E)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),f==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},E))}),n.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",d.notLocated," ",e.jsx("b",{children:n.filter(N=>!N.cc).length})]})})]})}function Dr(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:l,contName:o}=z(),i=t.filters,f=c.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),d=b=>f.filter(m=>b!=="country"&&i.country.length&&!i.country.includes(m.cc||"")?!1:Je(m,i,l,b==="country"?void 0:b)),p=c.useMemo(()=>{const b=d("win"),m=g=>b.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=g).length;return[m(0),m(7),m(30),b.length]},[f,i,l]),h=c.useMemo(()=>{if(l)return null;const b=d("status"),m={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(g=>{m[se(g)]+=1}),m},[f,i,l]),s=i.sector.length+i.country.length+i.engine.length+i.stage.length+i.angle.length+i.memoLevel.length+(i.signalOnly?1:0)+(i.win!=="all"?1:0)+(!l&&i.status!=="all"?1:0)+(i.search.trim()?1:0),v=(b,m,g,x="fbtn")=>e.jsxs("button",{type:"button",className:x,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:m}),g>0&&e.jsx("span",{className:"n",children:g}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,m)=>e.jsxs("button",{type:"button","aria-pressed":i.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[m],e.jsx("b",{children:p[m]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:i.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!l&&h&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,m])=>e.jsxs("button",{type:"button","aria-pressed":i.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[m,e.jsx("b",{children:h[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),i.signalOnly&&e.jsx("span",{className:"n",children:i.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,i.sector.length),v("pay",r.fCountry,i.country.length),v("det",r.fEngine,i.engine.length),v("sta",r.fStage,i.stage.length),l&&v("ang","Angle",i.angle.length),l&&v("mem","Mémo",i.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(f.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(qr,{poolFor:d})]})}function qr({poolFor:t}){const{st:a,dispatch:n,t:r,lang:l}=z(),o=a.filters,i=a.openFacet,{title:f,cols:d,options:p}=c.useMemo(()=>{if(i==="sig"){const m=t("signal").filter(u=>K(u)),g=new Map;m.forEach(u=>{const w=u.engine||"";g.set(w,(g.get(w)||0)+1)});const x=[{v:"*",label:r.fpSigAll,n:m.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...dt([...g.keys()],l).map(u=>({v:u,label:ve(u)+" "+ie(u,l),n:g.get(u)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(u)}))];return{title:r.fpSigTitle,cols:2,options:x}}if(i==="sec"){const m=t("sector"),g=new Map;return m.forEach(x=>{x.sector&&g.set(x.sector,(g.get(x.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:x,n:u,html:!1,on:o.sector.includes(x)}))}}if(i==="pay"){const m=t("country"),g=new Map;return m.forEach(x=>{x.cc&&g.set(x.cc,(g.get(x.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:we(x,l)||x,n:u,html:!1,on:o.country.includes(x)}))}}if(i==="det"){const m=t("engine"),g=new Map;return m.forEach(x=>{x.engine&&g.set(x.engine,(g.get(x.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:dt([...g.keys()],l).map(x=>({v:x,label:ve(x)+" "+ie(x,l)+' <span style="color:var(--dim);font-size:10px">· '+wa(ka(x),l)+"</span>",n:g.get(x)||0,html:!0,on:o.engine.includes(x)}))}}if(i==="ang"){const m=t("angle"),g=new Map;return m.forEach(x=>{x.angle&&g.set(x.angle,(g.get(x.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:x.replace(/[_-]+/g," "),n:u,html:!1,on:o.angle.includes(x)}))}}if(i==="mem"){const m=t("memoLevel"),g=new Map;m.forEach(u=>{if(u.kind==="target"){const w=We(u);g.set(w,(g.get(w)||0)+1)}});const x=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(u=>({v:String(u),label:x[u],n:g.get(u)||0,html:!1,on:o.memoLevel.includes(u)}))}}const v=t("stage"),b=new Map;return v.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,g)=>g[1]-m[1]).map(([m,g])=>({v:m,label:m,n:g,html:!1,on:o.stage.includes(m)}))}},[i,a,l]),h=v=>{if(i==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const m=o.signalEngines.includes(v)?o.signalEngines.filter(g=>g!==v):[...o.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(i==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage",value:v})},s=()=>{n(i==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:i==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:f}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(d===2?" two":""),children:p.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>h(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const jt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Pr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:l,dispatch:o,evalBusy:i,evalCards:f,caps:d,data:p}=z(),h=a==="client",[s,v]=c.useState(""),[b,m]=c.useState(!1),[g,x]=c.useState(""),[u,w]=c.useState(!1),[k,y]=c.useState(""),[S,C]=c.useState([]),F=c.useRef(!1),N=s.trim()?jt.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,E=c.useMemo(()=>g.split(`
`).map(T=>T.trim()).filter(Boolean).slice(0,15),[g]),P=S.length?S:f,O=p.credits,M=()=>{const T=s.trim();T&&(r(null,T),v(""))},q=async()=>{if(!h){r(null,E[0]||"");return}if(!E.length||u)return;w(!0),F.current=!1;const T=[];for(let B=0;B<E.length&&!F.current;B++){y(t.evaluating(B+1,E.length,E[B]));const R=await Lt(n,E[B],"atelier2");if(T.unshift({name:R.company||E[B],verdict:R.verdict,reason:R.reason||"",remaining:R.remaining??null}),C([...T]),R.verdict==="quota"){T.unshift({name:"",verdict:"quota",reason:t.quota(E.length-B-1),remaining:0}),C([...T]);break}}y(""),x(""),w(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:T=>v(T.target.value),onKeyDown:T=>{T.key==="Enter"&&M()}}),e.jsx("span",{className:"detect"+(jt.test(s.trim())?" url":""),children:N})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),disabled:i,onClick:M,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),d.showCredits&&O&&e.jsxs("button",{type:"button",className:"credits"+(O.total_available<=0&&!O.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:O.unlimited?"∞":O.total_available}),!O.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",O.daily_grant+O.purchased]}),O.total_available<=0&&!O.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>m(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:g,placeholder:t.bulkPh,onChange:T=>x(T.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{justifyContent:"center"},disabled:u||!E.length,onClick:()=>{q()},children:[e.jsx("span",{className:"fill"}),u&&k?k:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(E.length)})]})]}),P.slice(0,1).map((T,B)=>{const R=T.verdict==="kept",H=T.verdict==="quota",oe=R?"var(--brand)":H?"var(--bolt)":"var(--red)",de=R?"var(--brand-l)":H?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":oe,"--bgc":de},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:R?"✓ "+t.kept:H?"⏳":"✗ "+t.dropped})}),T.name&&e.jsx("span",{className:"rn",children:T.name}),e.jsx("span",{className:"rr",children:T.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",T.reason]}):null}),!H&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(R?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},B)}),h&&(l.kept+l.dropped>0||P.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(l.kept,l.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Br(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ir(){const{st:t,dispatch:a,byId:n,t:r,doDeep:l}=z(),o=t.memoConsole?n.get(t.memoConsole):null,i=c.useMemo(()=>o?[o.reasoning||"",Br(o.summary||"")].filter(Boolean).join(`
...
`;function Qr(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,l=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let i=t.y+10;return i+n>l-8&&(i=Math.max(8,t.y-n-14)),i<8&&(i=8),{left:o,top:i}}function Jr(){const{st:t,dispatch:a,byId:n,t:r,lang:l,caps:o,mode:i,askEvaluate:f,doAnalyse:d,doDecide:p,doPromote:h,doRepeche:s,doApproach:v,doDeep:b,doOnboard:m,outbound:g,evalBusy:x}=z(),u=t.popupId?n.get(t.popupId):null;if(!u)return null;const w=K(u),k=ee(u),y=Pe(u),S=u.kind==="target",C=F=>{a({type:"filters",patch:F}),a({type:"popup",id:null})};return Te.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Kr}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Qr(t.popupAnchor),onClick:F=>F.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:u.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(ye(u.date)),ie(u.engine,l))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[u.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[u.cc]}),children:(we(u.cc,l)||u.countryLabel||"").toUpperCase()}),u.sector&&e.jsx("button",{type:"button",onClick:()=>C({sector:[u.sector]}),children:u.sector.toUpperCase()}),u.stage&&e.jsx("button",{type:"button",onClick:()=>C({stage:[u.stage]}),children:u.stage.toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{className:"am2",children:Qe(u.amountEur,l)})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[ve(u.engine)," ",e.jsx("b",{children:ie(u.engine,l)})," — ",Sa(u.engine,l),u.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",u.noteTitle]})]}),w?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(ke,{o:u,lg:!0})," ",e.jsx(Be,{o:u,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(Ft(w,l))," · ",r.win7(Rt(w,l))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&k>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),o.pipe&&S&&y&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[y,typeof u.score=="number"&&u.score>0?" · "+r.score(u.score):""]})})]}),e.jsx(Pt,{name:u.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||i!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[k===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>f(u),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),k===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),k===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),k===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(u,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{p(u,!1),a({type:"popup",id:null})},children:r.actNo}),Ke(u)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{b(u),a({type:"popup",id:null})},children:r.memoDeep})]}),k===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{v(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),k===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),u.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:u.id}),a({type:"popup",id:null})},children:"📄"}),g&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{m(u),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>f(u),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),u.website&&e.jsx("a",{className:"psite",href:u.website.startsWith("http")?u.website:"https://"+u.website,target:"_blank",rel:"noopener noreferrer",title:u.website,children:"🌐"})]})]})]}),document.body)}function St(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Xr(t,a){const n=Ca(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function Zr(t,a){const r=[a.head.split("|").map(St).join(";")];for(const l of t){const o=a.stageOf(l);r.push([l.name||"",Xr(l,a.plabels),qe(l)||l.verdict||"",typeof l.score=="number"?l.score:"",l.countryLabel||l.cc||"",l.sector||"",o?a.stageLabel(o.stage):"",l.contactName||"",l.contactEmail||"",l.memoUrl||"",(l.date||"").slice(0,10),(l.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(St).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function en(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const tn=50;function et({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:l}=z(),[o,i]=c.useState(null),[f,d]=c.useState(!1),[p,h]=c.useState(""),[s,v]=c.useState(0),[b,m]=c.useState(""),[g,x]=c.useState(!1),u=c.useRef(null);c.useEffect(()=>()=>{u.current&&window.clearInterval(u.current)},[]);const w=async y=>{d(!0),h("");const S=await a();if(d(!1),S.ok){i(S);return}if(S.busy){h(l.alertPreviewBusy);return}if(!y){h(l.alertPreviewFail);return}v(tn),u.current=window.setInterval(()=>{v(C=>C>1?C-1:(u.current&&window.clearInterval(u.current),w(!1),0))},1e3)},k=async()=>{if(r||g)return;x(!0),m("");const y=await n();x(!1),m(y.ok?l.alertTestOk(y.sentTo||""):y.error||l.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:f||s>0,onClick:()=>{w(!0)},children:f?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||g,onClick:()=>{k()},children:g?"…":l.alertTest})]}),s>0&&e.jsx("p",{className:"mnote",children:l.alertPreviewRetry(s)}),p&&e.jsx("p",{className:"mnote warn",children:p}),b&&e.jsx("p",{className:"mnote",children:b}),!b&&e.jsx("p",{className:"mnote dim",children:l.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:l.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:l.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Ee="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Z({title:t,icon:a,children:n,wide:r}){const{dispatch:l}=z();return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&l({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>l({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function an(){const{st:t}=z();switch(t.modal){case"chain":return e.jsx(nn,{});case"space":return e.jsx(on,{});case"alert":return e.jsx(ln,{});case"queue":return e.jsx(un,{});case"export":return e.jsx(fn,{});case"plug":return e.jsx(gn,{});case"recharge":return e.jsx(bn,{});case"cover":return e.jsx(vn,{});case"crit":return e.jsx(yn,{});case"tuto":return e.jsx(wn,{});case"rdv":return e.jsx(rn,{});case"memoalert":return e.jsx(mn,{});default:return null}}function rn(){const{dispatch:t,fund:a}=z(),n=typeof document<"u"&&!!document.getElementById("rdv");return c.useEffect(()=>{n&&(t({type:"modal",modal:null}),mr())},[n,t]),n?null:e.jsx(Ta,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function nn(){const{st:t,dispatch:a,byId:n,t:r,lang:l,mode:o,askEvaluate:i,evalBusy:f}=z(),d=o==="client",p=t.chain.queue.map(b=>n.get(b)).filter(b=>!!b),h=t.chain.idx,s=p[h],v=h>=p.length;return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:v?r.finished:`${h+1} / ${p.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(v?100:h/Math.max(1,p.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:v||!s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(p.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:s.name}),e.jsx("div",{className:"sub",children:[we(s.cc,l)||s.countryLabel,s.sector,s.stage,r.daysAgo(ye(s.date))].filter(Boolean).map(b=>String(b).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:ie(s.engine,l).toUpperCase()}),typeof s.amountEur=="number"&&s.amountEur>0&&e.jsx("span",{children:Qe(s.amountEur,l)})]}),K(s)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(ke,{o:s,lg:!0})," ",e.jsx(Be,{o:s,src:!0})]}),(s.tagline||s.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:s.tagline||s.headline})]}),s.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:s.reasoning})]}),d&&X(s)&&e.jsxs("div",{className:"vbox",style:{"--c":se(s)==="retenu"?"var(--brand)":se(s)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:se(s)==="retenu"?"✓ "+r.kept:se(s)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:s.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!v&&s&&!(d&&X(s))&&e.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:f,onClick:()=>{i(s)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?r.closeBtn:r.skip})]})]})})}),document.body)}function on(){const{st:t,dispatch:a,dossiers:n,t:r,mode:l}=z(),o=l==="client",i=c.useMemo(()=>o?n.filter(s=>X(s)):[],[n,o]),f=c.useMemo(()=>Xe(i.filter(s=>se(s)==="retenu"),{key:"signal",dir:-1}),[i]),d=c.useMemo(()=>i.filter(s=>se(s)==="ecarte"),[i]),p=t.spaceTab==="retenu"?f:d,h=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(Z,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:f.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:d.length})]})]}),p.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),p.slice(0,40).map(s=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":h},children:typeof s.score=="number"&&s.score>0?s.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:s.name}),e.jsx("div",{className:"rr",children:s.reasoning||s.tagline||""})]})]},s.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function ln(){const{mode:t}=z();return t==="client"||t==="apercu"?e.jsx(sn,{}):e.jsx(pn,{})}function sn(){const{t,token:a,flash:n,flashErr:r,mode:l}=z(),[o,i]=c.useState("d"),f=l!=="client";return e.jsxs(Z,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>i("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>i("w"),children:t.alertTabWeekly})]}),o==="d"?e.jsx(dn,{t,token:a,readOnly:f,flash:n,flashErr:r}):e.jsx(cn,{t,token:a,readOnly:f,flash:n,flashErr:r})]})}function dn({t,token:a,readOnly:n,flash:r,flashErr:l}){const[o,i]=c.useState(null),[f,d]=c.useState(!1),[p,h]=c.useState(0);c.useEffect(()=>{let m=!0;return d(!1),ft(a).then(g=>{m&&(g?i(g):d(!0))}),()=>{m=!1}},[a,p]);const s=m=>{n||ft(a,m).then(g=>{if(!g){l(t.actErr);return}i(g),g.throttled?l(t.alertThrottled):r(t.alertSaved)})};if(f)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=m=>!o.sections||o.sections.includes(m),b=m=>{const g=o.sections||t.alertSec.map(([x])=>x);s({sections:v(m)?g.filter(x=>x!==m):[...g,m]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([m,g])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:v(m),disabled:n,onChange:()=>b(m)}),e.jsxs("span",{children:[g,m==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},m))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(et,{label:t.alertPreview,readOnly:n,onPreview:()=>Ra(a),onTest:()=>Fa(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function cn({t,token:a,readOnly:n,flash:r,flashErr:l}){const[o,i]=c.useState(null),[f,d]=c.useState(!1),[p,h]=c.useState(0);c.useEffect(()=>{let m=!0;return d(!1),mt(a).then(g=>{m&&(g?i(g):d(!0))}),()=>{m=!1}},[a,p]);const s=m=>{n||mt(a,m).then(g=>{if(!g){l(t.actErr);return}i(g),r(t.alertSaved)})};if(f)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=o.dow??0,b=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:v,disabled:n,onChange:m=>s({dow:Number(m.target.value)}),children:t.alertDow.map((m,g)=>e.jsx("option",{value:g,children:m},m))}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,b-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[b," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,b+1)}),disabled:n,children:"＋"})]})]}),e.jsx(et,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>Da(a),onTest:()=>Ma(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function pn(){const{st:t,t:a,lang:n,scoped:r,contName:l}=z(),[o,i]=c.useState(""),[f,d]=c.useState(!1),[p,h]=c.useState(!1),s=t.filters,v=c.useMemo(()=>r.filter(x=>K(x)).length,[r]),b=s.win==="1"?0:s.win==="7"?1:s.win==="30"?2:3,m=async()=>{if(!(!/.+@.+\..+/.test(o)||p)){h(!0);try{await fetch(`${Ye}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o.trim(),sectors:s.sector,countries:s.country,source:"atelier2",website:""})}),d(!0)}finally{h(!1)}}},g=[[a.amRows.continent,l],[a.amRows.since,a.amSince[b]],[a.amRows.signal,s.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,s.engine.length?s.engine.map(x=>ie(x,n)).join(", "):a.amAllEngines],[a.amRows.sectors,s.sector.length?s.sector.join(", "):a.amAllSectors],[a.amRows.countries,s.country.length?s.country.map(x=>we(x,n)||x).join(", "):a.amAllCountries],[a.amRows.stages,s.stage.length?s.stage.join(", "):a.amAllStages]];return e.jsx(Z,{title:a.alertTitle,icon:"🔔",children:f?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(o)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:g.map(([x,u])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:x}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:u}})]},x))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:o,onChange:x=>i(x.target.value),onKeyDown:x=>{x.key==="Enter"&&m()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void m(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function un(){var g,x,u;const{t,token:a,fund:n,mode:r,flash:l}=z(),[o,i]=c.useState(null),[f,d]=c.useState([]),[p,h]=c.useState(0),s=r==="client";c.useEffect(()=>{let w=!0;return(async()=>{const[k,y]=await Promise.all([Tt(n),At(a)]);w&&(k&&i(k),d(y))})(),()=>{w=!1}},[a,n,p]);const v=(o==null?void 0:o.per_day)??2,b=((g=o==null?void 0:o.analyzed_today)==null?void 0:g.length)??0,m=(x=o==null?void 0:o.tomorrow)!=null&&x.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(Z,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(b,b+(((u=o==null?void 0:o.pool_order)==null?void 0:u.length)??0))}})}),e.jsx("div",{className:"qrate",children:t.queueRate}),e.jsx("div",{className:"qrates",children:[1,2,3,5,10].map(w=>e.jsx("button",{type:"button",className:"qr"+(v===w?" on":""),disabled:!s,onClick:()=>{Ot(a,w).then(k=>{k!==null&&(h(y=>y+1),l(t.alertSaved))})},children:e.jsxs("b",{children:[w,"/j"]})},w))})]}),f.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:f.map(w=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:w.company}),e.jsxs("span",{className:"qd",children:[w.memo_type,typeof w.est_min=="number"?` · ~${w.est_min} min`:""]}),e.jsx("span",{className:"qt",children:w.status}),w.url&&e.jsx("a",{className:"qgo",href:w.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),s&&w.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{ut(a,w.company,"retry").then(()=>h(k=>k+1))},children:t.queueRetry}),s&&w.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{ut(a,w.company,"delete").then(()=>h(k=>k+1))},children:t.queueDelete})]},w.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[m.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),m.slice(0,10).map((w,k)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",k+1]}),e.jsx("b",{children:w.name}),typeof w.score=="number"&&e.jsx("span",{className:"qs2",children:w.score})]},w.name))]})]})}function fn(){const{t,token:a,flash:n,scoped:r,caps:l,stageOf:o}=z(),i=`${Ee}/cibles/list.csv?token=${a}`,f=`${Ee}/cibles/list.json?token=${a}`,d=`${Ee}/cibles/export.xlsx?token=${a}&scope=full`,p=`=IMPORTDATA("${i}")`,h=m=>{var g;(g=navigator.clipboard)==null||g.writeText(m).then(()=>n(t.exportCopied))},s=[{def:t.exportCsv,value:i,href:i},{def:t.exportSheet,value:p},{def:t.exportLive,value:f,href:f},{def:t.exportXlsx,value:d,href:d}],v=!l.lockActions&&r.length>0,b=()=>{en(Zr(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:m=>(t.stg.find(([g])=>g===m)||["",""])[1]})),n(t.exportViewDone(r.length))};return e.jsxs(Z,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:b,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:s.map(({def:m,value:g,href:x})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:m[0]}),e.jsxs("div",{children:[e.jsx("b",{children:m[1]}),e.jsx("p",{children:m[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>h(g),children:t.exportCopy}),x&&e.jsx("a",{className:"exb",href:x,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},m[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function mn(){const{t,token:a,flash:n,flashErr:r,mode:l}=z(),o=l!=="client",[i,f]=c.useState(null),[d,p]=c.useState(!1),[h,s]=c.useState(0),[v,b]=c.useState(!1);c.useEffect(()=>{let u=!0;return p(!1),ct(a).then(w=>{u&&(w?f(w):p(!0))}),()=>{u=!1}},[a,h]);const m=()=>(i==null?void 0:i.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=u=>{if(o||!i)return;const w={enabled:u.enabled??!!i.enabled,email:u.email??(i.email||""),sections:u.sections??m()};b(!0),ct(a,w).then(k=>{if(b(!1),!k){r(t.memoAlertErr);return}f(k),n(t.memoAlertSaved)})};if(d)return e.jsx(Z,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:t.retry})]})});if(!i)return e.jsx(Z,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const x=m();return e.jsxs(Z,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:o||v,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),e.jsx(xn,{value:i.email||"",readOnly:o||v,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:u=>g({email:u})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([u,w])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!x[u],disabled:o||v,onChange:()=>g({sections:{...x,[u]:!x[u]}})}),e.jsx("span",{children:w})]},u))}),e.jsx(et,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>Ea(a,x),onTest:()=>za(a,x)})]})}function xn({value:t,readOnly:a,label:n,okLabel:r,onSave:l}){const[o,i]=c.useState(t);c.useEffect(()=>{i(t)},[t]);const f=o.trim()!==t.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&f&&d&&l(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!f||!d,onClick:()=>l(o.trim()),children:r})]})]})}function gn(){const{t,token:a,flash:n,flashErr:r,canWrite:l}=z(),[o,i]=c.useState(null),[f,d]=c.useState(!1),[p,h]=c.useState(null),[s,v]=c.useState(""),[b,m]=c.useState(0);c.useEffect(()=>{let u=!0;return d(!1),pt(a).then(w=>{u&&(w?i({configured:w.configured,url_hint:w.url_hint}):d(!0))}),Oa(a).then(w=>{u&&h(w)}),()=>{u=!1}},[a,b]);const g=(u,w)=>{l&&pt(a,u).then(k=>{if(!k||k.ok===!1){r(t.actErr);return}u.test&&k.sent===!1?r(t.plugTestThrottled):n(w),m(y=>y+1)})},x='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(Z,{title:t.plugTitle,icon:"🔌",wide:!0,children:[p&&e.jsx("p",{className:"mnote"+(p.enabled?" warn":""),children:p.enabled?t.plugAutoOn(p.destination||"webhook"):t.plugAutoOff}),f?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>m(u=>u+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:s,disabled:!l,onChange:u=>v(u.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!l||!s.trim(),onClick:()=>g({url:s.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!l,onClick:()=>g({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!l,onClick:()=>g({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(hn,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:x}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var u;(u=navigator.clipboard)==null||u.writeText(x).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function hn(){const{t,token:a}=z(),[n,r]=c.useState("valides"),[l,o]=c.useState(!1),[i,f]=c.useState(null),d=async()=>{o(!0),f(await La(a,n)),o(!1)};return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:n,onChange:p=>r(p.target.value),children:t.plugBulkTabs.map(([p,h])=>e.jsx("option",{value:p,children:h},p))}),e.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{d()},children:l?"…":t.plugBulkPreview})]}),i&&(i.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(i.ready||0,i.linkedinReady||0,(i.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr}))]})}function bn(){const{t,data:a,lang:n}=z(),r=a.credits,l=a.email,o=async i=>{if(!l)return;const f=window.location.href.split("?")[0];try{const p=await(await fetch(`${Ye}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l,lookup_key:i,success_url:f+"?credits=ok",cancel_url:f+"?credits=cancel"})})).json();p.url&&(window.location.href=p.url)}catch{}};return e.jsxs(Z,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(i=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(i.credits,i.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(i.lookup_key)},children:t.rechargeBuy})]},i.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function vn(){const{t,data:a,dossiers:n}=z(),r=n.filter(o=>o.kind==="target"&&X(o)).length,l=a.marketEstimate||0;return e.jsx(Z,{title:t.coverTitle,icon:"🌍",children:l>0?e.jsx("p",{dangerouslySetInnerHTML:{__html:t.coverBody(r,l)}}):e.jsx("p",{children:t.coverScreened(r)})})}function yn(){var u,w,k;const{t,dossiers:a,token:n,mode:r,flash:l,criteria:o}=z(),i=r==="client",f=c.useMemo(()=>{const y=new Set;return a.forEach(S=>{S.angle&&y.add(S.angle)}),[...y]},[a]),[d,p]=c.useState(null);c.useEffect(()=>{let y=!0;return Aa(n).then(S=>{y&&p(S.thumbs)}),()=>{y=!1}},[n]);const[h,s]=c.useState(""),[v,b]=c.useState(""),[m,g]=c.useState(!1),x=async()=>{const y=h.trim();if(!(!y||m||!i)){g(!0),b("");try{const C=await(await fetch(`${Ee}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:y,who:"atelier2"})})).json().catch(()=>({}));if(C.reply&&b(String(C.reply)),C.job_id){b(t.critChatRunning);const F=async()=>{const N=await fetch(`${Ee}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:C.job_id})}).then(E=>E.json()).catch(()=>null);if(N&&N.done){b(String(N.reply||N.clarification||N.summary||"✓")),g(!1),N.applied&&l(t.alertSaved);return}setTimeout(()=>{F()},8e3)};setTimeout(()=>{F()},8e3),s("");return}s("")}finally{v.startsWith("⏳")||g(!1)}}};return e.jsxs(Z,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((u=o.points)!=null&&u.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(y=>e.jsx("li",{children:y},y))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((w=o==null?void 0:o.angles)!=null&&w.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(y=>{var S,C;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:y.title}),y.why&&e.jsx("p",{className:"why",children:y.why}),e.jsxs("div",{className:"lo",children:[!!((S=y.look)!=null&&S.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:y.look.map(F=>e.jsx("li",{children:F},F))})]}),!!((C=y.out)!=null&&C.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:y.out.map(F=>e.jsx("li",{children:F},F))})]})]})]},y.title)})]}),!!((k=o==null?void 0:o.gate)!=null&&k.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>e.jsxs("li",{children:[y.k&&e.jsx("b",{children:y.k}),y.t]},y.t))})]}),f.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(y=>e.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:h,disabled:!i||m,onChange:y=>s(y.target.value),onKeyDown:y=>{y.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!i||m||!h.trim(),onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),v&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:v})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),d===null?e.jsx("div",{className:"sp-empty",children:"…"}):d.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:d.slice(0,12).map((y,S)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:y.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:y.company}),e.jsx("span",{className:"qd",children:(y.ts||"").slice(0,10)})]},S))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([y,S])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Bt[y]||"v-cons"),children:y}),e.jsx("span",{children:S})]},y))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([y,S])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:y}),e.jsxs("span",{children:["← ",S]})]},y))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function wn(){const{t,dispatch:a,startTour:n}=z(),r=l=>{var o,i;a({type:"modal",modal:null}),l==="crit"||l==="plug"||l==="alert"?a({type:"modal",modal:l}):l.startsWith("tab")?a({type:"ptab",tab:Number(l.slice(3))}):l==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(i=document.querySelector(".atl2 .demand input"))==null||i.focus())};return e.jsxs(Z,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([l,o],i)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:f=>{(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:i+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:l.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+i))})]})}const It="atl2:mapfold",kn=()=>{if(typeof window>"u")return!1;try{const t=localStorage.getItem(It);if(t==="on")return!0;if(t==="off")return!1}catch{}return window.innerHeight<1e3},$t=c.createContext(null),z=()=>{const t=c.useContext($t);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function ke({o:t,lg:a}){const{lang:n}=z(),r=K(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:xt(r,n),children:[r.emoji," ",xt(r,n)]}):null}function Be({o:t,src:a}){const{lang:n,t:r}=z(),l=K(t);if(!l)return null;const o=$a(l),i=Va(l);return e.jsxs("em",{className:"sigwin"+(i?" hot":""),title:r.signaledOn(Ft(l,n))+" · "+r.win7(Rt(l,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(f,d)=>e.jsx("i",{className:d<o?"on":""},d))}),e.jsx("span",{className:"lb",children:i?r.lastDay:r.daysLeft(Math.max(0,l.left??0))}),a&&l.url&&e.jsx("a",{href:l.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:f=>f.stopPropagation(),children:"↗"})]})}function Vt({o:t}){const{lang:a}=z(),n=Ia(t.cc),r=t.cc?we(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const Ct="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Ut=t=>`atl2:tour:${t||"anon"}`;function jn(t){try{return localStorage.getItem(Ut(t))==="1"}catch{return!0}}function zt(t){try{localStorage.setItem(Ut(t),"1")}catch{}}function Nn(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function An({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:l,onFiltersChange:o}){const{lang:i}=qa(),f=Qa[i],d=ir(t,i,a),[p,h]=c.useReducer(dr,void 0,()=>sr((r==null?void 0:r.continent)??"europe",t||kn(),{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),s=c.useRef(!0);c.useEffect(()=>{if(s.current){s.current=!1;return}if(!t)try{localStorage.setItem(It,p.mapFolded?"on":"off")}catch{}},[p.mapFolded,t]);const v=c.useRef(o);v.current=o,c.useEffect(()=>{var j;(j=v.current)==null||j.call(v,p.filters)},[p.filters]);const[b,m]=c.useState(null),[g,x]=c.useState(null),[u,w]=c.useState({kept:0,dropped:0}),[k,y]=c.useState(!1),[S,C]=c.useState(""),[F,N]=c.useState(!1),[E,P]=c.useState(null),[O,M]=c.useState(!1),[q,T]=c.useState(!1),[,B]=c.useState(0),R=()=>B(j=>j+1),H=c.useRef([]),oe=c.useRef(new Set),de=c.useRef(new Set),Ae=c.useRef(new Map),xe=c.useRef(null),{mode:ce}=d,Y=c.useMemo(()=>l?{...d.caps,...l}:d.caps,[d.caps,l]),V=Y.pipe,U=d.session.token||"",D=ce==="client"&&!t;c.useEffect(()=>{if(document.querySelector(`link[href="${Ct}"]`))return;const j=document.createElement("link");j.rel="stylesheet",j.href=Ct,document.head.appendChild(j)},[]);const I=(j,A=!1)=>{C(j),N(A),xe.current&&clearTimeout(xe.current),xe.current=setTimeout(()=>C(""),A?4200:2400)},_=j=>I(j,!0),re=c.useMemo(()=>{const j=new Map;return d.dossiers.forEach(A=>{A.id&&j.set(A.id,A)}),j},[d.dossiers]),te=c.useMemo(()=>d.dossiers.filter(j=>Dt(j,p,V)),[d.dossiers,p,V]),Q=c.useRef(!1);c.useEffect(()=>{if(Q.current||t||d.loading||!d.dossiers.length)return;if(!Y.showFunnel||jn(d.session.token||"")){Q.current=!0;return}Q.current=!0;const j=window.setTimeout(()=>{zt(d.session.token||""),M(!0)},700);return()=>window.clearTimeout(j)},[t,d.loading,d.dossiers.length,Y.showFunnel,d.session.token]);const J=c.useMemo(()=>d.dossiers.filter(j=>cr(j,p,V,d.favIds)),[d.dossiers,p,V,d.favIds]),je=c.useMemo(()=>Pa(te,d.favIds),[te,d.favIds]),$=Ge.find(j=>j.key===p.continent),le=i==="fr"?$.fr:$.en,pe=(j,A)=>{const L=((j==null?void 0:j.name)||A||"").trim();if(!D){x({kicker:L});return}!L||k||(y(!0),(async()=>{try{const W=await Lt(U,L,"atelier2"),Oe={name:W.company||L,verdict:W.verdict,reason:W.reason||"",remaining:W.remaining??null};H.current=[Oe,...H.current].slice(0,8),W.verdict==="kept"&&w(ue=>({...ue,kept:ue.kept+1})),W.verdict==="ruled_out"&&w(ue=>({...ue,dropped:ue.dropped+1}));const Ce=j||d.dossiers.find(ue=>(ue.name||"").toLowerCase()===L.toLowerCase());Ce&&(W.verdict==="kept"?Ce.verdict=Ce.verdict||"MATCH":W.verdict==="ruled_out"&&(Ce.verdict="NO MATCH"),W.reason&&(Ce.reasoning=W.reason)),R()}finally{y(!1)}})())},Ne=j=>{if(!D){x({kicker:j.name});return}oe.current.add(j.id),ze(U,"fast_request",j.name||"",""),I(f.memoInstantSent(j.name)),R()},ge=j=>Ae.current.get(j.id)??d.thumbs.get((j.name||"").trim().toLowerCase()),ae=(j,A)=>h({type:"undoPush",entry:{id:j.id,name:j.name,prevCeoStatus:A}}),he=async(j,A,L)=>{const W=j.ceoStatus||"";j.ceoStatus=A,R();const Oe=await Ve(U,{status:A,airtable_id:j.airtableId,check_id:j.checkId,company:j.name,...(L==null?void 0:L.note)!==void 0?{note:L.note}:{},...L!=null&&L.via?{via:L.via}:{}});return Oe.ok?Oe.skipped?(j.ceoStatus=W,R(),_(f.actNotPersisted),!1):((L==null?void 0:L.undo)!==!1&&ae(j,W),L!=null&&L.msg&&I(L.msg),(A==="Validé"||A==="Écarté")&&!j.ceoNote&&(L==null?void 0:L.note)===void 0&&P({o:j,yes:A==="Validé"}),!0):(j.ceoStatus=W,R(),_(f.actErr),!1)},Se=async(j,A)=>{const L=await Ve(U,{status:j.ceoStatus||"Retenu",airtable_id:j.airtableId,check_id:j.checkId,company:j.name,note:A,via:"note"});return!L.ok||L.skipped?(_(L.skipped?f.actNotPersisted:f.actErr),!1):(j.ceoNote=A,R(),!0)},ne=c.useRef(new Map),be=j=>ne.current.has(j.id)?ne.current.get(j.id):d.stages.get((j.name||"").trim().toLowerCase()),_t=(j,A)=>{ne.current.set(j.id,A),R()},Ht=(j,A)=>{D&&he(j,A?"Validé":"Écarté",{msg:A?f.decidedYes(j.name):f.decidedNo(j.name)})},Yt=j=>{D&&he(j,"À trancher",{msg:f.promoted(j.name)})},Wt=j=>{D&&(async()=>{const A=j.ceoStatus||"";j.ceoStatus="Retenu",R();const L=await Ve(U,{status:"Retenu",check_id:j.checkId,company:j.name});if(!L.ok||L.skipped){j.ceoStatus=A,R(),_(L.skipped?f.actNotPersisted:f.actErr);return}ae(j,A),I(f.repeched(j.name))})()},Gt=()=>{const j=p.undo[p.undo.length-1];if(!j){I(f.undoNone);return}const A=re.get(j.id);if(!A){h({type:"undoPop"}),I(f.undoNone);return}let L=j.prevCeoStatus;if(!L)if((A.verdict||"").toUpperCase().includes("CALL"))L="À trancher";else{I(f.undoLockedTitle);return}(async()=>await he(A,L,{undo:!1})&&(h({type:"undoPop"}),A.ceoStatus=j.prevCeoStatus,R(),I(f.undoDone(A.name))))()},Kt=j=>{D&&(de.current.add(j.id),R(),(async()=>{const A=await Ua(U,j.name,"email");if(!A||A.ok===!1){de.current.delete(j.id),R(),_(f.actErr);return}ze(U,"approach",j.name||"",""),I(f.actApproachSent)})())},Qt=(j,A)=>{D&&(async()=>{if(!(await ze(U,A?"yes":"no",j.name||"","")).ok){_(f.actErr);return}Ae.current.set(j.id,A?"yes":"no"),R(),I(A?f.thumbUpDone:f.thumbDnDone)})()},Jt=j=>{!D||!Ke(j)||(ze(U,"detailed_request",j.name||"",""),I(f.memoDeepSent(j.name)))},Xt=j=>{const A=new Set(d.favIds),L=A.has(j.id);L?A.delete(j.id):A.add(j.id),d.setFavIds(A),D&&_a(U,{id:j.id,co:j.name},L)},Zt=()=>{!D||q||window.confirm(f.identSyncConfirm)&&(T(!0),(async()=>{const j=await Ha(U);T(!1),j?I(f.identSyncDone):_(f.actErr)})())},tt=/proplace/i.test(d.fund||""),ea=j=>{!D||!tt||(ze(U,"onboard_request",j.name||"",""),I(f.onboardSent(j.name)))},ta={st:p,dispatch:h,t:f,lang:i,mode:ce,caps:Y,pipe:V,token:U,fund:d.fund,email:d.email,criteria:d.criteria,data:d,doRepeche:Wt,thumbOf:ge,canWrite:D,commitStatus:he,saveNote:Se,stageOf:be,setStage:_t,flashErr:_,startTour:()=>M(!0),dossiers:d.dossiers,scopedAll:te,scoped:J,counts:je,byId:re,contName:le,favIds:d.favIds,toggleFav:Xt,askEvaluate:pe,doAnalyse:Ne,doDecide:Ht,doPromote:Yt,doApproach:Kt,doThumb:Qt,doDeep:Jt,doUndo:Gt,doSync:Zt,doOnboard:ea,outbound:tt,memoQueued:oe.current,approachDone:de.current,sessTally:u,evalCards:H.current,evalBusy:k,markRow:m,markedId:b,flash:I};return c.useEffect(()=>{const j=A=>{A.key==="Escape"&&(h({type:"popup",id:null}),h({type:"modal",modal:null}),h({type:"openFacet",facet:null}))};return window.addEventListener("keydown",j),()=>window.removeEventListener("keydown",j)},[]),e.jsx($t.Provider,{value:ta,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Za}),e.jsxs("div",{className:"app"+(V?" pipe":""),children:[Y.showTicker&&e.jsx(G,{name:"live",children:e.jsx(pr,{})}),Y.showIdent&&e.jsx(G,{name:"identite",children:e.jsx(Er,{})}),Y.showOnb&&e.jsx(G,{name:"onboarding",children:e.jsx(Tr,{})}),e.jsx(G,{name:"matin",children:e.jsx(zr,{})}),e.jsx(G,{name:"fraicheur",children:e.jsx(vr,{})}),e.jsx(G,{name:"mesure",children:e.jsx(yr,{})}),Y.showFunnel&&e.jsx(G,{name:"entonnoir",children:e.jsx(Sn,{})}),Y.showFunnel&&e.jsx(G,{name:"tunnel",children:e.jsx(Or,{})}),Y.showFunnel&&e.jsx(G,{name:"tuto",children:e.jsx(Fr,{})}),e.jsx(G,{name:"carte",fallback:e.jsx("div",{className:"void",children:f.loadError}),children:e.jsxs("div",{className:"fzone",children:[e.jsx(Cn,{}),e.jsxs("div",{className:"stage"+(p.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(Mr,{}),e.jsx(Dr,{})]})]})}),Y.showDemand&&e.jsx(G,{name:"evaluation",children:e.jsx(Pr,{})}),Y.showDemand&&p.memoConsole&&e.jsx(G,{name:"console",children:e.jsx(Ir,{})}),e.jsx(G,{name:"liste",fallback:e.jsxs("div",{className:"void",children:[f.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:f.retry})]}),children:e.jsx(Gr,{})}),d.loading&&e.jsx("div",{className:"void",children:f.loadingV2}),d.error&&!d.loading&&e.jsxs("div",{className:"void",children:[f.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:f.retry})]})]}),Y.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:f.lockbarText}),e.jsx("button",{type:"button",onClick:()=>h({type:"modal",modal:"rdv"}),children:f.lockbarCta})]}),p.popupId&&e.jsx(G,{name:"fiche",children:e.jsx(Jr,{})}),e.jsx(G,{name:"modales",children:e.jsx(an,{})}),e.jsx(gr,{}),E&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:E.o.name}),e.jsx(Nr,{placeholder:E.yes?f.whyYesPh:f.whyNoPh,onDone:j=>{const A=E.o;P(null),j&&Se(A,j).then(L=>{L&&I(f.csNoteSaved)})}})]}),O&&e.jsx(Cr,{steps:Nn(f),onClose:()=>{M(!1),zt(U)}}),S&&e.jsx("div",{className:"flash on"+(F?" err":""),children:S}),g&&e.jsx(Ba,{variant:"acquirer",initialCompany:Et().co,initialWebsite:Et().site,onClose:()=>x(null)})]})})}function Sn(){const{t}=z(),[a,n]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Cn(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:l,t:o}=z(),i=c.useMemo(()=>{const f={};return t.forEach(d=>{d.continent&&Je(d,a.filters,r)&&(f[d.continent]=(f[d.continent]||0)+1)}),f},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[Ya.map(f=>{const d=Ge.find(p=>p.key===f);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===f,onClick:()=>n({type:"continent",key:f}),children:[l==="fr"?d.fr:d.en,e.jsx("span",{className:"n",children:i[f]||0})]},f)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Et(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function zn(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{Vt as FlagCell,ke as SigBadge,Be as SigWin,An as default,zn as fmtShort,z as useV2};
