...
.atl2 .mapzone svg{display:block;width:100%;height:auto;max-height:520px;margin:0 auto}
...
`,qo=Ro+Oo;function oa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Mo(){const e=oa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Fo(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Mo();return r==="0"?"client":r==="1"||oa("embed")==="1"&&oa("chrome")==="1"?"apercu":"client"}const Po={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Do=e=>Po[e],He=e=>Object.assign(e,{continent:Pr(e.cc)});function Gt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Io=60*60*1e3;function Bo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Io?null:a}catch{return null}}function wt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const $o=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function _o(e,a,r="default"){const n=r!=="default",i=g.useMemo(()=>e||n?{mode:"anon"}:Er(),[e,n]),o=g.useMemo(()=>n?"visiteur":Fo(e,i),[e,i,n]),l=g.useMemo(()=>Do(o),[o]),s=o!=="visiteur",p=$o(r),[x,d]=g.useState([]),[c,u]=g.useState(""),[h,m]=g.useState(null),[b,v]=g.useState(null),[f,y]=g.useState(null),[j,w]=g.useState(()=>new Map),[z,T]=g.useState(()=>new Map),[O,F]=g.useState(""),[E,q]=g.useState(new Set),[N,k]=g.useState(null),[L,A]=g.useState(!0),[S,R]=g.useState(!1),[D,B]=g.useState(0),[H,ae]=g.useState(0),ie=g.useRef(0),de=g.useMemo(()=>{var _;if(o!=="client")return"";try{return((_=zr())==null?void 0:_.email)||""}catch{return""}},[o]);g.useEffect(()=>{const _=++ie.current;let U=!0;const V=()=>U&&_===ie.current,ee=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),se=Bo(ee);return se?(d(se.objs.map(He)),se.fund&&u(se.fund),m(se.marketEstimate??null),v(se.criteria??null),y(se.stats??null),F(se.generatedAt||""),A(!1)):A(!0),(async()=>{try{if(r==="ops"){const ve=await Ht(),pe=((ve==null?void 0:ve.recent_ops)||[]).map(W=>{const X=Yt(W.company_name||W.title?W:{...W,title:(W.headline_fr||W.headline||"").slice(0,120)},a),he=String(W.rubrique||"").toLowerCase();return X&&(he==="nominations"||he==="recrutements")&&(X.engine=he),X&&!String(W.company_name||"").trim()&&(X.noCo=!0),X}).filter(W=>!!W).map(W=>(Ar((W.name||"").trim())||(W.noCo=!0),W));try{const W=await Tr(),X=Lr(W),he=((W==null?void 0:W.date)||"").slice(0,10);if(X.length&&he){const Y=new Set;for(const re of pe){if(re.noCo||(re.date||"").slice(0,10)!==he)continue;const Q=Ma(X,Y,re.name,"");Q>=0&&(Y.add(Q),re.decryptHtml=X[Q].html)}for(const re of pe){if(re.decryptHtml||(re.date||"").slice(0,10)!==he)continue;const Q=Ma(X,Y,"",re.headline||re.tagline||re.name);Q>=0&&(Y.add(Q),re.decryptHtml=X[Q].html)}}}catch{}if(!V())return;d(pe.map(He)),wt(ee,{objs:pe})}else if(typeof r=="object"){const pe=(await Fa()||[]).filter(X=>(X.slug||"")===r.research).map(X=>Pa(X,a)).filter(X=>!!X),W=Gt(await Da(pe,a));if(!V())return;d(W.map(He)),wt(ee,{objs:W})}else if(s&&i.token){const ve=Rr(i.token),pe=Ht(),W=Or(i.token),X=qr(i.token),he=Mr(i.token),Y=await ve;let re=Y?Y.targets:[];V()&&Y&&(u(Y.fund||""),m(Y.marketEstimate??null),v(Y.criteria??null),y(Y.stats??null),F(Y.generatedAt||""),d(re.map(He)),A(!1),R(!1));const[Q,Be,ue,fe]=await Promise.all([pe,W,X,he]),Me=((Q==null?void 0:Q.recent_ops)||[]).map(je=>Yt(je,a)).filter(je=>!!je);if(re=[...re,...Me],!V())return;d(re.map(He));const Ue=new Set;for(const je of Be){const Fe=(je.id||je.co||"").toString().trim().toLowerCase();Fe&&Ue.add(Fe.startsWith("t:")?Fe:"t:"+Fe)}q(Ue),w(ue),T(fe),Y&&wt(ee,{fund:Y.fund,marketEstimate:Y.marketEstimate,criteria:Y.criteria,stats:Y.stats,generatedAt:Y.generatedAt,objs:re})}else{const ve=Fr(),pe=Fa(),W=Ht(),X=await ve;V()&&X.length&&(d(Gt(X).map(He)),A(!1),R(!1));const[he,Y]=await Promise.all([pe,W]),re=(he||[]).map(fe=>Pa(fe,a)).filter(fe=>!!fe),Q=await Da(re,a),Be=((Y==null?void 0:Y.recent_ops)||[]).map(fe=>Yt(fe,a)).filter(fe=>!!fe),ue=Gt([...X,...Q,...Be]);if(!V())return;d(ue.map(He)),wt(ee,{objs:ue})}V()&&R(!1)}catch{V()&&!se&&R(!0)}finally{V()&&A(!1)}})(),()=>{U=!1}},[s,i.token,a,D,p]),g.useEffect(()=>{if(!l.showCredits||!de){k(null);return}let _=!0;return(async()=>{try{const U=await fetch(`${ka}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:de})});if(!U.ok)return;const V=await U.json();_&&V&&V.ok!==!1&&k(V)}catch{}})(),()=>{_=!1}},[l.showCredits,de,H]);const K=g.useCallback(_=>q(new Set(_)),[]);return{session:i,mode:o,caps:l,fund:c,email:de,marketEstimate:h,generatedAt:O,criteria:b,stats:f,thumbs:j,stages:z,dossiers:x,favIds:E,setFavIds:K,credits:N,reloadCredits:()=>ae(_=>_+1),loading:L,error:S,refresh:()=>B(_=>_+1)}}const Pn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Uo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Pn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Vo(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Pn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Dn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Dn=40;function Ea(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!xe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(ja(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(at(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&We(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function In(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ea(e,a.filters,r)}function Ho(e,a,r,n){return!(!In(e,a,r)||r&&!Dr(e,a.ptab,n))}function za(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-at(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=xe(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const Yo=["ma","levees","nominations","recrutements","actualites"],Wo=300,Kt=7,Go={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Bn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Ko=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Wa(e){const a=xe(e);if(a)return"sig:"+(a.theme&&Bn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Qo(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=M(),s=l==="en",[p,x]=g.useState("all"),[d,c]=g.useState(!1),u=g.useMemo(()=>{const E=(a.filters.day||"").slice(0,10),q=A=>!(!o&&a.continent!=="monde"&&A.continent!==a.continent||E&&(A.date||"").slice(0,10)!==E),N=e.filter(A=>q(A)&&xe(A)),k=e.filter(A=>q(A)&&A.kind==="op"&&!xe(A)&&(E?!0:at(A.date)<=Kt)),L=E||new Date().toISOString().slice(0,10);return k.sort((A,S)=>{const R=(A.date||"").slice(0,10)===L?0:1,D=(S.date||"").slice(0,10)===L?0:1;return R!==D?R-D:(S.amountEur||0)-(A.amountEur||0)}),[...za(N,{key:"signal",dir:-1}),...k]},[e,a.continent,a.filters.day,o]),h=g.useMemo(()=>{const E={};for(const q of u){const N=Wa(q);E[N]=(E[N]||0)+1}return E},[u]),m=g.useMemo(()=>p==="all"?u:u.filter(E=>Wa(E)===p),[u,p]),b=g.useMemo(()=>m.slice(0,Wo),[m]),v=m.length-b.length,f=E=>E==="all"?u.length:h[E]||0,y=E=>E==="all"?s?"All":"Tout":E.startsWith("sig:")?Bn[s?"en":"fr"][E.slice(4)]||"🔔":Go[s?"en":"fr"][E],j=[{k:"all"}],w=Yo.filter(E=>f(E)>0||E===p);if(w.length){j.push({g:s?"DEALS":"OPÉRATIONS"});for(const E of w)j.push({k:E})}const z=Ko.map(E=>"sig:"+E).filter(E=>f(E)>0||E===p);if(z.length){j.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const E of z)j.push({k:E})}const T=E=>{try{return new Date(E+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return E}},O=(()=>{const E=(a.filters.day||"").slice(0,10),q=!o&&a.continent!=="monde"&&i?s?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return E?(s?`LIVE covers the events of ${T(E)}.`:`Le LIVE regroupe les événements du ${T(E)}.`)+q:(s?`LIVE covers the still-open signals and the deals of the last ${Kt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Kt} derniers jours.`)+q})(),F=E=>b.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ce(q)?" spent":""),onClick:N=>{const k=N.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:k.left+k.width/2,y:k.bottom}})},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(it,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(hr,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Nl(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(_t,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},E+(q.id||q.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},E+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:E=>{E.currentTarget.contains(E.relatedTarget)||c(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":d,onClick:()=>c(E=>!E),children:[y(p),t.jsx("b",{children:f(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!d,children:[t.jsx("span",{className:"tkfilscope",children:O}),j.map(E=>"g"in E?t.jsx("span",{className:"tkfilg",children:E.g},E.g):t.jsxs("button",{type:"button","aria-pressed":E.k===p,onClick:()=>{x(E.k),c(!1)},children:[y(E.k),t.jsx("b",{children:f(E.k)})]},E.k))]})]}),t.jsx("div",{className:"win",children:b.length?t.jsxs("div",{className:"run",children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const Xo="aDx8z7Hzksus",$n="+33 6 83 10 72 86",Ga="alexandre@proplace.co",Jo=`tel:${$n.replace(/[^\d+]/g,"")}`,Ka="pp-rdv-slot";function Zo(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ei(){const{t:e,caps:a,fund:r}=M();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:ai}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Jo,children:$n}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Ga}`,children:Ga})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(zo,{filloutId:Xo,parameters:r?{company_name:r}:void 0})})]})}function ti(){const[e,a]=g.useState(()=>typeof document>"u"?null:document.getElementById(Ka));return g.useEffect(()=>{e||a(document.getElementById(Ka))},[e]),e?nt.createPortal(t.jsx(ei,{}),e):null}const ai=`
...
`;class me extends g.Component{constructor(){super(...arguments);Oa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ni=8;function ri(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=M(),[s,p]=g.useState(!1),[x,d]=g.useState(!1),[c,u]=g.useState(!1),h=r||"home",{names:m,verdicts:b}=g.useMemo(()=>{const w=[],z={};return n.forEach(T=>{T.kind!=="target"||!T.name||(w.push(T.name),z[T.name]=Ir(T)||"")}),{names:w,verdicts:z}},[n]),v=g.useMemo(()=>m.length?Br(h,m,b,a):null,[h,m.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const f=x?v.added:v.added.slice(0,ni),y=v.added.length-f.length,j=w=>{const z=n.find(T=>T.name===w);z&&(o(z.id),l({type:"popup",id:z.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),$r(h,m,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[f.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),c&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Qt=600,Ye=62,Qa="atl2:fstats";function oi(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=M(),[l,s]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Qa)==="on"}catch{return!1}}),p=r.stats,x=g.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=g.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const c=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),h=x.reduce((y,j)=>Math.max(y,j.s||0),0),m=x.length?Qt/x.length:0,b=Math.max(4,m-4),v=x.length>=5&&h>0,f=[[p.screened,e.funScreened(c(d)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[f.map(([y,j,w],z)=>t.jsxs("span",{className:"fst-t",children:[z>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:j}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Qa,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Qt} ${Ye}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((y,j)=>{const w=(y.s||0)/h*(Ye-4),z=(y.m||0)/h*(Ye-4),T=j*m+(m-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${c(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:T,y:Ye-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:T,y:Ye-2-z,width:b,height:z,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Ye-1.5,x2:Qt,y2:Ye-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:c(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const ii=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function si({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=M(),[o,l]=g.useState(""),[s,p]=g.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),d=(rt(e)||"").startsWith("CALL")&&ke(e)===3,c=ke(e)>=2,u=async m=>{if(o||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(m);const b=await i(e,m);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},h=d?[["Validé",a.csYes],["Écarté",a.csNo]]:ii.filter(([m])=>!(c&&m==="Retenu")).map(([m,b])=>[m,a[b]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([m,b])=>t.jsx("button",{type:"button",className:"csb"+(x===m?" on":"")+(o===m?" busy":""),disabled:!!o,onClick:()=>{u(m)},children:b},m)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(li,{o:e})]})}function li({o:e}){const{t:a,saveNote:r,flash:n}=M(),[i,o]=g.useState(e.ceoNote||""),[l,s]=g.useState(!1),[p,x]=g.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),c=async()=>{if(l||!d)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&c()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{c()},children:p?a.csNoteSaved:a.csNoteOk})]})}function ci({placeholder:e,onDone:a}){const{t:r}=M(),[n,i]=g.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function di({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=M(),[p,x]=g.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const d=o(e),c=(d==null?void 0:d.stage)||"todo",u=async f=>{if(p||f===c)return;x(!0);const y=d;l(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const j=Math.max(Date.now(),Xa+=1);Xa=j;const w=await _r(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});x(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},h=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,m=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,b=c==="sent"&&h&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(c===f?" on":""),disabled:p,onClick:()=>{u(f)},children:y},f)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let Xa=0;const kt=8,jt=340;function Ja({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function pi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=M(),[l,s]=g.useState(0),[p,x]=g.useState(null),[d,c]=g.useState([]),u=g.useRef(!1);g.useEffect(()=>{u.current||(u.current=!0,c(e.filter(j=>!!document.querySelector(j.need||j.sel))))},[e]);const h=d[l],m=l>=d.length;g.useEffect(()=>{h&&(h.ptab!==void 0&&o.ptab!==h.ptab&&n({type:"ptab",tab:h.ptab}),h.dens&&o.dens!==h.dens&&n({type:"dens",dens:h.dens}))},[l,h]);const b=g.useCallback(()=>{if(!h){x(null);return}const j=document.querySelector(h.sel);if(!j){x(null);return}j.scrollIntoView({block:"nearest",behavior:"smooth"}),x(j.getBoundingClientRect())},[h]);g.useLayoutEffect(()=>{b();const j=window.setTimeout(b,260),w=()=>b();return window.addEventListener("scroll",w,!0),window.addEventListener("resize",w),()=>{window.clearTimeout(j),window.removeEventListener("scroll",w,!0),window.removeEventListener("resize",w)}},[b]);const v=g.useRef(a);if(v.current=a,g.useEffect(()=>{const j=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),v.current()):w.key==="ArrowRight"?s(z=>z+1):w.key==="ArrowLeft"&&s(z=>Math.max(0,z-1))};return document.addEventListener("keydown",j,!0),()=>document.removeEventListener("keydown",j,!0)},[]),!d.length)return null;let f=null;if(m){const j=i[3]||0;j>0?f={title:j===1?r.ahaATitle1:r.ahaATitleN(j),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:(i[1]||0)>0?f={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:()=>{n({type:"ptab",tab:1}),a()}}:f={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:jt};if(!m&&p){const j=p.bottom+14,z=window.innerHeight-j>190?j:Math.max(12,p.top-200);y={left:Math.min(Math.max(12,p.left+p.width/2-jt/2),window.innerWidth-jt-12),top:z,width:jt}}return nt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!m&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-kt,top:p.top-kt,width:p.width+kt*2,height:p.height+kt*2}}),(m||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(m?" fin":""),style:y,children:[m&&f?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:f.title}),t.jsx("p",{children:t.jsx(Ja,{text:f.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:f.go,children:f.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(l+1,d.length)}),t.jsx("h3",{children:h==null?void 0:h.title}),t.jsx("p",{children:t.jsx(Ja,{text:(h==null?void 0:h.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(j=>Math.max(0,j-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(j=>j+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function ui(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,dispatch:l}=M(),s=r?a:e,p=g.useMemo(()=>s.filter(f=>at(f.date)===0&&f.kind==="target"),[s]),x=g.useMemo(()=>r?a.filter(f=>ke(f)===0).slice().sort((f,y)=>(y.date||"").localeCompare(f.date||"")):[],[a,r]),d=g.useMemo(()=>p.filter(f=>r?ke(f)===0:!Ce(f)),[p,r]),c=r?x:d,u=r?a.length-x.length:p.length-d.length,h=r?a.length:p.length,m=h?Math.min(100,u/h*100):100;let b;r?b=i.morningThesis(p.length,x.length):p.length?u===0?b=i.goalSourced(p.length):u>=p.length?b=i.goalCleared:b=i.goalDone(u,p.length):b=i.goalSourced(0);const v=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&x.length&&l({type:"chainStart",queue:x.map(f=>f.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:b}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:m+"%"}})}),c.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:v,children:r?i.morningEval(c.length):o.pileMode?i.goalContinue(c.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function fi(){var q,N;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:x,startTour:d}=M(),[c,u]=g.useState(null),[h,m]=g.useState([]),b=p==="client";g.useEffect(()=>{if(!i||!o)return;let k=!0;return(async()=>{const[L,A]=await Promise.all([Na(o),Rn(i)]);k&&(L&&u(L),m(A))})(),()=>{k=!1}},[i,o]);const v=(c==null?void 0:c.per_day)??null,f=((q=c==null?void 0:c.pool_order)==null?void 0:q.length)??0,y=h.filter(k=>k.status==="running").length,j=g.useMemo(()=>s.filter(k=>k.kind==="target"&&Ce(k)).length,[s]),w=l.marketEstimate,z=typeof((N=l.stats)==null?void 0:N.screened)=="number"?l.stats.screened:j,T=w&&w>0?Math.min(100,Math.round(z/w*100)):null,O=k=>k.toLocaleString(a==="en"?"en-US":"fr-FR"),F=(o||"P").split(/\s+/).map(k=>k[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const k=Date.parse(l.generatedAt||"");if(Number.isNaN(k))return"";const L=new Date(k),A=S=>String(S).padStart(2,"0");return`${A(L.getDate())}/${A(L.getMonth()+1)} à ${A(L.getHours())}:${A(L.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:F}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),E&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(E)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[T===null&&z>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:O(z)})})]}),T!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:T+"%"}})}),t.jsxs("b",{children:[T," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(z,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(f)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:k=>{k.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:k=>n({type:"filters",patch:{search:k.target.value}})})]})]})]})}function mi(){const{t:e,counts:a,dispatch:r}=M();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const xi=["--p0","--p1","--p2","--p3","--p4"];function hi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i}=M(),o=g.useRef({});g.useEffect(()=>{o.current={...r}},[r]);const l=x=>{const d=o.current[x],c=d!==void 0?r[x]-d:0;return t.jsxs("button",{type:"button",className:"step"+(x===3&&r[3]>0?" wait":""),style:{"--c":`var(${xi[x]})`,"--tc":x<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===x,title:n.phelp[x],onClick:()=>a({type:"ptab",tab:x}),children:[t.jsxs("span",{className:"l",children:[n.plabels[x].toUpperCase(),x===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(c>0?" up":c<0?" down":""),children:[r[x],c!==0&&t.jsxs("em",{className:"delta",children:[c>0?"+":"−",Math.abs(c)]})]})]},x)},s=(x,d,c)=>t.jsxs("button",{type:"button",className:"off"+(d?" view":""),style:{"--c":x===5?"var(--p5)":x===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===x,title:n.phelp[x],onClick:()=>a({type:"ptab",tab:x}),children:[t.jsx("span",{className:"l",children:c.toUpperCase()}),t.jsx("span",{className:"n",children:r[x]})]},x),p=(x,d,c,u=!1)=>t.jsx("button",{type:"button",className:"tool",title:d,disabled:u,onClick:c,children:x},d);return t.jsxs("div",{className:"funnel",children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[p("↩",n.toolUndo,i,e.undo.length===0),p("↺",n.toolReset,()=>{a({type:"reset"})}),p("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),p("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const gi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function bi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=M(),s=g.useRef(null),[p,x]=g.useState(60);g.useEffect(()=>{let h=0;const m=()=>{var j;const b=s.current;if(!b)return;const v=(j=b.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!v)return;const f=v.getBoundingClientRect(),y=b.getBoundingClientRect();x(Math.max(20,Math.min(f.left+f.width/2-y.left,y.width-30)))};return h=requestAnimationFrame(m),window.addEventListener("resize",m),()=>{cancelAnimationFrame(h),window.removeEventListener("resize",m)}},[e.ptab]);const d=e.ptab;let c=r.tuto[d].p;if(d===3){const h=n.filter(v=>v.kind==="target"&&ke(v)===3),m=h.filter(v=>aa(v)==="auto").length,b=h.filter(v=>aa(v)==="cd").length;c=r.tutoPending(m,b,h.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(h=>h.id)})};if(d===1){const h=n.filter(m=>m.kind==="target"&&ke(m)===1&&!i.has(m.id)).slice(0,10);if(h.length)return{label:r.tuto[1].a,run:()=>h.forEach(m=>o(m))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":gi[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:c}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Ge{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*vi(e){for(const a of e)yield*a}function _n(e){return Array.from(vi(e))}var Z=1e-6,G=Math.PI,ze=G/2,Za=G/4,Te=G*2,Pe=180/G,Se=G/180,ne=Math.abs,yi=Math.atan,ht=Math.atan2,le=Math.cos,ce=Math.sin,wi=Math.sign||function(e){return e>0?1:e<0?-1:0},Qe=Math.sqrt;function ki(e){return e>1?0:e<-1?G:Math.acos(e)}function gt(e){return e>1?ze:e<-1?-ze:Math.asin(e)}function Ae(){}function Lt(e,a){e&&tn.hasOwnProperty(e.type)&&tn[e.type](e,a)}var en={Feature:function(e,a){Lt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Lt(r[n].geometry,a)}},tn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ia(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ia(r[n],a,0)},Polygon:function(e,a){an(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)an(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Lt(r[n],a)}};function ia(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function an(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ia(e[r],a,1);a.polygonEnd()}function Xe(e,a){e&&en.hasOwnProperty(e.type)?en[e.type](e,a):Lt(e,a)}function sa(e){return[ht(e[1],e[0]),gt(e[2])]}function et(e){var a=e[0],r=e[1],n=le(r);return[n*le(a),n*ce(a),ce(r)]}function Nt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Rt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Xt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function St(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function la(e){var a=Qe(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ca(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function da(e,a){return ne(e)>G&&(e-=Math.round(e/Te)*Te),[e,a]}da.invert=da;function ji(e,a,r){return(e%=Te)?a||r?ca(rn(e),on(a,r)):rn(e):a||r?on(a,r):da}function nn(e){return function(a,r){return a+=e,ne(a)>G&&(a-=Math.round(a/Te)*Te),[a,r]}}function rn(e){var a=nn(e);return a.invert=nn(-e),a}function on(e,a){var r=le(e),n=ce(e),i=le(a),o=ce(a);function l(s,p){var x=le(p),d=le(s)*x,c=ce(s)*x,u=ce(p),h=u*r+d*n;return[ht(c*i-h*o,d*r-u*n),gt(h*i+c*o)]}return l.invert=function(s,p){var x=le(p),d=le(s)*x,c=ce(s)*x,u=ce(p),h=u*i-c*o;return[ht(c*i+u*o,d*r+h*n),gt(h*r-d*n)]},l}function Ni(e,a,r,n,i,o){if(r){var l=le(a),s=ce(a),p=n*r;i==null?(i=a+n*Te,o=a-p/2):(i=sn(l,i),o=sn(l,o),(n>0?i<o:i>o)&&(i+=n*Te));for(var x,d=i;n>0?d>o:d<o;d-=p)x=sa([l,-s*le(d),-s*ce(d)]),e.point(x[0],x[1])}}function sn(e,a){a=et(a),a[0]-=e,la(a);var r=ki(-a[1]);return((-a[2]<0?-r:r)+Te-Z)%Te}function Un(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ae,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Tt(e,a){return ne(e[0]-a[0])<Z&&ne(e[1]-a[1])<Z}function Ct(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Vn(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(m){if(!((b=m.length-1)<=0)){var b,v=m[0],f=m[b],y;if(Tt(v,f)){if(!v[2]&&!f[2]){for(i.lineStart(),s=0;s<b;++s)i.point((v=m[s])[0],v[1]);i.lineEnd();return}f[0]+=2*Z}o.push(y=new Ct(v,m,null,!0)),l.push(y.o=new Ct(v,null,y,!1)),o.push(y=new Ct(f,m,null,!1)),l.push(y.o=new Ct(f,null,y,!0))}}),!!o.length){for(l.sort(a),ln(o),ln(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var x=o[0],d,c;;){for(var u=x,h=!0;u.v;)if((u=u.n)===x)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(h)for(s=0,p=d.length;s<p;++s)i.point((c=d[s])[0],c[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(h)for(d=u.p.z,s=d.length-1;s>=0;--s)i.point((c=d[s])[0],c[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,h=!h}while(!u.v);i.lineEnd()}}}function ln(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function Jt(e){return ne(e[0])<=G?e[0]:wi(e[0])*((ne(e[0])+G)%Te-G)}function Si(e,a){var r=Jt(a),n=a[1],i=ce(n),o=[ce(r),-le(r),0],l=0,s=0,p=new Ge;i===1?n=ze+Z:i===-1&&(n=-ze-Z);for(var x=0,d=e.length;x<d;++x)if(u=(c=e[x]).length)for(var c,u,h=c[u-1],m=Jt(h),b=h[1]/2+Za,v=ce(b),f=le(b),y=0;y<u;++y,m=w,v=T,f=O,h=j){var j=c[y],w=Jt(j),z=j[1]/2+Za,T=ce(z),O=le(z),F=w-m,E=F>=0?1:-1,q=E*F,N=q>G,k=v*T;if(p.add(ht(k*E*ce(q),f*O+k*le(q))),l+=N?F+E*Te:F,N^m>=r^w>=r){var L=Rt(et(h),et(j));la(L);var A=Rt(o,L);la(A);var S=(N^F>=0?-1:1)*gt(A[2]);(n>S||n===S&&(L[0]||L[1]))&&(s+=N^F>=0?1:-1)}}return(l<-Z||l<Z&&p<-1e-12)^s&1}function Hn(e,a,r,n){return function(i){var o=a(i),l=Un(),s=a(l),p=!1,x,d,c,u={point:h,lineStart:b,lineEnd:v,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=j,d=[],x=[]},polygonEnd:function(){u.point=h,u.lineStart=b,u.lineEnd=v,d=_n(d);var w=Si(x,n);d.length?(p||(i.polygonStart(),p=!0),Vn(d,Ei,w,r,i)):w&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),d=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function h(w,z){e(w,z)&&i.point(w,z)}function m(w,z){o.point(w,z)}function b(){u.point=m,o.lineStart()}function v(){u.point=h,o.lineEnd()}function f(w,z){c.push([w,z]),s.point(w,z)}function y(){s.lineStart(),c=[]}function j(){f(c[0][0],c[0][1]),s.lineEnd();var w=s.clean(),z=l.result(),T,O=z.length,F,E,q;if(c.pop(),x.push(c),c=null,!!O){if(w&1){if(E=z[0],(F=E.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),T=0;T<F;++T)i.point((q=E[T])[0],q[1]);i.lineEnd()}return}O>1&&w&2&&z.push(z.pop().concat(z.shift())),d.push(z.filter(Ci))}}return u}}function Ci(e){return e.length>1}function Ei(e,a){return((e=e.x)[0]<0?e[1]-ze-Z:ze-e[1])-((a=a.x)[0]<0?a[1]-ze-Z:ze-a[1])}const cn=Hn(function(){return!0},zi,Ti,[-G,-ze]);function zi(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?G:-G,p=ne(o-a);ne(p-G)<Z?(e.point(a,r=(r+l)/2>0?ze:-ze),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=G&&(ne(a-n)<Z&&(a-=n*Z),ne(o-s)<Z&&(o-=s*Z),r=Ai(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ai(e,a,r,n){var i,o,l=ce(e-r);return ne(l)>Z?yi((ce(a)*(o=le(n))*ce(r)-ce(n)*(i=le(a))*ce(e))/(i*o*l)):(a+n)/2}function Ti(e,a,r,n){var i;if(e==null)i=r*ze,n.point(-G,i),n.point(0,i),n.point(G,i),n.point(G,0),n.point(G,-i),n.point(0,-i),n.point(-G,-i),n.point(-G,0),n.point(-G,i);else if(ne(e[0]-a[0])>Z){var o=e[0]<a[0]?G:-G;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Li(e){var a=le(e),r=2*Se,n=a>0,i=ne(a)>Z;function o(d,c,u,h){Ni(h,e,r,u,d,c)}function l(d,c){return le(d)*le(c)>a}function s(d){var c,u,h,m,b;return{lineStart:function(){m=h=!1,b=1},point:function(v,f){var y=[v,f],j,w=l(v,f),z=n?w?0:x(v,f):w?x(v+(v<0?G:-G),f):0;if(!c&&(m=h=w)&&d.lineStart(),w!==h&&(j=p(c,y),(!j||Tt(c,j)||Tt(y,j))&&(y[2]=1)),w!==h)b=0,w?(d.lineStart(),j=p(y,c),d.point(j[0],j[1])):(j=p(c,y),d.point(j[0],j[1],2),d.lineEnd()),c=j;else if(i&&c&&n^w){var T;!(z&u)&&(T=p(y,c,!0))&&(b=0,n?(d.lineStart(),d.point(T[0][0],T[0][1]),d.point(T[1][0],T[1][1]),d.lineEnd()):(d.point(T[1][0],T[1][1]),d.lineEnd(),d.lineStart(),d.point(T[0][0],T[0][1],3)))}w&&(!c||!Tt(c,y))&&d.point(y[0],y[1]),c=y,h=w,u=z},lineEnd:function(){h&&d.lineEnd(),c=null},clean:function(){return b|(m&&h)<<1}}}function p(d,c,u){var h=et(d),m=et(c),b=[1,0,0],v=Rt(h,m),f=Nt(v,v),y=v[0],j=f-y*y;if(!j)return!u&&d;var w=a*f/j,z=-a*y/j,T=Rt(b,v),O=St(b,w),F=St(v,z);Xt(O,F);var E=T,q=Nt(O,E),N=Nt(E,E),k=q*q-N*(Nt(O,O)-1);if(!(k<0)){var L=Qe(k),A=St(E,(-q-L)/N);if(Xt(A,O),A=sa(A),!u)return A;var S=d[0],R=c[0],D=d[1],B=c[1],H;R<S&&(H=S,S=R,R=H);var ae=R-S,ie=ne(ae-G)<Z,de=ie||ae<Z;if(!ie&&B<D&&(H=D,D=B,B=H),de?ie?D+B>0^A[1]<(ne(A[0]-S)<Z?D:B):D<=A[1]&&A[1]<=B:ae>G^(S<=A[0]&&A[0]<=R)){var K=St(E,(-q+L)/N);return Xt(K,O),[A,sa(K)]}}}function x(d,c){var u=n?e:G-e,h=0;return d<-u?h|=1:d>u&&(h|=2),c<-u?h|=4:c>u&&(h|=8),h}return Hn(l,s,o,n?[0,-e]:[-G,e-G])}function Ri(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],x=a[1],d=0,c=1,u=p-l,h=x-s,m;if(m=r-l,!(!u&&m>0)){if(m/=u,u<0){if(m<d)return;m<c&&(c=m)}else if(u>0){if(m>c)return;m>d&&(d=m)}if(m=i-l,!(!u&&m<0)){if(m/=u,u<0){if(m>c)return;m>d&&(d=m)}else if(u>0){if(m<d)return;m<c&&(c=m)}if(m=n-s,!(!h&&m>0)){if(m/=h,h<0){if(m<d)return;m<c&&(c=m)}else if(h>0){if(m>c)return;m>d&&(d=m)}if(m=o-s,!(!h&&m<0)){if(m/=h,h<0){if(m>c)return;m>d&&(d=m)}else if(h>0){if(m<d)return;m<c&&(c=m)}return d>0&&(e[0]=l+d*u,e[1]=s+d*h),c<1&&(a[0]=l+c*u,a[1]=s+c*h),!0}}}}}var dt=1e9,Et=-dt;function Oi(e,a,r,n){function i(x,d){return e<=x&&x<=r&&a<=d&&d<=n}function o(x,d,c,u){var h=0,m=0;if(x==null||(h=l(x,c))!==(m=l(d,c))||p(x,d)<0^c>0)do u.point(h===0||h===3?e:r,h>1?n:a);while((h=(h+c+4)%4)!==m);else u.point(d[0],d[1])}function l(x,d){return ne(x[0]-e)<Z?d>0?0:3:ne(x[0]-r)<Z?d>0?2:1:ne(x[1]-a)<Z?d>0?1:0:d>0?3:2}function s(x,d){return p(x.x,d.x)}function p(x,d){var c=l(x,1),u=l(d,1);return c!==u?c-u:c===0?d[1]-x[1]:c===1?x[0]-d[0]:c===2?x[1]-d[1]:d[0]-x[0]}return function(x){var d=x,c=Un(),u,h,m,b,v,f,y,j,w,z,T,O={point:F,lineStart:k,lineEnd:L,polygonStart:q,polygonEnd:N};function F(S,R){i(S,R)&&d.point(S,R)}function E(){for(var S=0,R=0,D=h.length;R<D;++R)for(var B=h[R],H=1,ae=B.length,ie=B[0],de,K,_=ie[0],U=ie[1];H<ae;++H)de=_,K=U,ie=B[H],_=ie[0],U=ie[1],K<=n?U>n&&(_-de)*(n-K)>(U-K)*(e-de)&&++S:U<=n&&(_-de)*(n-K)<(U-K)*(e-de)&&--S;return S}function q(){d=c,u=[],h=[],T=!0}function N(){var S=E(),R=T&&S,D=(u=_n(u)).length;(R||D)&&(x.polygonStart(),R&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),D&&Vn(u,s,S,o,x),x.polygonEnd()),d=x,u=h=m=null}function k(){O.point=A,h&&h.push(m=[]),z=!0,w=!1,y=j=NaN}function L(){u&&(A(b,v),f&&w&&c.rejoin(),u.push(c.result())),O.point=F,w&&d.lineEnd()}function A(S,R){var D=i(S,R);if(h&&m.push([S,R]),z)b=S,v=R,f=D,z=!1,D&&(d.lineStart(),d.point(S,R));else if(D&&w)d.point(S,R);else{var B=[y=Math.max(Et,Math.min(dt,y)),j=Math.max(Et,Math.min(dt,j))],H=[S=Math.max(Et,Math.min(dt,S)),R=Math.max(Et,Math.min(dt,R))];Ri(B,H,e,a,r,n)?(w||(d.lineStart(),d.point(B[0],B[1])),d.point(H[0],H[1]),D||d.lineEnd(),T=!1):D&&(d.lineStart(),d.point(S,R),T=!1)}y=S,j=R,w=D}return O}}const pa=e=>e;var Zt=new Ge,ua=new Ge,Yn,Wn,fa,ma,De={point:Ae,lineStart:Ae,lineEnd:Ae,polygonStart:function(){De.lineStart=qi,De.lineEnd=Fi},polygonEnd:function(){De.lineStart=De.lineEnd=De.point=Ae,Zt.add(ne(ua)),ua=new Ge},result:function(){var e=Zt/2;return Zt=new Ge,e}};function qi(){De.point=Mi}function Mi(e,a){De.point=Gn,Yn=fa=e,Wn=ma=a}function Gn(e,a){ua.add(ma*e-fa*a),fa=e,ma=a}function Fi(){Gn(Yn,Wn)}var tt=1/0,Ot=tt,bt=-tt,qt=bt,Mt={point:Pi,lineStart:Ae,lineEnd:Ae,polygonStart:Ae,polygonEnd:Ae,result:function(){var e=[[tt,Ot],[bt,qt]];return bt=qt=-(Ot=tt=1/0),e}};function Pi(e,a){e<tt&&(tt=e),e>bt&&(bt=e),a<Ot&&(Ot=a),a>qt&&(qt=a)}var xa=0,ha=0,pt=0,Ft=0,Pt=0,Je=0,ga=0,ba=0,ut=0,Kn,Qn,Oe,qe,Ee={point:Ke,lineStart:dn,lineEnd:pn,polygonStart:function(){Ee.lineStart=Bi,Ee.lineEnd=$i},polygonEnd:function(){Ee.point=Ke,Ee.lineStart=dn,Ee.lineEnd=pn},result:function(){var e=ut?[ga/ut,ba/ut]:Je?[Ft/Je,Pt/Je]:pt?[xa/pt,ha/pt]:[NaN,NaN];return xa=ha=pt=Ft=Pt=Je=ga=ba=ut=0,e}};function Ke(e,a){xa+=e,ha+=a,++pt}function dn(){Ee.point=Di}function Di(e,a){Ee.point=Ii,Ke(Oe=e,qe=a)}function Ii(e,a){var r=e-Oe,n=a-qe,i=Qe(r*r+n*n);Ft+=i*(Oe+e)/2,Pt+=i*(qe+a)/2,Je+=i,Ke(Oe=e,qe=a)}function pn(){Ee.point=Ke}function Bi(){Ee.point=_i}function $i(){Xn(Kn,Qn)}function _i(e,a){Ee.point=Xn,Ke(Kn=Oe=e,Qn=qe=a)}function Xn(e,a){var r=e-Oe,n=a-qe,i=Qe(r*r+n*n);Ft+=i*(Oe+e)/2,Pt+=i*(qe+a)/2,Je+=i,i=qe*e-Oe*a,ga+=i*(Oe+e),ba+=i*(qe+a),ut+=i*3,Ke(Oe=e,qe=a)}function Jn(e){this._context=e}Jn.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Te);break}}},result:Ae};var va=new Ge,ea,Zn,er,ft,mt,vt={point:Ae,lineStart:function(){vt.point=Ui},lineEnd:function(){ea&&tr(Zn,er),vt.point=Ae},polygonStart:function(){ea=!0},polygonEnd:function(){ea=null},result:function(){var e=+va;return va=new Ge,e}};function Ui(e,a){vt.point=tr,Zn=ft=e,er=mt=a}function tr(e,a){ft-=e,mt-=a,va.add(Qe(ft*ft+mt*mt)),ft=e,mt=a}let un,Dt,fn,mn;class xn{constructor(a){this._append=a==null?ar:Vi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==fn||this._append!==Dt){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,fn=n,Dt=this._append,mn=this._,this._=i}this._+=mn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ar(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Vi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ar;if(a!==un){const r=10**a;un=a,Dt=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Dt}function Hi(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Xe(s,i(o))),o.result()}return l.area=function(s){return Xe(s,i(De)),De.result()},l.measure=function(s){return Xe(s,i(vt)),vt.result()},l.bounds=function(s){return Xe(s,i(Mt)),Mt.result()},l.centroid=function(s){return Xe(s,i(Ee)),Ee.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,pa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new xn(r)):new Jn(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new xn(r)),l},l.projection(e).digits(r).context(a)}function Aa(e){return function(a){var r=new ya;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ya(){}ya.prototype={constructor:ya,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ta(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Xe(r,e.stream(Mt)),a(Mt.result()),n!=null&&e.clipExtent(n),e}function nr(e,a,r){return Ta(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function Yi(e,a,r){return nr(e,[[0,0],a],r)}function Wi(e,a,r){return Ta(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Gi(e,a,r){return Ta(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var hn=16,Ki=le(30*Se);function gn(e,a){return+a?Xi(e,a):Qi(e)}function Qi(e){return Aa({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Xi(e,a){function r(n,i,o,l,s,p,x,d,c,u,h,m,b,v){var f=x-n,y=d-i,j=f*f+y*y;if(j>4*a&&b--){var w=l+u,z=s+h,T=p+m,O=Qe(w*w+z*z+T*T),F=gt(T/=O),E=ne(ne(T)-1)<Z||ne(o-c)<Z?(o+c)/2:ht(z,w),q=e(E,F),N=q[0],k=q[1],L=N-n,A=k-i,S=y*L-f*A;(S*S/j>a||ne((f*L+y*A)/j-.5)>.3||l*u+s*h+p*m<Ki)&&(r(n,i,o,l,s,p,N,k,E,w/=O,z/=O,T,b,v),v.point(N,k),r(N,k,E,w,z,T,x,d,c,u,h,m,b,v))}}return function(n){var i,o,l,s,p,x,d,c,u,h,m,b,v={point:f,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=z},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function f(F,E){F=e(F,E),n.point(F[0],F[1])}function y(){c=NaN,v.point=j,n.lineStart()}function j(F,E){var q=et([F,E]),N=e(F,E);r(c,u,d,h,m,b,c=N[0],u=N[1],d=F,h=q[0],m=q[1],b=q[2],hn,n),n.point(c,u)}function w(){v.point=f,n.lineEnd()}function z(){y(),v.point=T,v.lineEnd=O}function T(F,E){j(i=F,E),o=c,l=u,s=h,p=m,x=b,v.point=j}function O(){r(c,u,d,h,m,b,o,l,i,s,p,x,hn,n),v.lineEnd=w,w()}return v}}var Ji=Aa({point:function(e,a){this.stream.point(e*Se,a*Se)}});function Zi(e){return Aa({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function es(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function bn(e,a,r,n,i,o){if(!o)return es(e,a,r,n,i);var l=le(o),s=ce(o),p=l*e,x=s*e,d=l/e,c=s/e,u=(s*r-l*a)/e,h=(s*a+l*r)/e;function m(b,v){return b*=n,v*=i,[p*b-x*v+a,r-x*b-p*v]}return m.invert=function(b,v){return[n*(d*b-c*v+u),i*(h-c*b-d*v)]},m}function ts(e){return as(function(){return e})()}function as(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,x=0,d,c=0,u=1,h=1,m=null,b=cn,v=null,f,y,j,w=pa,z=.5,T,O,F,E,q;function N(S){return F(S[0]*Se,S[1]*Se)}function k(S){return S=F.invert(S[0],S[1]),S&&[S[0]*Pe,S[1]*Pe]}N.stream=function(S){return E&&q===S?E:E=Ji(Zi(d)(b(T(w(q=S)))))},N.preclip=function(S){return arguments.length?(b=S,m=void 0,A()):b},N.postclip=function(S){return arguments.length?(w=S,v=f=y=j=null,A()):w},N.clipAngle=function(S){return arguments.length?(b=+S?Li(m=S*Se):(m=null,cn),A()):m*Pe},N.clipExtent=function(S){return arguments.length?(w=S==null?(v=f=y=j=null,pa):Oi(v=+S[0][0],f=+S[0][1],y=+S[1][0],j=+S[1][1]),A()):v==null?null:[[v,f],[y,j]]},N.scale=function(S){return arguments.length?(r=+S,L()):r},N.translate=function(S){return arguments.length?(n=+S[0],i=+S[1],L()):[n,i]},N.center=function(S){return arguments.length?(o=S[0]%360*Se,l=S[1]%360*Se,L()):[o*Pe,l*Pe]},N.rotate=function(S){return arguments.length?(s=S[0]%360*Se,p=S[1]%360*Se,x=S.length>2?S[2]%360*Se:0,L()):[s*Pe,p*Pe,x*Pe]},N.angle=function(S){return arguments.length?(c=S%360*Se,L()):c*Pe},N.reflectX=function(S){return arguments.length?(u=S?-1:1,L()):u<0},N.reflectY=function(S){return arguments.length?(h=S?-1:1,L()):h<0},N.precision=function(S){return arguments.length?(T=gn(O,z=S*S),A()):Qe(z)},N.fitExtent=function(S,R){return nr(N,S,R)},N.fitSize=function(S,R){return Yi(N,S,R)},N.fitWidth=function(S,R){return Wi(N,S,R)},N.fitHeight=function(S,R){return Gi(N,S,R)};function L(){var S=bn(r,0,0,u,h,c).apply(null,a(o,l)),R=bn(r,n-S[0],i-S[1],u,h,c);return d=ji(s,p,x),O=ca(a,R),F=ca(d,O),T=gn(O,z),A()}function A(){return E=q=null,N}return function(){return a=e.apply(this,arguments),N.invert=a.invert&&k,L()}}function rr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}rr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ne(i)>Z&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ns(){return ts(rr).scale(175.295)}function rs(e){return e}function os(e){if(e==null)return rs;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var x=2,d=s.length,c=new Array(d);for(c[0]=(a+=s[0])*n+o,c[1]=(r+=s[1])*i+l;x<d;)c[x]=s[x],++x;return c}}function is(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ss(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return vn(e,r)})}:vn(e,a)}function vn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=ls(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function ls(e,a){var r=os(e.transform),n=e.arcs;function i(d,c){c.length&&c.pop();for(var u=n[d<0?~d:d],h=0,m=u.length;h<m;++h)c.push(r(u[h],h));d<0&&is(c,m)}function o(d){return r(d)}function l(d){for(var c=[],u=0,h=d.length;u<h;++u)i(d[u],c);return c.length<2&&c.push(c[0]),c}function s(d){for(var c=l(d);c.length<4;)c.push(c[0]);return c}function p(d){return d.map(s)}function x(d){var c=d.type,u;switch(c){case"GeometryCollection":return{type:c,geometries:d.geometries.map(x)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=p(d.arcs);break;case"MultiPolygon":u=d.arcs.map(p);break;default:return null}return{type:c,coordinates:u}}return x(a)}const or={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},cs=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ds(e,a,r){const n=or[e];if(!n||!n.length)return-1;const i=cs(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let zt=null;function ps(){return zt||(zt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ss(r,n),o=ns().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Hi(o),s=(i.features||[]).filter(d=>{var c;return(((c=d.properties)==null?void 0:c.name)||"")!=="Antarctica"}).map(d=>{var h;const c=((h=d.properties)==null?void 0:h.name)||"",u=l(d)||"";return u?{i2:Ur(c)||null,n:c,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const p={};for(const[d,c]of Object.entries(Vr)){const u=o(c);u&&(p[d]={x:u[0],y:u[1]})}const x={};for(const[d,c]of Object.entries(or)){const u=c.map(h=>o(h.ll)).filter(h=>!!h).map(([h,m])=>({x:h,y:m}));u.length&&(x[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:x}}catch{return null}})(),zt)}function us(e){const[a,r]=g.useState(null);return g.useEffect(()=>{if(!e||a)return;let n=!1;return ps().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const fs={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},yn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function wn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ms(e,a){const[r,n]=g.useState(1);return g.useEffect(()=>{let i=!0,o=0;const l=()=>{var x;if(!i)return;const p=(x=e.current)==null?void 0:x.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function xs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p}=M(),x=g.useRef(null),d=g.useRef(null),c=us(e.continent==="monde"),u=e.continent==="monde"?c:Sa.find(N=>N.key===e.continent)||null,h=ms(x,e.continent+":"+e.mapFolded+":"+!!u),[m,b]=g.useState(new Map),[v,f]=g.useState(null);g.useEffect(()=>{const N=x.current;if(!N)return;const k=new Map;N.querySelectorAll("path[data-i2]").forEach(L=>{const A=L.dataset.i2;if(A)try{const S=L.getBBox();S.width>0&&k.set(A,{x:S.x,y:S.y,w:S.width,h:S.height})}catch{}}),b(k)},[e.continent,h,u]);const y=g.useMemo(()=>r.filter(N=>N.cc),[r]),j=g.useMemo(()=>{const N=new Map;return y.forEach(k=>N.set(k.cc,(N.get(k.cc)||0)+1)),N},[y]),w=e.continent==="monde"&&c?c.anchors:null,z=e.continent==="monde"&&c?c.metros:null,T=g.useMemo(()=>y.map(N=>{const k=wn(N.name||N.id||""),L=wn((N.id||N.name||"")+"·y");if(w&&N.cc){const B=z?z[N.cc]:void 0;if(B&&B.length){const ae=ds(N.cc,N.city,k);if(ae>=0&&B[ae])return{d:N,x:B[ae].x+(k-.5)*5,y:B[ae].y+(L-.5)*5}}const H=w[N.cc];if(H)return{d:N,x:H.x+(k-.5)*10,y:H.y+(L-.5)*10}}const A=N.cc?m.get(N.cc):void 0;if(!A)return null;const S=fs[`${e.continent}:${N.cc||""}`];if(S)return{d:N,x:A.x+A.w*(S.fx+(k-.5)*S.sx),y:A.y+A.h*(S.fy+(L-.5)*S.sy)};const R=(k-.5)*Math.min(A.w*.55,60),D=(L-.5)*Math.min(A.h*.55,60);return{d:N,x:A.x+A.w/2+R,y:A.y+A.h/2+D}}).filter(N=>!!N),[y,m,w,z,e.continent]),O=N=>h>0?N/h:N,F=g.useMemo(()=>n?[0,1,2,3,4,5].map(N=>({c:yn[N],fr:p.plabels[N].toUpperCase(),en:p.plabels[N].toUpperCase(),n:r.filter(k=>k.kind==="target"&&ke(k)===N).length})).filter(N=>N.n>0):Ia.map((N,k)=>({...N,n:r.filter(L=>Ba(L)===k).length})),[r,n,p.plabels]),E=o?l.get(o):null,q=E?T.find(N=>N.d.id===E.id):null;return u?t.jsxs("div",{className:"mapzone",ref:d,children:[t.jsxs("svg",{ref:x,viewBox:u.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?u.fr:u.en,onMouseLeave:()=>{f(null),i(null)},children:[t.jsx("g",{children:u.countries.map((N,k)=>t.jsx("g",{className:"ct"+(N.i2&&j.get(N.i2)?"":" empty"),children:t.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},k))}),t.jsx("g",{children:T.map(N=>{const k=Ia[Ba(N.d)],L=!!xe(N.d),A=N.d.kind==="target",S=n&&A?yn[ke(N.d)]:k.c,R=!n&&Ce(N.d);return t.jsxs("g",{className:"co"+(R?" done":""),onMouseEnter:()=>{var H,ae;const D=(H=d.current)==null?void 0:H.getBoundingClientRect(),B=(ae=x.current)==null?void 0:ae.createSVGPoint();if(B&&x.current&&D){B.x=N.x,B.y=N.y;const ie=B.matrixTransform(x.current.getScreenCTM());f({x:ie.x-D.left,y:ie.y-D.top,label:N.d.name+" · "+(ot(N.d.cc,s)||N.d.countryLabel||"")})}i(N.d.id)},onMouseLeave:()=>{f(null),i(null)},onClick:()=>{var H;const D=(H=x.current)==null?void 0:H.createSVGPoint();let B=null;if(D&&x.current){D.x=N.x,D.y=N.y;const ae=D.matrixTransform(x.current.getScreenCTM());B={x:ae.x,y:ae.y}}a({type:"popup",id:N.d.id,anchor:B})},children:[t.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:O(Math.max(11,k.px+7))}),t.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:O(k.px),fill:S,stroke:L?"#DC2626":"#ffffff",strokeWidth:O(L?2.2:1.3)})]},N.d.id||N.d.name)})}),q&&t.jsx("circle",{className:"ring on",cx:q.x,cy:q.y,r:O(13),fill:"none",stroke:"#0F172A",strokeWidth:O(2)})]}),t.jsx("div",{className:"hov"+(v?" on":""),style:v?{left:v.x,top:v.y}:void 0,children:v==null?void 0:v.label}),t.jsx("div",{className:"legend",children:F.map((N,k)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":N.c}}),s==="fr"?N.fr:N.en," ",t.jsx("b",{children:N.n})]},k))}),r.some(N=>!N.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(N=>!N.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:d})}function hs(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function gs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=M(),s=e.filters,p=g.useMemo(()=>e.continent==="monde"?r:r.filter(m=>m.continent===e.continent),[r,e.continent]),x=m=>p.filter(b=>m!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:Ea(b,s,i,m==="country"?void 0:m)),d=g.useMemo(()=>{const m=x("win"),b=v=>m.filter(f=>(f.date?Math.max(0,Math.floor((Date.now()-Date.parse(f.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),m.length]},[p,s,i]),c=g.useMemo(()=>s.day?x("win").filter(m=>(m.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),h=(m,b,v,f="fbtn")=>t.jsxs("button",{type:"button",className:f,"aria-expanded":e.openFacet===m,onClick:()=>a({type:"openFacet",facet:m}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},m);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(hs(s.day,l)),t.jsx("b",{children:c})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((m,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===m,onClick:()=>a({type:"filters",patch:{win:m}}),children:[n.dates[b],t.jsx("b",{children:d[b]})]},m))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:m=>a({type:"filters",patch:{search:m.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):h("sec",n.fSector,s.sector.length),h("pay",n.fCountry,s.country.length),h("det",n.fEngine,s.engine.length),h("sta",n.fStage,s.stage.length),i&&h("ang","Angle",s.angle.length),i&&h("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(bs,{poolFor:x})]})}function bs({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=M(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:x}=g.useMemo(()=>{if(l==="sig"){const m=e("signal").filter(f=>xe(f)),b=new Map;m.forEach(f=>{const y=f.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...na([...b.keys()],i).map(f=>({v:f,label:Ze(f)+" "+Ie(f,i),n:b.get(f)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const m=e("sector"),b=new Map;return m.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v,n:f,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const m=e("country"),b=new Map;return m.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:ot(v,i)||v,n:f,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const m=e("engine"),b=new Map;return m.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:na([...b.keys()],i).map(v=>({v,label:Ze(v)+" "+Ie(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Hr(Yr(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const m=e("angle"),b=new Map;return m.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v.replace(/[_-]+/g," "),n:f,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const m=e("memoLevel"),b=new Map;m.forEach(f=>{if(f.kind==="target"){const y=ja(f);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:v[f],n:b.get(f)||0,html:!1,on:o.memoLevel.includes(f)}))}}const u=e("stage"),h=new Map;return u.forEach(m=>{m.stage&&h.set(m.stage,(h.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((m,b)=>b[1]-m[1]).map(([m,b])=>({v:m,label:m,n:b,html:!1,on:o.stage.includes(m)}))}},[l,a,i]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const m=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},c=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:c,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function ir(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function vs(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function kn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=M();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function sr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=M(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(kn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(kn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function ys({card:e,onEvaluate:a,onAddAll:r}){var s,p,x;const{t:n}=M(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ir(e.summary_md||"").map((d,c)=>t.jsx("p",{children:d},c))})]}),t.jsx(sr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function ws(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function ks({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=M(),s=i,[p,x]=g.useState(null),[d,c]=g.useState(null),[u,h]=g.useState(null),[m,b]=g.useState(!1);g.useEffect(()=>{let f=!0;return(async()=>{const y=await On({email:l,cbToken:s});f&&x(y)})(),()=>{f=!1}},[l,s,n]);const v=f=>{c(f),h(null),b(!0),(async()=>{const y=await Wr(f.id);h(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{c(null),h(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[ws(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?o.rsPub:o.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!m&&u&&t.jsx(ys,{card:u,onEvaluate:a,onAddAll:r})]})]})}const jn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function js(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:x,data:d,canWrite:c,source:u}=M(),h=a==="client",m=g.useMemo(()=>r||(u!=="default"?Gr():""),[r,u]),[b,v]=g.useState(""),[f,y]=g.useState(!1),[j,w]=g.useState(""),[z,T]=g.useState(!1),[O,F]=g.useState(""),[E,q]=g.useState([]),N=g.useRef(!1),[k,L]=g.useState(!1),[A,S]=g.useState(""),[R,D]=g.useState(""),[B,H]=g.useState(!1),[ae,ie]=g.useState(0),[de,K]=g.useState(""),[_,U]=g.useState(null),[V,ee]=g.useState(null),[se,ve]=g.useState(!1),[pe,W]=g.useState(null),[X,he]=g.useState(0),Y=g.useRef(!1),re=b.trim()?jn.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,Q=g.useMemo(()=>j.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[j]);g.useEffect(()=>{if(typeof window>"u")return;const P=(new URLSearchParams(window.location.search).get("rs")||"").trim();!P||!/^https?:\/\//i.test(P)||(S(P),L(!0))},[]),g.useEffect(()=>{const P=J=>{var ge;const oe=String(((ge=J.detail)==null?void 0:ge.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(S(oe),L(!0))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),g.useEffect(()=>{if(!c&&!m){W(null);return}let P=!0;return(async()=>{const J=await On({email:n,cbToken:m});P&&W(J.length)})(),()=>{P=!1}},[c,m,n,X]);const Be=E.length?E:p,ue=d.credits,fe=g.useCallback(P=>{const J=P.map(oe=>(oe||"").trim()).filter(Boolean);J.length&&(w(oe=>{const ge=oe.split(`
`).map(Ne=>Ne.trim()).filter(Boolean),$e=new Set(ge.map(Ne=>Ne.toLowerCase())),ye=J.filter(Ne=>!$e.has(Ne.toLowerCase()));return[...ge,...ye].slice(0,15).join(`
`)}),y(!0))},[]);g.useEffect(()=>{if(!B)return;ie(0);const P=window.setInterval(()=>ie(J=>J+1),1e3);return()=>window.clearInterval(P)},[B]);const Me=()=>{const P=b.trim();P&&(i(null,P),v(""))},Ue=async()=>{if(!h){i(null,Q[0]||"");return}if(!Q.length||z)return;T(!0),N.current=!1;const P=[];for(let J=0;J<Q.length&&!N.current;J++){F(e.evaluating(J+1,Q.length,Q[J]));const oe=await qn(r,Q[J],"atelier2");if(P.unshift({name:oe.company||Q[J],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),q([...P]),oe.verdict==="quota"){P.unshift({name:"",verdict:"quota",reason:e.quota(Q.length-J-1),remaining:0}),q([...P]),w(Q.slice(J+1).join(`
`)),F(""),T(!1);return}}F(""),w(N.current?Q.slice(P.length).join(`
`):""),T(!1)},je=async()=>{var oe,ge,$e;if(Y.current)return;const P=A.trim().replace(/\s+/g,""),J=R.trim();if(!P&&!J){K(e.rsNeed);return}if(!h&&!m){i(null,P||J.slice(0,80));return}Y.current=!0,K(""),U(null),ee(null),H(!0);try{const ye=await Qr({url:P,text:J,email:n,cbToken:m});if(H(!1),!ye||ye.status!=="success"){K((ye==null?void 0:ye.message)||"Erreur");return}U(ye),L(!1),fe((((oe=ye.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(_e=>(_e==null?void 0:_e.name)||"")),ee({state:"pending"});const Ne=await Xr(ye,{email:n,cbToken:m});ee(Ne.ok?{state:"ok",scopeLabel:((ge=Ne.summary)==null?void 0:ge.scope_label)||"",scope:(($e=Ne.summary)==null?void 0:$e.scope)||""}:{state:"fail",msg:Ne.error||""}),Ne.ok&&he(_e=>_e+1)}finally{Y.current=!1,H(!1)}},Fe=[_==null?void 0:_.industry,...(_==null?void 0:_.market_tags)||[],_==null?void 0:_.author].map(P=>(P||"").trim()).filter(Boolean),st=(V==null?void 0:V.state)==="pending",Ut=V&&(st?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):V.state==="ok"?t.jsx("span",{className:"rslink ok",children:V.scope&&V.scope!=="public"?e.rsSavedIn(V.scopeLabel||V.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:V.msg,children:e.rsSaveFail})),Vt=vs(_).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:b,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:P=>v(P.target.value),onKeyDown:P=>{P.key==="Enter"&&Me()}}),t.jsx("span",{className:"detect"+(jn.test(b.trim())?" url":""),children:re})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:Me,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),x.showCredits&&ue&&t.jsxs("button",{type:"button",className:"credits"+(ue.total_available<=0&&!ue.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ue.unlimited?"∞":ue.total_available}),!ue.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ue.daily_grant+ue.purchased]}),ue.total_available<=0&&!ue.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(k?" on":""),onClick:()=>L(!k),children:e.rsOpen}),pe!==null&&pe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(se?" on":""),onClick:()=>ve(!se),children:e.rsArchOpen(pe)})]}),se&&t.jsx(ks,{bump:X,cbToken:m,onClose:()=>ve(!1),onEvaluate:P=>i(null,P),onAddAll:fe}),k&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:A,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:P=>S(P.target.value),onKeyDown:P=>{P.key==="Enter"&&je()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:R,placeholder:e.rsTextPh,onChange:P=>D(P.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(B?" loading":""),style:{justifyContent:"center"},disabled:B||st||!A.trim()&&!R.trim(),onClick:()=>{je()},children:[t.jsx("span",{className:"fill"}),B?`${Kr(A.trim())==="youtube"&&A.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ae)}`:st?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),de&&t.jsx("div",{className:"rserr",children:de}),_&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:_.title}),_.source_url&&t.jsx("a",{href:_.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{U(null),ee(null)},children:"×"})]}),_.market&&t.jsx("p",{className:"rsmk",children:_.market}),Fe.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Fe.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[_.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${_.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ir(_.summary_md||"").map((P,J)=>t.jsx("p",{children:P},J))})]}),t.jsx(sr,{card:_,onEvaluate:P=>i(null,P),onAddAll:fe}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Vt)}),Ut]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:j,placeholder:e.bulkPh,onChange:P=>w(P.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(z?" loading":""),style:{justifyContent:"center"},disabled:z||!Q.length,onClick:()=>{Ue()},children:[t.jsx("span",{className:"fill"}),z&&O?O:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(Q.length)})]})]}),Be.slice(0,1).map((P,J)=>{const oe=P.verdict==="kept",ge=P.verdict==="quota",$e=oe?"var(--brand)":ge?"var(--bolt)":"var(--red)",ye=oe?"var(--brand-l)":ge?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":$e,"--bgc":ye},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:ge?"⏳":"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!ge&&t.jsx("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"space"}),children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),h&&(o.kept+o.dropped>0||Be.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Ns(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ss(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=M(),o=e.memoConsole?r.get(e.memoConsole):null,l=g.useMemo(()=>o?[o.reasoning||"",Ns(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const s=rt(o),p=ja(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((x,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Ca(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function lr({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=M(),[l,s]=g.useState(!1),[p,x]=g.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const d=async()=>{if(l)return;s(!0);const c=await Jr(r,e);if(s(!1),!c){o(a.actErr);return}x(c.results||[])};return t.jsxs("div",{className:"simb",onClick:c=>c.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{d()},children:l?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(c=>t.jsxs("li",{children:[t.jsx("b",{className:c.verdict==="kept"?"ok":"ko",children:c.company}),c.reason&&t.jsx("span",{children:c.reason})]},c.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}function $t({spec:e}){const a=g.useRef(null),r=g.useRef(null),[n,i]=g.useState(!1);return g.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;return $a({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)}),()=>{l=!0,o.replaceChildren()}},[e]),g.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;$a({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(p=>{!l&&p&&o.isConnected&&o.replaceChildren(p)});const s=p=>{p.key==="Escape"&&i(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&nt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Cs=`
...
`;function Es(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function zs(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:p,doDecide:x,doPromote:d,doRepeche:c,doApproach:u,doDeep:h,doOnboard:m,outbound:b,evalBusy:v}=M(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const y=xe(f),j=ke(f),w=rt(f),z=f.kind==="target",T=O=>{a({type:"filters",patch:O}),a({type:"popup",id:null})};return nt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Cs}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Es(e.popupAnchor,!!f.card),onClick:O=>O.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(at(f.date)),Ie(f.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>T({country:[f.cc]}),children:(ot(f.cc,i)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>T({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>T({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:It(f.amountEur,i)})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ze(f.engine)," ",t.jsx("b",{children:Ie(f.engine,i)})," — ",Zr(f.engine,i),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(it,{o:f,lg:!0})," ",t.jsx(_t,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Mn(y,i))," · ",n.win7(Fn(y,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx($t,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),o.pipe&&z&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})})]}),t.jsx(lr,{name:f.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(f,!1),a({type:"popup",id:null})},children:n.actNo}),Ca(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{h(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var O;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(O=document.querySelector(".atl2 .demand"))==null||O.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}const As=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),At=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Ts(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=At(a.slice(n));break}r+=At(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=At(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&As.has(p)?r+=`<${s[1]}${p}>`:r+=At(a.slice(i,o+1)),n=o+1}return r}const Nn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function be({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ls({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=M(),o=Bt(e),l=rt(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),c=g.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:d}].filter(b=>b.n>0),[e,a,s,l,p,x,d]),[u,h]=g.useState("");if(!c.length)return null;const m=c.some(b=>b.k===u)?u:c[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:c.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===b.k,className:m===b.k?"on":"",onClick:v=>{v.stopPropagation(),h(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[m==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(be,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(be,{k:a.cdVerdictDate,v:Nn(e.verdictDate,r)})]})]}),m==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Ts(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Rs,{o:e})]}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdSector,v:e.sector}),t.jsx(be,{k:a.cdStage,v:e.stage}),t.jsx(be,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(be,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(be,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(be,{k:a.cdAngle,v:e.angle}),t.jsx(be,{k:a.cdDetected,v:Nn(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdName,v:e.contactName}),t.jsx(be,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(be,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(be,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Rs({o:e}){const{t:a,token:r}=M(),[n,i]=g.useState(!1),[o,l]=g.useState(null),s=async()=>{n||(i(!0),l(await eo(r,e.name,e.website||e.domain||"")),i(!1))},p=(o==null?void 0:o.blocs)||{},x=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=x.some(([,c])=>c);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&d&&t.jsxs(t.Fragment,{children:[x.filter(([,c])=>c).map(([c,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:c}),t.jsx("p",{children:u})]},c)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!d&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const cr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function La({o:e}){const{t:a}=M(),r=Bt(e),n=rt(e),i=ke(e),o=aa(e),l=to(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(cr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const wa=e=>e.length>22?e.slice(0,21)+"…":e;function Sn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=M(),[o,l]=g.useState(!1);if(g.useEffect(()=>{n||l(!1)},[n]),Ce(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(wa(e.name))})]})}function dr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:p,doApproach:x,dispatch:d}=M();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:h=>{h.stopPropagation(),d({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:h=>{var m;h.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(m=document.querySelector(".atl2 .demand"))==null||m.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Sn,{o:e})});const c=ke(e),u=h=>m=>{m.stopPropagation(),h()};if(c===0)return t.jsx("span",{className:"cell",children:t.jsx(Sn,{o:e})});if(c===1){const h=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:h,onClick:u(()=>o(e)),children:h?a.actAnalyseQueued:a.actAnalyse})})}if(c===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(c===4){const h=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:h,onClick:u(()=>x(e)),children:h?a.actApproachSent:a.actApproach})})}return c===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):c===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Os({o:e}){const{t:a,doThumb:r,thumbOf:n}=M(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function qs({o:e}){const{lang:a}=M();return xe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(it,{o:e}),t.jsx(_t,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ze(e.engine||"")," ",Ie(e.engine||"",a)]})})}function Ms({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:p,favIds:x,toggleFav:d}=M(),c=ke(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],h=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,m=h<=0?0:h<=7?1:h<=30?2:3,b=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][c]:u[m],v=x.has(e.id),f=y=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const j=y.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:j.left+Math.min(280,j.width/3),y:j.bottom}})};return t.jsxs(g.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:f,children:[t.jsx("span",{className:"pt",style:{"--c":b}}),t.jsx(hr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:v?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),d(e)},children:v?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(Fs,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(qs,{o:e}),l.pipe&&t.jsx(La,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(dr,{o:e}),l.showThumbs&&t.jsx(Os,{o:e})]}),r&&!a&&t.jsx(Ds,{o:e})]})}function Fs({o:e}){const{lang:a,caps:r}=M();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=It(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Ps({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=M(),l=(u,h=!1)=>m=>{m.stopPropagation(),h&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),p=It(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ce(e),c=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),p&&t.jsx("span",{className:"oc-amt",children:p}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":c?"var(--brand)":"var(--red)"},children:[c?"✓":"✗"," ",t.jsx("b",{children:c?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var h;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(h=document.querySelector(".atl2 .demand"))==null||h.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(wa(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(wa(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx($t,{spec:e.card})})]})}function Ds({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=M();return!i.pipe&&e.kind==="op"?t.jsx(Ps,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Ls,{o:e}),t.jsx(si,{o:e}),t.jsx(di,{o:e}),t.jsx(lr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(La,{o:e})})]}),e.card&&t.jsx($t,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ze(e.engine||"")," ",Ie(e.engine||"",r)]}),xe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(it,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsxs("div",{className:"sec2 acts2",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"btn p",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})]})]})]})}function Is({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o}=M();if(!i.pipe&&e.kind==="op")return t.jsxs("div",{className:"dcard dops"+(a?" locked":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx($t,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),!a&&t.jsx("div",{className:"dact",children:t.jsx(dr,{o:e})})]});const l=ke(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":s},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(La,{o:e}),xe(e)&&t.jsx(it,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&l===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Bs(){const{t:e}=M(),[a,r]=g.useState(0);return g.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function $s({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=M(),o=i==="en",l=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),p=s.includes(0)?0:s.sort((d,c)=>(e[c]||0)-(e[d]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?o?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:o?`${x} ${x>1?"files":"file"} in “${l(p)}”`:`${x} dossier${x>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(o?"Open ":"Ouvrir ")+l(p)," →"]})]})}function _s(){const e=M(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,lang:s,sessTally:p,data:x,dossiers:d,source:c}=e,u=c==="ops"?8:Dn,[h,m]=g.useState(new Set);g.useEffect(()=>{m(new Set)},[a.ptab,a.continent]);const[b,v]=g.useState(null);g.useEffect(()=>{v(null)},[a.ptab,a.continent]);const f=k=>m(L=>{const A=new Set(L);return A.has(k)?A.delete(k):A.add(k),A}),y=g.useMemo(()=>za(l,a.sort),[l,a.sort]),j=g.useMemo(()=>y.filter(k=>xe(k)&&!Ce(k)).length,[y]),w=g.useMemo(()=>i.pipe?y:y.filter(k=>!Ce(k)&&!k.noCo),[y,i.pipe]),z=c==="ops"?y.filter(k=>k.noCo).length:0,T=i.pipe?n.plabels[a.ptab].toLowerCase():c==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,O=(k,L,A="",S=!1)=>t.jsxs("button",{type:"button","data-s":k,className:A,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:S?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:k}),children:[L,t.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),F=g.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const k=new Map;y.forEach(S=>{const R=S.engine||"?";k.has(R)||k.set(R,[]),k.get(R).push(S)});const L={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},A=na([...k.keys()],s);return[...k.entries()].sort((S,R)=>{const D=L[S[0]]??10+A.indexOf(S[0]),B=L[R[0]]??10+A.indexOf(R[0]);return D-B})},[y,i.pipe,a.groupBy,s]),E=i.lockRowsAfter;let q=0;const N=(k,L)=>{let A=a.shown[L]||u;c==="ops"&&k.length-A<=4&&(A=k.length);const R=k.slice(0,A).map(D=>{const B=E!==null&&q>=E;q++;const H=a.dens!=="maxi"&&(a.dens==="deplie"||(b?b==="open":c==="ops"&&!!D.decryptHtml)),ae=h.has(D.id)?!H:H;return a.dens==="maxi"?t.jsx(Is,{o:D,locked:B},D.id):t.jsx(Ms,{o:D,locked:B,open:ae,onToggle:()=>f(D.id)},D.id)});if(k.length>A&&c!=="ops"){const D=Math.min(u,k.length-A),B=k.length-A;R.push(t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>r({type:"more",group:L,by:u,base:u}),children:[t.jsx("span",{className:"more-label",children:n.more(D,B)}),t.jsxs("span",{className:"more-meta",children:[n.moreMeta(A,k.length)," · ",B," ",s==="en"?"remaining":B>1?"restantes":"restante"]})]},L+":more"))}return R};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:y.length})," ",T]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",c==="ops"&&y.length>0&&" — "+n.edSplit(y.length-z,z)]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||c==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([k,L])=>t.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k||k==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:k}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:L})]},k))}),(i.showFunnel||c==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":b==="open",onClick:()=>{v("open"),m(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":b==="closed",onClick:()=>{v("closed"),m(new Set)},children:n.foldAllLbl}),c==="ops"&&t.jsxs("button",{type:"button","aria-pressed":b===null,onClick:()=>{v(null),m(new Set)},children:["📖 ",n.foldArts]})]}),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:k=>r({type:"sort",key:k.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([k,L])=>t.jsx("option",{value:k,children:L},k))})]}),i.showChain&&w.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:w.map(k=>k.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(w.length):n.chainAll(w.length)]})]}),j>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(j)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),O("country",n.colCountry),O("name",n.colCompany),O("amount",n.colAmount,"h-amt",!0),O("stage",n.colStage,"h-stade"),O("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&O("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(c==="ops"?" opsl":"")+(y.length?"":" list-empty"),children:[F?F.map(([k,L])=>t.jsxs(g.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ze(k)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Ie(k,s)}),t.jsx("div",{className:"s",children:n.grpCount(L.filter(A=>!Ce(A)).length,L.length)})]})]}),N(L,k)]},k)):N(y,"pt"+a.ptab),x.loading&&!d.length&&t.jsx(Bs,{}),!y.length&&!(x.loading&&!d.length)&&(i.pipe?t.jsx($s,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),c==="ops"&&F&&(()=>{let k=0,L=0;for(const[S,R]of F){L+=R.length;let D=a.shown[S]||u;R.length-D<=4&&(D=R.length),k+=Math.min(R.length,D)}const A=L-k;return A<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>F.forEach(([S,R])=>r({type:"more",group:S,by:R.length,base:u})),children:[t.jsx("span",{className:"more-label",children:n.more(A,A)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(k,L)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}})]})}function Cn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Us(e,a){const r=ao(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Vs(e,a){const n=[a.head.split("|").map(Cn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",Us(i,a.plabels),Bt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Cn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Hs(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Ys=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Re({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Ws({o:e,qa:a}){const{t:r,lang:n,fund:i}=M(),o=(e.cribleStatus||"").trim().toUpperCase()||(Bt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=rt(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Re,{k:r.cdSector,v:e.sector}),t.jsx(Re,{k:r.cdStage,v:e.stage}),t.jsx(Re,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Re,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Re,{k:r.cdName,v:e.contactName}),t.jsx(Re,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Re,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Re,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Re,{k:r.cdAngle,v:e.angle}),t.jsx(Re,{k:r.cdDetected,v:Ys(e.date,n)})]}),p.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,x])=>x).map(([x,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:d})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Gs(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=M(),[s,p]=g.useState({}),x=25,d=g.useMemo(()=>n.slice(0,x),[n]);g.useEffect(()=>{d.length&&no(r,d.map(h=>h.name)).then(p)},[r,d]);const c=o.stats,u=h=>h.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),c&&typeof c.screened=="number"&&t.jsxs("p",{children:[u(c.screened)," ",e.funScreened(""),typeof c.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(c.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(c.screened/o.marketEstimate*100)," %"]})]})]}),d.map(h=>t.jsx(Ws,{o:h,qa:s[h.name]},h.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Ks=50;function Ra({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=M(),[o,l]=g.useState(null),[s,p]=g.useState(!1),[x,d]=g.useState(""),[c,u]=g.useState(0),[h,m]=g.useState(""),[b,v]=g.useState(!1),f=g.useRef(null);g.useEffect(()=>()=>{f.current&&window.clearInterval(f.current)},[]);const y=async w=>{p(!0),d("");const z=await a();if(p(!1),z.ok){l(z);return}if(z.busy){d(i.alertPreviewBusy);return}if(!w){d(i.alertPreviewFail);return}u(Ks),f.current=window.setInterval(()=>{u(T=>T>1?T-1:(f.current&&window.clearInterval(f.current),y(!1),0))},1e3)},j=async()=>{if(n||b)return;v(!0),m("");const w=await r();v(!1),m(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||c>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{j()},children:b?"…":i.alertTest})]}),c>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(c)}),x&&t.jsx("p",{className:"mnote warn",children:x}),h&&t.jsx("p",{className:"mnote",children:h}),!h&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const xt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function we({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=M();return nt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Qs(){const{st:e}=M();switch(e.modal){case"chain":return t.jsx(Js,{});case"space":return t.jsx(Zs,{});case"alert":return t.jsx(el,{});case"queue":return t.jsx(ol,{});case"export":return t.jsx(il,{});case"plug":return t.jsx(cl,{});case"recharge":return t.jsx(pl,{});case"cover":return t.jsx(fl,{});case"dossier":return t.jsx(ul,{});case"crit":return t.jsx(ml,{});case"tuto":return t.jsx(xl,{});case"rdv":return t.jsx(Xs,{});case"memoalert":return t.jsx(sl,{});default:return null}}function Xs(){const{dispatch:e,fund:a}=M(),r=typeof document<"u"&&!!document.getElementById("rdv");return g.useEffect(()=>{r&&(e({type:"modal",modal:null}),Zo())},[r,e]),r?null:t.jsx(io,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Js(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s}=M(),p=o==="client",x=e.chain.queue.map(h=>r.get(h)).filter(h=>!!h),d=e.chain.idx,c=x[d],u=d>=x.length;return nt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:u?n.finished:`${d+1} / ${x.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(u?100:d/Math.max(1,x.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:u||!c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(x.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:c.name}),t.jsx("div",{className:"sub",children:[ot(c.cc,i)||c.countryLabel,c.sector,c.stage,n.daysAgo(at(c.date))].filter(Boolean).map(h=>String(h).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ie(c.engine,i).toUpperCase()}),typeof c.amountEur=="number"&&c.amountEur>0&&t.jsx("span",{children:It(c.amountEur,i)})]}),xe(c)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(it,{o:c,lg:!0})," ",t.jsx(_t,{o:c,src:!0})]}),(c.tagline||c.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:c.tagline||c.headline})]}),c.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:c.reasoning})]}),p&&Ce(c)&&t.jsxs("div",{className:"vbox",style:{"--c":We(c)==="retenu"?"var(--brand)":We(c)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:We(c)==="retenu"?"✓ "+n.kept:We(c)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:c.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!u&&c&&!(p&&Ce(c))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(c)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(u?{type:"modal",modal:null}:{type:"chainNext"}),children:u?n.closeBtn:n.skip})]})]})})}),document.body)}function Zs(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=M(),o=i==="client",l=g.useMemo(()=>o?r.filter(c=>Ce(c)):[],[r,o]),s=g.useMemo(()=>za(l.filter(c=>We(c)==="retenu"),{key:"signal",dir:-1}),[l]),p=g.useMemo(()=>l.filter(c=>We(c)==="ecarte"),[l]),x=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(we,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(c=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof c.score=="number"&&c.score>0?c.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:c.name}),t.jsx("div",{className:"rr",children:c.reasoning||c.tagline||""})]})]},c.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function el(){const{mode:e}=M();return e==="client"||e==="apercu"?t.jsx(tl,{}):t.jsx(rl,{})}function tl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=M(),[o,l]=g.useState("d"),s=i!=="client";return t.jsxs(we,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(al,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(nl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(pr,{})]})}function al({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=g.useState(null),[s,p]=g.useState(!1),[x,d]=g.useState(0);g.useEffect(()=>{let m=!0;return p(!1),Va(a).then(b=>{m&&(b?l(b):p(!0))}),()=>{m=!1}},[a,x]);const c=m=>{r||Va(a,m).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=m=>!o.sections||o.sections.includes(m),h=m=>{const b=o.sections||e.alertSec.map(([v])=>v);c({sections:u(m)?b.filter(v=>v!==m):[...b,m]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>c({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>c({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>c({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>c({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([m,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(m),disabled:r,onChange:()=>h(m)}),t.jsxs("span",{children:[b,m==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},m))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ra,{label:e.alertPreview,readOnly:r,onPreview:()=>mo(a),onTest:()=>fo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function nl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=g.useState(null),[s,p]=g.useState(!1),[x,d]=g.useState(0);g.useEffect(()=>{let m=!0;return p(!1),Ha(a).then(b=>{m&&(b?l(b):p(!0))}),()=>{m=!1}},[a,x]);const c=m=>{r||Ha(a,m).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,h=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>c({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>c({dow:Number(m.target.value)}),children:e.alertDow.map((m,b)=>t.jsx("option",{value:b,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.max(6,h-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[h," h"]}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.min(21,h+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ra,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ho(a),onTest:()=>xo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function pr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=M(),[l,s]=g.useState(o||""),[p,x]=g.useState(!1),[d,c]=g.useState(!1);g.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,h=g.useMemo(()=>n.filter(f=>xe(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){c(!0);try{await fetch(`${ka}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{c(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Ie(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>ot(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([f,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,h)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function rl(){const{t:e}=M();return t.jsx(we,{title:e.alertTitle,icon:"🔔",children:t.jsx(pr,{})})}function ol(){var b,v,f;const{t:e,token:a,fund:r,mode:n,flash:i}=M(),[o,l]=g.useState(null),[s,p]=g.useState([]),[x,d]=g.useState(0),c=n==="client";g.useEffect(()=>{let y=!0;return(async()=>{const[j,w]=await Promise.all([Na(r),Rn(a)]);y&&(j&&l(j),p(w))})(),()=>{y=!1}},[a,r,x]);const u=(o==null?void 0:o.per_day)??2,h=((b=o==null?void 0:o.analyzed_today)==null?void 0:b.length)??0,m=(v=o==null?void 0:o.tomorrow)!=null&&v.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return t.jsxs(we,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(h,h+(((f=o==null?void 0:o.pool_order)==null?void 0:f.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),c&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Ua(a,y.company,"retry").then(()=>d(j=>j+1))},children:e.queueRetry}),c&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Ua(a,y.company,"delete").then(()=>d(j=>j+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[m.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),m.slice(0,10).map((y,j)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",j+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function il(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=M(),s=`${xt}/cibles/list.csv?token=${a}`,p=`${xt}/cibles/list.json?token=${a}`,x=`${xt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,c=v=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:x,href:x}],h=!i.lockActions&&n.length>0,m=()=>{Hs(Vs(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([f])=>f===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(we,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:f,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>c(f),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function sl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=M(),o=i!=="client",[l,s]=g.useState(null),[p,x]=g.useState(!1),[d,c]=g.useState(0),[u,h]=g.useState(!1);g.useEffect(()=>{let f=!0;return x(!1),_a(a).then(y=>{f&&(y?s(y):x(!0))}),()=>{f=!1}},[a,d]);const m=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=f=>{if(o||!l)return;const y={enabled:f.enabled??!!l.enabled,email:f.email??(l.email||""),sections:f.sections??m()};h(!0),_a(a,y).then(j=>{if(h(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(p)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(f=>f+1),children:e.retry})]})});if(!l)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=m();return t.jsxs(we,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(ll,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>b({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[f],disabled:o||u,onChange:()=>b({sections:{...v,[f]:!v[f]}})}),t.jsx("span",{children:y})]},f))}),t.jsx(Ra,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>oo(a,v),onTest:()=>ro(a,v)})]})}function ll({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=g.useState(e);g.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),p=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:x=>l(x.target.value),onKeyDown:x=>{x.key==="Enter"&&s&&p&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>i(o.trim()),children:n})]})]})}function cl(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=M(),[o,l]=g.useState(null),[s,p]=g.useState(!1),[x,d]=g.useState(null),[c,u]=g.useState(""),[h,m]=g.useState(0);g.useEffect(()=>{let f=!0;return p(!1),ra(a).then(y=>{f&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),lo(a).then(y=>{f&&d(y)}),()=>{f=!1}},[a,h]);const b=(f,y)=>{i&&ra(a,f).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}f.test&&j.sent===!1?n(e.plugTestThrottled):r(y),m(w=>w+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(we,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(f=>f+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:c,disabled:!i,onChange:f=>u(f.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!c.trim(),onClick:()=>b({url:c.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(dl,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function dl(){const{t:e,token:a,lang:r}=M(),[n,i]=g.useState("valides"),[o,l]=g.useState(!1),[s,p]=g.useState(null),[x,d]=g.useState(null),[c,u]=g.useState(!1),[h,m]=g.useState(!1),[b,v]=g.useState(null),[f,y]=g.useState(null),[j,w]=g.useState(null),z=`atl2:bulk:${a}:${n}`;g.useEffect(()=>{ra(a).then(k=>{y(k&&k.configured?k.url_hint||"webhook":null)})},[a]),g.useEffect(()=>{p(null),d(null),u(!1),v(null);try{const k=JSON.parse(localStorage.getItem(z)||"null");w(k&&Date.now()-Date.parse(k.t)<24*3600*1e3?k:null)}catch{w(null)}},[z]);const T=async()=>{l(!0),u(!1),v(null);const k=await po(a,n);p(k),d(k.ok?n:null),l(!1)},O=g.useRef(!1),F=async()=>{if(O.current)return;O.current=!0,m(!0);const k=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await uo(a,n,"webhook",void 0,k)}finally{O.current=!1}if(m(!1),u(!1),v(L),L.ok&&(L.pushed||0)>0){const A={t:new Date().toISOString(),n:L.pushed||0};w(A);try{localStorage.setItem(z,JSON.stringify(A))}catch{}}},E=s!=null&&s.ok&&s.ready||0,q=!!(s!=null&&s.ok)&&x===n&&E>0&&!!f&&!j,N=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:k=>i(k.target.value),children:e.plugBulkTabs.map(([k,L])=>t.jsx("option",{value:k,children:L},k))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{T()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(N,j.n)}),!j&&!!(s!=null&&s.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),q&&!c&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),q&&c&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(E,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:h,onClick:()=>{F()},children:h?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:h,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function pl(){const{t:e,data:a,lang:r}=M(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const x=await(await fetch(`${ka}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(we,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function ul(){const{t:e}=M();return t.jsx(we,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Gs,{})})}function fl(){const{t:e,lang:a,data:r,dossiers:n,token:i,canWrite:o,flash:l}=M(),[s,p]=g.useState(null),[x,d]=g.useState(!1);g.useEffect(()=>{let T=!0;return Na(i).then(O=>{T&&O&&typeof O.per_day=="number"&&p(O.per_day)}),()=>{T=!1}},[i]);const c=r.stats,u=typeof(c==null?void 0:c.screened)=="number"?c.screened:n.filter(T=>T.kind==="target"&&Ce(T)).length,h=r.marketEstimate||0,m=h>0?Math.min(100,Math.round(u/h*100)):null,b=(c==null?void 0:c.window_days)||30,v=u>0?u/b:0,f=h>0?Math.max(0,h-u):0,j=h>0&&v>0&&u>=100?Math.round(f/v):null,w=T=>Math.round(T).toLocaleString(a==="en"?"en-US":"fr-FR"),z=T=>{x||!o||(d(!0),co(i,T).then(O=>{if(d(!1),O===null){l(e.actErr);return}p(O),l(e.alertSaved)}))};return t.jsxs(we,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(u))}),h>0&&t.jsx("span",{children:e.covOf(w(h))})]}),m!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:m+"%"}}),t.jsxs("em",{children:[m," %"]})]}),j!==null&&t.jsx("p",{className:"mnote",children:e.covEta(j)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),v>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(v))}),c&&t.jsxs("div",{className:"covf",children:[typeof c.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.kept)})," ",e.covKept]}),typeof c.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.analyzed)})," ",e.covAna]}),typeof c.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.shown)})," ",e.covShown]})]}),o&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(T=>t.jsx("button",{type:"button",className:s===T?"on":"",disabled:x,onClick:()=>z(T),children:T===0?"⏸":T},T))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function ml(){var f,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o}=M(),l=n==="client",s=g.useMemo(()=>{const w=new Set;return a.forEach(z=>{z.angle&&w.add(z.angle)}),[...w]},[a]),[p,x]=g.useState(null);g.useEffect(()=>{let w=!0;return so(r).then(z=>{w&&x(z.thumbs)}),()=>{w=!1}},[r]);const[d,c]=g.useState(""),[u,h]=g.useState(""),[m,b]=g.useState(!1),v=async()=>{const w=d.trim();if(!(!w||m||!l)){b(!0),h("");try{const T=await(await fetch(`${xt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&h(String(T.reply)),T.job_id){h(e.critChatRunning);const O=async()=>{const F=await fetch(`${xt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(E=>E.json()).catch(()=>null);if(F&&F.done){h(String(F.reply||F.clarification||F.summary||"✓")),b(!1),F.applied&&i(e.alertSaved);return}setTimeout(()=>{O()},8e3)};setTimeout(()=>{O()},8e3),c("");return}c("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(we,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((f=o.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var z,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((z=w.look)!=null&&z.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(O=>t.jsx("li",{children:O},O))})]}),!!((T=w.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(O=>t.jsx("li",{children:O},O))})]})]})]},w.title)})]}),!!((j=o==null?void 0:o.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!l||m,onChange:w=>c(w.target.value),onKeyDown:w=>{w.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!l||m||!d.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,z)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},z))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(cr[w]||"v-cons"),children:w}),t.jsx("span",{children:z})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",z]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function xl(){const{t:e,dispatch:a,startTour:r}=M(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(we,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const ta={},En=(ta==null?void 0:ta.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function zn(){return new Date().toISOString().slice(0,10)}const ur=g.createContext(null);function fr(){const e=g.useContext(ur);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function hl({token:e,children:a}){const{dispatch:r,st:n,lang:i}=M(),[o,l]=g.useState(()=>n.filters.day||zn()),[s,p]=g.useState(null),[x,d]=g.useState(!1),c=g.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=g.useCallback(()=>{l(zn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);g.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),g.useEffect(()=>{const b=v=>{var y;const f=(y=v.detail)==null?void 0:y.day;typeof f=="string"&&c(f)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[c]),g.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),g.useEffect(()=>{if(!e||!o)return;let b=!1;d(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${En}/cibles/edition.json?${v}`).then(f=>f.json()).then(f=>{b||p(f)}).catch(()=>{b||p({ok:!1,error:"network"})}).finally(()=>{b||d(!1)}),()=>{b=!0}},[e,o]);const h=g.useMemo(()=>`${En}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=g.useMemo(()=>({token:e,day:o,ed:s,loading:x,pickDay:c,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:h,isEn:i==="en"}),[e,o,s,x,c,u,n.filters.day,h,i]);return t.jsx(ur.Provider,{value:m,children:a})}function gl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=fr();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["No thesis brief for ",t.jsx("b",{children:e})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):t.jsxs(t.Fragment,{children:["Pas encore de brief de thèse pour le ",t.jsx("b",{children:e}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const mr="atl2:mapfold",vl=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(mr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},xr=g.createContext(null),M=()=>{const e=g.useContext(xr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function it({o:e,lg:a}){const{lang:r}=M(),n=xe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ya(n,r),children:[n.emoji," ",Ya(n,r)]}):null}function _t({o:e,src:a}){const{lang:r,t:n}=M(),i=xe(e);if(!i)return null;const o=ko(i),l=jo(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Mn(i,r))+" · "+n.win7(Fn(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<o?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function hr({o:e}){const{lang:a}=M(),r=wo(e.cc),n=e.cc?ot(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const An="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",gr=e=>`atl2:tour:${e||"anon"}`;function yl(e){try{return localStorage.getItem(gr(e))==="1"}catch{return!0}}function Tn(e){try{localStorage.setItem(gr(e),"1")}catch{}}function wl(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function El({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){const{lang:l}=bo(),s=Lo[l],p=_o(e,l,a),[x,d]=g.useReducer(Vo,void 0,()=>Uo((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||vl(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),c=g.useRef(!0);g.useEffect(()=>{if(c.current){c.current=!1;return}if(!e)try{localStorage.setItem(mr,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e]);const u=g.useRef(o);u.current=o,g.useEffect(()=>{var C;(C=u.current)==null||C.call(u,x.filters)},[x.filters]);const[h,m]=g.useState(null),[b,v]=g.useState(null),[f,y]=g.useState({kept:0,dropped:0}),[j,w]=g.useState(!1),[z,T]=g.useState(""),[O,F]=g.useState(!1),[E,q]=g.useState(null),[N,k]=g.useState(!1),[L,A]=g.useState(!1),[,S]=g.useState(0),R=()=>S(C=>C+1),D=g.useRef([]),B=g.useRef(new Set),H=g.useRef(new Set),ae=g.useRef(new Map),ie=g.useRef(null),{mode:de}=p,K=g.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[p.caps,i,a]),_=K.pipe,U=p.session.token||"",V=de==="client"&&!e;g.useEffect(()=>{if(document.querySelector(`link[href="${An}"]`))return;const C=document.createElement("link");C.rel="stylesheet",C.href=An,document.head.appendChild(C)},[]);const ee=(C,I=!1)=>{T(C),F(I),ie.current&&clearTimeout(ie.current),ie.current=setTimeout(()=>T(""),I?4200:2400)},se=C=>ee(C,!0),ve=g.useMemo(()=>{const C=new Map;return p.dossiers.forEach(I=>{I.id&&C.set(I.id,I)}),C},[p.dossiers]),pe=g.useMemo(()=>p.dossiers.filter(C=>In(C,x,_)),[p.dossiers,x,_]),W=g.useRef(!1);g.useEffect(()=>{if(W.current||e||p.loading||!p.dossiers.length)return;if(!K.showFunnel||yl(p.session.token||"")){W.current=!0;return}W.current=!0;const C=window.setTimeout(()=>{Tn(p.session.token||""),k(!0)},700);return()=>window.clearTimeout(C)},[e,p.loading,p.dossiers.length,K.showFunnel,p.session.token]);const X=g.useMemo(()=>p.dossiers.filter(C=>Ho(C,x,_,p.favIds)),[p.dossiers,x,_,p.favIds]),he=g.useMemo(()=>vo(pe,p.favIds),[pe,p.favIds]),Y=Sa.find(C=>C.key===x.continent),re=x.continent==="monde"?s.contWorld:(l==="fr"?Y==null?void 0:Y.fr:Y==null?void 0:Y.en)||"";g.useEffect(()=>{const C=I=>{var te;const $=(((te=I.detail)==null?void 0:te.name)||"").trim();$&&Q(null,$)};return window.addEventListener("ppmap:evaluate",C),()=>window.removeEventListener("ppmap:evaluate",C)}),g.useEffect(()=>{const C=te=>{const Le=String(te||"").trim();Le&&d({type:"filters",patch:{sector:[Le]}})},I=te=>{var Le;return C((Le=te.detail)==null?void 0:Le.sector)},$=te=>{te.data&&te.data.type==="pp-filter"&&C(te.data.sector)};return window.addEventListener("ppmap:filter",I),window.addEventListener("message",$),()=>{window.removeEventListener("ppmap:filter",I),window.removeEventListener("message",$)}},[]);const Q=(C,I)=>{const $=((C==null?void 0:C.name)||I||"").trim();if(!V){v({kicker:$});return}!$||j||(w(!0),(async()=>{try{const te=await qn(U,$,"atelier2"),Le={name:te.company||$,verdict:te.verdict,reason:te.reason||"",remaining:te.remaining??null};D.current=[Le,...D.current].slice(0,8),te.verdict==="kept"&&y(Ve=>({...Ve,kept:Ve.kept+1})),te.verdict==="ruled_out"&&y(Ve=>({...Ve,dropped:Ve.dropped+1}));const lt=C||p.dossiers.find(Ve=>(Ve.name||"").toLowerCase()===$.toLowerCase());lt&&(te.verdict==="kept"?lt.verdict=lt.verdict||"MATCH":te.verdict==="ruled_out"&&(lt.verdict="NO MATCH"),te.reason&&(lt.reasoning=te.reason)),R()}finally{w(!1)}})())},Be=C=>{if(!V){v({kicker:C.name});return}B.current.add(C.id),ct(U,"fast_request",C.name||"",""),ee(s.memoInstantSent(C.name)),R()},ue=C=>ae.current.get(C.id)??p.thumbs.get((C.name||"").trim().toLowerCase()),fe=(C,I)=>d({type:"undoPush",entry:{id:C.id,name:C.name,prevCeoStatus:I}}),Me=async(C,I,$)=>{const te=C.ceoStatus||"";C.ceoStatus=I,R();const Le=await Wt(U,{status:I,airtable_id:C.airtableId,check_id:C.checkId,company:C.name,...($==null?void 0:$.note)!==void 0?{note:$.note}:{},...$!=null&&$.via?{via:$.via}:{}});return Le.ok?Le.skipped?(C.ceoStatus=te,R(),se(s.actNotPersisted),!1):(($==null?void 0:$.undo)!==!1&&fe(C,te),$!=null&&$.msg&&ee($.msg),(I==="Validé"||I==="Écarté")&&!C.ceoNote&&($==null?void 0:$.note)===void 0&&q({o:C,yes:I==="Validé"}),!0):(C.ceoStatus=te,R(),se(s.actErr),!1)},Ue=async(C,I)=>{const $=await Wt(U,{status:C.ceoStatus||"Retenu",airtable_id:C.airtableId,check_id:C.checkId,company:C.name,note:I,via:"note"});return!$.ok||$.skipped?(se($.skipped?s.actNotPersisted:s.actErr),!1):(C.ceoNote=I,R(),!0)},je=g.useRef(new Map),Fe=C=>je.current.has(C.id)?je.current.get(C.id):p.stages.get((C.name||"").trim().toLowerCase()),st=(C,I)=>{je.current.set(C.id,I),R()},Ut=(C,I)=>{V&&Me(C,I?"Validé":"Écarté",{msg:I?s.decidedYes(C.name):s.decidedNo(C.name)})},Vt=C=>{V&&Me(C,"À trancher",{msg:s.promoted(C.name)})},P=C=>{V&&(async()=>{const I=C.ceoStatus||"";C.ceoStatus="Retenu",R();const $=await Wt(U,{status:"Retenu",check_id:C.checkId,company:C.name});if(!$.ok||$.skipped){C.ceoStatus=I,R(),se($.skipped?s.actNotPersisted:s.actErr);return}fe(C,I),ee(s.repeched(C.name))})()},J=()=>{const C=x.undo[x.undo.length-1];if(!C){ee(s.undoNone);return}const I=ve.get(C.id);if(!I){d({type:"undoPop"}),ee(s.undoNone);return}let $=C.prevCeoStatus;if(!$)if((I.verdict||"").toUpperCase().includes("CALL"))$="À trancher";else{ee(s.undoLockedTitle);return}(async()=>await Me(I,$,{undo:!1})&&(d({type:"undoPop"}),I.ceoStatus=C.prevCeoStatus,R(),ee(s.undoDone(I.name))))()},oe=C=>{V&&(H.current.add(C.id),R(),(async()=>{const I=await No(U,C.name,"email");if(!I||I.ok===!1){H.current.delete(C.id),R(),se(s.actErr);return}ct(U,"approach",C.name||"",""),ee(s.actApproachSent)})())},ge=(C,I)=>{V&&(async()=>{if(!(await ct(U,I?"yes":"no",C.name||"","")).ok){se(s.actErr);return}ae.current.set(C.id,I?"yes":"no"),R(),ee(I?s.thumbUpDone:s.thumbDnDone)})()},$e=C=>{!V||!Ca(C)||(ct(U,"detailed_request",C.name||"",""),ee(s.memoDeepSent(C.name)))},ye=C=>{const I=new Set(p.favIds),$=I.has(C.id);$?I.delete(C.id):I.add(C.id),p.setFavIds(I),V&&So(U,{id:C.id,co:C.name},$)},Ne=()=>{!V||L||window.confirm(s.identSyncConfirm)&&(A(!0),(async()=>{const C=await Co(U);A(!1),C?ee(s.identSyncDone):se(s.actErr)})())},_e=/proplace/i.test(p.fund||""),br=C=>{!V||!_e||(ct(U,"onboard_request",C.name||"",""),ee(s.onboardSent(C.name)))},vr={st:x,dispatch:d,t:s,lang:l,mode:de,caps:K,pipe:_,token:U,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:P,thumbOf:ue,canWrite:V,commitStatus:Me,saveNote:Ue,stageOf:Fe,setStage:st,flashErr:se,startTour:()=>k(!0),dossiers:p.dossiers,scopedAll:pe,scoped:X,counts:he,byId:ve,contName:re,favIds:p.favIds,toggleFav:ye,askEvaluate:Q,doAnalyse:Be,doDecide:Ut,doPromote:Vt,doApproach:oe,doThumb:ge,doDeep:$e,doUndo:J,doSync:Ne,doOnboard:br,outbound:_e,memoQueued:B.current,approachDone:H.current,sessTally:f,evalCards:D.current,evalBusy:j,markRow:m,markedId:h,flash:ee};g.useEffect(()=>{const C=I=>{I.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[]);const yr=C=>U?t.jsx(hl,{token:U,children:C}):t.jsx(t.Fragment,{children:C});return t.jsx(xr.Provider,{value:vr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:qo}),yr(t.jsxs("div",{className:"app"+(_?" pipe":"")+(U?" has-thesis":""),children:[K.showTicker&&t.jsx(me,{name:"live",children:t.jsxs("div",{className:"live-stack"+(U?" live-stack--cibles":""),children:[t.jsx(Qo,{}),!!U&&t.jsx(gl,{})]})}),K.showIdent&&t.jsx(me,{name:"identite",children:t.jsx(fi,{})}),K.showOnb&&t.jsx(me,{name:"onboarding",children:t.jsx(mi,{})}),K.showMorning&&t.jsx(me,{name:"matin",children:t.jsx(ui,{})}),t.jsx(me,{name:"fraicheur",children:t.jsx(ri,{})}),t.jsx(me,{name:"mesure",children:t.jsx(oi,{})}),K.showFunnel&&t.jsx(me,{name:"entonnoir",children:t.jsx(kl,{})}),K.showFunnel&&t.jsx(me,{name:"tunnel",children:t.jsx(hi,{})}),K.showFunnel&&t.jsx(me,{name:"tuto",children:t.jsx(bi,{})}),t.jsx(me,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(jl,{}),t.jsxs("div",{className:"stage"+(x.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(xs,{}),t.jsx(gs,{})]})]})}),K.showDemand&&t.jsx(me,{name:"evaluation",children:t.jsx(js,{})}),K.showDemand&&x.memoConsole&&t.jsx(me,{name:"console",children:t.jsx(Ss,{})}),t.jsx(me,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(_s,{})}),!!U&&t.jsx(me,{name:"edition",children:t.jsx(bl,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),K.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),x.popupId&&t.jsx(me,{name:"fiche",children:t.jsx(zs,{})}),t.jsx(me,{name:"modales",children:t.jsx(Qs,{})}),t.jsx(ti,{}),E&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:E.o.name}),t.jsx(ci,{placeholder:E.yes?s.whyYesPh:s.whyNoPh,onDone:C=>{const I=E.o;q(null),C&&Ue(I,C).then($=>{$&&ee(s.csNoteSaved)})}})]}),N&&t.jsx(pi,{steps:wl(s),onClose:()=>{k(!1),Tn(U)}}),z&&t.jsx("div",{className:"flash on"+(O?" err":""),children:z}),b&&t.jsx(yo,{variant:"acquirer",initialCompany:Ln().co,initialWebsite:Ln().site,onClose:()=>v(null)})]})})}function kl(){const{t:e}=M(),[a,r]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function jl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:i,t:o}=M(),l=g.useMemo(()=>{const s={};return e.forEach(p=>{Ea(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[Eo.map(s=>{const p=Sa.find(d=>d.key===s),x=s==="monde"?o.contWorld:i==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[x,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Ln(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Nl(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{hr as FlagCell,it as SigBadge,_t as SigWin,El as default,Nl as fmtShort,M as useV2};
